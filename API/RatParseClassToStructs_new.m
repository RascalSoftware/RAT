function [problemDef,problemDef_cells,problemDef_limits,controls] = RatParseClassToStructs_new(inputProblemDef,inputControls)
...
backsNames = inputStruct.backParNames;          % *****8 ToDo

...
Oxide_hydr = params(3);
Alloy_thick = params(4);
Alloy_rough = params(5); 
Alloy_SLD = params(6);
Gold_Thick = params(7);
Gold_SLD = params(8);
Gold_rough = params(9);
...
% Oxide is 'hydrated' with alloy, so make calculate the oxide SLD
% as if a hudration....
oxide_sld = (Oxide_hydr * Alloy_SLD) + ((1 - Oxide_hydr) * 3.41e-6);
sldOx = VF_ox * oxide_sld;

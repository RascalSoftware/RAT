classdef reflContrastsClass < handle
    ...
    methods
        ...
        function  obj = reflContrastsClass()
            % Class Constructor
            %obj.addContrast({},{'name','Contrast 1'});
        end
        
        function obj = addReflContrast(obj, allowedNames, varargin)
        ...
        function obj = setReflContrastModel(obj, whichContrast, modelType, allowedNames, varargin)
        ...
        function obj = setReflContrast(obj, whichContrast, allowedNames, varargin)
...
%                     thisContrast.model = modelArray;
                %otherwise
                    ...
                    if ~isempty(inputBlock.domainRatio)
        ...
        function displayReflContrastsObject(obj)
            makeContrastsTable(obj);
            fprintf('    Reflectivity Constrasts: ---------------------------------------------------------------------------------------- \n\n');
        ...
        function obj = makeContrastsTable(obj)
            ...
            val = ["name";"Data";"Background";"Bulk in";"Bulk out";"Scalefactor";"Resolution";"Resample";"domainRatio";"Model"];
            ...
            for i = 1:nContrasts
                ...
                if isempty(thisModel)
                    ...
                    for n = 1:length(thisModel)
                        contrastsCell(10+(n-1),i) = {thisModel(n)};
                    end
                end
            end

...
static emlrtRSInfo kg_emlrtRSI = { 31, /* lineNo */
...
static emlrtRTEInfo wl_emlrtRTEI = { 9,/* lineNo */
  7,                                   /* colNo */
  "abeles_paraPoints",                 /* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/Abeles/abeles_paraPoints.m"/* pName */
};
  ...
  rfinal, real_T layers, real_T points, emxArray_real_T *out)
{
  ...
  i1 = out->size[0];
  out->size[0] = i;
  emxEnsureCapacity_real_T(sp, out, i1, &wl_emlrtRTEI);
  ...
  for (loop = 0; loop < i; loop++) {
    ...
    i1 = loop + 1;
    if ((i1 < 1) || (i1 > x->size[1])) {
      emlrtDynamicBoundsCheckR2012b(i1, 1, x->size[1], &ei_emlrtBCI, sp);
    }
    ...
    blast_im = 0.0;
    if (1 > sld->size[0]) {
      emlrtDynamicBoundsCheckR2012b(1, 1, sld->size[0], &di_emlrtBCI, sp);
    }
    ...
    for (reploop = 0; reploop < i2; reploop++) {
      ...
      for (nl = 0; nl < i3; nl++) {
        ...
        if ((i1 < 1) || (i1 > sld->size[0])) {
          emlrtDynamicBoundsCheckR2012b(i1, 1, sld->size[0], &ci_emlrtBCI, sp);
        }

        i1 = nl + 1;
        if ((i1 < 1) || (i1 > sld->size[0])) {
          emlrtDynamicBoundsCheckR2012b(i1, 1, sld->size[0], &bi_emlrtBCI, sp);
        }

        i1 = (int32_T)(nl + 1U);
        if ((i1 < 1) || (i1 > sld->size[0])) {
          emlrtDynamicBoundsCheckR2012b(i1, 1, sld->size[0], &fi_emlrtBCI, sp);
        }
    ...
    if ((i1 < 1) || (i1 > out->size[0])) {
      emlrtDynamicBoundsCheckR2012b(i1, 1, out->size[0], &gi_emlrtBCI, sp);
    }

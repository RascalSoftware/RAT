...
static emlrtRSInfo pf_emlrtRSI = { 28, /* lineNo */
...
static emlrtRTEInfo qb_emlrtRTEI = { 39,/* lineNo */
  19,                                  /* colNo */
  "abeles_single",                     /* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/Abeles/abeles_single.m"/* pName */
};
                   ...
                   emxArray_real_T *out)
{
  ...
  i1 = out->size[0];
  out->size[0] = i;
  emxEnsureCapacity_real_T(sp, out, i1, &vk_emlrtRTEI);
  ...
  for (loop = 0; loop < i; loop++) {
    ...
    i1 = loop + 1;
    if ((i1 < 1) || (i1 > x->size[1])) {
      emlrtDynamicBoundsCheckR2012b(i1, 1, x->size[1], &jf_emlrtBCI, sp);
    }
    ...
    blast_im = 0.0;
    if (1 > sld->size[0]) {
      emlrtDynamicBoundsCheckR2012b(1, 1, sld->size[0], &if_emlrtBCI, sp);
    }
    ...
    emlrtForLoopVectorCheckR2012b(1.0, 1.0, nrepeats, mxDOUBLE_CLASS, (int32_T)
      nrepeats, &qb_emlrtRTEI, sp);
    for (reploop = 0; reploop < i2; reploop++) {
      covrtLogFor(&emlrtCoverageInstance, 17U, 0U, 1, 1);
      for (nl = 0; nl < i3; nl++) {
        covrtLogFor(&emlrtCoverageInstance, 17U, 0U, 2, 1);
        covrtLogBasicBlock(&emlrtCoverageInstance, 17U, 2U);
        i1 = nl + 1;
        if ((i1 < 1) || (i1 > sld->size[0])) {
          emlrtDynamicBoundsCheckR2012b(i1, 1, sld->size[0], &hf_emlrtBCI, sp);
        }

        i1 = nl + 1;
        if ((i1 < 1) || (i1 > sld->size[0])) {
          emlrtDynamicBoundsCheckR2012b(i1, 1, sld->size[0], &gf_emlrtBCI, sp);
        }

        i1 = (int32_T)(nl + 1U);
        if ((i1 < 1) || (i1 > sld->size[0])) {
          emlrtDynamicBoundsCheckR2012b(i1, 1, sld->size[0], &kf_emlrtBCI, sp);
        }
      ...
      covrtLogFor(&emlrtCoverageInstance, 17U, 0U, 2, 0);
    }

    covrtLogFor(&emlrtCoverageInstance, 17U, 0U, 1, 0);
    ...
    if ((i1 < 1) || (i1 > out->size[0])) {
      emlrtDynamicBoundsCheckR2012b(i1, 1, out->size[0], &lf_emlrtBCI, sp);
    }

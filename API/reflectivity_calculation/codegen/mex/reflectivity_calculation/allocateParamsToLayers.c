...
static emlrtBCInfo bf_emlrtBCI = { -1, /* iFirst */
  ...
  "/home/arwel/Documents/RascalDev/RAT_new/targetFunctions/common/groupLayers/allocateParamsToLayers.m",/* pName */
  0                                    /* checkKind */
};
...
static emlrtRTEInfo wf_emlrtRTEI = { 9,/* lineNo */
  20,                                  /* colNo */
  "allocateParamsToLayers",            /* fName */
  "/home/arwel/Documents/RascalDev/RAT_new/targetFunctions/common/groupLayers/allocateParamsToLayers.m"/* pName */
};
  ...
  const emxArray_cell_wrap_2 *layersDetails, emxArray_cell_wrap_13 *outLayers)
{
  ...
  emxEnsureCapacity_cell_wrap_13(sp, outLayers, i, &wf_emlrtRTEI);
  i = layersDetails->size[0];
  for (b_i = 0; b_i < i; b_i++) {
    i1 = layersDetails->size[0] - 1;
    if (b_i > i1) {
      emlrtDynamicBoundsCheckR2012b(b_i, 0, i1, &cf_emlrtBCI, sp);
    }
    ...
    for (b_n = 0; b_n <= i1 - 2; b_n++) {
      ...
      if (!muDoubleScalarIsNaN(layersDetails->data[b_i].f1->data[b_n])) {
        ...
        if ((i2 < 1) || (i2 > params->size[1])) {
          emlrtDynamicBoundsCheckR2012b(i2, 1, params->size[1], &ff_emlrtBCI, sp);
        }
    ...
    if (layersDetails->data[b_i].f1->size[1] < 1) {
      emlrtDynamicBoundsCheckR2012b(layersDetails->data[b_i].f1->size[1], 1,
        layersDetails->data[b_i].f1->size[1], &df_emlrtBCI, sp);
    }

...
static emlrtDCInfo ad_emlrtDCI = { 3,  /* lineNo */
  8,                                   /* colNo */
...
static emlrtRTEInfo yr_emlrtRTEI = { 6,/* lineNo */
  9,                                   /* colNo */
  "applyBackgroundCorrection",         /* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/callReflectivity/applyBackgroundCorrection.m"/* pName */
};

static emlrtRTEInfo as_emlrtRTEI = { 7,/* lineNo */
  9,                                   /* colNo */
  "applyBackgroundCorrection",         /* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/callReflectivity/applyBackgroundCorrection.m"/* pName */
};

static emlrtRTEInfo bs_emlrtRTEI = { 10,/* lineNo */
  28,                                  /* colNo */
  "applyBackgroundCorrection",         /* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/callReflectivity/applyBackgroundCorrection.m"/* pName */
};
  ...
  backsType)
{
  ...
  if (backsType != (int32_T)muDoubleScalarFloor(backsType)) {
    emlrtIntegerCheckR2012b(backsType, &ad_emlrtDCI, sp);
  }
  ...
  switch ((int32_T)backsType) {
   case 1:
    ...
    reflect->size[1] = 2;
    emxEnsureCapacity_real_T(sp, reflect, i, &yr_emlrtRTEI);
    i = Simul->size[0] * Simul->size[1];
    Simul->size[1] = 2;
    emxEnsureCapacity_real_T(sp, Simul, i, &as_emlrtRTEI);
   ...
   case 2:
    emxInit_real_T(sp, &b_shifted_dat, 1, &bs_emlrtRTEI, true);
    ...
    emxEnsureCapacity_real_T(sp, b_shifted_dat, i, &bs_emlrtRTEI);
    for (i = 0; i <= loop_ub; i++) {

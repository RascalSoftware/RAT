...
static emlrtRSInfo ff_emlrtRSI = { 43, /* lineNo */
  "callReflectivity",                  /* fcnName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"/* pathName */
};

static emlrtRSInfo gf_emlrtRSI = { 62, /* lineNo */
  "callReflectivity",                  /* fcnName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"/* pathName */
};

static emlrtRSInfo hf_emlrtRSI = { 63, /* lineNo */
  "callReflectivity",                  /* fcnName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"/* pathName */
};

static emlrtRSInfo if_emlrtRSI = { 69, /* lineNo */
  "callReflectivity",                  /* fcnName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"/* pathName */
};

static emlrtRSInfo jf_emlrtRSI = { 71, /* lineNo */
  "callReflectivity",                  /* fcnName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"/* pathName */
};
...
static emlrtRSInfo lf_emlrtRSI = { 103,/* lineNo */
  "colon",                             /* fcnName */
  "/usr/local/MATLAB/R2020a/toolbox/eml/lib/matlab/ops/colon.m"/* pathName */
};

static emlrtRSInfo hg_emlrtRSI = { 55, /* lineNo */
  "callReflectivity",                  /* fcnName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"/* pathName */
};
...
static emlrtRTEInfo pj_emlrtRTEI = { 23,/* lineNo */
  5,                                   /* colNo */
  "callReflectivity",                  /* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"/* pName */
};

static emlrtRTEInfo qj_emlrtRTEI = { 26,/* lineNo */
  5,                                   /* colNo */
  "callReflectivity",                  /* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"/* pName */
};

static emlrtRTEInfo rj_emlrtRTEI = { 36,/* lineNo */
  5,                                   /* colNo */
  "callReflectivity",                  /* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"/* pName */
};

static emlrtRTEInfo sj_emlrtRTEI = { 48,/* lineNo */
  1,                                   /* colNo */
  "callReflectivity",                  /* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"/* pName */
};

static emlrtRTEInfo tj_emlrtRTEI = { 43,/* lineNo */
  5,                                   /* colNo */
  "callReflectivity",                  /* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"/* pName */
};

static emlrtRTEInfo uj_emlrtRTEI = { 63,/* lineNo */
  44,                                  /* colNo */
  "callReflectivity",                  /* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"/* pName */
};

static emlrtRTEInfo vj_emlrtRTEI = { 69,/* lineNo */
  11,                                  /* colNo */
  "callReflectivity",                  /* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"/* pName */
};

static emlrtRTEInfo wj_emlrtRTEI = { 71,/* lineNo */
  1,                                   /* colNo */
  "callReflectivity",                  /* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"/* pName */
};

static emlrtRTEInfo xj_emlrtRTEI = { 73,/* lineNo */
  15,                                  /* colNo */
  "callReflectivity",                  /* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"/* pName */
};
...
static emlrtRTEInfo ak_emlrtRTEI = { 55,/* lineNo */
  9,                                   /* colNo */
  "callReflectivity",                  /* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"/* pName */
};

static emlrtRTEInfo cl_emlrtRTEI = { 56,/* lineNo */
  44,                                  /* colNo */
  "callReflectivity",                  /* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"/* pName */
};
  ...
  emxArray_real_T *reflectivity, emxArray_real_T *Simulation)
{
  ...
  /* this_data = allData{i}; */
  emxInit_real_T(sp, &slds, 2, &pj_emlrtRTEI, true);
  if (covrtLogIf(&emlrtCoverageInstance, 16U, 0U, 0, layers->size[0] == 0)) {
    ...
    slds->size[0] = 1;
    slds->size[1] = 3;
    emxEnsureCapacity_real_T(sp, slds, i, &pj_emlrtRTEI);
    slds->data[0] = 0.0;
    slds->data[1] = nbairs;
    slds->data[2] = 0.0;
    lays = 0;
    ...
    slds->size[1] = 3;
    emxEnsureCapacity_real_T(sp, slds, i, &qj_emlrtRTEI);
    for (i = 0; i < 3; i++) {
  ...
  if (1 > this_data->size[0]) {
    emlrtDynamicBoundsCheckR2012b(1, 1, this_data->size[0], &of_emlrtBCI, sp);
  }

  emxInit_real_T(sp, &firstSection, 2, &rj_emlrtRTEI, true);
  if (covrtLogIf(&emlrtCoverageInstance, 16U, 0U, 1, simLimits[0] <
    ...
    if (2 > this_data->size[0]) {
      emlrtDynamicBoundsCheckR2012b(2, 1, this_data->size[0], &pf_emlrtBCI, sp);
    }

    if (1 > this_data->size[0]) {
      emlrtDynamicBoundsCheckR2012b(1, 1, this_data->size[0], &qf_emlrtBCI, sp);
    }

    step = this_data->data[1] - this_data->data[0];
    if (1 > this_data->size[0]) {
      emlrtDynamicBoundsCheckR2012b(1, 1, this_data->size[0], &rf_emlrtBCI, sp);
    }
    ...
    if (muDoubleScalarIsNaN(step) || muDoubleScalarIsNaN(b)) {
      ...
      emxEnsureCapacity_real_T(&st, firstSection, i, &rj_emlrtRTEI);
  ...
  emxInit_real_T(sp, &lastSection, 2, &tj_emlrtRTEI, true);
  if (covrtLogIf(&emlrtCoverageInstance, 16U, 0U, 2, simLimits[1] >
    ...
    if ((i < 1) || (i > this_data->size[0])) {
      emlrtDynamicBoundsCheckR2012b(i, 1, this_data->size[0], &lf_emlrtBCI, sp);
    }
    ...
    if (muDoubleScalarIsNaN(b) || muDoubleScalarIsNaN(step)) {
      ...
      emxEnsureCapacity_real_T(&st, lastSection, i, &tj_emlrtRTEI);
  ...
  emxInit_real_T(sp, &simXdata, 2, &sj_emlrtRTEI, true);
  ...
  simXdata->size[1] = (firstSection->size[1] + this_data->size[0]) +
    lastSection->size[1];
  emxEnsureCapacity_real_T(sp, simXdata, i, &sj_emlrtRTEI);
  ...
  emxInit_real_T(sp, &simRef, 1, &ak_emlrtRTEI, true);
  emxInit_real_T(sp, &b_simRef, 1, &cl_emlrtRTEI, true);
  ...
  emxEnsureCapacity_real_T(sp, b_simRef, i, &cl_emlrtRTEI);
  ...
  emxEnsureCapacity_real_T(sp, firstSection, i, &vj_emlrtRTEI);
  loop_ub = this_data->size[0] - 1;
  for (i = 0; i <= loop_ub; i++) {
    lays = (int32_T)((i + splits_idx_0) + 1U);
    if ((lays < 1) || (lays > simRef->size[0])) {
      emlrtDynamicBoundsCheckR2012b(lays, 1, simRef->size[0], &jf_emlrtBCI, sp);
    }
  ...
  emxEnsureCapacity_real_T(&b_st, reflectivity, i, &wj_emlrtRTEI);
  for (i = 0; i < loop_ub; i++) {
  ...
  emxEnsureCapacity_real_T(&st, b_simRef, i, &xj_emlrtRTEI);
  ...
  Simulation->size[1] = 2;
  emxEnsureCapacity_real_T(&b_st, Simulation, i, &yj_emlrtRTEI);
                      ...
                      emxArray_real_T *Simulation)
{
  ...
  emxFree_real_T(&lastSection);
  emxInit_real_T(sp, &simRef, 1, &ak_emlrtRTEI, true);
  emxInit_real_T(sp, &b_simRef, 1, &uj_emlrtRTEI, true);
  splits_idx_0 = (uint32_T)firstSection->size[1];
  ...
  i = b_simRef->size[0];
  b_simRef->size[0] = simRef->size[0];
  emxEnsureCapacity_real_T(sp, b_simRef, i, &uj_emlrtRTEI);
  loop_ub = simRef->size[0] - 1;
  emxFree_real_T(&slds);
  for (i = 0; i <= loop_ub; i++) {
    b_simRef->data[i] = simRef->data[i];

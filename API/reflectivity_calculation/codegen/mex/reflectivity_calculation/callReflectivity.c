...
static emlrtRTEInfo rk_emlrtRTEI = { 23,/* lineNo */
  5,                                   /* colNo */
  "callReflectivity",                  /* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"/* pName */
};

static emlrtRTEInfo sk_emlrtRTEI = { 26,/* lineNo */
  5,                                   /* colNo */
  "callReflectivity",                  /* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"/* pName */
};

static emlrtRTEInfo tk_emlrtRTEI = { 36,/* lineNo */
  5,                                   /* colNo */
  "callReflectivity",                  /* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"/* pName */
};

static emlrtRTEInfo uk_emlrtRTEI = { 48,/* lineNo */
  1,                                   /* colNo */
  "callReflectivity",                  /* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"/* pName */
};

static emlrtRTEInfo vk_emlrtRTEI = { 43,/* lineNo */
  5,                                   /* colNo */
  "callReflectivity",                  /* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"/* pName */
};

static emlrtRTEInfo wk_emlrtRTEI = { 63,/* lineNo */
  44,                                  /* colNo */
  "callReflectivity",                  /* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"/* pName */
};

static emlrtRTEInfo xk_emlrtRTEI = { 69,/* lineNo */
  11,                                  /* colNo */
  "callReflectivity",                  /* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"/* pName */
};

static emlrtRTEInfo yk_emlrtRTEI = { 71,/* lineNo */
  1,                                   /* colNo */
  "callReflectivity",                  /* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"/* pName */
};

static emlrtRTEInfo al_emlrtRTEI = { 73,/* lineNo */
  15,                                  /* colNo */
  "callReflectivity",                  /* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"/* pName */
};

static emlrtRTEInfo bl_emlrtRTEI = { 73,/* lineNo */
  1,                                   /* colNo */
  "callReflectivity",                  /* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"/* pName */
};

static emlrtRTEInfo cl_emlrtRTEI = { 55,/* lineNo */
  9,                                   /* colNo */
  "callReflectivity",                  /* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"/* pName */
};

static emlrtRTEInfo ml_emlrtRTEI = { 56,/* lineNo */
  44,                                  /* colNo */
  "callReflectivity",                  /* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"/* pName */
};
  ...
  emxArray_real_T *reflectivity, emxArray_real_T *Simulation)
{
  ...
  /* this_data = allData{i}; */
  emxInit_real_T(sp, &slds, 2, &rk_emlrtRTEI, true);
  if (layers->size[0] == 0) {
    i = slds->size[0] * slds->size[1];
    slds->size[0] = 1;
    slds->size[1] = 3;
    emxEnsureCapacity_real_T(sp, slds, i, &rk_emlrtRTEI);
    slds->data[0] = 0.0;
    slds->data[1] = nbairs;
    slds->data[2] = 0.0;
    lays = 0;
    ...
    slds->size[1] = 3;
    emxEnsureCapacity_real_T(sp, slds, i, &sk_emlrtRTEI);
    for (i = 0; i < 3; i++) {
  ...
  emxInit_real_T(sp, &firstSection, 2, &tk_emlrtRTEI, true);
  if (simLimits[0] < this_data->data[0]) {
    ...
    if (muDoubleScalarIsNaN(step) || muDoubleScalarIsNaN(b)) {
      ...
      emxEnsureCapacity_real_T(&st, firstSection, i, &tk_emlrtRTEI);
  ...
  emxInit_real_T(sp, &lastSection, 2, &vk_emlrtRTEI, true);
  if (simLimits[1] > this_data->data[this_data->size[0] - 1]) {
    ...
    if (muDoubleScalarIsNaN(b) || muDoubleScalarIsNaN(step)) {
      ...
      emxEnsureCapacity_real_T(&st, lastSection, i, &vk_emlrtRTEI);
  ...
  emxInit_real_T(sp, &simXdata, 2, &uk_emlrtRTEI, true);
  ...
  simXdata->size[1] = (firstSection->size[1] + this_data->size[0]) +
    lastSection->size[1];
  emxEnsureCapacity_real_T(sp, simXdata, i, &uk_emlrtRTEI);
  ...
  emxInit_real_T(sp, &simRef, 1, &cl_emlrtRTEI, true);
  emxInit_real_T(sp, &b_simRef, 1, &ml_emlrtRTEI, true);
  ...
  emxEnsureCapacity_real_T(sp, b_simRef, i, &ml_emlrtRTEI);
  ...
  emxEnsureCapacity_real_T(sp, firstSection, i, &xk_emlrtRTEI);
  ...
  emxEnsureCapacity_real_T(&b_st, reflectivity, i, &yk_emlrtRTEI);
  for (i = 0; i < loop_ub; i++) {
  ...
  emxEnsureCapacity_real_T(&st, b_simRef, i, &al_emlrtRTEI);
  ...
  Simulation->size[1] = 2;
  emxEnsureCapacity_real_T(&b_st, Simulation, i, &bl_emlrtRTEI);
                      ...
                      emxArray_real_T *Simulation)
{
  ...
  emxFree_real_T(&lastSection);
  emxInit_real_T(sp, &simRef, 1, &cl_emlrtRTEI, true);
  emxInit_real_T(sp, &b_simRef, 1, &wk_emlrtRTEI, true);
  splits_idx_0 = (uint32_T)firstSection->size[1];
  ...
  i = b_simRef->size[0];
  b_simRef->size[0] = simRef->size[0];
  emxEnsureCapacity_real_T(sp, b_simRef, i, &wk_emlrtRTEI);
  loop_ub = simRef->size[0] - 1;
  emxFree_real_T(&slds);
  for (i = 0; i <= loop_ub; i++) {
    b_simRef->data[i] = simRef->data[i];

...
static emlrtRTEInfo ae_emlrtRTEI = { 63,/* lineNo */
  18,                                  /* colNo */
  "reflectivity_calculation",          /* fName */
  "/home/arwel/Documents/RascalDev/RAT/API/reflectivity_calculation/reflectivity_calculation.m"/* pName */
};
...
static emlrtRTEInfo fe_emlrtRTEI = { 35,/* lineNo */
  1,                                   /* colNo */
  "reflectivity_calculation",          /* fName */
  "/home/arwel/Documents/RascalDev/RAT/API/reflectivity_calculation/reflectivity_calculation.m"/* pName */
};

static emlrtRTEInfo ge_emlrtRTEI = { 41,/* lineNo */
  1,                                   /* colNo */
  "reflectivity_calculation",          /* fName */
  "/home/arwel/Documents/RascalDev/RAT/API/reflectivity_calculation/reflectivity_calculation.m"/* pName */
};

static emlrtRTEInfo he_emlrtRTEI = { 47,/* lineNo */
  1,                                   /* colNo */
  "reflectivity_calculation",          /* fName */
  "/home/arwel/Documents/RascalDev/RAT/API/reflectivity_calculation/reflectivity_calculation.m"/* pName */
};

static emlrtRTEInfo ie_emlrtRTEI = { 53,/* lineNo */
  1,                                   /* colNo */
  "reflectivity_calculation",          /* fName */
  "/home/arwel/Documents/RascalDev/RAT/API/reflectivity_calculation/reflectivity_calculation.m"/* pName */
};
...
static emlrtRTEInfo ke_emlrtRTEI = { 89,/* lineNo */
  1,                                   /* colNo */
  "reflectivity_calculation",          /* fName */
  "/home/arwel/Documents/RascalDev/RAT/API/reflectivity_calculation/reflectivity_calculation.m"/* pName */
};
  ...
  struct2_T *controls, struct4_T *problem, cell_7 *result)
{
  ...
  emxInit_cell_wrap_8(sp, &reflectivity, 1, &de_emlrtRTEI, true);
  ...
  emxEnsureCapacity_cell_wrap_8(sp, reflectivity, i2, &fd_emlrtRTEI);
  for (b_i = 0; b_i < i1; b_i++) {
    ...
    emxEnsureCapacity_real_T(sp, reflectivity->data[b_i].f1, i2, &gd_emlrtRTEI);
    i2 = reflectivity->size[0] - 1;
    if (b_i > i2) {
      emlrtDynamicBoundsCheckR2012b(b_i, 0, i2, &emlrtBCI, sp);
    }
  ...
  for (b_i = 0; b_i < i1; b_i++) {
    ...
    emxEnsureCapacity_real_T(sp, Simulation->data[b_i].f1, i, &hd_emlrtRTEI);
    i = Simulation->size[0] - 1;
    if (b_i > i) {
      emlrtDynamicBoundsCheckR2012b(b_i, 0, i, &b_emlrtBCI, sp);
    }
  ...
  emxInit_cell_wrap_9(sp, &shifted_data, 1, &fe_emlrtRTEI, true);
  ...
  emxEnsureCapacity_cell_wrap_9(sp, shifted_data, i, &fd_emlrtRTEI);
  for (b_i = 0; b_i < i1; b_i++) {
    ...
    emxEnsureCapacity_real_T(sp, shifted_data->data[b_i].f1, i, &id_emlrtRTEI);
    i = shifted_data->size[0] - 1;
    if (b_i > i) {
      emlrtDynamicBoundsCheckR2012b(b_i, 0, i, &c_emlrtBCI, sp);
    }
  ...
  emxInit_cell_wrap_9(sp, &layerSlds, 1, &ge_emlrtRTEI, true);
  ...
  emxEnsureCapacity_cell_wrap_9(sp, layerSlds, i, &fd_emlrtRTEI);
  for (b_i = 0; b_i < i1; b_i++) {
    ...
    emxEnsureCapacity_real_T(sp, layerSlds->data[b_i].f1, i, &jd_emlrtRTEI);
    i = layerSlds->size[0] - 1;
    if (b_i > i) {
      emlrtDynamicBoundsCheckR2012b(b_i, 0, i, &d_emlrtBCI, sp);
    }
  ...
  emxInit_cell_wrap_8(sp, &sldProfiles, 1, &he_emlrtRTEI, true);
  ...
  emxEnsureCapacity_cell_wrap_8(sp, sldProfiles, i, &fd_emlrtRTEI);
  for (b_i = 0; b_i < i1; b_i++) {
    ...
    emxEnsureCapacity_real_T(sp, sldProfiles->data[b_i].f1, i, &kd_emlrtRTEI);
    i = sldProfiles->size[0] - 1;
    if (b_i > i) {
      emlrtDynamicBoundsCheckR2012b(b_i, 0, i, &e_emlrtBCI, sp);
    }
  ...
  emxInit_cell_wrap_10(sp, &allLayers, 1, &ie_emlrtRTEI, true);
  ...
  emxEnsureCapacity_cell_wrap_10(sp, allLayers, i, &fd_emlrtRTEI);
  for (b_i = 0; b_i < i1; b_i++) {
  ...
  emxInit_cell_wrap_6(sp, &cell1, 1, &je_emlrtRTEI, true);
  emxInit_cell_wrap_1(sp, &cell3, 1, &ke_emlrtRTEI, true);
  switch (kstr) {
   case 0:
    ...
    emxEnsureCapacity_cell_wrap_0(sp, t0_f1, i, &md_emlrtRTEI);
    ...
    emxEnsureCapacity_cell_wrap_1(sp, t0_f2, i, &md_emlrtRTEI);
    ...
    emxEnsureCapacity_cell_wrap_0(sp, t0_f3, i, &md_emlrtRTEI);
    ...
    emxEnsureCapacity_cell_wrap_0(sp, t0_f4, i, &md_emlrtRTEI);
    ...
    emxEnsureCapacity_cell_wrap_11(sp, t0_f5, i, &md_emlrtRTEI);
    ...
    for (i2 = 0; i2 <= i; i2++) {
      ...
      emxEnsureCapacity_real_T(sp, t0_f5->data[i2].f1, i3, &md_emlrtRTEI);
    ...
    emxEnsureCapacity_cell_wrap_3(sp, t0_f6, i, &md_emlrtRTEI);
    ...
    emxEnsureCapacity_cell_wrap_4(sp, t0_f7, i, &md_emlrtRTEI);
    ...
    emxEnsureCapacity_cell_wrap_4(sp, t0_f8, i, &md_emlrtRTEI);
    ...
    emxEnsureCapacity_cell_wrap_4(sp, t0_f9, i, &md_emlrtRTEI);
    ...
    emxEnsureCapacity_cell_wrap_4(sp, expl_temp.f12, i, &yd_emlrtRTEI);
    ...
    emxEnsureCapacity_cell_wrap_4(sp, expl_temp.f11, i, &yd_emlrtRTEI);
    ...
    emxEnsureCapacity_cell_wrap_4(sp, expl_temp.f10, i, &yd_emlrtRTEI);
    ...
    emxEnsureCapacity_cell_wrap_4(sp, expl_temp.f9, i, &yd_emlrtRTEI);
    ...
    emxEnsureCapacity_cell_wrap_4(sp, expl_temp.f8, i, &yd_emlrtRTEI);
    ...
    emxEnsureCapacity_cell_wrap_4(sp, expl_temp.f7, i, &yd_emlrtRTEI);
    ...
    emxEnsureCapacity_cell_wrap_3(sp, expl_temp.f6, i, &yd_emlrtRTEI);
    kstr = t0_f6->size[0];
    for (i = 0; i < kstr; i++) {
    ...
    emxEnsureCapacity_cell_wrap_11(sp, expl_temp.f5, i, &yd_emlrtRTEI);
    ...
    emxEnsureCapacity_cell_wrap_0(sp, expl_temp.f4, i, &yd_emlrtRTEI);
    ...
    emxEnsureCapacity_cell_wrap_0(sp, expl_temp.f3, i, &yd_emlrtRTEI);
    ...
    emxEnsureCapacity_cell_wrap_1(sp, expl_temp.f2, i, &yd_emlrtRTEI);
    ...
    emxEnsureCapacity_cell_wrap_0(sp, expl_temp.f1, i, &yd_emlrtRTEI);
    ...
    emxInit_cell_wrap_11(sp, &b_reflectivity, 1, &fd_emlrtRTEI, true);
    emxInit_cell_wrap_1(sp, &b_layerSlds, 1, &fd_emlrtRTEI, true);
    emxInit_cell_wrap_11(sp, &b_sldProfiles, 1, &fd_emlrtRTEI, true);
    emxInit_cell_wrap_11(sp, &b_allLayers, 1, &fd_emlrtRTEI, true);
    st.site = &emlrtRSI;
    ...
    emxEnsureCapacity_cell_wrap_8(sp, reflectivity, i, &ae_emlrtRTEI);
    ...
    for (i2 = 0; i2 < i; i2++) {
      ...
      emxEnsureCapacity_real_T(sp, reflectivity->data[i2].f1, i3, &ae_emlrtRTEI);
    ...
    for (i2 = 0; i2 < i; i2++) {
      ...
      emxEnsureCapacity_real_T(sp, Simulation->data[i2].f1, i3, &be_emlrtRTEI);
    ...
    for (i2 = 0; i2 < i; i2++) {
      ...
      emxEnsureCapacity_real_T(sp, shifted_data->data[i2].f1, i3, &ce_emlrtRTEI);
    ...
    for (i2 = 0; i2 < i; i2++) {
      ...
      emxEnsureCapacity_real_T(sp, layerSlds->data[i2].f1, i3, &ce_emlrtRTEI);
    ...
    emxEnsureCapacity_cell_wrap_8(sp, sldProfiles, i, &ae_emlrtRTEI);
    ...
    for (i2 = 0; i2 < i; i2++) {
      ...
      emxEnsureCapacity_real_T(sp, sldProfiles->data[i2].f1, i3, &ae_emlrtRTEI);
  ...
  emxInit_int8_T(sp, &cell6, 1, &le_emlrtRTEI, true);
  ...
  covrtLogBasicBlock(&emlrtCoverageInstance, 0U, 27U);
  i = result->f6->size[0];

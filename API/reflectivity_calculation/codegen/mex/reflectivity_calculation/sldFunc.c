...
static emlrtRSInfo ed_emlrtRSI = { 29, /* lineNo */
  "sldFunc",                           /* fcnName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/resampleLayers/sldFunc.m"/* pathName */
};
...
static emlrtRTEInfo cj_emlrtRTEI = { 24,/* lineNo */
  14,                                  /* colNo */
  "sldFunc",                           /* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/resampleLayers/sldFunc.m"/* pName */
};

static emlrtRTEInfo ej_emlrtRTEI = { 24,/* lineNo */
  1,                                   /* colNo */
  "sldFunc",                           /* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/resampleLayers/sldFunc.m"/* pName */
};
...
static emlrtRTEInfo hj_emlrtRTEI = { 29,/* lineNo */
  22,                                  /* colNo */
  "sldFunc",                           /* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/resampleLayers/sldFunc.m"/* pName */
};

static emlrtRTEInfo ij_emlrtRTEI = { 29,/* lineNo */
  5,                                   /* colNo */
  "sldFunc",                           /* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/resampleLayers/sldFunc.m"/* pName */
};

static emlrtRTEInfo jj_emlrtRTEI = { 30,/* lineNo */
  22,                                  /* colNo */
  "sldFunc",                           /* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/resampleLayers/sldFunc.m"/* pName */
};

static emlrtRTEInfo kj_emlrtRTEI = { 30,/* lineNo */
  5,                                   /* colNo */
  "sldFunc",                           /* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/resampleLayers/sldFunc.m"/* pName */
};

static emlrtRTEInfo lj_emlrtRTEI = { 48,/* lineNo */
  9,                                   /* colNo */
  "sldFunc",                           /* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/resampleLayers/sldFunc.m"/* pName */
};

static emlrtRTEInfo mj_emlrtRTEI = { 46,/* lineNo */
  9,                                   /* colNo */
  "sldFunc",                           /* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/resampleLayers/sldFunc.m"/* pName */
};
             ...
             emxArray_real_T *sldVal)
{
  ...
  emxInit_boolean_T(sp, &b_x, 1, &cj_emlrtRTEI, true);
  ...
  emxEnsureCapacity_boolean_T(&st, b_x, i, &cj_emlrtRTEI);
  for (i = 0; i < loop_ub; i++) {
  ...
  emxInit_uint32_T(&c_st, &where, 1, &ej_emlrtRTEI, true);
  i = where->size[0];
  where->size[0] = ii->size[0];
  emxEnsureCapacity_uint32_T(&st, where, i, &ej_emlrtRTEI);
  loop_ub = ii->size[0];
  for (i = 0; i < loop_ub; i++) {
  ...
  if (covrtLogIf(&emlrtCoverageInstance, 14U, 0U, 0, covrtLogMcdc
    ...
    emxEnsureCapacity_real_T(sp, sldVal, i, &gj_emlrtRTEI);
    ...
    i = b_x->size[0];
    b_x->size[0] = SLD->size[0];
    emxEnsureCapacity_boolean_T(&st, b_x, i, &hj_emlrtRTEI);
    for (i = 0; i < loop_ub; i++) {
    ...
    i = where->size[0];
    where->size[0] = ii->size[0];
    emxEnsureCapacity_uint32_T(&st, where, i, &ij_emlrtRTEI);
    loop_ub = ii->size[0];
    for (i = 0; i < loop_ub; i++) {
      where->data[i] = (uint32_T)ii->data[i];
    }
    ...
    i = b_x->size[0];
    b_x->size[0] = SLD->size[0];
    emxEnsureCapacity_boolean_T(&st, b_x, i, &jj_emlrtRTEI);
    for (i = 0; i < loop_ub; i++) {
      b_x->data[i] = (x < SLD->data[i]);
    }
    ...
    emxInit_uint32_T(&c_st, &aboveVals, 1, &kj_emlrtRTEI, true);
    i = aboveVals->size[0];
    aboveVals->size[0] = ii->size[0];
    emxEnsureCapacity_uint32_T(&st, aboveVals, i, &kj_emlrtRTEI);
    loop_ub = ii->size[0];
    for (i = 0; i < loop_ub; i++) {
    ...
    if (1 > aboveVals->size[0]) {
      emlrtDynamicBoundsCheckR2012b(1, 1, aboveVals->size[0], &ge_emlrtBCI, sp);
    }

    i = (int32_T)where->data[where->size[0] - 1];
    if ((i < 1) || (i > SLD->size[0])) {
      emlrtDynamicBoundsCheckR2012b(i, 1, SLD->size[0], &he_emlrtBCI, sp);
    }

    i = (int32_T)aboveVals->data[0];
    if ((i < 1) || (i > SLD->size[0])) {
      emlrtDynamicBoundsCheckR2012b(i, 1, SLD->size[0], &ie_emlrtBCI, sp);
    }

    i = (int32_T)aboveVals->data[0];
    if ((i < 1) || (i > SLD->size[0])) {
      emlrtDynamicBoundsCheckR2012b(i, 1, SLD->size[0], &je_emlrtBCI, sp);
    }

    i = (int32_T)where->data[where->size[0] - 1];
    if ((i < 1) || (i > SLD->size[0])) {
      emlrtDynamicBoundsCheckR2012b(i, 1, SLD->size[0], &ke_emlrtBCI, sp);
    }

    i = (int32_T)where->data[where->size[0] - 1];
    if ((i < 1) || (i > SLD->size[0])) {
      emlrtDynamicBoundsCheckR2012b(i, 1, SLD->size[0], &le_emlrtBCI, sp);
    }
    ...
    if (covrtLogIf(&emlrtCoverageInstance, 14U, 0U, 1, SLD->data[((int32_T)
      ...
      i = sldVal->size[0];
      sldVal->size[0] = 1;
      emxEnsureCapacity_real_T(sp, sldVal, i, &mj_emlrtRTEI);
      ...
      i = sldVal->size[0];
      sldVal->size[0] = 1;
      emxEnsureCapacity_real_T(sp, sldVal, i, &lj_emlrtRTEI);
      sldVal->data[0] = SLD->data[((int32_T)where->data[where->size[0] - 1] +
        SLD->size[0]) - 1] - deltaY;
    }

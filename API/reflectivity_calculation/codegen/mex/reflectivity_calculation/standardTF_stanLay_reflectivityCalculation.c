...
static emlrtRTEInfo lf_emlrtRTEI = { 127,/* lineNo */
  1,                                   /* colNo */
  "standardTF_stanLay_reflectivityCalculation",/* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/standard_TF/standardTF_stanLay_reflectivityCalculation.m"/* pName */
};

static emlrtRTEInfo mf_emlrtRTEI = { 128,/* lineNo */
  1,                                   /* colNo */
  "standardTF_stanLay_reflectivityCalculation",/* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/standard_TF/standardTF_stanLay_reflectivityCalculation.m"/* pName */
};

static emlrtRTEInfo nf_emlrtRTEI = { 129,/* lineNo */
  1,                                   /* colNo */
  "standardTF_stanLay_reflectivityCalculation",/* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/standard_TF/standardTF_stanLay_reflectivityCalculation.m"/* pName */
};

static emlrtRTEInfo of_emlrtRTEI = { 130,/* lineNo */
  1,                                   /* colNo */
  "standardTF_stanLay_reflectivityCalculation",/* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/standard_TF/standardTF_stanLay_reflectivityCalculation.m"/* pName */
};

static emlrtRTEInfo pf_emlrtRTEI = { 131,/* lineNo */
  1,                                   /* colNo */
  "standardTF_stanLay_reflectivityCalculation",/* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/standard_TF/standardTF_stanLay_reflectivityCalculation.m"/* pName */
};

static emlrtRTEInfo qf_emlrtRTEI = { 132,/* lineNo */
  1,                                   /* colNo */
  "standardTF_stanLay_reflectivityCalculation",/* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/standard_TF/standardTF_stanLay_reflectivityCalculation.m"/* pName */
};

static emlrtRTEInfo rf_emlrtRTEI = { 53,/* lineNo */
  1,                                   /* colNo */
  "standardTF_stanLay_reflectivityCalculation",/* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/standard_TF/standardTF_stanLay_reflectivityCalculation.m"/* pName */
};

static emlrtRTEInfo sf_emlrtRTEI = { 133,/* lineNo */
  1,                                   /* colNo */
  "standardTF_stanLay_reflectivityCalculation",/* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/standard_TF/standardTF_stanLay_reflectivityCalculation.m"/* pName */
};

static emlrtRTEInfo tf_emlrtRTEI = { 136,/* lineNo */
  1,                                   /* colNo */
  "standardTF_stanLay_reflectivityCalculation",/* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/standard_TF/standardTF_stanLay_reflectivityCalculation.m"/* pName */
};
...
static emlrtRTEInfo vf_emlrtRTEI = { 59,/* lineNo */
  5,                                   /* colNo */
  "standardTF_stanLay_reflectivityCalculation",/* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/standard_TF/standardTF_stanLay_reflectivityCalculation.m"/* pName */
};

static emlrtRTEInfo wf_emlrtRTEI = { 64,/* lineNo */
  5,                                   /* colNo */
  "standardTF_stanLay_reflectivityCalculation",/* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/standard_TF/standardTF_stanLay_reflectivityCalculation.m"/* pName */
};

static emlrtRTEInfo xf_emlrtRTEI = { 69,/* lineNo */
  5,                                   /* colNo */
  "standardTF_stanLay_reflectivityCalculation",/* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/standard_TF/standardTF_stanLay_reflectivityCalculation.m"/* pName */
};

static emlrtRTEInfo yf_emlrtRTEI = { 74,/* lineNo */
  5,                                   /* colNo */
  "standardTF_stanLay_reflectivityCalculation",/* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/standard_TF/standardTF_stanLay_reflectivityCalculation.m"/* pName */
};

static emlrtRTEInfo ag_emlrtRTEI = { 79,/* lineNo */
  5,                                   /* colNo */
  "standardTF_stanLay_reflectivityCalculation",/* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/standard_TF/standardTF_stanLay_reflectivityCalculation.m"/* pName */
};

static emlrtRTEInfo bg_emlrtRTEI = { 84,/* lineNo */
  5,                                   /* colNo */
  "standardTF_stanLay_reflectivityCalculation",/* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/standard_TF/standardTF_stanLay_reflectivityCalculation.m"/* pName */
};

static emlrtRTEInfo cg_emlrtRTEI = { 134,/* lineNo */
  1,                                   /* colNo */
  "standardTF_stanLay_reflectivityCalculation",/* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/standard_TF/standardTF_stanLay_reflectivityCalculation.m"/* pName */
};
  ...
  *allLayers)
{
  ...
  emxEnsureCapacity_real_T(sp, problem->ssubs, i, &lf_emlrtRTEI);
  ...
  emxEnsureCapacity_real_T(sp, problem->qshifts, i1, &nf_emlrtRTEI);
  ...
  emxEnsureCapacity_real_T(sp, problem->scalefactors, i1, &of_emlrtRTEI);
  if ((int32_T)problemDef->numberOfContrasts != i) {
    emlrtIntegerCheckR2012b(problemDef->numberOfContrasts, &k_emlrtDCI, sp);
  }
  ...
  emxEnsureCapacity_real_T(sp, problem->nbairs, i1, &pf_emlrtRTEI);
  if ((int32_T)problemDef->numberOfContrasts != i) {
    emlrtIntegerCheckR2012b(problemDef->numberOfContrasts, &l_emlrtDCI, sp);
  }
  ...
  emxEnsureCapacity_real_T(sp, problem->nbsubs, i1, &qf_emlrtRTEI);
  if ((int32_T)problemDef->numberOfContrasts != i) {
    emlrtIntegerCheckR2012b(problemDef->numberOfContrasts, &m_emlrtDCI, sp);
  }
  ...
  emxInit_real_T(sp, &chis, 1, &rf_emlrtRTEI, true);
  if ((int32_T)problemDef->numberOfContrasts != i) {
  ...
  emxEnsureCapacity_real_T(sp, chis, i1, &rf_emlrtRTEI);
  if ((int32_T)problemDef->numberOfContrasts != i) {
    emlrtIntegerCheckR2012b(problemDef->numberOfContrasts, &n_emlrtDCI, sp);
  }
  ...
  emxEnsureCapacity_real_T(sp, problem->resolutions, i1, &sf_emlrtRTEI);
  if ((int32_T)problemDef->numberOfContrasts != i) {
    emlrtIntegerCheckR2012b(problemDef->numberOfContrasts, &o_emlrtDCI, sp);
  }
  ...
  emxEnsureCapacity_real_T(sp, problem->allSubRough, i1, &tf_emlrtRTEI);
  if ((int32_T)problemDef->numberOfContrasts != i) {
    emlrtIntegerCheckR2012b(problemDef->numberOfContrasts, &p_emlrtDCI, sp);
  }
  ...
  emxEnsureCapacity_cell_wrap_11(sp, reflectivity, i, &uf_emlrtRTEI);
  for (b_i = 0; b_i < loop_ub; b_i++) {
    ...
    emxEnsureCapacity_real_T(sp, reflectivity->data[b_i].f1, i, &vf_emlrtRTEI);
    i = reflectivity->size[0] - 1;
    if (b_i > i) {
      emlrtDynamicBoundsCheckR2012b(b_i, 0, i, &y_emlrtBCI, sp);
    }
  ...
  emxEnsureCapacity_cell_wrap_6(sp, Simulation, i, &uf_emlrtRTEI);
  for (b_i = 0; b_i < loop_ub; b_i++) {
    ...
    emxEnsureCapacity_real_T(sp, Simulation->data[b_i].f1, i, &wf_emlrtRTEI);
    i = Simulation->size[0] - 1;
    if (b_i > i) {
      emlrtDynamicBoundsCheckR2012b(b_i, 0, i, &ab_emlrtBCI, sp);
    }
  ...
  emxEnsureCapacity_cell_wrap_1(sp, shifted_data, i, &uf_emlrtRTEI);
  for (b_i = 0; b_i < loop_ub; b_i++) {
    ...
    emxEnsureCapacity_real_T(sp, shifted_data->data[b_i].f1, i, &xf_emlrtRTEI);
    i = shifted_data->size[0] - 1;
    if (b_i > i) {
      emlrtDynamicBoundsCheckR2012b(b_i, 0, i, &bb_emlrtBCI, sp);
    }
  ...
  emxEnsureCapacity_cell_wrap_1(sp, layerSlds, i, &uf_emlrtRTEI);
  for (b_i = 0; b_i < loop_ub; b_i++) {
    ...
    emxEnsureCapacity_real_T(sp, layerSlds->data[b_i].f1, i, &yf_emlrtRTEI);
    i = layerSlds->size[0] - 1;
    if (b_i > i) {
      emlrtDynamicBoundsCheckR2012b(b_i, 0, i, &cb_emlrtBCI, sp);
    }
  ...
  emxEnsureCapacity_cell_wrap_11(sp, sldProfiles, i, &uf_emlrtRTEI);
  for (b_i = 0; b_i < loop_ub; b_i++) {
    ...
    emxEnsureCapacity_real_T(sp, sldProfiles->data[b_i].f1, i, &ag_emlrtRTEI);
    i = sldProfiles->size[0] - 1;
    if (b_i > i) {
      emlrtDynamicBoundsCheckR2012b(b_i, 0, i, &db_emlrtBCI, sp);
    }
  ...
  emxEnsureCapacity_cell_wrap_11(sp, allLayers, i, &uf_emlrtRTEI);
  for (b_i = 0; b_i < loop_ub; b_i++) {
    ...
    emxEnsureCapacity_real_T(sp, allLayers->data[b_i].f1, i, &bg_emlrtRTEI);
    i = allLayers->size[0] - 1;
    if (b_i > i) {
      emlrtDynamicBoundsCheckR2012b(b_i, 0, i, &eb_emlrtBCI, sp);
    }
  ...
  emxEnsureCapacity_real_T(sp, problem->calculations.all_chis, i, &cg_emlrtRTEI);
  loop_ub = chis->size[0];
  for (i = 0; i < loop_ub; i++) {

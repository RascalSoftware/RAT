...
static emlrtRSInfo kb_emlrtRSI = { 99, /* lineNo */
  "sumprod",                           /* fcnName */
...
static emlrtRSInfo mb_emlrtRSI = { 185,/* lineNo */
...
static emlrtRTEInfo th_emlrtRTEI = { 20,/* lineNo */
  1,                                   /* colNo */
  "sum",                               /* fName */
  "/usr/local/MATLAB/R2020a/toolbox/eml/lib/matlab/datafun/sum.m"/* pName */
};

static emlrtRTEInfo uh_emlrtRTEI = { 125,/* lineNo */
  13,                                  /* colNo */
...
void b_sum(const emlrtStack *sp, const emxArray_real_T *x, emxArray_real_T *y)
{
  ...
  if ((x->size[0] == 0) || (x->size[1] == 0)) {
    ...
    emxEnsureCapacity_real_T(&b_st, y, j, &th_emlrtRTEI);
    ...
    j = y->size[0];
    y->size[0] = x->size[0];
    emxEnsureCapacity_real_T(&c_st, y, j, &uh_emlrtRTEI);

...
REFLECTIVITY_CALCULATION_DLL_EXPORT extern double rt_hypotd_snf(double u0,
  double u1);
REFLECTIVITY_CALCULATION_DLL_EXPORT extern double rt_powd_snf(double u0, double
  u1);

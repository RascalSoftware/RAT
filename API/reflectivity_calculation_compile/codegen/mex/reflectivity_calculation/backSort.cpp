              ...
              real_T *b_nba, real_T *b_nbs, real_T *resol)
{
  ...
  if ((i < 1) || (i > backs.size(1))) {
    emlrtDynamicBoundsCheckR2012b(i, 1, backs.size(1), &ae_emlrtBCI, sp);
  }
  ...
  *backg = backs[i - 1];
  ...
  if ((i < 1) || (i > shifts.size(1))) {
    emlrtDynamicBoundsCheckR2012b(i, 1, shifts.size(1), &be_emlrtBCI, sp);
  }
  ...
  *qshift = shifts[i - 1];
  ...
  if ((i < 1) || (i > sf.size(1))) {
    emlrtDynamicBoundsCheckR2012b(i, 1, sf.size(1), &ce_emlrtBCI, sp);
  }
  ...
  *b_sf = sf[i - 1];
  ...
  if ((i < 1) || (i > nba.size(1))) {
    emlrtDynamicBoundsCheckR2012b(i, 1, nba.size(1), &de_emlrtBCI, sp);
  }
  ...
  *b_nba = nba[i - 1];
  ...
  if ((i < 1) || (i > nbs.size(1))) {
    emlrtDynamicBoundsCheckR2012b(i, 1, nbs.size(1), &ee_emlrtBCI, sp);
  }
  ...
  *b_nbs = nbs[i - 1];
  ...
  if ((i < 1) || (i > res.size(1))) {
    emlrtDynamicBoundsCheckR2012b(i, 1, res.size(1), &fe_emlrtBCI, sp);
  }

  ...
  &Simulation)
{
  ...
  if (simLimits[0] < this_data[0]) {
    if (2 > this_data.size(0)) {
      emlrtDynamicBoundsCheckR2012b(2, 1, this_data.size(0), &qg_emlrtBCI, sp);
    }

    if (1 > this_data.size(0)) {
      emlrtDynamicBoundsCheckR2012b(1, 1, this_data.size(0), &pg_emlrtBCI, sp);
    }
  ...
  if (simLimits[1] > this_data[this_data.size(0) - 1]) {
    ...
    if ((i < 1) || (i > this_data.size(0))) {
      emlrtDynamicBoundsCheckR2012b(i, 1, this_data.size(0), &jg_emlrtBCI, sp);
    }
  ...
  if (firstSection.size(1) + 1U > splits_idx_1) {
    ...
    if ((i < 1) || (i > Simulation.size(0))) {
      emlrtDynamicBoundsCheckR2012b(i, 1, Simulation.size(0), &ng_emlrtBCI, sp);
    }
    ...
    if ((static_cast<int32_T>(splits_idx_1) < 1) || (static_cast<int32_T>
      ...
      emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(splits_idx_1), 1,
        Simulation.size(0), &mg_emlrtBCI, sp);
    }
                      ...
                      &Simulation)
{
  ...
  for (int32_T j = 0; j < i; j++) {
    ...
    if ((i1 < 1) || (i1 > dummydata.size(0))) {
      emlrtDynamicBoundsCheckR2012b(i1, 1, dummydata.size(0), &hg_emlrtBCI, &st);
    }
    ...
    for (int32_T b_i = 0; b_i <= i1; b_i++) {
      ...
      if ((lays < 1) || (lays > simXdata.size(0))) {
        emlrtDynamicBoundsCheckR2012b(lays, 1, simXdata.size(0), &cg_emlrtBCI,
          &b_st);
      }
      ...
      if ((loop_ub < 1) || (loop_ub > simXdata.size(0))) {
        emlrtDynamicBoundsCheckR2012b(loop_ub, 1, simXdata.size(0), &eg_emlrtBCI,
          &b_st);
      }
      ...
      if ((lays < 1) || (lays > dummydata.size(0))) {
        emlrtDynamicBoundsCheckR2012b(lays, 1, dummydata.size(0), &yf_emlrtBCI,
          &st);
      }

      if (loop_ub > simRef.size(0)) {
        emlrtDynamicBoundsCheckR2012b(loop_ub, 1, simRef.size(0), &ag_emlrtBCI,
          &st);
      }
    ...
    if (step != 0.0) {
      i1 = j + 1;
      if ((i1 < 1) || (i1 > dummydata.size(0))) {
        emlrtDynamicBoundsCheckR2012b(i1, 1, dummydata.size(0), &fg_emlrtBCI,
          &st);
      }

      lays = j + 1;
      if ((lays < 1) || (lays > dummydata.size(0))) {
        emlrtDynamicBoundsCheckR2012b(lays, 1, dummydata.size(0), &gg_emlrtBCI,
          &st);
      }

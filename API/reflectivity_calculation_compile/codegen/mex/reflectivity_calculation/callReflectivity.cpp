...
static emlrtRSInfo ef_emlrtRSI = { 37, // lineNo
...
static emlrtRSInfo ff_emlrtRSI = { 44, // lineNo
  "callReflectivity",                  // fcnName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"// pathName 
};
...
static emlrtRSInfo of_emlrtRSI = { 26, // lineNo
...
static emlrtRSInfo xf_emlrtRSI = { 62, // lineNo
  "callReflectivity",                  // fcnName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"// pathName 
};

static emlrtRSInfo yf_emlrtRSI = { 63, // lineNo
  "callReflectivity",                  // fcnName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"// pathName 
};
...
static emlrtRTEInfo hh_emlrtRTEI = { 26,// lineNo
  5,                                   // colNo
  "callReflectivity",                  // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"// pName 
};

static emlrtRTEInfo ih_emlrtRTEI = { 23,// lineNo
  5,                                   // colNo
  "callReflectivity",                  // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"// pName 
};

static emlrtRTEInfo jh_emlrtRTEI = { 39,// lineNo
  5,                                   // colNo
  "callReflectivity",                  // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"// pName 
};
...
static emlrtRTEInfo lh_emlrtRTEI = { 46,// lineNo
  5,                                   // colNo
  "callReflectivity",                  // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"// pName 
};

static emlrtRTEInfo mh_emlrtRTEI = { 44,// lineNo
  5,                                   // colNo
  "callReflectivity",                  // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"// pName 
};

static emlrtRTEInfo nh_emlrtRTEI = { 49,// lineNo
  1,                                   // colNo
  "callReflectivity",                  // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"// pName 
};

static emlrtRTEInfo oh_emlrtRTEI = { 52,// lineNo
  1,                                   // colNo
  "callReflectivity",                  // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"// pName 
};

static emlrtRTEInfo ph_emlrtRTEI = { 5,// lineNo
  1,                                   // colNo
  "resolution_polly",                  // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/Resolution_Functions/Simple_Gaussian/resolution_polly.m"// pName 
};

static emlrtRTEInfo qh_emlrtRTEI = { 74,// lineNo
  1,                                   // colNo
  "callReflectivity",                  // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"// pName 
};

static emlrtRTEInfo yh_emlrtRTEI = { 103,// lineNo
  9,                                   // colNo
  "colon",                             // fName
  ...
  &Simulation)
{
  ...
  if (1 > this_data.size(1)) {
    emlrtDynamicBoundsCheckR2012b(1, 1, this_data.size(1), &vg_emlrtBCI, sp);
  }

  if (layers.size(0) == 0) {
    slds.set_size((&ih_emlrtRTEI), sp, 1, 3);
    slds[0] = 0.0;
    slds[1] = nbairs;
    slds[2] = 0.0;
    lays = 0;
    ...
    slds.set_size((&hh_emlrtRTEI), sp, layers.size(0), 3);
    for (i = 0; i < 3; i++) {
      for (n = 0; n < loop_ub; n++) {
  ...
  if (1 > this_data.size(1)) {
    emlrtDynamicBoundsCheckR2012b(1, 1, this_data.size(1), &ug_emlrtBCI, sp);
  }

  if (1 > this_data.size(0)) {
    emlrtDynamicBoundsCheckR2012b(1, 1, this_data.size(0), &tg_emlrtBCI, sp);
  }

  if (simLimits[0] < this_data[0]) {
    if (2 > this_data.size(0)) {
      emlrtDynamicBoundsCheckR2012b(2, 1, this_data.size(0), &sg_emlrtBCI, sp);
    }

    if (1 > this_data.size(0)) {
      emlrtDynamicBoundsCheckR2012b(1, 1, this_data.size(0), &rg_emlrtBCI, sp);
    }

    step = this_data[1] - this_data[0];
    if (1 > this_data.size(0)) {
      emlrtDynamicBoundsCheckR2012b(1, 1, this_data.size(0), &qg_emlrtBCI, sp);
    }

    st.site = &ef_emlrtRSI;
    kd = this_data[0] - step;
    if (muDoubleScalarIsNaN(step) || muDoubleScalarIsNaN(kd)) {
      firstSection.set_size((&kh_emlrtRTEI), (&st), 1, 1);
      firstSection[0] = rtNaN;
    } else if ((step == 0.0) || ((simLimits[0] < kd) && (step < 0.0)) || ((kd <
                 simLimits[0]) && (step > 0.0))) {
      firstSection.set_size((&kh_emlrtRTEI), (&st), 1, 0);
      ...
      loop_ub = static_cast<int32_T>(muDoubleScalarFloor((kd - simLimits[0]) /
        step));
      firstSection.set_size((&kh_emlrtRTEI), (&st), 1, (loop_ub + 1));
      for (i = 0; i <= loop_ub; i++) {
      ...
      if (ndbl > 2.147483647E+9) {
        emlrtErrorWithMessageIdR2018a(&c_st, &tb_emlrtRTEI,
          "Coder:MATLAB:pmaxsize", "Coder:MATLAB:pmaxsize", 0);
      }

      firstSection.set_size((&yh_emlrtRTEI), (&b_st), 1, n);
      if (n > 0) {
        firstSection[0] = simLimits[0];
        if (n > 1) {
    ...
    firstSection.set_size((&jh_emlrtRTEI), sp, 1, 0);
  }
  ...
  if (simLimits[1] > this_data[this_data.size(0) - 1]) {
    ...
    if ((i < 1) || (i > this_data.size(0))) {
      emlrtDynamicBoundsCheckR2012b(i, 1, this_data.size(0), &lg_emlrtBCI, sp);
    }
    ...
    if (muDoubleScalarIsNaN(a) || muDoubleScalarIsNaN(step)) {
      lastSection.set_size((&mh_emlrtRTEI), (&st), 1, 1);
      lastSection[0] = rtNaN;
    } else if ((step == 0.0) || ((a < simLimits[1]) && (step < 0.0)) ||
               ((simLimits[1] < a) && (step > 0.0))) {
      lastSection.set_size((&mh_emlrtRTEI), (&st), 1, 0);
      ...
      loop_ub = static_cast<int32_T>(muDoubleScalarFloor((simLimits[1] - a) /
        step));
      lastSection.set_size((&mh_emlrtRTEI), (&st), 1, (loop_ub + 1));
      for (i = 0; i <= loop_ub; i++) {
      ...
      lastSection.set_size((&yh_emlrtRTEI), (&b_st), 1, n);
      if (n > 0) {
        lastSection[0] = a;
        if (n > 1) {
    ...
    lastSection.set_size((&lh_emlrtRTEI), sp, 1, 0);
  }

  n = firstSection.size(1);
  loop_ub = this_data.size(0);
  simXdata.set_size((&nh_emlrtRTEI), sp, ((firstSection.size(1) + this_data.size
  ...
  Simulation.set_size((&oh_emlrtRTEI), sp, simXdata.size(0), 2);
  ...
  b_simRef.set_size((&ai_emlrtRTEI), sp, simRef.size(0));
  ...
  if (firstSection.size(1) + 1U > splits_idx_1) {
    ...
    if ((i < 1) || (i > Simulation.size(0))) {
      emlrtDynamicBoundsCheckR2012b(i, 1, Simulation.size(0), &pg_emlrtBCI, sp);
    }
    ...
    if ((static_cast<int32_T>(splits_idx_1) < 1) || (static_cast<int32_T>
      ...
      emlrtDynamicBoundsCheckR2012b(static_cast<int32_T>(splits_idx_1), 1,
        Simulation.size(0), &og_emlrtBCI, sp);
    }
  ...
  loop_ub = n - i;
  reflectivity.set_size((&qh_emlrtRTEI), sp, loop_ub, 2);
  for (n = 0; n < loop_ub; n++) {
                      ...
                      &Simulation)
{
  ...
  if (simLimits[0] < this_data[0]) {
    ...
    if (muDoubleScalarIsNaN(step) || muDoubleScalarIsNaN(g)) {
      ...
      firstSection.set_size((&kh_emlrtRTEI), (&st), 1, (ilow + 1));
      for (i = 0; i <= ilow; i++) {
        firstSection[i] = simLimits[0] + step * static_cast<real_T>(i);
      }
    } else {
  ...
  if (simLimits[1] > this_data[this_data.size(0) - 1]) {
    ...
    if (muDoubleScalarIsNaN(g) || muDoubleScalarIsNaN(step)) {
      ...
      lastSection.set_size((&mh_emlrtRTEI), (&st), 1, (ilow + 1));
      for (i = 0; i <= ilow; i++) {
  ...
  st.site = &hf_emlrtRSI;
  dummydata.set_size((&ph_emlrtRTEI), (&st), simXdata.size(0));
  ilow = simXdata.size(0);
  for (i = 0; i < ilow; i++) {
    dummydata[i] = 0.0;
  }
  ...
  for (int32_T j = 0; j < i; j++) {
    ...
    if ((i1 < 1) || (i1 > dummydata.size(0))) {
      emlrtDynamicBoundsCheckR2012b(i1, 1, dummydata.size(0), &jg_emlrtBCI, &st);
    }
    ...
    emlrtForLoopVectorCheckR2012b(static_cast<real_T>(ilow), 1.0,
      static_cast<real_T>(lays + 9), mxDOUBLE_CLASS, i1 + 1, &sb_emlrtRTEI, &st);
    for (int32_T b_i = 0; b_i <= i1; b_i++) {
      b_st.site = &of_emlrtRSI;
      lays = j + 1;
      if ((lays < 1) || (lays > simXdata.size(0))) {
        emlrtDynamicBoundsCheckR2012b(lays, 1, simXdata.size(0), &eg_emlrtBCI,
          &b_st);
      }
      ...
      if ((loop_ub < 1) || (loop_ub > simXdata.size(0))) {
        emlrtDynamicBoundsCheckR2012b(loop_ub, 1, simXdata.size(0), &gg_emlrtBCI,
          &b_st);
      }
      ...
      if ((lays < 1) || (lays > dummydata.size(0))) {
        emlrtDynamicBoundsCheckR2012b(lays, 1, dummydata.size(0), &bg_emlrtBCI,
          &st);
      }

      if (loop_ub > simRef.size(0)) {
        emlrtDynamicBoundsCheckR2012b(loop_ub, 1, simRef.size(0), &cg_emlrtBCI,
          &st);
      }
    ...
    if (step != 0.0) {
      i1 = j + 1;
      if ((i1 < 1) || (i1 > dummydata.size(0))) {
        emlrtDynamicBoundsCheckR2012b(i1, 1, dummydata.size(0), &hg_emlrtBCI,
          &st);
      }
  ...
  ilow = i1 - i;
  reflectivity.set_size((&qh_emlrtRTEI), sp, ilow, 2);
  for (i1 = 0; i1 < ilow; i1++) {

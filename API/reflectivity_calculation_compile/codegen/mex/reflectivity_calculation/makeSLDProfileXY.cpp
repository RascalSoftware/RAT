                      ...
                      &out)
{
  ...
  if (numberOfLayers > 0.0) {
    ...
    if (1 > layers.size(0)) {
      emlrtDynamicBoundsCheckR2012b(1, 1, layers.size(0), &xe_emlrtBCI, sp);
    }
    ...
    for (n = 0; n < xoffset; n++) {
      ...
      for (int32_T b_i = 0; b_i < k; b_i++) {
        ...
        if ((vlen < 1) || (vlen > layers.size(0))) {
          emlrtDynamicBoundsCheckR2012b(vlen, 1, layers.size(0), &qe_emlrtBCI,
            sp);
        }
        ...
        vlen = b_i + 1;
        if ((vlen < 1) || (vlen > layers.size(0))) {
          emlrtDynamicBoundsCheckR2012b(vlen, 1, layers.size(0), &we_emlrtBCI,
            sp);
        }
        ...
        if ((vlen < 1) || (vlen > SLD.size(1))) {
          emlrtDynamicBoundsCheckR2012b(vlen, 1, SLD.size(1), &te_emlrtBCI, sp);
        }
    ...
    // layers(end,3);
    if (x.size(1) < 1) {
      emlrtDynamicBoundsCheckR2012b(x.size(1), 1, x.size(1), &ue_emlrtBCI, sp);
    }
    ...
    if ((xoffset < 1) || (xoffset > SLD.size(1))) {
      emlrtDynamicBoundsCheckR2012b(xoffset, 1, SLD.size(1), &se_emlrtBCI, sp);
    }
    ...
    if ((i < 1) || (i > SLD.size(1))) {
      emlrtDynamicBoundsCheckR2012b(i, 1, SLD.size(1), &re_emlrtBCI, sp);
    }

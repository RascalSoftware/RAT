...
static emlrtRSInfo mg_emlrtRSI = { 45, // lineNo
...
static emlrtRSInfo ng_emlrtRSI = { 54, // lineNo
  "standardTF_stanlay_paraContrasts",  // fcnName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/standard_TF/standardTF_stanLay/standardTF_stanlay_paraContrasts.m"// pathName 
};
...
static emlrtRSInfo pg_emlrtRSI = { 78, // lineNo
  "standardTF_stanlay_paraContrasts",  // fcnName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/standard_TF/standardTF_stanLay/standardTF_stanlay_paraContrasts.m"// pathName 
};
...
static emlrtRTEInfo cc_emlrtRTEI = { 36,// lineNo
  9,                                   // colNo
  "standardTF_stanlay_paraContrasts",  // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/standard_TF/standardTF_stanLay/standardTF_stanlay_paraContrasts.m"// pName 
};
...
static emlrtRTEInfo ci_emlrtRTEI = { 3,// lineNo
  26,                                  // colNo
  "standardTF_stanlay_paraContrasts",  // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/standard_TF/standardTF_stanLay/standardTF_stanlay_paraContrasts.m"// pName 
};

static emlrtRTEInfo di_emlrtRTEI = { 27,// lineNo
  5,                                   // colNo
  "standardTF_stanlay_paraContrasts",  // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/standard_TF/standardTF_stanLay/standardTF_stanlay_paraContrasts.m"// pName 
};

static emlrtRTEInfo ei_emlrtRTEI = { 32,// lineNo
  5,                                   // colNo
  "standardTF_stanlay_paraContrasts",  // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/standard_TF/standardTF_stanLay/standardTF_stanlay_paraContrasts.m"// pName 
};
...
static emlrtRTEInfo gi_emlrtRTEI = { 19,// lineNo
  12,                                  // colNo
  "standardTF_stanlay_paraContrasts",  // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/standard_TF/standardTF_stanLay/standardTF_stanlay_paraContrasts.m"// pName 
};

static emlrtRTEInfo hi_emlrtRTEI = { 89,// lineNo
  5,                                   // colNo
  "standardTF_stanlay_paraContrasts",  // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/standard_TF/standardTF_stanLay/standardTF_stanlay_paraContrasts.m"// pName 
};

static emlrtRTEInfo ii_emlrtRTEI = { 90,// lineNo
  5,                                   // colNo
  "standardTF_stanlay_paraContrasts",  // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/standard_TF/standardTF_stanLay/standardTF_stanlay_paraContrasts.m"// pName 
};

static emlrtRTEInfo ji_emlrtRTEI = { 91,// lineNo
  5,                                   // colNo
  "standardTF_stanlay_paraContrasts",  // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/standard_TF/standardTF_stanLay/standardTF_stanlay_paraContrasts.m"// pName 
};

static emlrtRTEInfo ki_emlrtRTEI = { 92,// lineNo
  5,                                   // colNo
  "standardTF_stanlay_paraContrasts",  // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/standard_TF/standardTF_stanLay/standardTF_stanlay_paraContrasts.m"// pName 
};

static emlrtRTEInfo li_emlrtRTEI = { 93,// lineNo
  5,                                   // colNo
  "standardTF_stanlay_paraContrasts",  // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/standard_TF/standardTF_stanLay/standardTF_stanlay_paraContrasts.m"// pName 
};
  ...
  cell_wrap_11, 1U> &allLayers, coder::array<real_T, 1U> &allRoughs)
{
  ...
  reflectivity.set_size((&ci_emlrtRTEI), sp, i);
  for (b_i = 0; b_i < i; b_i++) {
    ...
    reflectivity[b_i].f1.set_size((&di_emlrtRTEI), sp, 2, reflectivity[b_i].
      f1.size(1));
    i1 = reflectivity.size(0) - 1;
    if (b_i > i1) {
      emlrtDynamicBoundsCheckR2012b(b_i, 0, i1, &wh_emlrtBCI, sp);
    ...
    reflectivity[b_i].f1.set_size((&di_emlrtRTEI), sp, reflectivity[b_i].f1.size
      (0), 2);
    i1 = reflectivity.size(0) - 1;
  ...
  Simulation.set_size((&ci_emlrtRTEI), sp, i);
  for (b_i = 0; b_i < i; b_i++) {
    ...
    Simulation[b_i].f1.set_size((&ei_emlrtRTEI), sp, 2, Simulation[b_i].f1.size
      (1));
    i1 = Simulation.size(0) - 1;
    if (b_i > i1) {
      emlrtDynamicBoundsCheckR2012b(b_i, 0, i1, &xh_emlrtBCI, sp);
    ...
    Simulation[b_i].f1.set_size((&ei_emlrtRTEI), sp, Simulation[b_i].f1.size(0),
      2);
    i1 = Simulation.size(0) - 1;
  ...
  allLayers.set_size((&ci_emlrtRTEI), sp, i);
  for (b_i = 0; b_i < i; b_i++) {
    ...
    allLayers[b_i].f1.set_size((&fi_emlrtRTEI), sp, 2);
    if (b_i > i1) {
  ...
  outSsubs.set_size((&gi_emlrtRTEI), sp, i);
  sldProfiles.set_size((&ci_emlrtRTEI), sp, i);
  reflectivity.set_size((&ci_emlrtRTEI), sp, i);
  Simulation.set_size((&ci_emlrtRTEI), sp, i);
  shifted_data.set_size((&ci_emlrtRTEI), sp, i);
  layerSlds.set_size((&ci_emlrtRTEI), sp, i);
  chis.set_size((&gi_emlrtRTEI), sp, i);
  backgs.set_size((&gi_emlrtRTEI), sp, i);
  qshifts.set_size((&gi_emlrtRTEI), sp, i);
  sfs.set_size((&gi_emlrtRTEI), sp, i);
  nbas.set_size((&gi_emlrtRTEI), sp, i);
  nbss.set_size((&gi_emlrtRTEI), sp, i);
  resols.set_size((&gi_emlrtRTEI), sp, i);
  allRoughs.set_size((&gi_emlrtRTEI), sp, i);
    ...
    for (c_i = 0; c_i <= ub_loop; c_i++) {
      ...
      try {
        ...
        if ((i3 < 1) || (i3 > cBacks.size(1))) {
          emlrtDynamicBoundsCheckR2012b(i3, 1, cBacks.size(1), &ai_emlrtBCI,
            &b_st);
        }

        if (i3 > cShifts.size(1)) {
          emlrtDynamicBoundsCheckR2012b(i3, 1, cShifts.size(1), &bi_emlrtBCI,
            &b_st);
        }

        if (i3 > cScales.size(1)) {
          emlrtDynamicBoundsCheckR2012b(i3, 1, cScales.size(1), &ci_emlrtBCI,
            &b_st);
        }

        if (i3 > cNbas.size(1)) {
          emlrtDynamicBoundsCheckR2012b(i3, 1, cNbas.size(1), &di_emlrtBCI,
            &b_st);
        }

        if (i3 > cNbss.size(1)) {
          emlrtDynamicBoundsCheckR2012b(i3, 1, cNbss.size(1), &ei_emlrtBCI,
            &b_st);
        }

        if (i3 > cRes.size(1)) {
          emlrtDynamicBoundsCheckR2012b(i3, 1, cRes.size(1), &fi_emlrtBCI, &b_st);
        }
        ...
        //  arrays
        if (1 > params.size(1)) {
          emlrtDynamicBoundsCheckR2012b(1, 1, params.size(1), &oh_emlrtBCI,
            &b_st);
        }
        ...
        if ((i3 < 1) || (i3 > resample.size(1))) {
          emlrtDynamicBoundsCheckR2012b(i3, 1, resample.size(1), &ph_emlrtBCI,
            &b_st);
        }
        ...
        if ((i3 < 1) || (i3 > dataPresent.size(1))) {
          emlrtDynamicBoundsCheckR2012b(i3, 1, dataPresent.size(1), &qh_emlrtBCI,
            &b_st);
        }
        ...
        if (c_i > i3) {
          emlrtDynamicBoundsCheckR2012b(c_i, 0, i3, &vh_emlrtBCI, &b_st);
        }

        i3 = c_i + 1;
        if ((i3 < 1) || (i3 > backsType.size(1))) {
          emlrtDynamicBoundsCheckR2012b(i3, 1, backsType.size(1), &rh_emlrtBCI,
            &b_st);
        }
        ...
        if ((i3 < 1) || (i3 > outSsubs.size(0))) {
          emlrtDynamicBoundsCheckR2012b(i3, 1, outSsubs.size(0), &hi_emlrtBCI,
            &b_st);
        }
        ...
        sldProfiles[c_i].f1.set_size((&hi_emlrtRTEI), (&b_st), sldProfile.size(0),
        ...
        sldProfiles[c_i].f1.set_size((&hi_emlrtRTEI), (&b_st), sldProfiles[c_i].
        ...
        reflectivity[c_i].f1.set_size((&ii_emlrtRTEI), (&b_st), reflect.size(0),
        ...
        reflectivity[c_i].f1.set_size((&ii_emlrtRTEI), (&b_st), reflectivity[c_i]
          .f1.size(0), 2);
        i3 = reflectivity.size(0) - 1;
        ...
        Simulation[c_i].f1.set_size((&ji_emlrtRTEI), (&b_st), Simul.size(0),
        ...
        Simulation[c_i].f1.set_size((&ji_emlrtRTEI), (&b_st), Simulation[c_i].
          f1.size(0), 2);
        i3 = Simulation.size(0) - 1;
        ...
        shifted_data[c_i].f1.set_size((&ki_emlrtRTEI), (&b_st), shifted_dat.size
        ...
        shifted_data[c_i].f1.set_size((&ki_emlrtRTEI), (&b_st), shifted_data[c_i]
          .f1.size(0), 3);
        i3 = shifted_data.size(0) - 1;
        ...
        layerSlds[c_i].f1.set_size((&li_emlrtRTEI), (&b_st), thisData.size(0),
        ...
        layerSlds[c_i].f1.set_size((&li_emlrtRTEI), (&b_st), layerSlds[c_i].
          f1.size(0), 3);
        i3 = layerSlds.size(0) - 1;
        i4 = layerSlds.size(0) - 1;
        if (c_i > i4) {
          emlrtDynamicBoundsCheckR2012b(c_i, 0, i4, &mi_emlrtBCI, &b_st);
        }
        ...
        if ((i3 < 1) || (i3 > chis.size(0))) {
          emlrtDynamicBoundsCheckR2012b(i3, 1, chis.size(0), &ni_emlrtBCI, &b_st);
        }
        ...
        if ((i3 < 1) || (i3 > qshifts.size(0))) {
          emlrtDynamicBoundsCheckR2012b(i3, 1, qshifts.size(0), &pi_emlrtBCI,
            &b_st);
        }
        ...
        if ((i3 < 1) || (i3 > sfs.size(0))) {
          emlrtDynamicBoundsCheckR2012b(i3, 1, sfs.size(0), &qi_emlrtBCI, &b_st);
        }

        sfs[i3 - 1] = thisSf;
        i3 = c_i + 1;
        if ((i3 < 1) || (i3 > nbas.size(0))) {
          emlrtDynamicBoundsCheckR2012b(i3, 1, nbas.size(0), &ri_emlrtBCI, &b_st);
        }

        nbas[i3 - 1] = thisNba;
        i3 = c_i + 1;
        if ((i3 < 1) || (i3 > nbss.size(0))) {
          emlrtDynamicBoundsCheckR2012b(i3, 1, nbss.size(0), &si_emlrtBCI, &b_st);
        }

        nbss[i3 - 1] = thisNbs;
        i3 = c_i + 1;
        if ((i3 < 1) || (i3 > resols.size(0))) {
          emlrtDynamicBoundsCheckR2012b(i3, 1, resols.size(0), &ti_emlrtBCI,
            &b_st);
        }
        ...
        if ((i3 < 1) || (i3 > allRoughs.size(0))) {
          emlrtDynamicBoundsCheckR2012b(i3, 1, allRoughs.size(0), &ui_emlrtBCI,
            &b_st);
        }

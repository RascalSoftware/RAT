...
namespace RAT
{
  static void printParameters(const DreamParams &DREAMPar)
  {
    ...
    static const char t10_f2[27]{ ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
      ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 's', 't', 'e', 'p',
      's', ':', ' ' };

    static const char t11_f2[27]{ ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
      ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'z', 'e', 't',
      'a', ':', ' ' };
    ...
    static const char t1_f2[27]{ ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
      ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'n', 'P', 'a', 'r', 'a', 'm',
      's', ':', ' ' };

    static const char t2_f2[27]{ ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
      ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'n', 'C', 'h', 'a', 'i', 'n',
      's', ':', ' ' };

    static const char t3_f2[27]{ ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
      ' ', ' ', ' ', ' ', 'n', 'G', 'e', 'n', 'e', 'r', 'a', 't', 'i', 'o', 'n',
      's', ':', ' ' };

    static const char t4_f2[27]{ ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
      ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'p', 'a', 'r', 'a', 'l', 'l', 'e',
      'l', ':', ' ' };

    static const char t5_f2[27]{ ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
      ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'C', 'P',
      'U', ':', ' ' };

    static const char t6_f2[27]{ ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
      ' ', 'j', 'u', 'm', 'p', 'P', 'r', 'o', 'b', 'a', 'b', 'i', 'l', 'i', 't',
      'y', ':', ' ' };

    static const char t7_f2[27]{ ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
      ' ', ' ', ' ', ' ', ' ', ' ', 'p', 'U', 'n', 'i', 't', 'G', 'a', 'm', 'm',
      'a', ':', ' ' };

    static const char t8_f2[27]{ ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
      ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'n', 'C',
      'R', ':', ' ' };

    static const char t9_f2[27]{ ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
      ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'd', 'e', 'l', 't',
      'a', ':', ' ' };
    ...
    bools[1].f1 = b_f1;
    c_f1.reserve(100);
    coder::strjoin(t1_f1, t1_f2, (char *)c_f1.data(), iv);
             ...
             3U> &chain, c_struct_T &output, ::coder::array<double, 2U> &log_L)
  {
    ...
    do {
      exitg1 = 0;
      if (t <= static_cast<int>(DREAMPar.nGenerations - 1.0) - 1) {
        double varargin_1;
        int b_loop_ub;
        int i1;
        ...
        metropolisRule(DREAMPar, log_L_xnew, log_PR_xnew, b_X, c_X, accept,
                       idx_ac);
        ...
        if (coder::b_mod(static_cast<double>(t) + 2.0, 1.0) == 0.0) {
          ...
          for (i = 0; i < loop_ub; i++) {
            for (i1 = 0; i1 < result; i1++) {
              chain[((static_cast<int>(iloc) + chain.size(0) * i1) + chain.size
                     (0) * chain.size(1) * i) - 1] = b_xnew[i1 + result * i];
            }
          }
        }
        ...
        if (DREAMPar.adaptPCR) {
          ...
          if ((b_loop_ub == b_r.size(0)) && (loop_ub_tmp == b_r.size(1))) {
            ...
            binary_expand_op(x, xold, b_loop_ub - 1, loop_ub_tmp - 1, X,
                             b_loop_ub - 1, loop_ub_tmp - 1, b_r);
          }
        ...
        for (i = 0; i < input_sizes_idx_1; i++) {
          log_L[(t + log_L.size(0) * (i + 1)) + 1] = X[i + X.size(0) * (result -
            1)];
        }

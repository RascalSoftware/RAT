...
namespace RAT
{
  void cast(const ::coder::array<cell_wrap_52, 1U> &b, ::coder::array<
            cell_wrap_10, 1U> &c)
  {
    int32_T i;
    c.set_size(b.size(0));
  ...
  void cast(const ::coder::array<cell_wrap_52, 2U> &b, ::coder::array<
            cell_wrap_10, 2U> &c)
  {
    int32_T i;
  ...
  void cast(const ::coder::array<cell_wrap_17, 2U> &b, ::coder::array<
            cell_wrap_10, 2U> &c)
  {
    int32_T i;
    c.set_size(b.size(0), b.size(1));
  ...
  void cast(const ::coder::array<cell_wrap_8, 1U> &b, ::coder::array<
            cell_wrap_10, 1U> &c)
  {
    int32_T i;
    c.set_size(b.size(0));
  ...
  void cast(const ::coder::array<cell_wrap_24, 1U> &b, ::coder::array<
            cell_wrap_10, 1U> &c)
  {
    int32_T i;
    c.set_size(b.size(0));
  ...
  void cast(const ::coder::array<cell_wrap_25, 2U> &b, ::coder::array<
            cell_wrap_10, 2U> &c)
  {
    int32_T i;

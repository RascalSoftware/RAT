...
namespace RAT
{
  ...
  struct struct8_T
  {
    ...
    real_T chi;
    ::coder::array<cell_wrap_8, 1U> data;
  };

  struct struct9_T
  {
    ::coder::array<cell_wrap_8, 1U> refPredInts;
    ::coder::array<cell_wrap_8, 2U> sldPredInts;
    ::coder::array<cell_wrap_8, 1U> refXdata;
    ::coder::array<cell_wrap_8, 2U> sldXdata;

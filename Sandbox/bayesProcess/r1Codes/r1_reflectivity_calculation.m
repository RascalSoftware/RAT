...
switch whichtype
    ...
    otherwise
        problem = r1_callReflectivityCalculation(problem);
end
...
for i = 1:number_of_contrasts;
    ...
    problem.calculations.all_chis(i) = r1_rascal_chi_squared(thisref(limits(1):limits(2),2),this_data((limits(1):limits(2)),2),length(problem.params),this_data((limits(1):limits(2)),3),[]);
 end

...
if coder.target('MATLAB')
    ...
    path = '/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/matlabEngineCaller_customLayers/tmwExample/example_single';
    
    incPath1 = '/usr/local/MATLAB/R2018b/extern/include';
    %incPath2 = '/usr/include/openmpi';
    
    linkPath1 = '/usr/local/MATLAB/R2018b/bin/glnxa64';
    linkFile1 = 'libeng.so';
    linkFile2 = 'libmx.so';

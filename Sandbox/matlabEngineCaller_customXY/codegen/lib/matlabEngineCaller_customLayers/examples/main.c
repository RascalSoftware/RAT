...
static void argInit_1x33_char_T(char result[33]);
static void argInit_1x71_char_T(char result[71]);
...
static void main_matlabEngineCaller_customLayers(void)
{
  ...
  argInit_1x33_char_T(cv);
  argInit_1x71_char_T(cv1);

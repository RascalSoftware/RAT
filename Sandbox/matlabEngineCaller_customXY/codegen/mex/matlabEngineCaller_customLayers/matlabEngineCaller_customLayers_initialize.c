...
static void c_matlabEngineCaller_customLaye(void)
{
  ...
  covrtBasicBlockInit(&emlrtCoverageInstance, 0U, 9U, 2836, -1, 2870);
  covrtBasicBlockInit(&emlrtCoverageInstance, 0U, 8U, 2736, -1, 2789);
  covrtBasicBlockInit(&emlrtCoverageInstance, 0U, 7U, 2538, -1, 2679);
  covrtBasicBlockInit(&emlrtCoverageInstance, 0U, 6U, 2469, -1, 2494);
  covrtBasicBlockInit(&emlrtCoverageInstance, 0U, 5U, 802, -1, 2386);
  ...
  covrtIfInit(&emlrtCoverageInstance, 0U, 0U, 440, 465, 788, 2884);
  covrtIfInit(&emlrtCoverageInstance, 0U, 1U, 470, 483, -1, 580);
  covrtIfInit(&emlrtCoverageInstance, 0U, 2U, 620, 637, -1, 684);
  covrtIfInit(&emlrtCoverageInstance, 0U, 3U, 2443, 2460, 2823, 2879);
  covrtIfInit(&emlrtCoverageInstance, 0U, 4U, 2693, 2719, -1, 2806);
  ...
  covrtForInit(&emlrtCoverageInstance, 0U, 0U, 2504, 2526, 2818);

 ...
 *
 * _coder_matlabEngineCaller_customXY_api.c
 *
...
static emlrtRTEInfo d_emlrtRTEI = { 1, /* lineNo */
  1,                                   /* colNo */
  "_coder_matlabEngineCaller_customXY_api",/* fName */
  ""                                   /* pName */
};
...
static void e_emlrt_marshallIn(const emlrtStack *sp, const mxArray *funcName,
  const char_T *identifier, char_T y[33]);
...
static void f_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u, const
  emlrtMsgIdentifier *parentId, char_T y[33]);
static void g_emlrt_marshallIn(const emlrtStack *sp, const mxArray *funcPath,
  const char_T *identifier, char_T y[71]);
static void h_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u, const
  emlrtMsgIdentifier *parentId, char_T y[71]);
...
static void k_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src, const
  emlrtMsgIdentifier *msgId, char_T ret[33]);
static void l_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src, const
  emlrtMsgIdentifier *msgId, char_T ret[71]);
  ...
  emlrtMsgIdentifier *msgId, char_T ret[33])
{
  ...
  emlrtImportCharArrayR2015b(sp, src, &ret[0], 33);
  emlrtDestroyArray(&src);
}
...
static void l_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src, const
  emlrtMsgIdentifier *msgId, char_T ret[71])
{
  static const int32_T dims[2] = { 1, 71 };

  emlrtCheckBuiltInR2012b(sp, msgId, src, "char", false, 2U, dims);
  emlrtImportCharArrayR2015b(sp, src, &ret[0], 71);
  emlrtDestroyArray(&src);
}

void matlabEngineCaller_customXY_api(const mxArray * const prhs[6], int32_T nlhs,
  const mxArray *plhs[2])
{
  ...
  matlabEngineCaller_customXY(&st, *params, contrast, funcName, funcPath, bulkIn,
...
/* End of code generation (_coder_matlabEngineCaller_customXY_api.c) */

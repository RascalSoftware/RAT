...
%   D2O calibration using the Nested Sampler.
...
model.ssfun = @fitfun;
Nlive = 1000;% controls.Nlive;
tolerance = 1;
likelihood = @NS_Intrafun;
%model = problemDef_cells;
Nmcmc = 50;% controls.nmcmc;
...
%-------------------------------------------------------
function LogLike = NS_Intrafun(data,model,parnames,pars)


%First calculate chisquared
chisq = fitfun(data,model,parnames,pars);

function problem = linear_DE_new_test(problem,controls)
...
I_itermax = 1000;%problem.maxiter;
...
res = rascal_deopt(@intrafun,problem,@PlotIt,controls,S_struct);

end


function S_MSE = intrafun(p,problem,controls);

function problem = rascal_DE_new_test(problem,controls)
...
problem = rascal_deopt(@intrafun,problem,@PlotIt,controls);

end


function S_MSE = intrafun(x,problem,controls);

%x = cell2mat(struct2cell(x));

problem.fitpars = x;
problem = unpackparams(problem,controls);

 ...
 *
 * _coder_callFoo_info.c
 *
 * Code generation for function '_coder_callFoo_info'
 *
 */

/* Include files */
#include "_coder_callFoo_info.h"
...
mxArray *emlrtMexFcnProperties(void)
{
  ...
  emlrtSetField(xEntryPoints, 0, "Name", emlrtMxCreateString("callFoo"));
...
/* End of code generation (_coder_callFoo_info.c) */

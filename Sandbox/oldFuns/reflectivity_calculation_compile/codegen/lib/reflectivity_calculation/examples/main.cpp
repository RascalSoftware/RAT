...
static coder::array<double, 2U> argInit_Unboundedxd5_real_T();
static void argInit_cell_7(cell_7 *result);
...
static cell_wrap_6 argInit_cell_wrap_6();
...
//
// Arguments    : cell_wrap_6 result[1]
// Return Type  : void
//
static void argInit_1x1_cell_wrap_6(cell_wrap_6 result[1])
{
...
//
// Arguments    : cell_wrap_4 result[3]
// Return Type  : void
//
static void argInit_1x3_cell_wrap_4(cell_wrap_4 result[3])
{
...
//
// Arguments    : void
// Return Type  : coder::array<cell_wrap_5, 2U>
//
static coder::array<cell_wrap_5, 2U> argInit_1xUnbounded_cell_wrap_5()
{
...
static void argInit_cell_7(cell_7 *result)
{
  ...
  argInit_1x1_cell_wrap_6(result->f14);
}
...
static cell_wrap_1 argInit_cell_wrap_1()
{
  ...
  // Set the value of each structure field.
  // Change this value to the value that the application requires.
  result.f1 = argInit_Unboundedxd5_real_T();
  return result;
}
...
static cell_wrap_3 argInit_cell_wrap_3()
{
  ...
  // Set the value of each structure field.
  // Change this value to the value that the application requires.
  argInit_1xd7_real_T(result.f1.data, result.f1.size);
  return result;
}
...
static void argInit_cell_wrap_5(cell_wrap_5 *result)
{
  // Set the value of each structure field.
  // Change this value to the value that the application requires.
  argInit_1x3_cell_wrap_4(result->f1);
}

//
// Arguments    : void
// Return Type  : cell_wrap_6
//
static cell_wrap_6 argInit_cell_wrap_6()
{
  cell_wrap_6 result;
  ...
  // Set the value of each structure field.
  // Change this value to the value that the application requires.
  result.f1 = argInit_1xUnbounded_cell_wrap_5();
  return result;
}
...
static void argInit_struct0_T(struct0_T *result)
{
  ...
  b_result_tmp = argInit_Unboundedx2_real_T();
...
static void argInit_struct2_T(struct2_T *result)
{
  ...
  result->repeats = result_tmp;
  result->nsimu = result_tmp;
  result->burnin = result_tmp;
...
static void main_reflectivity_calculation()
{
  ...
  argInit_cell_7(&problemDef_cells);

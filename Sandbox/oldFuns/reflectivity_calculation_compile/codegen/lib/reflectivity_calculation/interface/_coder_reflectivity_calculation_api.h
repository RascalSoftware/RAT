...
typedef struct {
  emxArray_cell_wrap_8 *f1;
  emxArray_cell_wrap_8 *f2;
  emxArray_cell_wrap_9 *f3;
  emxArray_cell_wrap_9 *f4;
  emxArray_cell_wrap_8 *f5;
  emxArray_real_T *f6;
} cell_10;
...
extern void reflectivity_calculation(struct0_T *problemDef, cell_7
  *problemDef_cells, struct1_T *problemDef_limits, struct2_T *controls,
  struct4_T *problem, cell_10 *result);

...
## Generated on : Wed Apr 14 11:39:25 2021
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /home/arwel/Documents/RascalDev/RAT/compile/reflectivity_calculation_compile/codegen/lib/reflectivity_calculation
TGT_FCN_LIB               = ISO_C++
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I/home/arwel/Documents/RascalDev/RAT/compile/reflectivity_calculation_compile -I$(MATLAB_ROOT)/extern/include
...
%.o : /home/arwel/Documents/RascalDev/RAT/compile/reflectivity_calculation_compile/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : /home/arwel/Documents/RascalDev/RAT/compile/reflectivity_calculation_compile/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"

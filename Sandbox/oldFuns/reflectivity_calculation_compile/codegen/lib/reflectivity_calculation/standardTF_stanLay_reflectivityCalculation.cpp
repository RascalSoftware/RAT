...
//                const cell_15 *problemDef_cells
...
// Return Type  : void
//
void c_standardTF_stanLay_reflectivi(const struct0_T *problemDef, const cell_15 *
  ...
  coder::array<cell_wrap_1, 1U> &shifted_data, coder::array<cell_wrap_9, 1U>
  &layerSlds, coder::array<cell_wrap_1, 1U> &sldProfiles, coder::array<
  cell_wrap_13, 1U> &allLayers)
{
  int loop_ub;

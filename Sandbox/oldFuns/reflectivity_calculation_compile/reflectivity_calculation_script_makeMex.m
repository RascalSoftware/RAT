...
% 
% Script generated from project 'reflectivity_calculation.prj' on 14-Apr-2021.
% 
...
ARG = coder.typeof(0,[1 7],[1 1]);
ARGS_1_2{6} = coder.typeof({ARG}, [Inf  1],[1 1]);
...
ARGS_1_2{14} = coder.typeof({ARG}, [1 Inf],[1 1]);

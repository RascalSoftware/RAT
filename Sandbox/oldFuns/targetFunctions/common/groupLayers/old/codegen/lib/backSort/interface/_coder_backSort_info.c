...
/* Include files */
#include "_coder_backSort_info.h"
...
mxArray *emlrtMexFcnProperties(void)
{
  ...
  emlrtSetField(xEntryPoints, 0, "Name", mxCreateString("backSort"));
  emlrtSetField(xEntryPoints, 0, "NumberOfInputs", mxCreateDoubleScalar(12.0));
...
/* End of code generation (_coder_backSort_info.c) */

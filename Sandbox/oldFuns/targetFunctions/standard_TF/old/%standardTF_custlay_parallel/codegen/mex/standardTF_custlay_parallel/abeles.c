            ...
            real_T ssub, real_T layers, real_T points, emxArray_real_T *out)
{
  ...
  while (loop <= (int32_T)points - 1) {
    ...
    i22 = loop + 1;
    if (!((i22 >= 1) && (i22 <= i21))) {
      emlrtDynamicBoundsCheckR2012b(i22, 1, i21, &we_emlrtBCI, sp);
    }
    ...
    i21 = sld->size[0];
    if (!(1 <= i21)) {
      emlrtDynamicBoundsCheckR2012b(1, 1, i21, &xe_emlrtBCI, sp);
    }
    ...
    while (reploop <= (int32_T)nrepeats - 1) {
      ...
      while (nl <= (int32_T)layers - 1) {
        ...
        i22 = nl + 1;
        if (!((i22 >= 1) && (i22 <= i21))) {
          emlrtDynamicBoundsCheckR2012b(i22, 1, i21, &ye_emlrtBCI, sp);
        }

        i21 = sld->size[0];
        i22 = nl + 1;
        if (!((i22 >= 1) && (i22 <= i21))) {
          emlrtDynamicBoundsCheckR2012b(i22, 1, i21, &af_emlrtBCI, sp);
        }

        i21 = sld->size[0];
        i22 = nl + 1;
        if (!((i22 >= 1) && (i22 <= i21))) {
          emlrtDynamicBoundsCheckR2012b(i22, 1, i21, &bf_emlrtBCI, sp);
        }
    ...
    if (!((loop + 1 >= 1) && (loop + 1 <= i21))) {
      emlrtDynamicBoundsCheckR2012b(loop + 1, 1, i21, &cf_emlrtBCI, sp);
    }

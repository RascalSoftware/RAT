            ...
            points, emxArray_real_T *out)
{
  ...
  emxEnsureCapacity((emxArray__common *)out, i12, (int)sizeof(double));
  for (loop = 0; loop < (int)points; loop++) {
    ...
    for (reploop = 0; reploop < (int)nrepeats; reploop++) {
      for (nl = 0; nl < (int)layers; nl++) {
        ...
        for (i12 = 0; i12 < 2; i12++) {
          for (i13 = 0; i13 < 2; i13++) {
            b_MI[i12 + (i13 << 1)].re = 0.0;
            b_MI[i12 + (i13 << 1)].im = 0.0;
            for (i14 = 0; i14 < 2; i14++) {
              b_MI[i12 + (i13 << 1)].re += MI[i12 + (i14 << 1)].re * N[i14 +
                (i13 << 1)].re - MI[i12 + (i14 << 1)].im * N[i14 + (i13 << 1)].
                im;
              b_MI[i12 + (i13 << 1)].im += MI[i12 + (i14 << 1)].re * N[i14 +
                (i13 << 1)].im + MI[i12 + (i14 << 1)].im * N[i14 + (i13 << 1)].
                re;
            }
          }
        }
    ...
    for (i12 = 0; i12 < 2; i12++) {
      for (i13 = 0; i13 < 2; i13++) {
        ...
        b_MI[i12 + (i13 << 1)].im = 0.0;
        for (i14 = 0; i14 < 2; i14++) {
          b_MI[i12 + (i13 << 1)].re += MI[i12 + (i14 << 1)].re * N[i14 + (i13 <<
            1)].re - MI[i12 + (i14 << 1)].im * N[i14 + (i13 << 1)].im;
          b_MI[i12 + (i13 << 1)].im += MI[i12 + (i14 << 1)].re * N[i14 + (i13 <<
            1)].im + MI[i12 + (i14 << 1)].im * N[i14 + (i13 << 1)].re;
        }
      }
    }

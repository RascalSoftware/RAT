...
emlrtContext emlrtContextGlobal = { true,/* bFirstTime */
  ...
  NULL,                                /* fErrorFunction */
  "standardTF_stanlay_parallel",       /* fFunctionName */
  NULL,                                /* fRTCallStack */
  false,                               /* bDebugMode */
...
static void ab_emlrt_marshallIn(const emlrtStack *sp, const mxArray *fileHandle,
...
static const mxArray *i_emlrt_marshallOut(const emxArray_cell_wrap_4 *u);
...
static void w_emlrt_marshallIn(const emlrtStack *sp, const mxArray
  *layersDetails, const char_T *identifier, emxArray_cell_wrap_2 *y);
  ...
  const char_T *identifier)
{
  ...
  bb_emlrt_marshallIn(sp, emlrtAlias(fileHandle), &thisId);
...
static void bb_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u, const
  emlrtMsgIdentifier *parentId)
{
  jb_emlrt_marshallIn(sp, emlrtAlias(u), parentId);
  emlrtDestroyArray(&u);
}
  ...
  emlrtMsgIdentifier *msgId, emxArray_char_T *ret)
{
  ...
  ret->size[0] = iv9[0];
  ret->size[1] = iv9[1];
  emxEnsureCapacity((emxArray__common *)ret, i17, (int32_T)sizeof(char_T));
  ...
  emlrtMsgIdentifier *msgId, real_T ret[2])
{
  ...
  for (i18 = 0; i18 < 2; i18++) {
    ret[i18] = (*(real_T (*)[2])mxGetData(src))[i18];
  }
...
static const mxArray *i_emlrt_marshallOut(const emxArray_cell_wrap_4 *u)
{
  ...
  while (i14 < n) {
    r5 = &u->data[i14];
    u_size[0] = r5->f1.size[0];
    u_size[1] = r5->f1.size[1];
    i15 = r5->f1.size[0];
    i = r5->f1.size[1];
    loop_ub = i15 * i;
    for (i16 = 0; i16 < loop_ub; i16++) {
      tmp_data[i16] = r5->f1.data[i16];
    }

    loop_ub = i15 * i;
    for (i15 = 0; i15 < loop_ub; i15++) {
      u_data[i15] = tmp_data[i15];
    }
    ...
    for (i = 0; i < u_size[1]; i++) {
      for (loop_ub = 0; loop_ub < u_size[0]; loop_ub++) {
        pData[i15] = u_data[loop_ub + u_size[0] * i];
        i15++;
      }
    }
  ...
  emlrtMsgIdentifier *parentId, emxArray_cell_wrap_0 *y)
{
  ...
  y->size[0] = sizes[0];
  y->size[1] = sizes[1];
  emxEnsureCapacity((emxArray__common *)y, i5, (int32_T)sizeof(cell_wrap_0));
  n = y->size[1];
  for (i5 = 0; i5 < n; i5++) {
  ...
  *layersDetails, const char_T *identifier, emxArray_cell_wrap_2 *y)
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  x_emlrt_marshallIn(sp, emlrtAlias(layersDetails), &thisId, y);
  ...
  emlrtMsgIdentifier *parentId, emxArray_cell_wrap_2 *y)
{
  ...
  y->size[0] = sizes[0];
  y->size[1] = sizes[1];
  emxEnsureCapacity_cell_wrap_2(y, i6);
  n = y->size[1];
  for (i6 = 0; i6 < n; i6++) {
    sprintf(&str[0], "%d", i6 + 1);
    thisId.fIdentifier = &str[0];
    y_emlrt_marshallIn(sp, emlrtAlias(emlrtGetCell(sp, parentId, u, i6)),
...
void standardTF_stanlay_parallel_api(const mxArray *prhs[30], const mxArray
  *plhs[15])
{
  ...
  emxArray_cell_wrap_2 *layersDetails;
  ...
  emxInit_cell_wrap_2(&st, &layersDetails, 2, true);
  ...
  numberOfLayers = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[26]),
    "numberOfLayers");
  w_emlrt_marshallIn(&st, emlrtAliasP(prhs[27]), "layersDetails", layersDetails);
  whichType = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[28]), "whichType");
  ab_emlrt_marshallIn(&st, emlrtAlias(prhs[29]), "fileHandle");

  /* Invoke the target function */
  standardTF_stanlay_parallel(resam, numberOfContrasts, geometry, nbairs, nbsubs,
  ...
  plhs[13] = i_emlrt_marshallOut(allLayers);
  ...
  emxFree_cell_wrap_2(&layersDetails);
...
void standardTF_stanlay_parallel_atexit(void)
{
  ...
  standardTF_stanlay_parallel_xil_terminate();
}

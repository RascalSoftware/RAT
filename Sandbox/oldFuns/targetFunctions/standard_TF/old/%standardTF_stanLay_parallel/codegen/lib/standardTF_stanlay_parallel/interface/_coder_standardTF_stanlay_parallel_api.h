 ...
 *
 * _coder_standardTF_stanlay_parallel_api.h
 *
 * Code generation for function '_coder_standardTF_stanlay_parallel_api'
 *
 */

#ifndef _CODER_STANDARDTF_STANLAY_PARALLEL_API_H
#define _CODER_STANDARDTF_STANLAY_PARALLEL_API_H
...
extern void standardTF_stanlay_parallel(emxArray_real_T *resam, real_T
  ...
  *cNbas, emxArray_real_T *cNbss, emxArray_real_T *cRes, emxArray_real_T *backs,
  ...
  numberOfLayers, emxArray_cell_wrap_2 *layersDetails, real_T whichType,
...
extern void standardTF_stanlay_parallel_api(const mxArray *prhs[30], const
  mxArray *plhs[15]);
extern void standardTF_stanlay_parallel_atexit(void);
extern void standardTF_stanlay_parallel_initialize(void);
extern void standardTF_stanlay_parallel_terminate(void);
extern void standardTF_stanlay_parallel_xil_terminate(void);

#endif

/* End of code generation (_coder_standardTF_stanlay_parallel_api.h) */

...
static emlrtRTEInfo i_emlrtRTEI = { 34,/* lineNo */
  5,                                   /* colNo */
  "groupLayers_Mod",                   /* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/groupLayers/groupLayers_Mod.m"/* pName */
};
                     ...
                     *outSsubs)
{
  ...
  emxInit_real_T(sp, &layers, 2, &i_emlrtRTEI, true);
  ...
  if (!((allLayers->size[0] == 0) || (allLayers->size[1] == 0))) {
    ...
    switch (kstr) {
     ...
     case 1:
      emxInit_real_T1(sp, &sldss, 1, &k_emlrtRTEI, true);
      i8 = allLayers->size[1];
      if (!(3 <= i8)) {
        emlrtDynamicBoundsCheckR2012b(3, 1, i8, &lc_emlrtBCI, sp);
      }

      i8 = allLayers->size[1];
      if (!(2 <= i8)) {
        emlrtDynamicBoundsCheckR2012b(2, 1, i8, &mc_emlrtBCI, sp);
      }

      loop_ub = allLayers->size[0];
      i8 = sldss->size[0];
      sldss->size[0] = loop_ub;
      emxEnsureCapacity(sp, (emxArray__common *)sldss, i8, (int32_T)sizeof
                        (real_T), &h_emlrtRTEI);
      for (i8 = 0; i8 < loop_ub; i8++) {
        sldss->data[i8] = allLayers->data[i8 + allLayers->size[0]];
      }

      emxInit_real_T1(sp, &thicks, 1, &l_emlrtRTEI, true);
      loop_ub = allLayers->size[0];
      i8 = thicks->size[0];
      thicks->size[0] = loop_ub;
      emxEnsureCapacity(sp, (emxArray__common *)thicks, i8, (int32_T)sizeof
                        (real_T), &h_emlrtRTEI);
      for (i8 = 0; i8 < loop_ub; i8++) {
        thicks->data[i8] = allLayers->data[i8];
      }

      i8 = allLayers->size[0];
      b_loop_ub = allLayers->size[0];
      if (!((i8 >= 1) && (i8 <= b_loop_ub))) {
        emlrtDynamicBoundsCheckR2012b(i8, 1, b_loop_ub, &nc_emlrtBCI, sp);
      }
      ...
      if (1 > i8 - 1) {
        ...
        if (!((loop_ub >= 1) && (loop_ub <= i8))) {
          emlrtDynamicBoundsCheckR2012b(loop_ub, 1, i8, &oc_emlrtBCI, sp);
        }
      }

      emxInit_real_T1(sp, &b_allLayers, 1, &h_emlrtRTEI, true);
      i8 = allLayers->size[0];
      iv2[0] = 1;
      iv2[1] = loop_ub;
      st.site = &j_emlrtRSI;
      indexShapeCheck(&st, i8, iv2);
      ...
      emxInit_real_T1(sp, &roughs, 1, &j_emlrtRTEI, true);
      i8 = roughs->size[0];
      ...
      if (allLayers->size[1] == 5) {
        ...
        emxInit_real_T1(&c_st, &c_allLayers, 1, &h_emlrtRTEI, true);
        loop_ub = allLayers->size[0];
        kstr = allLayers->size[0];
        b_loop_ub = allLayers->size[0];
        roughs_idx_0 = roughs->size[0];
        ...
        emxEnsureCapacity(sp, (emxArray__common *)c_allLayers, i8, (int32_T)
                          sizeof(real_T), &h_emlrtRTEI);
        for (i8 = 0; i8 < c_loop_ub; i8++) {
          c_allLayers->data[i8] = allLayers->data[i8 + allLayers->size[0] * 3];
        }
        ...
        emxEnsureCapacity(sp, (emxArray__common *)layers, i8, (int32_T)sizeof
                          (real_T), &h_emlrtRTEI);
        for (i8 = 0; i8 < loop_ub; i8++) {
          layers->data[i8] = thicks->data[i8];
        }

        for (i8 = 0; i8 < kstr; i8++) {
          layers->data[i8 + layers->size[0]] = sldss->data[i8];
        }
        ...
        for (i8 = 0; i8 < b_loop_ub; i8++) {
          layers->data[i8 + layers->size[0] * 3] = c_allLayers->data[i8];
        }
    ...
    for (i8 = 0; i8 < 2; i8++) {
      n[i8] = (uint32_T)allLayers->size[i8];
    }
    ...
    if ((int32_T)n[1] == 5) {
      ...
      while (kstr <= (int32_T)n[0] - 1) {
        i8 = allLayers->size[1];
        if (!(4 <= i8)) {
          emlrtDynamicBoundsCheckR2012b(4, 1, i8, &qc_emlrtBCI, sp);
        }

        i8 = allLayers->size[0];
        b_loop_ub = kstr + 1;
        if (!((b_loop_ub >= 1) && (b_loop_ub <= i8))) {
          emlrtDynamicBoundsCheckR2012b(b_loop_ub, 1, i8, &pc_emlrtBCI, sp);
        }

        i8 = allLayers->size[1];
        if (!(5 <= i8)) {
          emlrtDynamicBoundsCheckR2012b(5, 1, i8, &rc_emlrtBCI, sp);
        }

        i8 = allLayers->size[0];
        b_loop_ub = 1 + kstr;
        if (!((b_loop_ub >= 1) && (b_loop_ub <= i8))) {
          emlrtDynamicBoundsCheckR2012b(b_loop_ub, 1, i8, &vc_emlrtBCI, sp);
        }
        ...
        if (!muDoubleScalarIsNaN(allLayers->data[kstr + allLayers->size[0] * 3]))
        {
          i8 = layers->size[1];
          if (!(2 <= i8)) {
            emlrtDynamicBoundsCheckR2012b(2, 1, i8, &tc_emlrtBCI, sp);
          }

          i8 = layers->size[1];
          if (!(2 <= i8)) {
            emlrtDynamicBoundsCheckR2012b(2, 1, i8, &sc_emlrtBCI, sp);
          }

          i8 = layers->size[0];
          b_loop_ub = 1 + kstr;
          if (!((b_loop_ub >= 1) && (b_loop_ub <= i8))) {
            emlrtDynamicBoundsCheckR2012b(b_loop_ub, 1, i8, &wc_emlrtBCI, sp);
          }

          i8 = layers->size[0];
          c_loop_ub = 1 + kstr;
          if (!((c_loop_ub >= 1) && (c_loop_ub <= i8))) {
            emlrtDynamicBoundsCheckR2012b(c_loop_ub, 1, i8, &xc_emlrtBCI, sp);
          }
  ...
  for (i8 = 0; i8 < 3; i8++) {
    for (b_loop_ub = 0; b_loop_ub < loop_ub; b_loop_ub++) {
      c_loop_ub = 1 + i8;
      if (!(c_loop_ub <= kstr)) {
        emlrtDynamicBoundsCheckR2012b(c_loop_ub, 1, kstr, &uc_emlrtBCI, sp);
      }

      outLayers->data[b_loop_ub + outLayers->size[0] * i8] = layers->

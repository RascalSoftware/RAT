...
static emlrtRTEInfo w_emlrtRTEI = { 5, /* lineNo */
  1,                                   /* colNo */
  "resampleLayers",                    /* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/resampleLayers/resampleLayers.m"/* pName */
};
                    ...
                    emxArray_real_T *newSLD)
{
  ...
  emxInit_real_T1(sp, &allNonZero, 1, &x_emlrtRTEI, true);
  emxInit_real_T1(sp, &b_yn, 1, &u_emlrtRTEI, true);
  emxInit_real_T(sp, &nx, 2, &u_emlrtRTEI, true);
  emxInit_real_T(sp, &ny, 2, &u_emlrtRTEI, true);
  emxInit_real_T(sp, &thisLayerx, 2, &y_emlrtRTEI, true);
  emxInit_real_T(sp, &thisLayery, 2, &ab_emlrtRTEI, true);
  st.site = &ub_emlrtRSI;
  ...
  if (!(1 <= idx)) {
    emlrtDynamicBoundsCheckR2012b(1, 1, idx, &md_emlrtBCI, &st);
  }
  ...
  if (!(1 <= yn_idx_0)) {
    emlrtDynamicBoundsCheckR2012b(1, 1, yn_idx_0, &ld_emlrtBCI, &st);
  }
  ...
  i = 1;
  emxInit_real_T(&st, &b_nx, 2, &u_emlrtRTEI, true);
  emxInit_real_T(&st, &b_ny, 2, &u_emlrtRTEI, true);
  do {
    exitg2 = 0;
    idx = allNonZero->size[0];
    if (i - 1 <= idx - 2) {
      ...
      if (!((i12 >= 1) && (i12 <= yn_idx_0))) {
        emlrtDynamicBoundsCheckR2012b(i12, 1, yn_idx_0, &kd_emlrtBCI, &st);
      }

      yn_idx_0 = b_yn->size[0];
      i12 = (i - 1) + 1;
      if (!((i12 >= 1) && (i12 <= yn_idx_0))) {
        emlrtDynamicBoundsCheckR2012b(i12, 1, yn_idx_0, &jd_emlrtBCI, &st);
      }
      ...
      if (diff <= 1.0E-8) {
        ...
        idx = allNonZero->size[0];
        if (!((i >= 1) && (i <= idx))) {
          emlrtDynamicBoundsCheckR2012b(i, 1, idx, &sd_emlrtBCI, &st);
        }
        ...
        yn_idx_0 = b_yn->size[0];
        if (!((i >= 1) && (i <= yn_idx_0))) {
          emlrtDynamicBoundsCheckR2012b(i, 1, yn_idx_0, &td_emlrtBCI, &st);
        }
        ...
        idx = allNonZero->size[0];
        if (!((i >= 1) && (i <= idx))) {
          emlrtDynamicBoundsCheckR2012b(i, 1, idx, &qd_emlrtBCI, &st);
        }
        ...
        yn_idx_0 = b_yn->size[0];
        if (!((i >= 1) && (i <= yn_idx_0))) {
          emlrtDynamicBoundsCheckR2012b(i, 1, yn_idx_0, &rd_emlrtBCI, &st);
        }
  ...
  emxFree_real_T(&b_nx);
  emxFree_real_T(&b_yn);
  emxInit_real_T(&st, &c_nx, 2, &u_emlrtRTEI, true);
  ...
  emxFree_real_T(&c_nx);
  emxInit_real_T(&st, &c_ny, 2, &u_emlrtRTEI, true);
  ...
  emxInit_real_T(&c_st, &newSld, 2, &w_emlrtRTEI, true);
  yn_idx_0 = nx->size[1];
  ny_idx_0 = ny->size[1];
  ...
  emxFree_real_T(&ny);
  emxInit_int32_T(&b_st, &ii, 1, &bb_emlrtRTEI, true);
  st.site = &xb_emlrtRSI;
  ...
  if (!((ny_idx_0 >= 1) && (ny_idx_0 <= i12))) {
    emlrtDynamicBoundsCheckR2012b(ny_idx_0, 1, i12, &pd_emlrtBCI, sp);
  }
  ...
  if (1.0 > allNonZero->data[allNonZero->size[0] - 1]) {
    ...
    if (!((ny_idx_0 >= 1) && (ny_idx_0 <= i12))) {
      emlrtDynamicBoundsCheckR2012b(ny_idx_0, 1, i12, &od_emlrtBCI, sp);
    }
  }
  ...
  if (1.0 > allNonZero->data[allNonZero->size[0] - 1]) {
    ...
    if (!((yn_idx_0 >= 1) && (yn_idx_0 <= i12))) {
      emlrtDynamicBoundsCheckR2012b(yn_idx_0, 1, i12, &nd_emlrtBCI, sp);
    }
  }
  ...
  emxInit_real_T1(&c_st, &b_newSld, 1, &u_emlrtRTEI, true);
  i12 = b_newSld->size[0];
  ...
  emxInit_real_T1(&b_st, &c_newSld, 1, &u_emlrtRTEI, true);
  i12 = c_newSld->size[0];

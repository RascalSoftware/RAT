 ...
 *
 * Code generation for function 'standardTF_stanlay_parallel_data'
 *
 */
...
emlrtRTEInfo lc_emlrtRTEI = { 243,     /* lineNo */
  9,                                   /* colNo */
  "find",                              /* fName */
  "/usr/local/MATLAB/R2016b/toolbox/eml/lib/matlab/elmat/find.m"/* pName */
};

emlrtRTEInfo mc_emlrtRTEI = { 381,     /* lineNo */
  15,                                  /* colNo */
  "colon",                             /* fName */
  "/usr/local/MATLAB/R2016b/toolbox/eml/lib/matlab/ops/colon.m"/* pName */
};

/* End of code generation (standardTF_stanlay_parallel_data.c) */

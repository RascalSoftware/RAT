 ...
 *
 * standardTF_stanlay_parallel_emxutil.h
 *
 * Code generation for function 'standardTF_stanlay_parallel_emxutil'
 *
 */

#ifndef STANDARDTF_STANLAY_PARALLEL_EMXUTIL_H
#define STANDARDTF_STANLAY_PARALLEL_EMXUTIL_H
...
extern void emxEnsureCapacity_cell_wrap_1(const emlrtStack *sp,
  ...
  *srcLocation);
extern void emxEnsureCapacity_cell_wrap_2(const emlrtStack *sp,
  emxArray_cell_wrap_2 *emxArray, int32_T oldNumel, const emlrtRTEInfo
  *srcLocation);
...
/* End of code generation (standardTF_stanlay_parallel_emxutil.h) */

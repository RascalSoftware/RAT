...
#include "backSort.h"
#include "main.h"
#include "backSort_terminate.h"
#include "backSort_emxAPI.h"
#include "backSort_initialize.h"

/* Function Declarations */
static emxArray_real_T *argInit_1xUnbounded_real_T(void);
static double argInit_real_T(void);
static void main_backSort(void);
...
static void main_backSort(void)
{
  ...
  /* Initialize function 'backSort' input arguments. */
  cBacks = argInit_real_T();
  cShifts = argInit_real_T();
  cScales = argInit_real_T();
  cNbas = argInit_real_T();
  cNbss = argInit_real_T();
  cRes = argInit_real_T();

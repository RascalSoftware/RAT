      ...
      for (nl = 0; nl < (int)layers; nl++) {
        ...
        for (i3 = 0; i3 < 2; i3++) {
          for (i4 = 0; i4 < 2; i4++) {
            ...
            b_MI[i3 + (i4 << 1)].im = 0.0;
            for (i5 = 0; i5 < 2; i5++) {
              b_MI[i3 + (i4 << 1)].re += MI[i3 + (i5 << 1)].re * N[i5 + (i4 << 1)]
                .re - MI[i3 + (i5 << 1)].im * N[i5 + (i4 << 1)].im;
              b_MI[i3 + (i4 << 1)].im += MI[i3 + (i5 << 1)].re * N[i5 + (i4 << 1)]
                .im + MI[i3 + (i5 << 1)].im * N[i5 + (i4 << 1)].re;
            }
          }
        }

...
static real_T c_emlrt_marshallIn(const emlrtStack *sp, const mxArray *allRoughs,
...
static void emlrt_marshallIn(const emlrtStack *sp, const mxArray *allLayers,
  ...
  const char_T *identifier)
{
  ...
  y = d_emlrt_marshallIn(sp, emlrtAlias(allRoughs), &thisId);
  emlrtDestroyArray(&allRoughs);
  return y;
}
  ...
  const char_T *identifier, emxArray_real_T *y)
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  b_emlrt_marshallIn(sp, emlrtAlias(allLayers), &thisId, y);
  emlrtDestroyArray(&allLayers);
}
...
void groupLayers_Mod_api(const mxArray *prhs[5], const mxArray *plhs[2])
{
  ...
  emxInit_real_T(&st, &allLayers, 2, true);
  emxInit_char_T(&st, &geometry, 2, true);
  emxInit_real_T(&st, &outLayers, 2, true);
  prhs[0] = emlrtProtectR2012b(prhs[0], 0, false, -1);

  /* Marshall function inputs */
  emlrt_marshallIn(&st, emlrtAlias(prhs[0]), "allLayers", allLayers);
  allRoughs = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[1]), "allRoughs");
  e_emlrt_marshallIn(&st, emlrtAliasP(prhs[2]), "geometry", geometry);
  nbair = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[3]), "nbair");
  nbsubs = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[4]), "nbsubs");

  /* Invoke the target function */
  groupLayers_Mod(allLayers, allRoughs, geometry, nbair, nbsubs, outLayers,
                  &outSsubs);

  /* Marshall function outputs */
  plhs[0] = emlrt_marshallOut(outLayers);
  plhs[1] = b_emlrt_marshallOut(outSsubs);
  outLayers->canFreeData = false;
  emxFree_real_T(&outLayers);
  emxFree_char_T(&geometry);
  allLayers->canFreeData = false;
  emxFree_real_T(&allLayers);
  emlrtHeapReferenceStackLeaveFcnR2012b(&st);
}

void groupLayers_Mod_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
  ...
  groupLayers_Mod_xil_terminate();
}

void groupLayers_Mod_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
void groupLayers_Mod_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/* End of code generation (_coder_groupLayers_Mod_api.c) */

...
void resampleLayers(const emxArray_real_T *layerSLD, emxArray_real_T *newSLD)
{
  ...
  i0 = ny->size[0] * ny->size[1];
  ny->size[0] = 1;
  ny->size[1] = 0;
  emxEnsureCapacity((emxArray__common *)ny, i0, (int)sizeof(double));
  i0 = thisLayerx->size[0] * thisLayerx->size[1];
  thisLayerx->size[0] = 1;
  thisLayerx->size[1] = 1;
  emxEnsureCapacity((emxArray__common *)thisLayerx, i0, (int)sizeof(double));
  thisLayerx->data[0] = allNonZero->data[0];
  i0 = thisLayery->size[0] * thisLayery->size[1];
  thisLayery->size[0] = 1;
  thisLayery->size[1] = 1;
  emxEnsureCapacity((emxArray__common *)thisLayery, i0, (int)sizeof(double));
    ...
    if (i <= idx - 2) {
      ...
      if (diff <= 1.0E-8) {
        ...
        for (i0 = 0; i0 < loop_ub; i0++) {
          b_nx->data[b_nx->size[0] * i0] = nx->data[nx->size[0] * i0];
        }
        ...
        loop_ub = b_nx->size[1];
        for (i0 = 0; i0 < loop_ub; i0++) {
          nx->data[nx->size[0] * i0] = b_nx->data[b_nx->size[0] * i0];
        }

        diff = mean(thisLayery);
        i0 = b_ny->size[0] * b_ny->size[1];
        b_ny->size[0] = 1;
        b_ny->size[1] = ny->size[1] + 1;
        emxEnsureCapacity((emxArray__common *)b_ny, i0, (int)sizeof(double));
        loop_ub = ny->size[1];
        for (i0 = 0; i0 < loop_ub; i0++) {
          b_ny->data[b_ny->size[0] * i0] = ny->data[ny->size[0] * i0];
        }
        ...
        loop_ub = b_ny->size[1];
        for (i0 = 0; i0 < loop_ub; i0++) {
          ny->data[ny->size[0] * i0] = b_ny->data[b_ny->size[0] * i0];
        }
  ...
  for (i0 = 0; i0 < loop_ub; i0++) {
    c_nx->data[c_nx->size[0] * i0] = nx->data[nx->size[0] * i0];
  }
  ...
  loop_ub = c_nx->size[1];
  for (i0 = 0; i0 < loop_ub; i0++) {
    nx->data[nx->size[0] * i0] = c_nx->data[c_nx->size[0] * i0];
  }

  emxFree_real_T(&c_nx);
  emxInit_real_T(&c_ny, 2);
  diff = mean(thisLayery);
  i0 = c_ny->size[0] * c_ny->size[1];
  c_ny->size[0] = 1;
  c_ny->size[1] = ny->size[1] + 1;
  emxEnsureCapacity((emxArray__common *)c_ny, i0, (int)sizeof(double));
  loop_ub = ny->size[1];
  emxFree_real_T(&thisLayery);
  for (i0 = 0; i0 < loop_ub; i0++) {
    c_ny->data[c_ny->size[0] * i0] = ny->data[ny->size[0] * i0];
  }
  ...
  loop_ub = c_ny->size[1];
  for (i0 = 0; i0 < loop_ub; i0++) {
    ny->data[ny->size[0] * i0] = c_ny->data[c_ny->size[0] * i0];
  }
  ...
  newSld->size[1] = 2;
  emxEnsureCapacity((emxArray__common *)newSld, i0, (int)sizeof(double));
  for (i0 = 0; i0 < nx_idx_0; i0++) {
    newSld->data[i0] = nx->data[i0];
  }

  emxFree_real_T(&nx);
  for (i0 = 0; i0 < i; i0++) {
    newSld->data[i0 + newSld->size[0]] = ny->data[i0];
  }
  ...
  i0 = allNonZero->size[0];
  allNonZero->size[0] = ii->size[0];
  emxEnsureCapacity((emxArray__common *)allNonZero, i0, (int)sizeof(double));
  loop_ub = ii->size[0];
  for (i0 = 0; i0 < loop_ub; i0++) {
    allNonZero->data[i0] = ii->data[i0];
  }
  ...
  emxEnsureCapacity((emxArray__common *)allNonZero, i0, (int)sizeof(double));
  for (i0 = 0; i0 < loop_ub; i0++) {
    allNonZero->data[i0] = 1.0E-20;
  }

  emxInit_real_T1(&b_newSld, 1);
  i0 = b_newSld->size[0];
  b_newSld->size[0] = loop_ub;
  emxEnsureCapacity((emxArray__common *)b_newSld, i0, (int)sizeof(double));
  for (i0 = 0; i0 < loop_ub; i0++) {
    b_newSld->data[i0] = newSld->data[i0];
  }

  emxInit_real_T1(&c_newSld, 1);
  i0 = c_newSld->size[0];
  c_newSld->size[0] = nx_idx_0;
  emxEnsureCapacity((emxArray__common *)c_newSld, i0, (int)sizeof(double));
  for (i0 = 0; i0 < nx_idx_0; i0++) {
    c_newSld->data[i0] = newSld->data[i0 + newSld->size[0]];
  }
  ...
  emxEnsureCapacity((emxArray__common *)newSLD, i0, (int)sizeof(double));
  for (i0 = 0; i0 < loop_ub; i0++) {
    newSLD->data[i0] = b_newSld->data[i0];
  }

  emxFree_real_T(&b_newSld);
  for (i0 = 0; i0 < nx_idx_0; i0++) {
    newSLD->data[i0 + newSLD->size[0]] = c_newSld->data[i0];
  }

  emxFree_real_T(&c_newSld);
  for (i0 = 0; i0 < idx; i0++) {
    newSLD->data[i0 + (newSLD->size[0] << 1)] = allNonZero->data[i0];
  }

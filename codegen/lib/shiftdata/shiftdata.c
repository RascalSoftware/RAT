               ...
               emxArray_real_T *shifted_data)
{
  ...
  switch ((int)dataPresent) {
   case 1:
    ...
    for (i0 = 0; i0 < c_data; i0++) {
      b_data->data[i0] = data->data[i0] + horshift;
    }

    idx = b_data->size[0];
    for (i0 = 0; i0 < idx; i0++) {
      data->data[i0] = b_data->data[i0];
    }

    emxFree_real_T(&b_data);
    emxInit_real_T(&d_data, 1);
    idx = data->size[0];
    i0 = d_data->size[0];
    d_data->size[0] = idx;
    emxEnsureCapacity((emxArray__common *)d_data, i0, (int)sizeof(double));
    for (i0 = 0; i0 < idx; i0++) {
      d_data->data[i0] = data->data[i0 + data->size[0]];
    }

    emxInit_real_T(&r0, 1);
    rdivide(d_data, scalefac, r0);
    idx = r0->size[0];
    emxFree_real_T(&d_data);
    for (i0 = 0; i0 < idx; i0++) {
      data->data[i0 + data->size[0]] = r0->data[i0];
    }

    emxFree_real_T(&r0);
    emxInit_real_T(&e_data, 1);
    idx = data->size[0];
    i0 = e_data->size[0];
    e_data->size[0] = idx;
    emxEnsureCapacity((emxArray__common *)e_data, i0, (int)sizeof(double));
    for (i0 = 0; i0 < idx; i0++) {
      e_data->data[i0] = data->data[i0 + (data->size[0] << 1)];
    }

    emxInit_real_T(&r1, 1);
    rdivide(e_data, scalefac, r1);
    idx = r1->size[0];
    emxFree_real_T(&e_data);
    for (i0 = 0; i0 < idx; i0++) {
      data->data[i0 + (data->size[0] << 1)] = r1->data[i0];
    }
    ...
    for (i0 = 0; i0 < idx; i0++) {
      x->data[i0] = (data->data[i0] < dataLimits[0]);
    }
    ...
    emxEnsureCapacity((emxArray__common *)lowIndex, i0, (int)sizeof(int));
    idx = ii->size[0];
    for (i0 = 0; i0 < idx; i0++) {
    ...
    emxEnsureCapacity((emxArray__common *)x, i0, (int)sizeof(boolean_T));
    for (i0 = 0; i0 < idx; i0++) {
      x->data[i0] = (data->data[i0] > dataLimits[1]);
    }
    ...
    shifted_data->size[0] = hiIndex - i0;
    ...
    for (c_data = 0; c_data < 3; c_data++) {
      idx = hiIndex - i0;
      for (nx = 0; nx < idx; nx++) {
        shifted_data->data[nx + shifted_data->size[0] * c_data] = data->data[(i0
   ...
   default:
    ...
    shifted_data->size[1] = 3;
    emxEnsureCapacity((emxArray__common *)shifted_data, i0, (int)sizeof(double));
    idx = data->size[0] * data->size[1];
    for (i0 = 0; i0 < idx; i0++) {
      shifted_data->data[i0] = data->data[i0];
    }
    break;
  }

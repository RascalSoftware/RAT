 ...
 *
 * _coder_standard_layers_mod_api.c
 *
...
emlrtContext emlrtContextGlobal = { true,/* bFirstTime */
  ...
  NULL,                                /* fErrorFunction */
  "standard_layers_mod",               /* fFunctionName */
  NULL,                                /* fRTCallStack */
  false,                               /* bDebugMode */
...
static real_T (*c_emlrt_marshallIn(const emlrtStack *sp, const mxArray
  *contrastLayers, const char_T *identifier))[2];
static real_T (*d_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u, const
  emlrtMsgIdentifier *parentId))[2];
static real_T e_emlrt_marshallIn(const emlrtStack *sp, const mxArray
  *numberOfLayers, const char_T *identifier);
...
static void g_emlrt_marshallIn(const emlrtStack *sp, const mxArray
  *layersDetails, const char_T *identifier, emxArray_cell_wrap_0 *y);
  ...
  *contrastLayers, const char_T *identifier))[2]
{
  ...
  y = d_emlrt_marshallIn(sp, emlrtAlias(contrastLayers), &thisId);
  ...
  *numberOfLayers, const char_T *identifier)
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  y = f_emlrt_marshallIn(sp, emlrtAlias(numberOfLayers), &thisId);
  emlrtDestroyArray(&numberOfLayers);
  return y;
}
  ...
  *layersDetails, const char_T *identifier, emxArray_cell_wrap_0 *y)
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  h_emlrt_marshallIn(sp, emlrtAlias(layersDetails), &thisId, y);
...
void standard_layers_mod_api(const mxArray *prhs[4], const mxArray *plhs[2])
{
  real_T (*layersOutput_data)[10];
  emxArray_real_T *params;
  emxArray_cell_wrap_0 *layersDetails;
  real_T (*contrastLayers)[2];
  real_T numberOfLayers;
  int32_T layersOutput_size[2];
  real_T sRoughOutput;
  ...
  layersOutput_data = (real_T (*)[10])mxMalloc(sizeof(real_T [10]));
  emlrtHeapReferenceStackEnterFcnR2012b(&st);
  emxInit_real_T(&st, &params, 2, true);
  emxInit_cell_wrap_0(&st, &layersDetails, 2, true);
  prhs[0] = emlrtProtectR2012b(prhs[0], 0, false, -1);
  prhs[1] = emlrtProtectR2012b(prhs[1], 1, false, -1);

  /* Marshall function inputs */
  emlrt_marshallIn(&st, emlrtAlias(prhs[0]), "params", params);
  contrastLayers = c_emlrt_marshallIn(&st, emlrtAlias(prhs[1]), "contrastLayers");
  numberOfLayers = e_emlrt_marshallIn(&st, emlrtAliasP(prhs[2]),
    "numberOfLayers");
  g_emlrt_marshallIn(&st, emlrtAliasP(prhs[3]), "layersDetails", layersDetails);
  ...
  plhs[0] = emlrt_marshallOut(*layersOutput_data, layersOutput_size);
  plhs[1] = b_emlrt_marshallOut(sRoughOutput);
  emxFree_cell_wrap_0(&layersDetails);
  params->canFreeData = false;
  emxFree_real_T(&params);
  emlrtHeapReferenceStackLeaveFcnR2012b(&st);
}

void standard_layers_mod_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
  ...
  standard_layers_mod_xil_terminate();
}

void standard_layers_mod_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
void standard_layers_mod_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/* End of code generation (_coder_standard_layers_mod_api.c) */

function y=alphafun(cellIn,invR)
% alphafun(x,y1,y2,y3,...)
...
% Thanks to E. Prudencio for pointing out an error here
  ...
  a1Cell = {cellIn{1:(ind+1)}};
  a2Cell = {cellIn{(stage+1):-1:(stage+1-ind)}};
  a1 = a1*(1-alphafun(a1Cell,invR));
  a2 = a2*(1-alphafun(a2Cell,invR));
...
%************************************************************%
function z=qfun(iq,qfunin,invR)

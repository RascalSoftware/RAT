...
ARGS_1_3.domainRatio = coder.typeof(0,[Inf 2],[1 0]);
...
ARGS_1_5 = struct;
ARG = coder.typeof('X',[1 Inf],[0 1]);
ARGS_1_5.priorNames = coder.typeof({ARG}, [Inf  1],[1 0]);
ARG = coder.typeof('X',[1 Inf],[0 1]);
ARGS_1_5.priorVals = coder.typeof({ARG}, [Inf  3],[1 0]);
...
% ARGS_1_5.paramPriors = coder.typeof({ARG}, [Inf  1],[1 0]);
% ARG = cell([1 4]);
% ARG{1} = coder.typeof('X',[1 Inf],[0 1]);
% ARG{2} = coder.typeof('X',[1 Inf],[0 1]);
% ARG{3} = coder.typeof(0);
...
% ARG = coder.typeof(ARG,[1 4]);
% ARG = ARG.makeHeterogeneous();
% ARGS_1_5.backsPriors = coder.typeof({ARG}, [Inf  1],[1 0]);
% ARG = cell([1 4]);
% ARG{1} = coder.typeof('X',[1 Inf],[0 1]);
% ARG{2} = coder.typeof('X',[1 Inf],[0 1]);
% ARG{3} = coder.typeof(0);
...
% ARG = coder.typeof(ARG,[1 4]);
% ARG = ARG.makeHeterogeneous();
% ARGS_1_5.resolPriors = coder.typeof({ARG}, [Inf  1],[1 0]);
% ARG = cell([1 4]);
% ARG{1} = coder.typeof('X',[1 Inf],[0 1]);
% ARG{2} = coder.typeof('X',[1 Inf],[0 1]);
% ARG{3} = coder.typeof(0);
...
% ARG = coder.typeof(ARG,[1 4]);
% ARG = ARG.makeHeterogeneous();
% ARGS_1_5.nbaPriors = coder.typeof({ARG}, [Inf  1],[1 0]);
% ARG = cell([1 4]);
% ARG{1} = coder.typeof('X',[1 Inf],[0 1]);
% ARG{2} = coder.typeof('X',[1 Inf],[0 1]);
% ARG{3} = coder.typeof(0);
...
% ARG = coder.typeof(ARG,[1 4]);
% ARG = ARG.makeHeterogeneous();
% ARGS_1_5.nbsPriors = coder.typeof({ARG}, [Inf  1],[1 0]);
% ARG = cell([1 4]);
...
% ARG = coder.typeof(ARG,[1 4]);
% ARG = ARG.makeHeterogeneous();
% ARGS_1_5.shiftPriors = coder.typeof({ARG}, [Inf  1],[1 0]);
% ARG = cell([1 4]);
% ARG{1} = coder.typeof('X',[1 Inf],[0 1]);
% ARG{2} = coder.typeof('X',[1 Inf],[0 1]);
% ARG{3} = coder.typeof(0);
...
% ARG = coder.typeof(ARG,[1 4]);
% ARG = ARG.makeHeterogeneous();
% ARGS_1_5.scalesPriors = coder.typeof({ARG}, [Inf  1],[1 0]);
%ARGS{1}{5} = coder.typeof(ARGS_1_5);

...
ARGS_1_4_checks.fitParams = coder.typeof(0,[1 maxArraySize],[0 1]);
ARGS_1_4_checks.fitBacks = coder.typeof(0,[1 maxArraySize],[0 1]);
ARGS_1_4_checks.fitShifts = coder.typeof(0,[1 maxArraySize],[0 1]);
ARGS_1_4_checks.fitScales = coder.typeof(0,[1 maxArraySize],[0 1]);
ARGS_1_4_checks.fitNbairs = coder.typeof(0,[1 maxArraySize],[0 1]);
ARGS_1_4_checks.fitNbsubs = coder.typeof(0,[1 maxArraySize],[0 1]);
ARGS_1_4_checks.fitResol = coder.typeof(0,[1 maxArraySize],[0 1]);
...
ARGS_1_5.resolPriors = coder.typeof({ARG_22}, [Inf 1],[1 0]);
ARG_23 = cell([1 4]);
...
ARGS_1_5.nbaPriors = coder.typeof({ARG_23}, [Inf 1],[1 0]);
ARG_24 = cell([1 4]);
...
ARGS_1_5.shiftPriors = coder.typeof({ARG_25}, [Inf 1],[1 0]);
ARG_26 = cell([1 4]);

...
ARGS_1_2_checks = struct;
ARGS_1_2_checks.fitParam = coder.typeof(0,[1 maxArraySize],[0 1]);
ARGS_1_2_checks.fitBackgroundParam = coder.typeof(0,[1 maxArraySize],[0 1]);
ARGS_1_2_checks.fitQzshift = coder.typeof(0,[1 maxArraySize],[0 1]);
ARGS_1_2_checks.fitScalefactor = coder.typeof(0,[1 maxArraySize],[0 1]);
ARGS_1_2_checks.fitBulkIn = coder.typeof(0,[1 maxArraySize],[0 1]);
ARGS_1_2_checks.fitBulkOut = coder.typeof(0,[1 maxArraySize],[0 1]);
ARGS_1_2_checks.fitResolutionParam = coder.typeof(0,[1 maxArraySize],[0 1]);
ARGS_1_2_checks.fitDomainRatio = coder.typeof(0,[1 maxArraySize],[0 1]);
ARGS_1_2.checks = coder.typeof(ARGS_1_2_checks);

  ...
  rfinal, real_T layers, real_T points, emxArray_real_T *out)
{
  ...
  i1 = out->size[0];
  out->size[0] = i;
  emxEnsureCapacity_real_T(sp, out, i1, &wk_emlrtRTEI);
  ...
  for (loop = 0; loop < i; loop++) {
    ...
    i1 = loop + 1;
    if ((i1 < 1) || (i1 > x->size[0])) {
      emlrtDynamicBoundsCheckR2012b(i1, 1, x->size[0], &ch_emlrtBCI, sp);
    }
    ...
    blast_im = 0.0;
    if (1 > sld->size[0]) {
      emlrtDynamicBoundsCheckR2012b(1, 1, sld->size[0], &bh_emlrtBCI, sp);
    }
    ...
    for (reploop = 0; reploop < i2; reploop++) {
      ...
      for (nl = 0; nl < i3; nl++) {
        ...
        if ((i1 < 1) || (i1 > sld->size[0])) {
          emlrtDynamicBoundsCheckR2012b(i1, 1, sld->size[0], &ah_emlrtBCI, sp);
        }

        i1 = nl + 1;
        if ((i1 < 1) || (i1 > sld->size[0])) {
          emlrtDynamicBoundsCheckR2012b(i1, 1, sld->size[0], &yg_emlrtBCI, sp);
        }

        i1 = (int32_T)(nl + 1U);
        if ((i1 < 1) || (i1 > sld->size[0])) {
          emlrtDynamicBoundsCheckR2012b(i1, 1, sld->size[0], &dh_emlrtBCI, sp);
        }
    ...
    if ((i1 < 1) || (i1 > out->size[0])) {
      emlrtDynamicBoundsCheckR2012b(i1, 1, out->size[0], &eh_emlrtBCI, sp);
    }

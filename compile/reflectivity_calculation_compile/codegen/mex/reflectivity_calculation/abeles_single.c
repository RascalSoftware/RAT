                   ...
                   emxArray_real_T *out)
{
  ...
  i1 = out->size[0];
  out->size[0] = i;
  emxEnsureCapacity_real_T(sp, out, i1, &dk_emlrtRTEI);
  ...
  for (loop = 0; loop < i; loop++) {
    ...
    i1 = loop + 1;
    if ((i1 < 1) || (i1 > x->size[0])) {
      emlrtDynamicBoundsCheckR2012b(i1, 1, x->size[0], &ff_emlrtBCI, sp);
    }
    ...
    blast_im = 0.0;
    if (1 > sld->size[0]) {
      emlrtDynamicBoundsCheckR2012b(1, 1, sld->size[0], &ef_emlrtBCI, sp);
    }
    ...
    emlrtForLoopVectorCheckR2012b(1.0, 1.0, nrepeats, mxDOUBLE_CLASS, (int32_T)
      nrepeats, &rb_emlrtRTEI, sp);
    for (reploop = 0; reploop < i2; reploop++) {
      covrtLogFor(&emlrtCoverageInstance, 19U, 0U, 1, 1);
      for (nl = 0; nl < i3; nl++) {
        covrtLogFor(&emlrtCoverageInstance, 19U, 0U, 2, 1);
        covrtLogBasicBlock(&emlrtCoverageInstance, 19U, 2U);
        i1 = nl + 1;
        if ((i1 < 1) || (i1 > sld->size[0])) {
          emlrtDynamicBoundsCheckR2012b(i1, 1, sld->size[0], &df_emlrtBCI, sp);
        }

        i1 = nl + 1;
        if ((i1 < 1) || (i1 > sld->size[0])) {
          emlrtDynamicBoundsCheckR2012b(i1, 1, sld->size[0], &cf_emlrtBCI, sp);
        }
    ...
    covrtLogBasicBlock(&emlrtCoverageInstance, 19U, 3U);
    re = -78.956835208714864 * pair_re;
    snlay = -78.956835208714864 * pair_im;
    ...
    if ((i1 < 1) || (i1 > out->size[0])) {
      emlrtDynamicBoundsCheckR2012b(i1, 1, out->size[0], &hf_emlrtBCI, sp);
    }
  ...
  covrtLogBasicBlock(&emlrtCoverageInstance, 19U, 4U);
}

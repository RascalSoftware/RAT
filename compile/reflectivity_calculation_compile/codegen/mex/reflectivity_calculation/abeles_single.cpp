                   ...
                   points, coder::array<real_T, 1U> &out)
{
  ...
  for (int32_T loop = 0; loop < i; loop++) {
    ...
    i3 = loop + 1;
    if ((i3 < 1) || (i3 > x.size(0))) {
      emlrtDynamicBoundsCheckR2012b(i3, 1, x.size(0), &ug_emlrtBCI, sp);
    }
    ...
    blast_im = 0.0;
    if (1 > sld.size(0)) {
      emlrtDynamicBoundsCheckR2012b(1, 1, sld.size(0), &tg_emlrtBCI, sp);
    }
    ...
    for (int32_T reploop = 0; reploop < i1; reploop++) {
      for (int32_T nl = 0; nl < i2; nl++) {
        ...
        i3 = nl + 1;
        if ((i3 < 1) || (i3 > sld.size(0))) {
          emlrtDynamicBoundsCheckR2012b(i3, 1, sld.size(0), &rg_emlrtBCI, sp);
        }

        i3 = static_cast<int32_T>(nl + 1U);
        if ((i3 < 1) || (i3 > sld.size(0))) {
          emlrtDynamicBoundsCheckR2012b(i3, 1, sld.size(0), &vg_emlrtBCI, sp);
        }
    ...
    if ((i3 < 1) || (i3 > out.size(0))) {
      emlrtDynamicBoundsCheckR2012b(i3, 1, out.size(0), &wg_emlrtBCI, sp);
    }

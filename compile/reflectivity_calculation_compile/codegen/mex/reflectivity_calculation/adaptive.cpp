...
static emlrtDCInfo ob_emlrtDCI = { 274,// lineNo
  30,                                  // colNo
  "adaptive",                          // fName
...
static emlrtRTEInfo vj_emlrtRTEI = { 426,// lineNo
  1,                                   // colNo
  "adaptive",                          // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/resampleLayers/adaptive.m"// pName 
};

static emlrtRTEInfo wj_emlrtRTEI = { 429,// lineNo
  40,                                  // colNo
  "adaptive",                          // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/resampleLayers/adaptive.m"// pName 
};

static emlrtRTEInfo xj_emlrtRTEI = { 430,// lineNo
  14,                                  // colNo
  "adaptive",                          // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/resampleLayers/adaptive.m"// pName 
};

static emlrtRTEInfo yj_emlrtRTEI = { 422,// lineNo
  23,                                  // colNo
  "adaptive",                          // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/resampleLayers/adaptive.m"// pName 
};

static emlrtRTEInfo ak_emlrtRTEI = { 429,// lineNo
  22,                                  // colNo
  "adaptive",                          // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/resampleLayers/adaptive.m"// pName 
};

static emlrtRTEInfo bk_emlrtRTEI = { 431,// lineNo
  22,                                  // colNo
  "adaptive",                          // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/resampleLayers/adaptive.m"// pName 
};

static emlrtRTEInfo ck_emlrtRTEI = { 303,// lineNo
  14,                                  // colNo
  "cat",                               // fName
  ...
  &cornerAngle)
{
  ...
  if (2 > normalizedData.size(0) - 1) {
    ...
    if (2 > normalizedData.size(0)) {
      emlrtDynamicBoundsCheckR2012b(2, 1, normalizedData.size(0), &nf_emlrtBCI,
        &st);
    }
    ...
    if ((i1 < 1) || (i1 > normalizedData.size(0))) {
      emlrtDynamicBoundsCheckR2012b(i1, 1, normalizedData.size(0), &of_emlrtBCI,
        &st);
    }
  ...
  if (1 > normalizedData.size(0) - 2) {
    ...
    if (1 > normalizedData.size(0)) {
      emlrtDynamicBoundsCheckR2012b(1, 1, normalizedData.size(0), &pf_emlrtBCI,
        &st);
    }

    b_i = normalizedData.size(0) - 2;
    if ((b_i < 1) || (b_i > normalizedData.size(0))) {
      emlrtDynamicBoundsCheckR2012b(b_i, 1, normalizedData.size(0), &qf_emlrtBCI,
        &st);
    }
  }
  ...
  if (3 > normalizedData.size(0)) {
    ...
    if (normalizedData.size(0) < 1) {
      emlrtDynamicBoundsCheckR2012b(normalizedData.size(0), 1,
        normalizedData.size(0), &rf_emlrtBCI, &st);
    }
  ...
  if (2 > normalizedData.size(0) - 1) {
    ...
    if (2 > normalizedData.size(0)) {
      emlrtDynamicBoundsCheckR2012b(2, 1, normalizedData.size(0), &sf_emlrtBCI,
        &st);
    }
    ...
    if ((k < 1) || (k > normalizedData.size(0))) {
      emlrtDynamicBoundsCheckR2012b(k, 1, normalizedData.size(0), &tf_emlrtBCI,
        &st);
    }
  }
  ...
  if (1 > normalizedData.size(0) - 2) {
    ...
    if (1 > normalizedData.size(0)) {
      emlrtDynamicBoundsCheckR2012b(1, 1, normalizedData.size(0), &vf_emlrtBCI,
        &st);
    }

    b_i = normalizedData.size(0) - 2;
    if ((b_i < 1) || (b_i > normalizedData.size(0))) {
      emlrtDynamicBoundsCheckR2012b(b_i, 1, normalizedData.size(0), &wf_emlrtBCI,
        &st);
    }
  }
  ...
  array<real_T, 2U> &sldProfile)
{
  ...
  newDataPoints.set_size((&vj_emlrtRTEI), sp, trueCount, 2);
  input_sizes_idx_0 = trueCount << 1;
  for (b_i = 0; b_i < input_sizes_idx_0; b_i++) {
    newDataPoints[b_i] = 0.0;
  }

  r.set_size((&wj_emlrtRTEI), sp, (segmentsToSplit.size(0) + 1));
  ...
  for (i = 0; i < end; i++) {
    if (r[i]) {
      ...
      if ((input_sizes_idx_0 < 1) || (input_sizes_idx_0 > b_i)) {
        emlrtDynamicBoundsCheckR2012b(input_sizes_idx_0, 1, b_i, &dk_emlrtBCI,
          sp);
      }
    }
  }

  r1.set_size((&xj_emlrtRTEI), sp, (segmentsToSplit.size(0) + 1));
  r1[0] = false;
  input_sizes_idx_0 = segmentsToSplit.size(0);
  for (b_i = 0; b_i < input_sizes_idx_0; b_i++) {
  ...
  r2.set_size((&yj_emlrtRTEI), sp, input_sizes_idx_0);
  input_sizes_idx_0 = 0;
  for (i = 0; i <= end; i++) {
    if (r[i]) {
  ...
  r3.set_size((&yj_emlrtRTEI), sp, input_sizes_idx_0);
  input_sizes_idx_0 = 0;
  for (i = 0; i <= end; i++) {
    if (r1[i]) {
  ...
  r4.set_size((&yj_emlrtRTEI), sp, input_sizes_idx_0);
  input_sizes_idx_0 = 0;
  for (i = 0; i <= end; i++) {
    if (r[i]) {
  ...
  r5.set_size((&yj_emlrtRTEI), sp, input_sizes_idx_0);
  input_sizes_idx_0 = 0;
  for (i = 0; i <= end; i++) {
    if (r1[i]) {
  ...
  r6.set_size((&ak_emlrtRTEI), sp, r4.size(0));
  ...
  r7.set_size((&bk_emlrtRTEI), (&st), newDataPoints.size(0));
  ...
  b_dataPoints.set_size((&ck_emlrtRTEI), sp, (end + input_sizes_idx_0), 2);
  ...
  dataPoints.set_size((&yj_emlrtRTEI), sp, b_dataPoints.size(0), 2);

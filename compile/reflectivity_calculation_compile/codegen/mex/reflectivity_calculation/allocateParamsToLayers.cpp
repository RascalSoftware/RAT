  ...
  cell_wrap_19, 2U> &outLayers)
{
  ...
  for (int32_T b_i = 0; b_i < i; b_i++) {
    ...
    if (b_i > i1) {
      emlrtDynamicBoundsCheckR2012b(b_i, 0, i1, &td_emlrtBCI, sp);
    }
    ...
    for (int32_T n = 0; n <= i1 - 2; n++) {
      ...
      if (!muDoubleScalarIsNaN(layersDetails[b_i].f1.data[n])) {
        ...
        if ((i2 < 1) || (i2 > params.size(1))) {
          emlrtDynamicBoundsCheckR2012b(i2, 1, params.size(1), &xd_emlrtBCI, sp);
        }
    ...
    if (layersDetails[b_i].f1.size[1] < 1) {
      emlrtDynamicBoundsCheckR2012b(layersDetails[b_i].f1.size[1], 1,
        layersDetails[b_i].f1.size[1], &ud_emlrtBCI, sp);
    }
    ...
    for (i2 = 0; i2 < 5; i2++) {
      if (b_i > i1) {
        emlrtDynamicBoundsCheckR2012b(b_i, 0, i1, &wd_emlrtBCI, sp);
      }

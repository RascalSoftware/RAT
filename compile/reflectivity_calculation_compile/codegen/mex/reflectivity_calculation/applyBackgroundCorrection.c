...
static emlrtDCInfo nc_emlrtDCI = { 3,  /* lineNo */
  8,                                   /* colNo */
...
static emlrtRTEInfo so_emlrtRTEI = { 6,/* lineNo */
  9,                                   /* colNo */
  "applyBackgroundCorrection",         /* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/callReflectivity/applyBackgroundCorrection.m"/* pName */
};

static emlrtRTEInfo to_emlrtRTEI = { 7,/* lineNo */
  9,                                   /* colNo */
  "applyBackgroundCorrection",         /* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/callReflectivity/applyBackgroundCorrection.m"/* pName */
};

static emlrtRTEInfo uo_emlrtRTEI = { 10,/* lineNo */
  28,                                  /* colNo */
  "applyBackgroundCorrection",         /* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/callReflectivity/applyBackgroundCorrection.m"/* pName */
};
  ...
  backsType)
{
  ...
  if (backsType != (int32_T)muDoubleScalarFloor(backsType)) {
    emlrtIntegerCheckR2012b(backsType, &nc_emlrtDCI, sp);
  }

  switch ((int32_T)backsType) {
   case 1:
    covrtLogSwitch(&emlrtCoverageInstance, 21U, 0U, 0, 1);
    covrtLogBasicBlock(&emlrtCoverageInstance, 21U, 0U);

    /* Add background to the simulation */
    i = reflect->size[0] * reflect->size[1];
    reflect->size[1] = 2;
    emxEnsureCapacity_real_T(sp, reflect, i, &so_emlrtRTEI);
    i = Simul->size[0] * Simul->size[1];
    Simul->size[1] = 2;
    emxEnsureCapacity_real_T(sp, Simul, i, &to_emlrtRTEI);
   ...
   case 2:
    emxInit_real_T(sp, &b_shifted_dat, 1, &uo_emlrtRTEI, true);
    covrtLogSwitch(&emlrtCoverageInstance, 21U, 0U, 0, 2);
    ...
    emxEnsureCapacity_real_T(sp, b_shifted_dat, i, &uo_emlrtRTEI);
    for (i = 0; i <= loop_ub; i++) {
   ...
   default:
    covrtLogSwitch(&emlrtCoverageInstance, 21U, 0U, 0, 0);
    break;
  }

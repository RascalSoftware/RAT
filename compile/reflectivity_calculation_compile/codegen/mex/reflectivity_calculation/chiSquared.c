...
static emlrtRSInfo bg_emlrtRSI = { 12, /* lineNo */
  "chiSquared",                        /* fcnName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/costFunctions/chiSquared/chiSquared.m"/* pathName */
};

static emlrtRSInfo cg_emlrtRSI = { 16, /* lineNo */
  "chiSquared",                        /* fcnName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/costFunctions/chiSquared/chiSquared.m"/* pathName */
};

static emlrtRSInfo dg_emlrtRSI = { 17, /* lineNo */
  "chiSquared",                        /* fcnName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/costFunctions/chiSquared/chiSquared.m"/* pathName */
};

static emlrtRSInfo eg_emlrtRSI = { 21, /* lineNo */
  "chiSquared",                        /* fcnName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/costFunctions/chiSquared/chiSquared.m"/* pathName */
};
...
static emlrtRTEInfo fk_emlrtRTEI = { 16,/* lineNo */
  15,                                  /* colNo */
  "chiSquared",                        /* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/costFunctions/chiSquared/chiSquared.m"/* pName */
};

static emlrtRTEInfo gk_emlrtRTEI = { 47,/* lineNo */
  9,                                   /* colNo */
  "div",                               /* fName */
...
static emlrtRTEInfo jk_emlrtRTEI = { 19,/* lineNo */
  15,                                  /* colNo */
  "chiSquared",                        /* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/costFunctions/chiSquared/chiSquared.m"/* pName */
};
                  ...
                  emxArray_real_T *thisFit, real_T P)
{
  ...
  if (covrtLogIf(&emlrtCoverageInstance, 22U, 0U, 0, N <= P)) {
  ...
  if (thisData->size[0] != thisFit->size[0]) {
    emlrtSizeEqCheck1DR2012b(thisData->size[0], thisFit->size[0], &s_emlrtECI,
      sp);
  }

  emxInit_real_T(sp, &terms, 1, &kk_emlrtRTEI, true);
  st.site = &cg_emlrtRSI;
  loop_ub = thisData->size[0];
  i = terms->size[0];
  terms->size[0] = thisData->size[0];
  emxEnsureCapacity_real_T(&st, terms, i, &fk_emlrtRTEI);
  for (i = 0; i < loop_ub; i++) {
  ...
  emxInit_real_T(&st, &b_terms, 1, &gk_emlrtRTEI, true);
  i = b_terms->size[0];
  b_terms->size[0] = terms->size[0];
  emxEnsureCapacity_real_T(sp, b_terms, i, &gk_emlrtRTEI);
  loop_ub = terms->size[0];
  for (i = 0; i < loop_ub; i++) {
    b_terms->data[i] = terms->data[i] / thisData->data[i + thisData->size[0] * 2];
  }

  emxInit_boolean_T(sp, &x, 1, &hk_emlrtRTEI, true);
  st.site = &cg_emlrtRSI;
  power(&st, b_terms, terms);
  st.site = &dg_emlrtRSI;
  i = x->size[0];
  x->size[0] = terms->size[0];
  emxEnsureCapacity_boolean_T(&st, x, i, &hk_emlrtRTEI);
  loop_ub = terms->size[0];
  ...
  emxFree_boolean_T(&x);
  emxInit_uint32_T(&c_st, &n, 1, &ik_emlrtRTEI, true);
  i = n->size[0];
  n->size[0] = ii->size[0];
  emxEnsureCapacity_uint32_T(&st, n, i, &ik_emlrtRTEI);
  loop_ub = ii->size[0];
  for (i = 0; i < loop_ub; i++) {
    n->data[i] = (uint32_T)ii->data[i];
  }

  if (covrtLogIf(&emlrtCoverageInstance, 22U, 0U, 1, covrtLogMcdc
                 (&emlrtCoverageInstance, 22U, 0U, 0, !covrtLogCond
                  (&emlrtCoverageInstance, 22U, 0U, 0, n->size[0] == 0)))) {
    covrtLogBasicBlock(&emlrtCoverageInstance, 22U, 3U);
    i = ii->size[0];
    ii->size[0] = n->size[0];
    emxEnsureCapacity_int32_T(sp, ii, i, &jk_emlrtRTEI);
    loop_ub = n->size[0];
    for (i = 0; i < loop_ub; i++) {

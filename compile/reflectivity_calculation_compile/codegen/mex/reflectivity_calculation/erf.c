...
static emlrtRSInfo ic_emlrtRSI = { 9,  /* lineNo */
  "erf",                               /* fcnName */
...
static emlrtRSInfo lc_emlrtRSI = { 62, /* lineNo */
  "applyScalarFunction",               /* fcnName */
  "/usr/local/MATLAB/R2020a/toolbox/eml/eml/+coder/+internal/applyScalarFunction.m"/* pathName */
};

static emlrtRTEInfo vh_emlrtRTEI = { 12,/* lineNo */
  9,                                   /* colNo */
  "eml_erfcore",                       /* fName */
...
void b_erf(const emlrtStack *sp, const emxArray_real_T *x, emxArray_real_T *y)
{
  ...
  y->size[0] = 1;
  y->size[1] = x->size[1];
  emxEnsureCapacity_real_T(&b_st, y, b, &vh_emlrtRTEI);

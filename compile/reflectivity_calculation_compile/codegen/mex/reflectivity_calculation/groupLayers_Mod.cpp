  ...
  if (allLayers.size(0) != 0) {
    ...
    for (b_loop_ub = 0; b_loop_ub < i; b_loop_ub++) {
      ...
      if ((i1 < 1) || (i1 > allLayers.size(0))) {
        emlrtDynamicBoundsCheckR2012b(i1, 1, allLayers.size(0), &ke_emlrtBCI, sp);
      }
      ...
      if (!muDoubleScalarIsNaN(this_pcw)) {
        ...
        if ((i1 < 1) || (i1 > layers.size(0))) {
          emlrtDynamicBoundsCheckR2012b(i1, 1, layers.size(0), &me_emlrtBCI, sp);
        }

        kstr = b_loop_ub + 1;
        if ((kstr < 1) || (kstr > layers.size(0))) {
          emlrtDynamicBoundsCheckR2012b(kstr, 1, layers.size(0), &ne_emlrtBCI,
            sp);
        }

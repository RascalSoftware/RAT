...
static emlrtRTEInfo wn_emlrtRTEI = { 1,/* lineNo */
  1,                                   /* colNo */
  ...
  const mxArray *plhs[2])
{
  ...
  emxInitStruct_struct0_T(&st, &problemDef, &wn_emlrtRTEI, true);
  emxInitStruct_cell_6(&st, &problemDef_cells, &wn_emlrtRTEI, true);
  emxInitStruct_struct1_T(&st, &problemDef_limits, &wn_emlrtRTEI, true);
  emxInitStruct_struct2_T(&st, &controls, &wn_emlrtRTEI, true);
  emxInitStruct_struct4_T(&st, &problem, &wn_emlrtRTEI, true);
  emxInitStruct_cell_8(&st, &result, &wn_emlrtRTEI, true);

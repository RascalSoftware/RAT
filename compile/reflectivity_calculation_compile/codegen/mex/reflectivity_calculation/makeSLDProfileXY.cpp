...
static emlrtRSInfo hb_emlrtRSI = { 4,  // lineNo
...
static emlrtRSInfo kb_emlrtRSI = { 37, // lineNo
  "makeSLDProfileXY",                  // fcnName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/makeSLDProfiles/makeSLDProfileXY.m"// pathName 
};

static emlrtRSInfo lb_emlrtRSI = { 42, // lineNo
  "makeSLDProfileXY",                  // fcnName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/makeSLDProfiles/makeSLDProfileXY.m"// pathName 
};
...
static emlrtRSInfo nb_emlrtRSI = { 47, // lineNo
  "makeSLDProfileXY",                  // fcnName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/makeSLDProfiles/makeSLDProfileXY.m"// pathName 
};
...
static emlrtRSInfo pb_emlrtRSI = { 49, // lineNo
  "makeSLDProfileXY",                  // fcnName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/makeSLDProfiles/makeSLDProfileXY.m"// pathName 
};

static emlrtRSInfo qb_emlrtRSI = { 54, // lineNo
  "makeSLDProfileXY",                  // fcnName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/makeSLDProfiles/makeSLDProfileXY.m"// pathName 
};

static emlrtRSInfo sc_emlrtRSI = { 169,// lineNo
  "colMajorFlatIter",                  // fcnName
  "/usr/local/MATLAB/R2020a/toolbox/eml/lib/matlab/datafun/private/combineVectorElements.m"// pathName 
};

static emlrtRSInfo tc_emlrtRSI = { 187,// lineNo
  "colMajorFlatIter",                  // fcnName
  "/usr/local/MATLAB/R2020a/toolbox/eml/lib/matlab/datafun/private/combineVectorElements.m"// pathName 
};

static emlrtRSInfo xc_emlrtRSI = { 145,// lineNo
...
static emlrtDCInfo jb_emlrtDCI = { 7,  // lineNo
  28,                                  // colNo
  "makeSLDProfileXY",                  // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/makeSLDProfiles/makeSLDProfileXY.m",// pName 
  4                                    // checkKind
...
static emlrtDCInfo kb_emlrtDCI = { 7,  // lineNo
  28,                                  // colNo
  "makeSLDProfileXY",                  // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/makeSLDProfiles/makeSLDProfileXY.m",// pName 
  1                                    // checkKind
...
static emlrtDCInfo lb_emlrtDCI = { 40, // lineNo
  12,                                  // colNo
  "makeSLDProfileXY",                  // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/makeSLDProfiles/makeSLDProfileXY.m",// pName 
  1                                    // checkKind
...
static emlrtDCInfo mb_emlrtDCI = { 37, // lineNo
  12,                                  // colNo
  "makeSLDProfileXY",                  // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/makeSLDProfiles/makeSLDProfileXY.m",// pName 
  1                                    // checkKind
...
static emlrtRTEInfo ff_emlrtRTEI = { 44,// lineNo
  5,                                   // colNo
  "makeSLDProfileXY",                  // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/makeSLDProfiles/makeSLDProfileXY.m"// pName 
};

static emlrtRTEInfo gf_emlrtRTEI = { 44,// lineNo
  9,                                   // colNo
  "makeSLDProfileXY",                  // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/makeSLDProfiles/makeSLDProfileXY.m"// pName 
};

static emlrtRTEInfo hf_emlrtRTEI = { 50,// lineNo
  5,                                   // colNo
  "makeSLDProfileXY",                  // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/makeSLDProfiles/makeSLDProfileXY.m"// pName 
};

static emlrtRTEInfo if_emlrtRTEI = { 4,// lineNo
  23,                                  // colNo
  "makeSLDProfileXY",                  // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/makeSLDProfiles/makeSLDProfileXY.m"// pName 
};

static emlrtRTEInfo jf_emlrtRTEI = { 6,// lineNo
  5,                                   // colNo
  "makeSLDProfileXY",                  // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/makeSLDProfiles/makeSLDProfileXY.m"// pName 
};

static emlrtRTEInfo kf_emlrtRTEI = { 7,// lineNo
  5,                                   // colNo
  "makeSLDProfileXY",                  // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/makeSLDProfiles/makeSLDProfileXY.m"// pName 
};

static emlrtRTEInfo lf_emlrtRTEI = { 125,// lineNo
  13,                                  // colNo
  "combineVectorElements",             // fName
  "/usr/local/MATLAB/R2020a/toolbox/eml/lib/matlab/datafun/private/combineVectorElements.m"// pName 
};

static emlrtRTEInfo mf_emlrtRTEI = { 42,// lineNo
  11,                                  // colNo
  "makeSLDProfileXY",                  // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/makeSLDProfiles/makeSLDProfileXY.m"// pName 
};

static emlrtRTEInfo nf_emlrtRTEI = { 42,// lineNo
  5,                                   // colNo
  "makeSLDProfileXY",                  // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/makeSLDProfiles/makeSLDProfileXY.m"// pName 
};

static emlrtRTEInfo of_emlrtRTEI = { 54,// lineNo
  1,                                   // colNo
  "makeSLDProfileXY",                  // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/makeSLDProfiles/makeSLDProfileXY.m"// pName 
};
                      ...
                      &out)
{
  ...
  if (numberOfLayers > 0.0) {
    ...
    b_layers.set_size((&if_emlrtRTEI), sp, layers.size(0));
    for (i = 0; i < vstride; i++) {
      b_layers[i] = layers[i];
    }
    ...
    if (muDoubleScalarIsNaN(layerThicks)) {
      x.set_size((&jf_emlrtRTEI), sp, 1, 1);
      x[0] = rtNaN;
    } else if (layerThicks < 0.0) {
      x.set_size((&jf_emlrtRTEI), sp, 1, 0);
    } else if (muDoubleScalarIsInf(layerThicks) && (0.0 == layerThicks)) {
      x.set_size((&jf_emlrtRTEI), sp, 1, 1);
      x[0] = rtNaN;
    } else {
      vstride = static_cast<int32_T>(muDoubleScalarFloor(layerThicks));
      x.set_size((&jf_emlrtRTEI), sp, 1, (vstride + 1));
      for (i = 0; i <= vstride; i++) {
        x[i] = i;
      }
    }

    SLD.set_size((&kf_emlrtRTEI), sp, x.size(1), SLD.size(1));
    d = numberOfLayers * nrepeats;
    if (!(d + 2.0 >= 0.0)) {
      emlrtNonNegativeCheckR2012b(d + 2.0, &jb_emlrtDCI, sp);
    }

    d1 = static_cast<int32_T>(muDoubleScalarFloor(d + 2.0));
    if (d + 2.0 != d1) {
      emlrtIntegerCheckR2012b(d + 2.0, &kb_emlrtDCI, sp);
    }

    i = static_cast<int32_T>(d + 2.0);
    SLD.set_size((&kf_emlrtRTEI), sp, SLD.size(0), i);
    if (!(d + 2.0 >= 0.0)) {
      emlrtNonNegativeCheckR2012b(d + 2.0, &hb_emlrtDCI, sp);
    }

    if (d + 2.0 != d1) {
      emlrtIntegerCheckR2012b(d + 2.0, &ib_emlrtDCI, sp);
    }
    ...
    if (1 > layers.size(0)) {
      emlrtDynamicBoundsCheckR2012b(1, 1, layers.size(0), &we_emlrtBCI, sp);
    }
    ...
    emlrtForLoopVectorCheckR2012b(1.0, 1.0, nrepeats, mxDOUBLE_CLASS,
      static_cast<int32_T>(nrepeats), &kb_emlrtRTEI, sp);
    for (n = 0; n < xoffset; n++) {
      ...
      for (int32_T b_i = 0; b_i < k; b_i++) {
        ...
        if ((vlen < 1) || (vlen > layers.size(0))) {
          emlrtDynamicBoundsCheckR2012b(vlen, 1, layers.size(0), &pe_emlrtBCI,
            sp);
        }
        ...
        vlen = b_i + 1;
        if ((vlen < 1) || (vlen > layers.size(0))) {
          emlrtDynamicBoundsCheckR2012b(vlen, 1, layers.size(0), &ve_emlrtBCI,
            sp);
        }

        vlen = b_i + 1;
        if ((vlen < 1) || (vlen > layers.size(0))) {
          emlrtDynamicBoundsCheckR2012b(vlen, 1, layers.size(0), &ue_emlrtBCI,
            sp);
        }
        ...
        if (static_cast<real_T>(b_i) + 1.0 < numberOfLayers) {
          ...
          if ((vlen < 1) || (vlen > layers.size(0))) {
            emlrtDynamicBoundsCheckR2012b(vlen, 1, layers.size(0), &oe_emlrtBCI,
              sp);
          }
        ...
        if ((vlen < 1) || (vlen > SLD.size(1))) {
          emlrtDynamicBoundsCheckR2012b(vlen, 1, SLD.size(1), &se_emlrtBCI, sp);
        }
    ...
    // layers(end,3);
    if (x.size(1) < 1) {
      emlrtDynamicBoundsCheckR2012b(x.size(1), 1, x.size(1), &te_emlrtBCI, sp);
    }

    if (d + 1.0 != static_cast<int32_T>(muDoubleScalarFloor(d + 1.0))) {
      emlrtIntegerCheckR2012b(d + 1.0, &mb_emlrtDCI, sp);
    }

    xoffset = static_cast<int32_T>(d + 1.0);
    if ((xoffset < 1) || (xoffset > SLD.size(1))) {
      emlrtDynamicBoundsCheckR2012b(xoffset, 1, SLD.size(1), &re_emlrtBCI, sp);
    }
    ...
    if (d + 2.0 != d1) {
      emlrtIntegerCheckR2012b(d + 2.0, &lb_emlrtDCI, sp);
    }

    if ((i < 1) || (i > SLD.size(1))) {
      emlrtDynamicBoundsCheckR2012b(i, 1, SLD.size(1), &qe_emlrtBCI, sp);
    }
    ...
    if ((SLD.size(0) == 0) || (SLD.size(1) == 0)) {
      ...
      b_layers.set_size((&mf_emlrtRTEI), (&c_st), (static_cast<int32_T>(sz_idx_0)));
      ...
      vstride = SLD.size(0);
      b_layers.set_size((&lf_emlrtRTEI), (&d_st), SLD.size(0));
    ...
    SLD.set_size((&nf_emlrtRTEI), sp, b_layers.size(0), 1);
    ...
    int32_T k;
    x.set_size((&ff_emlrtRTEI), sp, 1, 101);
    for (i = 0; i < 101; i++) {
      x[i] = i;
    }
    ...
    SLD.set_size((&gf_emlrtRTEI), sp, 1, 101);
    for (i = 0; i < 101; i++) {
      SLD[i] = i;
    }
    ...
    SLD.set_size((&hf_emlrtRTEI), sp, 1, airBox.size(1));
  ...
  out.set_size((&of_emlrtRTEI), (&b_st), x.size(1), 2);
  vstride = x.size(1);
  for (i = 0; i < vstride; i++) {
    out[i] = x[i];
  }

...
static void emxExpand_cell_wrap_11(const emlrtStack *sp, emxArray_cell_wrap_11
  *emxArray, int32_T fromIndex, int32_T toIndex, const emlrtRTEInfo *srcLocation);
static void emxExpand_cell_wrap_12(const emlrtStack *sp, emxArray_cell_wrap_12
  *emxArray, int32_T fromIndex, int32_T toIndex, const emlrtRTEInfo *srcLocation);
static void emxExpand_cell_wrap_16(const emlrtStack *sp, emxArray_cell_wrap_16
  *emxArray, int32_T fromIndex, int32_T toIndex, const emlrtRTEInfo *srcLocation);
static void emxExpand_cell_wrap_17(const emlrtStack *sp, emxArray_cell_wrap_17
  *emxArray, int32_T fromIndex, int32_T toIndex, const emlrtRTEInfo *srcLocation);
...
static void emxExpand_cell_wrap_5(const emlrtStack *sp, emxArray_cell_wrap_5
  *emxArray, int32_T fromIndex, int32_T toIndex, const emlrtRTEInfo *srcLocation);
static void emxExpand_cell_wrap_7(const emlrtStack *sp, emxArray_cell_wrap_7
  *emxArray, int32_T fromIndex, int32_T toIndex, const emlrtRTEInfo *srcLocation);
...
static void emxFreeStruct_cell_wrap_16(cell_wrap_16 *pStruct);
...
static void emxInitStruct_cell_wrap_11(const emlrtStack *sp, cell_wrap_11
  *pStruct, const emlrtRTEInfo *srcLocation, boolean_T doPush);
static void emxInitStruct_cell_wrap_12(const emlrtStack *sp, cell_wrap_12
  *pStruct, const emlrtRTEInfo *srcLocation, boolean_T doPush);
static void emxInitStruct_cell_wrap_16(const emlrtStack *sp, cell_wrap_16
  *pStruct, const emlrtRTEInfo *srcLocation, boolean_T doPush);
static void emxInitStruct_cell_wrap_17(const emlrtStack *sp, cell_wrap_17
  *pStruct, const emlrtRTEInfo *srcLocation, boolean_T doPush);
...
static void emxInitStruct_cell_wrap_5(const emlrtStack *sp, cell_wrap_5 *pStruct,
  const emlrtRTEInfo *srcLocation, boolean_T doPush);
static void emxInitStruct_cell_wrap_7(const emlrtStack *sp, cell_wrap_7 *pStruct,
  const emlrtRTEInfo *srcLocation, boolean_T doPush);
...
static void emxTrim_cell_wrap_12(emxArray_cell_wrap_12 *emxArray, int32_T
  fromIndex, int32_T toIndex);
static void emxTrim_cell_wrap_16(emxArray_cell_wrap_16 *emxArray, int32_T
  fromIndex, int32_T toIndex);
...
static void emxTrim_cell_wrap_5(emxArray_cell_wrap_5 *emxArray, int32_T
  fromIndex, int32_T toIndex);
static void emxTrim_cell_wrap_7(emxArray_cell_wrap_7 *emxArray, int32_T
  fromIndex, int32_T toIndex);
  ...
  *emxArray, int32_T fromIndex, int32_T toIndex, const emlrtRTEInfo *srcLocation)
{
  int32_T i;
  for (i = fromIndex; i < toIndex; i++) {
    emxInitStruct_cell_wrap_12(sp, &emxArray->data[i], srcLocation, false);
  }
}
  ...
  *emxArray, int32_T fromIndex, int32_T toIndex, const emlrtRTEInfo *srcLocation)
{
  int32_T i;
  for (i = fromIndex; i < toIndex; i++) {
    emxInitStruct_cell_wrap_17(sp, &emxArray->data[i], srcLocation, false);
  }
}
  ...
  fromIndex, int32_T toIndex)
{
  int32_T i;
  for (i = fromIndex; i < toIndex; i++) {
    emxFreeStruct_cell_wrap_17(&emxArray->data[i]);
  }
}
  ...
  emxArray, int32_T oldNumel, const emlrtRTEInfo *srcLocation)
{
  ...
  if (oldNumel > newNumel) {
    ...
    if (oldNumel < newNumel) {
      emxExpand_cell_wrap_17(sp, emxArray, oldNumel, newNumel, srcLocation);
    }
  }
}
  ...
  emxArray, int32_T oldNumel, const emlrtRTEInfo *srcLocation)
{
  ...
  if (newNumel > emxArray->allocatedSize) {
    ...
    newData = emlrtCallocMex((uint32_T)i, sizeof(cell_wrap_18));
    if (newData == NULL) {
      emlrtHeapAllocationErrorR2012b(srcLocation, sp);
    }

    if (emxArray->data != NULL) {
      memcpy(newData, emxArray->data, sizeof(cell_wrap_18) * oldNumel);
      if (emxArray->canFreeData) {
        emlrtFreeMex(emxArray->data);
      }
    }

    emxArray->data = (cell_wrap_18 *)newData;
    emxArray->allocatedSize = i;
    emxArray->canFreeData = true;
  }
}
...
{
  if (*pEmxArray != (emxArray_cell_wrap_18 *)NULL) {
    if (((*pEmxArray)->data != (cell_wrap_18 *)NULL) && (*pEmxArray)
        ->canFreeData) {
      emlrtFreeMex((*pEmxArray)->data);
    }
    ...
    emlrtFreeMex((*pEmxArray)->size);
    emlrtFreeMex(*pEmxArray);
    *pEmxArray = (emxArray_cell_wrap_18 *)NULL;
  }
}
  ...
  emlrtRTEInfo *srcLocation, boolean_T doPush)
{
  ...
  emxInit_cell_wrap_12(sp, &pStruct->f5, 2, srcLocation, doPush);
  ...
  emxInit_cell_wrap_5(sp, &pStruct->f10, 2, srcLocation, doPush);
...
void emxInitStruct_cell_8(const emlrtStack *sp, cell_8 *pStruct, const
  emlrtRTEInfo *srcLocation, boolean_T doPush)
{
  emxInit_cell_wrap_7(sp, &pStruct->f1, 1, srcLocation, doPush);
  emxInit_cell_wrap_7(sp, &pStruct->f2, 1, srcLocation, doPush);
  emxInit_cell_wrap_1(sp, &pStruct->f3, 1, srcLocation, doPush);
  emxInit_cell_wrap_1(sp, &pStruct->f4, 1, srcLocation, doPush);
  emxInit_cell_wrap_7(sp, &pStruct->f5, 1, srcLocation, doPush);
...
void emxInit_cell_wrap_18(const emlrtStack *sp, emxArray_cell_wrap_18
  **pEmxArray, int32_T numDimensions, const emlrtRTEInfo *srcLocation, boolean_T
  doPush)
{
  emxArray_cell_wrap_18 *emxArray;
  int32_T i;
  *pEmxArray = (emxArray_cell_wrap_18 *)emlrtMallocMex(sizeof
  ...
  if (doPush) {
    emlrtPushHeapReferenceStackR2012b(sp, (void *)pEmxArray, (void *)
      &emxFree_cell_wrap_18);
  }

  emxArray = *pEmxArray;
  emxArray->data = (cell_wrap_18 *)NULL;
  emxArray->numDimensions = numDimensions;
  emxArray->size = (int32_T *)emlrtMallocMex(sizeof(int32_T) * numDimensions);
  if ((void *)emxArray->size == NULL) {
    emlrtHeapAllocationErrorR2012b(srcLocation, sp);

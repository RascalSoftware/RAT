    ...
    for (j = 0; j <= loop_ub; j++) {
      ...
      try {
        ...
        if ((i1 < 1) || (i1 > out.size(0))) {
          emlrtDynamicBoundsCheckR2012b(i1, 1, out.size(0), &fh_emlrtBCI, &st);
        }
        ...
        for (c_i = 0; c_i < i2; c_i++) {
          ...
          if ((b_i < 1) || (b_i > xdata.size(0))) {
            emlrtDynamicBoundsCheckR2012b(b_i, 1, xdata.size(0), &ih_emlrtBCI,
              &b_st);
          }

          if (i1 > xdata.size(0)) {
            emlrtDynamicBoundsCheckR2012b(i1, 1, xdata.size(0), &jh_emlrtBCI,
              &b_st);
          }
          ...
          sumg += g;
          if (i1 > out.size(0)) {
            emlrtDynamicBoundsCheckR2012b(i1, 1, out.size(0), &kh_emlrtBCI, &st);
          }

          if (b_i > dummyref.size(0)) {
            emlrtDynamicBoundsCheckR2012b(b_i, 1, dummyref.size(0), &lh_emlrtBCI,
              &st);
          }

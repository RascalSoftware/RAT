...
static emlrtRSInfo ue_emlrtRSI = { 24, // lineNo
  "sortrows",                          // fcnName
...
static emlrtRSInfo xe_emlrtRSI = { 95, // lineNo
...
static emlrtRSInfo ye_emlrtRSI = { 82, // lineNo
  "sortIdx",                           // fcnName
  "/usr/local/MATLAB/R2020a/toolbox/eml/eml/+coder/+internal/sortIdx.m"// pathName 
};

static emlrtRSInfo af_emlrtRSI = { 86, // lineNo
  "sortIdx",                           // fcnName
  "/usr/local/MATLAB/R2020a/toolbox/eml/eml/+coder/+internal/sortIdx.m"// pathName 
};
...
static emlrtRSInfo cf_emlrtRSI = { 58, // lineNo
  "mergesort",                         // fcnName
  "/usr/local/MATLAB/R2020a/toolbox/eml/eml/+coder/+internal/mergesort.m"// pathName 
};

static emlrtRSInfo df_emlrtRSI = { 85, // lineNo
  "mergesort",                         // fcnName
  "/usr/local/MATLAB/R2020a/toolbox/eml/eml/+coder/+internal/mergesort.m"// pathName 
};

static emlrtRSInfo ef_emlrtRSI = { 113,// lineNo
  "mergesort",                         // fcnName
  "/usr/local/MATLAB/R2020a/toolbox/eml/eml/+coder/+internal/mergesort.m"// pathName 
};

static emlrtRSInfo hf_emlrtRSI = { 39, // lineNo
...
void sortrows(const emlrtStack *sp, coder::array<real_T, 2U> &y)
{
  ...
  st.site = &ve_emlrtRSI;
  n = y.size(0) + 1;
  idx.set_size((&dk_emlrtRTEI), (&st), y.size(0));
  i2 = y.size(0);
  for (j = 0; j < i2; j++) {
    idx[j] = 0;
  }
  ...
  if (y.size(0) == 0) {
    ...
    iwork.set_size((&ek_emlrtRTEI), (&b_st), y.size(0));
    i2 = y.size(0) - 1;
  ...
  st.site = &we_emlrtRSI;
  i2 = y.size(0);
  ycol.set_size((&fk_emlrtRTEI), (&st), y.size(0));

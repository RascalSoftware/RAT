...
// File: loopMatalbCustlayWrapper_XYSingle.cpp
//
...
namespace RAT
{
    ...
    array<cell_wrap_14, 1U> &allLayers, ::coder::array<real_T, 1U> &allRoughs)
  {
    ...
    for (int32_T b_i{0}; b_i < i; b_i++) {
      tempAllLayers[b_i].f1.set_size(1, 2);
...
//
// File trailer for loopMatalbCustlayWrapper_XYSingle.cpp
//
// [EOF]
//

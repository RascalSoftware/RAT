...
// File: standardTF_custXY_paraContrasts.cpp
//
...
//                ::coder::array<cell_wrap_35, 1U> &allLayers
//                ::coder::array<real_T, 1U> &allRoughs
// Return Type  : void
//
namespace RAT
{
  void standardTF_custXY_paraContrasts(const real_T
    ...
    coder::array<real_T, 1U> &chis, ::coder::array<cell_wrap_12, 1U>
    &reflectivity, ::coder::array<cell_wrap_12, 1U> &Simulation, ::coder::array<
    cell_wrap_14, 1U> &shifted_data, ::coder::array<cell_wrap_10, 1U> &layerSlds,
    ::coder::array<cell_wrap_14, 1U> &sldProfiles, ::coder::array<cell_wrap_35,
    1U> &allLayers, ::coder::array<real_T, 1U> &allRoughs)
  {
    ...
    switch (b_index) {
     case 0:
      ...
      loopMatalbCustlayWrapper_CustLaysingle(problemDef_numberOfContrasts,
        sldProf, allRoughs);
    ...
    for (int32_T i{0}; i < loop_ub_tmp; i++) {
      ...
      callReflectivity(nbas[i], nbss[i], (const real_T *)((::coder::array<real_T,
        2U> *)&problemDef_cells->f4.data[i].f1)->data(),
                       ...
                       Simul);
      applyBackgroundCorrection(reflect, Simul, shifted_dat_data,
...
//
// File trailer for standardTF_custXY_paraContrasts.cpp
//
// [EOF]
//

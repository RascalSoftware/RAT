...
// File: standardTF_custXY_paraPoints.cpp
//
...
namespace RAT
{
    ...
    1U> &allLayers, ::coder::array<real_T, 1U> &allRoughs)
  {
    ...
    for (int32_T i{0}; i < loop_ub_tmp; i++) {
      ...
      b_callReflectivity(nbas[i], nbss[i], (const real_T *)((::coder::array<
        real_T, 2U> *)&problemDef_cells->f4.data[i].f1)->data(),
...
//
// File trailer for standardTF_custXY_paraPoints.cpp
//
// [EOF]
//

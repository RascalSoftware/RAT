...
// File: standardTF_custlay_single.cpp
//
...
namespace RAT
{
  void standardTF_custlay_single(const struct0_T *problemDef, const cell_18
    ...
    1U> &allLayers, ::coder::array<real_T, 1U> &allRoughs)
  {
    ...
    for (int32_T i{0}; i < loop_ub_tmp; i++) {
      ...
      standardTF_layers_core(allLayers[i].f1, allRoughs[i],
...
//
// File trailer for standardTF_custlay_single.cpp
//
// [EOF]
//

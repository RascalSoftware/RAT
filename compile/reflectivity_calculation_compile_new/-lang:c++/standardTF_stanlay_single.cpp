...
// File: standardTF_stanlay_single.cpp
//
...
namespace RAT
{
  void standardTF_stanlay_single(const struct0_T *problemDef, const cell_18
    ...
    1U> &allLayers, ::coder::array<real_T, 1U> &allRoughs)
  {
    ...
    for (int32_T b_i{0}; b_i < i; b_i++) {
      ...
      standardTF_layers_core(thisContrastLayers_data,
...
//
// File trailer for standardTF_stanlay_single.cpp
//
// [EOF]
//

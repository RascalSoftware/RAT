...
static void emxFreeStruct_cell_6(cell_6 *pStruct);
static void emxFreeStruct_cell_9(cell_9 *pStruct);
...
static void emxFreeStruct_cell_wrap_7(cell_wrap_7 *pStruct);
...
static void emxFree_cell_wrap_7(emxArray_cell_wrap_7 **pEmxArray);
...
static void emxInitMatrix_cell_wrap_4(const emlrtStack *sp, cell_wrap_4 pMatrix
  [3], boolean_T doPush);
static void emxInitStruct_cell_6(const emlrtStack *sp, cell_6 *pStruct,
  boolean_T doPush);
static void emxInitStruct_cell_9(const emlrtStack *sp, cell_9 *pStruct,
  boolean_T doPush);
...
static void emxInit_cell_wrap_5(const emlrtStack *sp, emxArray_cell_wrap_5
  **pEmxArray, int32_T numDimensions, boolean_T doPush);
static void emxInit_cell_wrap_7(const emlrtStack *sp, emxArray_cell_wrap_7
  **pEmxArray, int32_T numDimensions, boolean_T doPush);
  ...
  emlrtMsgIdentifier *parentId, struct0_T *y)
{
  ...
  f_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 22, "fitpars")),
                     &thisId, y->fitpars);
...
static void emxFreeStruct_cell_6(cell_6 *pStruct)
{
  ...
  emxFree_cell_wrap_5(&pStruct->f14);
}

/*
 * Arguments    : cell_9 *pStruct
 * Return Type  : void
 */
static void emxFreeStruct_cell_9(cell_9 *pStruct)
{
  emxFree_cell_wrap_7(&pStruct->f1);
  emxFree_cell_wrap_7(&pStruct->f2);
  emxFree_cell_wrap_8(&pStruct->f3);
  emxFree_cell_wrap_8(&pStruct->f4);
  emxFree_cell_wrap_7(&pStruct->f5);
...
/*
 * Arguments    : emxArray_cell_wrap_7 **pEmxArray
 * Return Type  : void
 */
static void emxFree_cell_wrap_7(emxArray_cell_wrap_7 **pEmxArray)
{
  ...
  boolean_T doPush)
{
  ...
  emxInit_cell_wrap_5(sp, &pStruct->f14, 2, doPush);
}
...
static void emxInitStruct_cell_9(const emlrtStack *sp, cell_9 *pStruct,
  boolean_T doPush)
{
  emxInit_cell_wrap_7(sp, &pStruct->f1, 1, doPush);
  emxInit_cell_wrap_7(sp, &pStruct->f2, 1, doPush);
  emxInit_cell_wrap_8(sp, &pStruct->f3, 1, doPush);
  emxInit_cell_wrap_8(sp, &pStruct->f4, 1, doPush);
  emxInit_cell_wrap_7(sp, &pStruct->f5, 1, doPush);
  ...
  emlrtMsgIdentifier *parentId, emxArray_cell_wrap_5 *y)
{
  ...
  for (i = 0; i < sizes[1]; i++) {
    sprintf(&str[0], "%d", i + 1);
    thisId.fIdentifier = &str[0];
    r_emlrt_marshallIn(sp, emlrtAlias(emlrtGetCell(sp, parentId, u, i)), &thisId,
                       y->data[i].f1);
  }
  ...
  *problemDef_limits, const char_T *identifier, struct1_T *y)
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  t_emlrt_marshallIn(sp, emlrtAlias(problemDef_limits), &thisId, y);
  ...
  emlrtMsgIdentifier *parentId, struct1_T *y)
{
  ...
  thisId.fIdentifier = "params";
  u_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 0, "params")),
                     &thisId, y->params);
  thisId.fIdentifier = "backs";
  u_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 1, "backs")),
                     &thisId, y->backs);
  thisId.fIdentifier = "scales";
  u_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 2, "scales")),
                     &thisId, y->scales);
  thisId.fIdentifier = "shifts";
  u_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 3, "shifts")),
                     &thisId, y->shifts);
  thisId.fIdentifier = "nba";
  u_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 4, "nba")),
                     &thisId, y->nba);
  thisId.fIdentifier = "nbs";
  u_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 5, "nbs")),
                     &thisId, y->nbs);
  thisId.fIdentifier = "res";
  u_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 6, "res")),
                     &thisId, y->res);
  emlrtDestroyArray(&u);
}
  ...
  emlrtMsgIdentifier *parentId, struct2_T *y)
{
  ...
  x_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 2, "display")),
                     &thisId, y->display);
  ...
  const mxArray *plhs[2])
{
  ...
  emxInitStruct_cell_6(&st, &problemDef_cells, true);
  ...
  emxInitStruct_cell_9(&st, &result, true);
  ...
  g_emlrt_marshallIn(&st, emlrtAliasP(prhs[1]), "problemDef_cells",
                     &problemDef_cells);
  s_emlrt_marshallIn(&st, emlrtAliasP(prhs[2]), "problemDef_limits",
                     &problemDef_limits);

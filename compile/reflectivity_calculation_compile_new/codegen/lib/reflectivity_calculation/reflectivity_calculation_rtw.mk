...
## Generated on : Thu Apr 15 10:46:43 2021
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /home/arwel/Documents/RascalDev/RAT/compile/reflectivity_calculation_compile_new/codegen/lib/reflectivity_calculation
TGT_FCN_LIB               = ISO_C++
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I/home/arwel/Documents/RascalDev/RAT/compile/reflectivity_calculation_compile_new -I$(MATLAB_ROOT)/extern/include
...
%.o : /home/arwel/Documents/RascalDev/RAT/compile/reflectivity_calculation_compile_new/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : /home/arwel/Documents/RascalDev/RAT/compile/reflectivity_calculation_compile_new/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"

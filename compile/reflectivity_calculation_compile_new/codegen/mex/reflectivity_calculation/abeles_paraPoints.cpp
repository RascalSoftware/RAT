  ...
  &out)
{
  ...
  out.set_size((&xj_emlrtRTEI), sp, ub_loop);
...
#pragma omp for nowait
    ...
    for (loop = 0; loop <= ub_loop; loop++) {
      ...
      try {
        i = loop + 1;
        if ((i < 1) || (i > x.size(0))) {
          emlrtDynamicBoundsCheckR2012b(i, 1, x.size(0), &oh_emlrtBCI, &st);
        }
        ...
        blast.im = 0.0;
        if (1 > sld.size(0)) {
          emlrtDynamicBoundsCheckR2012b(1, 1, sld.size(0), &nh_emlrtBCI, &st);
        }
        ...
        emlrtForLoopVectorCheckR2012b(1.0, 1.0, nrepeats, mxDOUBLE_CLASS,
          static_cast<int32_T>(nrepeats), &ec_emlrtRTEI, &st);
        if (0 <= i - 1) {
        ...
        for (reploop = 0; reploop < i; reploop++) {
          for (nl = 0; nl < i1; nl++) {
            ...
            if ((i2 < 1) || (i2 > sld.size(0))) {
              emlrtDynamicBoundsCheckR2012b(i2, 1, sld.size(0), &ph_emlrtBCI,
                &st);
            }

            thick = sld[i2 - 1];
            if (i2 > sld.size(0)) {
              emlrtDynamicBoundsCheckR2012b(i2, 1, sld.size(0), &qh_emlrtBCI,
                &st);
            }

            preal = sld[(i2 + sld.size(0)) - 1];
            if (i2 > sld.size(0)) {
              emlrtDynamicBoundsCheckR2012b(i2, 1, sld.size(0), &rh_emlrtBCI,
                &st);
            }
        ...
        if ((i < 1) || (i > out.size(0))) {
          emlrtDynamicBoundsCheckR2012b(i, 1, out.size(0), &sh_emlrtBCI, &st);
        }

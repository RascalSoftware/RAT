...
static emlrtRTEInfo dc_emlrtRTEI = { 39,// lineNo
  19,                                  // colNo
  "abeles_single",                     // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/reflectivityCalculations/Abeles/abeles_single.m"// pName 
};
                   ...
                   points, coder::array<real_T, 1U> &out)
{
  ...
  out.set_size((&pj_emlrtRTEI), sp, i);
  ...
  for (int32_T loop = 0; loop < i; loop++) {
    ...
    i3 = loop + 1;
    if ((i3 < 1) || (i3 > x.size(0))) {
      emlrtDynamicBoundsCheckR2012b(i3, 1, x.size(0), &hh_emlrtBCI, sp);
    }
    ...
    blast_im = 0.0;
    if (1 > sld.size(0)) {
      emlrtDynamicBoundsCheckR2012b(1, 1, sld.size(0), &gh_emlrtBCI, sp);
    }
    ...
    emlrtForLoopVectorCheckR2012b(1.0, 1.0, nrepeats, mxDOUBLE_CLASS,
      static_cast<int32_T>(nrepeats), &dc_emlrtRTEI, sp);
    for (int32_T reploop = 0; reploop < i1; reploop++) {
      for (int32_T nl = 0; nl < i2; nl++) {
        i3 = nl + 1;
        if ((i3 < 1) || (i3 > sld.size(0))) {
          emlrtDynamicBoundsCheckR2012b(i3, 1, sld.size(0), &fh_emlrtBCI, sp);
        }

        i3 = nl + 1;
        if ((i3 < 1) || (i3 > sld.size(0))) {
          emlrtDynamicBoundsCheckR2012b(i3, 1, sld.size(0), &eh_emlrtBCI, sp);
        }

        i3 = static_cast<int32_T>(nl + 1U);
        if ((i3 < 1) || (i3 > sld.size(0))) {
          emlrtDynamicBoundsCheckR2012b(i3, 1, sld.size(0), &ih_emlrtBCI, sp);
        }
    ...
    if ((i3 < 1) || (i3 > out.size(0))) {
      emlrtDynamicBoundsCheckR2012b(i3, 1, out.size(0), &jh_emlrtBCI, sp);
    }

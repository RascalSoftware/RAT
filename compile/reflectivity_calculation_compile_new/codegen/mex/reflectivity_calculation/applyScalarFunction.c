...
static emlrtRSInfo pc_emlrtRSI = { 61, /* lineNo */
  "applyScalarFunction",               /* fcnName */
  "/opt/matlab2020b/toolbox/eml/eml/+coder/+internal/applyScalarFunction.m"/* pathName */
};

static emlrtRTEInfo si_emlrtRTEI = { 31,/* lineNo */
  21,                                  /* colNo */
  "applyScalarFunction",               /* fName */
  "/opt/matlab2020b/toolbox/eml/eml/+coder/+internal/applyScalarFunction.m"/* pName */
};
  ...
  emxArray_real_T *z1)
{
  ...
  z1->size[0] = 1;
  z1->size[1] = x->size[1];
  emxEnsureCapacity_real_T(sp, z1, ub_loop, &si_emlrtRTEI);
  st.site = &pc_emlrtRSI;
...
#pragma omp parallel \
 ...
 private(c_st,b_emlrtJBEnviron,d,absx,s,S,R,eint,b) \
      ...
      if (setjmp(b_emlrtJBEnviron) == 0) {
        ...
        if (muDoubleScalarIsNaN(d)) {
          ...
          if (absx < 3.7252902984619141E-9) {
            ...
            s = d * d;
            z1->data[k] = d + d * ((s * (s * (s * (s * -2.3763016656650163E-5 +

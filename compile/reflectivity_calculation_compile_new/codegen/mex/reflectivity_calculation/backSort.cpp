...
static emlrtDCInfo kb_emlrtDCI = { 41, // lineNo
  13,                                  // colNo
  "backSort",                          // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/backSorts/backSort.m",// pName 
  1                                    // checkKind
...
static emlrtDCInfo lb_emlrtDCI = { 44, // lineNo
  14,                                  // colNo
  "backSort",                          // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/backSorts/backSort.m",// pName 
  1                                    // checkKind
...
static emlrtDCInfo mb_emlrtDCI = { 47, // lineNo
  10,                                  // colNo
  "backSort",                          // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/backSorts/backSort.m",// pName 
  1                                    // checkKind
...
static emlrtDCInfo nb_emlrtDCI = { 50, // lineNo
  11,                                  // colNo
  "backSort",                          // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/backSorts/backSort.m",// pName 
  1                                    // checkKind
...
static emlrtDCInfo ob_emlrtDCI = { 53, // lineNo
  11,                                  // colNo
  "backSort",                          // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/backSorts/backSort.m",// pName 
  1                                    // checkKind
...
static emlrtDCInfo pb_emlrtDCI = { 56, // lineNo
  13,                                  // colNo
  "backSort",                          // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/backSorts/backSort.m",// pName 
  1                                    // checkKind
              ...
              real_T *b_nba, real_T *b_nbs, real_T *resol)
{
  ...
  if (cBacks != static_cast<int32_T>(muDoubleScalarFloor(cBacks))) {
    emlrtIntegerCheckR2012b(cBacks, &kb_emlrtDCI, sp);
  }

  i = static_cast<int32_T>(cBacks);
  if ((i < 1) || (i > backs.size(1))) {
    emlrtDynamicBoundsCheckR2012b(i, 1, backs.size(1), &he_emlrtBCI, sp);
  }
  ...
  *backg = backs[i - 1];
  ...
  if (cShifts != static_cast<int32_T>(muDoubleScalarFloor(cShifts))) {
    emlrtIntegerCheckR2012b(cShifts, &lb_emlrtDCI, sp);
  }

  i = static_cast<int32_T>(cShifts);
  if ((i < 1) || (i > shifts.size(1))) {
    emlrtDynamicBoundsCheckR2012b(i, 1, shifts.size(1), &ie_emlrtBCI, sp);
  }
  ...
  *qshift = shifts[i - 1];
  ...
  if (cScales != static_cast<int32_T>(muDoubleScalarFloor(cScales))) {
    emlrtIntegerCheckR2012b(cScales, &mb_emlrtDCI, sp);
  }

  i = static_cast<int32_T>(cScales);
  if ((i < 1) || (i > sf.size(1))) {
    emlrtDynamicBoundsCheckR2012b(i, 1, sf.size(1), &je_emlrtBCI, sp);
  }
  ...
  *b_sf = sf[i - 1];
  ...
  if (cNbas != static_cast<int32_T>(muDoubleScalarFloor(cNbas))) {
    emlrtIntegerCheckR2012b(cNbas, &nb_emlrtDCI, sp);
  }

  i = static_cast<int32_T>(cNbas);
  if ((i < 1) || (i > nba.size(1))) {
    emlrtDynamicBoundsCheckR2012b(i, 1, nba.size(1), &ke_emlrtBCI, sp);
  }
  ...
  *b_nba = nba[i - 1];
  ...
  if (cNbss != static_cast<int32_T>(muDoubleScalarFloor(cNbss))) {
    emlrtIntegerCheckR2012b(cNbss, &ob_emlrtDCI, sp);
  }

  i = static_cast<int32_T>(cNbss);
  if ((i < 1) || (i > nbs.size(1))) {
    emlrtDynamicBoundsCheckR2012b(i, 1, nbs.size(1), &le_emlrtBCI, sp);
  }
  ...
  *b_nbs = nbs[i - 1];
  ...
  if (cRes != static_cast<int32_T>(muDoubleScalarFloor(cRes))) {
    emlrtIntegerCheckR2012b(cRes, &pb_emlrtDCI, sp);
  }

  i = static_cast<int32_T>(cRes);
  if ((i < 1) || (i > res.size(1))) {
    emlrtDynamicBoundsCheckR2012b(i, 1, res.size(1), &me_emlrtBCI, sp);
  }

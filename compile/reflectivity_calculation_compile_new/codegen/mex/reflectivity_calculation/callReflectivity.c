...
static emlrtRSInfo vf_emlrtRSI = { 21, /* lineNo */
  ...
  "/home/sp1115144/Desktop/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"/* pathName */
};
...
static emlrtRSInfo xf_emlrtRSI = { 79, /* lineNo */
  "callReflectivity",                  /* fcnName */
  "/home/sp1115144/Desktop/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"/* pathName */
};
...
static emlrtRSInfo eg_emlrtRSI = { 28, /* lineNo */
  "abeles_single",                     /* fcnName */
  "/home/sp1115144/Desktop/RAT/targetFunctions/common/reflectivityCalculations/Abeles/abeles_single.m"/* pathName */
};

static emlrtRSInfo rg_emlrtRSI = { 61, /* lineNo */
  "callReflectivity",                  /* fcnName */
  "/home/sp1115144/Desktop/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"/* pathName */
};

static emlrtRSInfo sg_emlrtRSI = { 69, /* lineNo */
  "callReflectivity",                  /* fcnName */
  "/home/sp1115144/Desktop/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"/* pathName */
};
...
static emlrtBCInfo yg_emlrtBCI = { -1, /* iFirst */
  ...
  "sld",                               /* aName */
  "abeles_single",                     /* fName */
  "/home/sp1115144/Desktop/RAT/targetFunctions/common/reflectivityCalculations/Abeles/abeles_single.m",/* pName */
  0                                    /* checkKind */
};
...
static emlrtBCInfo bh_emlrtBCI = { -1, /* iFirst */
  ...
  "/home/sp1115144/Desktop/RAT/targetFunctions/common/callReflectivity/callReflectivity.m",/* pName */
  0                                    /* checkKind */
};
...
static emlrtRTEInfo fl_emlrtRTEI = { 7,/* lineNo */
  5,                                   /* colNo */
  "callReflectivity",                  /* fName */
  "/home/sp1115144/Desktop/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"/* pName */
};

static emlrtRTEInfo gl_emlrtRTEI = { 10,/* lineNo */
  5,                                   /* colNo */
  "callReflectivity",                  /* fName */
  "/home/sp1115144/Desktop/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"/* pName */
};

static emlrtRTEInfo hl_emlrtRTEI = { 33,/* lineNo */
  1,                                   /* colNo */
  "callReflectivity",                  /* fName */
  "/home/sp1115144/Desktop/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"/* pName */
};

static emlrtRTEInfo il_emlrtRTEI = { 21,/* lineNo */
  5,                                   /* colNo */
  "callReflectivity",                  /* fName */
  "/home/sp1115144/Desktop/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"/* pName */
};

static emlrtRTEInfo jl_emlrtRTEI = { 28,/* lineNo */
  5,                                   /* colNo */
  "callReflectivity",                  /* fName */
  "/home/sp1115144/Desktop/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"/* pName */
};

static emlrtRTEInfo kl_emlrtRTEI = { 36,/* lineNo */
  1,                                   /* colNo */
  "callReflectivity",                  /* fName */
  "/home/sp1115144/Desktop/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"/* pName */
};

static emlrtRTEInfo ll_emlrtRTEI = { 42,/* lineNo */
  1,                                   /* colNo */
  "callReflectivity",                  /* fName */
  "/home/sp1115144/Desktop/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"/* pName */
};

static emlrtRTEInfo ml_emlrtRTEI = { 79,/* lineNo */
  26,                                  /* colNo */
  "callReflectivity",                  /* fName */
  "/home/sp1115144/Desktop/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"/* pName */
};

static emlrtRTEInfo nl_emlrtRTEI = { 49,/* lineNo */
  5,                                   /* colNo */
  "callReflectivity",                  /* fName */
  "/home/sp1115144/Desktop/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"/* pName */
};

static emlrtRTEInfo ol_emlrtRTEI = { 85,/* lineNo */
  56,                                  /* colNo */
  "callReflectivity",                  /* fName */
  "/home/sp1115144/Desktop/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"/* pName */
};

static emlrtRTEInfo pl_emlrtRTEI = { 83,/* lineNo */
  61,                                  /* colNo */
  "callReflectivity",                  /* fName */
  "/home/sp1115144/Desktop/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"/* pName */
};

static emlrtRTEInfo ql_emlrtRTEI = { 91,/* lineNo */
  1,                                   /* colNo */
  "callReflectivity",                  /* fName */
  "/home/sp1115144/Desktop/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"/* pName */
};

static emlrtRTEInfo rl_emlrtRTEI = { 61,/* lineNo */
  17,                                  /* colNo */
  "callReflectivity",                  /* fName */
  "/home/sp1115144/Desktop/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"/* pName */
};

static emlrtRTEInfo qm_emlrtRTEI = { 72,/* lineNo */
  56,                                  /* colNo */
  "callReflectivity",                  /* fName */
  "/home/sp1115144/Desktop/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"/* pName */
};

static emlrtRTEInfo rm_emlrtRTEI = { 69,/* lineNo */
  61,                                  /* colNo */
  "callReflectivity",                  /* fName */
  "/home/sp1115144/Desktop/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"/* pName */
};
  ...
  emxArray_real_T *Simulation)
{
  ...
  if (1 > this_data->size[1]) {
    emlrtDynamicBoundsCheckR2012b(1, 1, this_data->size[1], &nh_emlrtBCI, sp);
  }
  ...
  if (1 > i) {
    emlrtDynamicBoundsCheckR2012b(1, 1, i, &mh_emlrtBCI, sp);
  }

  if (2 > i) {
    emlrtDynamicBoundsCheckR2012b(2, 1, i, &lh_emlrtBCI, sp);
  }

  if (1 > this_data->size[1]) {
    emlrtDynamicBoundsCheckR2012b(1, 1, this_data->size[1], &kh_emlrtBCI, sp);
  }

  if (1 > this_data->size[0]) {
    emlrtDynamicBoundsCheckR2012b(1, 1, this_data->size[0], &jh_emlrtBCI, sp);
  }

  emxInit_real_T(sp, &firstSection, 2, &il_emlrtRTEI, true);
  if (simLimits_data[0] < this_data->data[0]) {
    if (2 > this_data->size[0]) {
      emlrtDynamicBoundsCheckR2012b(2, 1, this_data->size[0], &ih_emlrtBCI, sp);
    }

    if (1 > this_data->size[0]) {
      emlrtDynamicBoundsCheckR2012b(1, 1, this_data->size[0], &hh_emlrtBCI, sp);
    }

    step = this_data->data[1] - this_data->data[0];
    if (1 > this_data->size[0]) {
      emlrtDynamicBoundsCheckR2012b(1, 1, this_data->size[0], &gh_emlrtBCI, sp);
    }
    ...
    } else if ((step == 0.0) || ((simLimits_data[0] < b) && (step < 0.0)) || ((b
      < simLimits_data[0]) && (step > 0.0))) {
      firstSection->size[0] = 1;
      firstSection->size[1] = 0;
    } else if ((muDoubleScalarIsInf(simLimits_data[0]) || muDoubleScalarIsInf(b))
  ...
  if (simLimits_data[1] > this_data->data[this_data->size[0] - 1]) {
    ...
    if ((this_data->size[0] - 1 < 1) || (this_data->size[0] - 1 >
         this_data->size[0])) {
      emlrtDynamicBoundsCheckR2012b(this_data->size[0] - 1, 1, this_data->size[0],
        &qh_emlrtBCI, sp);
    }

    step = this_data->data[this_data->size[0] - 1] - this_data->data
      [this_data->size[0] - 2];
    st.site = &wf_emlrtRSI;
    if (this_data->size[0] < 1) {
      emlrtDynamicBoundsCheckR2012b(this_data->size[0], 1, this_data->size[0],
    ...
    } else if ((muDoubleScalarIsInf(b) || muDoubleScalarIsInf(simLimits_data[1]))
  ...
  simLimits_idx_0 = firstSection->size[1];
  ...
  for (i = 0; i < loop_ub; i++) {
    simXdata->data[i + simLimits_idx_0] = this_data->data[i];
  }

  b_loop_ub = lastSection->size[1];
  for (i = 0; i < b_loop_ub; i++) {
    simXdata->data[(i + simLimits_idx_0) + loop_ub] = lastSection->data[i];
  }
  ...
  if (res == -1.0) {
    if (4 > this_data->size[1]) {
      emlrtDynamicBoundsCheckR2012b(4, 1, this_data->size[1], &fh_emlrtBCI, sp);
    }

    if (1 > this_data->size[0]) {
      emlrtDynamicBoundsCheckR2012b(1, 1, this_data->size[0], &eh_emlrtBCI, sp);
    }
    ...
    simLimits_idx_0 = firstSection->size[1];
    b = this_data->data[this_data->size[0] * 3];
    step = this_data->data[(this_data->size[0] + this_data->size[0] * 3) - 1];
    loop_ub = this_data->size[0];
    i = simResolData->size[0];
    simResolData->size[0] = (firstSection->size[1] + this_data->size[0]) +
      lastSection->size[1];
    emxEnsureCapacity_real_T(sp, simResolData, i, &nl_emlrtRTEI);
    b_loop_ub = firstSection->size[1];
    for (i = 0; i < b_loop_ub; i++) {
      simResolData->data[i] = b;
    }

    for (i = 0; i < loop_ub; i++) {
      simResolData->data[i + simLimits_idx_0] = this_data->data[i +
        this_data->size[0] * 3];
    }

    b_loop_ub = lastSection->size[1];
    for (i = 0; i < b_loop_ub; i++) {
      simResolData->data[(i + simLimits_idx_0) + loop_ub] = step;
    }
  }
  ...
  if (res == -1.0) {
    ...
    st.site = &sg_emlrtRSI;
    data_resolution_polly(&st, simXdata, b_simRef, simResolData, simXdata->size
                          [0], simRef);
  } else {
  ...
  if (firstSection->size[1] + 1U > splits_idx_1) {
    ...
    if (((int32_T)(firstSection->size[1] + 1U) < 1) || ((int32_T)
         (firstSection->size[1] + 1U) > Simulation->size[0])) {
      emlrtDynamicBoundsCheckR2012b((int32_T)(firstSection->size[1] + 1U), 1,
        Simulation->size[0], &ch_emlrtBCI, sp);
    }
  ...
  for (lays = 0; lays < loop_ub; lays++) {
    reflectivity->data[lays] = Simulation->data[i + lays];
  }

  for (lays = 0; lays < loop_ub; lays++) {
    reflectivity->data[lays + reflectivity->size[0]] = Simulation->data[(i +
      lays) + Simulation->size[0]];
  }
                      ...
                      *Simulation)
{
  ...
  if (layers->size[0] == 0) {
    ...
    for (i = 0; i < 3; i++) {
      for (i1 = 0; i1 < loop_ub; i1++) {
        slds->data[i1 + slds->size[0] * i] = layers->data[i1 + layers->size[0] *
          i];
      }
    }
  ...
  if (simLimits_data[0] < this_data->data[0]) {
    ...
    if (muDoubleScalarIsNaN(simLimits_data[0]) || muDoubleScalarIsNaN(step) ||
      ...
      firstSection->size[0] = 1;
      firstSection->size[1] = 0;
    } else if ((muDoubleScalarIsInf(simLimits_data[0]) || muDoubleScalarIsInf
                (snlay)) && (muDoubleScalarIsInf(step) || (simLimits_data[0] ==
                 snlay))) {
      i = firstSection->size[0] * firstSection->size[1];
      firstSection->size[0] = 1;
      firstSection->size[1] = 1;
      ...
      i = firstSection->size[0] * firstSection->size[1];
      firstSection->size[0] = 1;
      loop_ub = (int32_T)muDoubleScalarFloor((snlay - simLimits_data[0]) / step);
      firstSection->size[1] = loop_ub + 1;
      emxEnsureCapacity_real_T(&st, firstSection, i, &il_emlrtRTEI);
      for (i = 0; i <= loop_ub; i++) {
        firstSection->data[i] = simLimits_data[0] + step * (real_T)i;
  ...
  if (simLimits_data[1] > this_data->data[this_data->size[0] - 1]) {
    ...
    if (muDoubleScalarIsNaN(snlay) || muDoubleScalarIsNaN(step) ||
      ...
      lastSection->size[0] = 1;
      lastSection->size[1] = 0;
    } else if ((muDoubleScalarIsInf(snlay) || muDoubleScalarIsInf
                (simLimits_data[1])) && (muDoubleScalarIsInf(step) || (snlay ==
                 simLimits_data[1]))) {
      i = lastSection->size[0] * lastSection->size[1];
      lastSection->size[0] = 1;
      lastSection->size[1] = 1;
    ...
    } else if ((muDoubleScalarFloor(snlay) == snlay) && (muDoubleScalarFloor
                (step) == step)) {
      i = lastSection->size[0] * lastSection->size[1];
      lastSection->size[0] = 1;
      loop_ub = (int32_T)muDoubleScalarFloor((simLimits_data[1] - snlay) / step);
      lastSection->size[1] = loop_ub + 1;
      emxEnsureCapacity_real_T(&st, lastSection, i, &jl_emlrtRTEI);
      for (i = 0; i <= loop_ub; i++) {
  ...
  if (res == -1.0) {
    ...
    simLimits_idx_0 = firstSection->size[1];
    snlay = this_data->data[this_data->size[0] * 3];
    step = this_data->data[(this_data->size[0] + this_data->size[0] * 3) - 1];
    loop_ub = this_data->size[0];
    i = simResolData->size[0];
    simResolData->size[0] = (firstSection->size[1] + this_data->size[0]) +
  ...
  for (simLimits_idx_0 = 0; simLimits_idx_0 < i; simLimits_idx_0++) {
    i1 = simLimits_idx_0 + 1;
    if ((i1 < 1) || (i1 > simXdata->size[0])) {
      emlrtDynamicBoundsCheckR2012b(i1, 1, simXdata->size[0], &ah_emlrtBCI, &st);
    }

    b_st.site = &eg_emlrtRSI;
    step = simXdata->data[simLimits_idx_0] * 1.54 / 12.566370614359172;
    ...
    emlrtForLoopVectorCheckR2012b(1.0, 1.0, nrepeats, mxDOUBLE_CLASS, (int32_T)
      nrepeats, &tb_emlrtRTEI, &st);
    for (b_loop_ub = 0; b_loop_ub < i2; b_loop_ub++) {
      for (loop_ub = 0; loop_ub <= b_layers; loop_ub++) {
        i1 = loop_ub + 1;
        if ((i1 < 1) || (i1 > slds->size[0])) {
          emlrtDynamicBoundsCheckR2012b(i1, 1, slds->size[0], &yg_emlrtBCI, &st);
        }

        if ((loop_ub + 1 < 1) || (loop_ub + 1 > slds->size[0])) {
        ...
        for (i1 = 0; i1 < 2; i1++) {
          ...
          pair_re = MI[i1 + 2].re;
          brm = MI[i1 + 2].im;
          b_MI[i1].re = (re * N_tmp.re - bim * N_tmp.im) + (pair_re * ar - brm *
            d);
          b_MI[i1].im = (re * N_tmp.im + bim * N_tmp.re) + (pair_re * d + brm *
            ar);
          b_MI[i1 + 2].re = (re * d1 - bim * step) + (pair_re * snlay - brm *
            rough);
          b_MI[i1 + 2].im = (re * step + bim * d1) + (pair_re * rough + brm *
            snlay);
        }
    ...
    for (i1 = 0; i1 < 2; i1++) {
      ...
      b_MI[i1 + 2].re = (snlay * d1 - rough * step) + (re * pair.re - bim *
        pair.im);
      b_MI[i1 + 2].im = (snlay * step + rough * d1) + (re * pair.im + bim *
        pair.re);
    }
    ...
    if ((simLimits_idx_0 + 1 < 1) || (simLimits_idx_0 + 1 > simRef->size[0])) {
      emlrtDynamicBoundsCheckR2012b(simLimits_idx_0 + 1, 1, simRef->size[0],
        &th_emlrtBCI, &st);
    }

    simRef->data[simLimits_idx_0] = muDoubleScalarHypot(pair.re, pair.im);
    if (*emlrtBreakCheckR2012bFlagVar != 0) {
      emlrtBreakCheckR2012b(&st);
    }
  }
  ...
  for (i1 = 0; i1 < loop_ub; i1++) {
    reflectivity->data[i1] = Simulation->data[i + i1];
  }

  for (i1 = 0; i1 < loop_ub; i1++) {
    reflectivity->data[i1 + reflectivity->size[0]] = Simulation->data[(i + i1) +
      Simulation->size[0]];
  }

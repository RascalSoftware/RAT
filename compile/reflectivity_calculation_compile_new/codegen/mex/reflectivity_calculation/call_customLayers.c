...
static emlrtRSInfo jh_emlrtRSI = { 52, /* lineNo */
  "call_customLayers",                 /* fcnName */
  "/home/sp1115144/Desktop/RAT/targetFunctions/common/callCustomLayers/call_customLayers.m"/* pathName */
};

static emlrtMCInfo emlrtMCI = { 44,    /* lineNo */
  5,                                   /* colNo */
  "callMatlabCustomLayers",            /* fName */
  "/home/sp1115144/Desktop/RAT/targetFunctions/common/callMatlabFunction/callMatlabCustomLayers.m"/* pName */
};

static emlrtMCInfo b_emlrtMCI = { 51,  /* lineNo */
  9,                                   /* colNo */
  "callMatlabCustomLayers",            /* fName */
  "/home/sp1115144/Desktop/RAT/targetFunctions/common/callMatlabFunction/callMatlabCustomLayers.m"/* pName */
};
...
static emlrtBCInfo io_emlrtBCI = { -1, /* iFirst */
  ...
  "/home/sp1115144/Desktop/RAT/targetFunctions/common/callCustomLayers/call_customLayers.m",/* pName */
  0                                    /* checkKind */
};
...
static emlrtDCInfo ic_emlrtDCI = { 41, /* lineNo */
  5,                                   /* colNo */
  "callMatlabCustomLayers",            /* fName */
  "/home/sp1115144/Desktop/RAT/targetFunctions/common/callMatlabFunction/callMatlabCustomLayers.m",/* pName */
  1                                    /* checkKind */
...
static emlrtDCInfo jc_emlrtDCI = { 52, /* lineNo */
  20,                                  /* colNo */
  "callMatlabCustomLayers",            /* fName */
  "/home/sp1115144/Desktop/RAT/targetFunctions/common/callMatlabFunction/callMatlabCustomLayers.m",/* pName */
  1                                    /* checkKind */
...
static emlrtDCInfo kc_emlrtDCI = { 52, /* lineNo */
  20,                                  /* colNo */
  "callMatlabCustomLayers",            /* fName */
  "/home/sp1115144/Desktop/RAT/targetFunctions/common/callMatlabFunction/callMatlabCustomLayers.m",/* pName */
  4                                    /* checkKind */
...
static emlrtRTEInfo no_emlrtRTEI = { 41,/* lineNo */
  5,                                   /* colNo */
  "callMatlabCustomLayers",            /* fName */
  "/home/sp1115144/Desktop/RAT/targetFunctions/common/callMatlabFunction/callMatlabCustomLayers.m"/* pName */
};

static emlrtRTEInfo oo_emlrtRTEI = { 58,/* lineNo */
  13,                                  /* colNo */
  "call_customLayers",                 /* fName */
  "/home/sp1115144/Desktop/RAT/targetFunctions/common/callCustomLayers/call_customLayers.m"/* pName */
};

static emlrtRTEInfo po_emlrtRTEI = { 75,/* lineNo */
  13,                                  /* colNo */
  "call_customLayers",                 /* fName */
  "/home/sp1115144/Desktop/RAT/targetFunctions/common/callCustomLayers/call_customLayers.m"/* pName */
};

static emlrtRTEInfo qo_emlrtRTEI = { 12,/* lineNo */
  5,                                   /* colNo */
  "callMatlabCustomLayers",            /* fName */
  "/home/sp1115144/Desktop/RAT/targetFunctions/common/callMatlabFunction/callMatlabCustomLayers.m"/* pName */
};

static emlrtRTEInfo ks_emlrtRTEI = { 69,/* lineNo */
  21,                                  /* colNo */
  "call_customLayers",                 /* fName */
  "/home/sp1115144/Desktop/RAT/targetFunctions/common/callCustomLayers/call_customLayers.m"/* pName */
};

static emlrtRTEInfo ls_emlrtRTEI = { 67,/* lineNo */
  21,                                  /* colNo */
  "call_customLayers",                 /* fName */
  "/home/sp1115144/Desktop/RAT/targetFunctions/common/callCustomLayers/call_customLayers.m"/* pName */
};

static emlrtRSInfo wi_emlrtRSI = { 44, /* lineNo */
  "callMatlabCustomLayers",            /* fcnName */
  "/home/sp1115144/Desktop/RAT/targetFunctions/common/callMatlabFunction/callMatlabCustomLayers.m"/* pathName */
};

static emlrtRSInfo xi_emlrtRSI = { 51, /* lineNo */
  "callMatlabCustomLayers",            /* fcnName */
  "/home/sp1115144/Desktop/RAT/targetFunctions/common/callMatlabFunction/callMatlabCustomLayers.m"/* pathName */
};

static emlrtRSInfo bj_emlrtRSI = { 56, /* lineNo */
  "callMatlabCustomLayers",            /* fcnName */
  "/home/sp1115144/Desktop/RAT/targetFunctions/common/callMatlabFunction/callMatlabCustomLayers.m"/* pathName */
};

static emlrtRSInfo cj_emlrtRSI = { 57, /* lineNo */
  "callMatlabCustomLayers",            /* fcnName */
  "/home/sp1115144/Desktop/RAT/targetFunctions/common/callMatlabFunction/callMatlabCustomLayers.m"/* pathName */
};
                  ...
                  emlrtMCInfo *location, const mxArray **g, const mxArray **h)
{
  ...
  pArrays[3] = e;
  pArrays[4] = f;
  emlrtAssign(g, emlrtCallMATLABR2012b(sp, 2, &mv[0], 5, pArrays, "feval", true,
    location));
  emlrtAssign(h, mv[1]);
}
  ...
  *sRough)
{
  ...
  emxInit_real_T(sp, &bulkOuts, 1, &qo_emlrtRTEI, true);
  ...
  if (nContrasts != i) {
    emlrtIntegerCheckR2012b(nContrasts, &ic_emlrtDCI, &st);
  }

  i1 = bulkOuts->size[0];
  loop_ub = (int32_T)nContrasts;
  bulkOuts->size[0] = loop_ub;
  emxEnsureCapacity_real_T(&st, bulkOuts, i1, &no_emlrtRTEI);
  if (loop_ub != i) {
    emlrtIntegerCheckR2012b(nContrasts, &ic_emlrtDCI, &st);
  }
  ...
  if (((int32_T)contrast < 1) || ((int32_T)contrast > loop_ub)) {
  ...
  y = NULL;
  iv[0] = thisCustomFile[0].f1->size[0];
  ...
  emlrt_marshallIn(&b_st, size(&b_st, emlrtAlias(tempOut), &b_emlrtMCI),
                   "<output of size>", n);
  if (!(n[0] >= 0.0)) {
    emlrtNonNegativeCheckR2012b(n[0], &kc_emlrtDCI, &st);
  }

  if (n[0] != (int32_T)muDoubleScalarFloor(n[0])) {
    emlrtIntegerCheckR2012b(n[0], &jc_emlrtDCI, &st);
  }

  if (!(n[1] >= 0.0)) {
    emlrtNonNegativeCheckR2012b(n[1], &kc_emlrtDCI, &st);
  }

  if (n[1] != (int32_T)muDoubleScalarFloor(n[1])) {
    emlrtIntegerCheckR2012b(n[1], &jc_emlrtDCI, &st);
  }
  ...
  *sRough = c_emlrt_marshallIn(&b_st, emlrtAlias(tempRough), "tempRough");
  ...
  if ((uint32_T)output->size[1] == 5U) {
    emxInit_real_T(sp, &newOutLayers, 2, &oo_emlrtRTEI, true);

    /*  we need to calculate the hydrated SLD */
    i = newOutLayers->size[0] * newOutLayers->size[1];
    newOutLayers->size[0] = output->size[0];
    newOutLayers->size[1] = 3;
    emxEnsureCapacity_real_T(sp, newOutLayers, i, &oo_emlrtRTEI);
    loop_ub = output->size[0] * 3;
    for (i = 0; i < loop_ub; i++) {
      newOutLayers->data[i] = 0.0;
    }

    if (1 > output->size[1]) {
      emlrtDynamicBoundsCheckR2012b(1, 1, output->size[1], &io_emlrtBCI, sp);
    }

    b_n[0] = output->size[0];
    emlrtSubAssignSizeCheckR2012b(&b_n[0], 1, &output->size[0], 1, &bb_emlrtECI,
      sp);
    loop_ub = output->size[0];
    for (i = 0; i < loop_ub; i++) {
      newOutLayers->data[i] = output->data[i];
    }

    /*  Thickness' */
    if (3 > output->size[1]) {
      emlrtDynamicBoundsCheckR2012b(3, 1, output->size[1], &jo_emlrtBCI, sp);
    }

    emlrtSubAssignSizeCheckR2012b(&newOutLayers->size[0], 1, &output->size[0], 1,
      &cb_emlrtECI, sp);
    loop_ub = output->size[0];
    for (i = 0; i < loop_ub; i++) {
      newOutLayers->data[i + newOutLayers->size[0] * 2] = output->data[i +
        output->size[0] * 2];
    }
    ...
    for (b_i = 0; b_i < i; b_i++) {
      if (2 > output->size[1]) {
        emlrtDynamicBoundsCheckR2012b(2, 1, output->size[1], &lo_emlrtBCI, sp);
      }

      if ((b_i + 1 < 1) || (b_i + 1 > output->size[0])) {
        emlrtDynamicBoundsCheckR2012b(b_i + 1, 1, output->size[0], &nx_emlrtBCI,
          sp);
      }

      if (4 > output->size[1]) {
        emlrtDynamicBoundsCheckR2012b(4, 1, output->size[1], &mo_emlrtBCI, sp);
      }

      if ((b_i + 1 < 1) || (b_i + 1 > output->size[0])) {
        emlrtDynamicBoundsCheckR2012b(b_i + 1, 1, output->size[0], &qo_emlrtBCI,
          sp);
      }
      ...
      if (5 > output->size[1]) {
        emlrtDynamicBoundsCheckR2012b(5, 1, output->size[1], &oo_emlrtBCI, sp);
      }

      i1 = b_i + 1;
      if ((i1 < 1) || (i1 > output->size[0])) {
        emlrtDynamicBoundsCheckR2012b(i1, 1, output->size[0], &no_emlrtBCI, sp);
      }

      if (output->data[b_i + output->size[0] * 4] == 0.0) {
        /*  Bulk out */
        loop_ub = bulkIn->size[0];
        i1 = bulkOuts->size[0];
        bulkOuts->size[0] = bulkIn->size[0];
        emxEnsureCapacity_real_T(sp, bulkOuts, i1, &ls_emlrtRTEI);
        ...
        i1 = bulkOuts->size[0];
        bulkOuts->size[0] = 1;
        emxEnsureCapacity_real_T(sp, bulkOuts, i1, &ks_emlrtRTEI);
        bulkOuts->data[0] = bulkOut;
      }

      d = (1.0 - thisHydration) * output->data[b_i + output->size[0]];
      loop_ub = bulkOuts->size[0];
      for (i1 = 0; i1 < loop_ub; i1++) {
        bulkOuts->data[i1] = thisHydration * bulkOuts->data[i1] + d;
      }

      if (1 > bulkOuts->size[0]) {
        emlrtDynamicBoundsCheckR2012b(1, 1, bulkOuts->size[0], &mx_emlrtBCI, sp);
      }

      if ((b_i + 1 < 1) || (b_i + 1 > newOutLayers->size[0])) {
    ...
    output->size[1] = 3;
    emxEnsureCapacity_real_T(sp, output, i, &po_emlrtRTEI);
    loop_ub = newOutLayers->size[0] * newOutLayers->size[1];
    for (i = 0; i < loop_ub; i++) {
  ...
  *sRough = c_emlrt_marshallIn(&b_st, emlrtAlias(tempRough), "tempRough");
  ...
  if ((uint32_T)output->size[1] == 5U) {
    ...
    for (loop_ub = 0; loop_ub < i; loop_ub++) {
      ...
      i1 = loop_ub + 1;
      if ((i1 < 1) || (i1 > output->size[0])) {
        emlrtDynamicBoundsCheckR2012b(i1, 1, output->size[0], &ko_emlrtBCI, sp);
      }
      ...
      if ((loop_ub + 1 < 1) || (loop_ub + 1 > output->size[0])) {
        emlrtDynamicBoundsCheckR2012b(loop_ub + 1, 1, output->size[0],
          &qo_emlrtBCI, sp);
      }

      thisHydration = output->data[loop_ub + output->size[0] * 3] / 100.0;
      ...
      if (output->data[loop_ub + output->size[0] * 4] == 0.0) {
        /*  Bulk out */
        thisBulkHydr = bulkIn;
      } else {
      ...
      if ((loop_ub + 1 < 1) || (loop_ub + 1 > newOutLayers->size[0])) {
        emlrtDynamicBoundsCheckR2012b(loop_ub + 1, 1, newOutLayers->size[0],
          &ro_emlrtBCI, sp);
      }

      newOutLayers->data[loop_ub + newOutLayers->size[0]] = thisHydration *
        thisBulkHydr + (1.0 - thisHydration) * output->data[loop_ub +
        output->size[0]];

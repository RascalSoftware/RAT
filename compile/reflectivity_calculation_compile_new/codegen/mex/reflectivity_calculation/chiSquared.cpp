...
static emlrtRSInfo yf_emlrtRSI = { 12, // lineNo
  "chiSquared",                        // fcnName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/costFunctions/chiSquared/chiSquared.m"// pathName 
};

static emlrtRSInfo ag_emlrtRSI = { 16, // lineNo
  "chiSquared",                        // fcnName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/costFunctions/chiSquared/chiSquared.m"// pathName 
};

static emlrtRSInfo bg_emlrtRSI = { 17, // lineNo
  "chiSquared",                        // fcnName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/costFunctions/chiSquared/chiSquared.m"// pathName 
};

static emlrtRSInfo cg_emlrtRSI = { 21, // lineNo
  "chiSquared",                        // fcnName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/costFunctions/chiSquared/chiSquared.m"// pathName 
};
...
static emlrtRTEInfo qj_emlrtRTEI = { 16,// lineNo
  15,                                  // colNo
  "chiSquared",                        // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/costFunctions/chiSquared/chiSquared.m"// pName 
};

static emlrtRTEInfo rj_emlrtRTEI = { 47,// lineNo
  9,                                   // colNo
  "div",                               // fName
  "/usr/local/MATLAB/R2020a/toolbox/eml/eml/+coder/+internal/div.m"// pName
};

static emlrtRTEInfo sj_emlrtRTEI = { 17,// lineNo
  14,                                  // colNo
  "chiSquared",                        // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/costFunctions/chiSquared/chiSquared.m"// pName 
};

static emlrtRTEInfo tj_emlrtRTEI = { 17,// lineNo
  5,                                   // colNo
  "chiSquared",                        // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/costFunctions/chiSquared/chiSquared.m"// pName 
};

static emlrtRTEInfo uj_emlrtRTEI = { 19,// lineNo
  15,                                  // colNo
  "chiSquared",                        // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/costFunctions/chiSquared/chiSquared.m"// pName 
};
                  ...
                  const coder::array<real_T, 2U> &thisFit, real_T P)
{
  ...
  if (2 > thisData.size(1)) {
    emlrtDynamicBoundsCheckR2012b(2, 1, thisData.size(1), &mh_emlrtBCI, sp);
  }

  if (3 > thisData.size(1)) {
    emlrtDynamicBoundsCheckR2012b(3, 1, thisData.size(1), &lh_emlrtBCI, sp);
  }
  ...
  st.site = &ag_emlrtRSI;
  nx = thisData.size(0);
  terms.set_size((&qj_emlrtRTEI), (&st), thisData.size(0));
  ...
  b_terms.set_size((&rj_emlrtRTEI), sp, terms.size(0));
  nx = terms.size(0);
  for (idx = 0; idx < nx; idx++) {
  ...
  st.site = &bg_emlrtRSI;
  x.set_size((&sj_emlrtRTEI), (&st), terms.size(0));
  nx = terms.size(0);
  for (idx = 0; idx < nx; idx++) {
  ...
  n.set_size((&tj_emlrtRTEI), (&st), ii.size(0));
  nx = ii.size(0);
  for (idx = 0; idx < nx; idx++) {

...
static emlrtRSInfo mb_emlrtRSI = { 42, // lineNo
  "makeSLDProfileXY",                  // fcnName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/makeSLDProfiles/makeSLDProfileXY.m"// pathName 
};
...
static emlrtRSInfo ob_emlrtRSI = { 47, // lineNo
  "makeSLDProfileXY",                  // fcnName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/makeSLDProfiles/makeSLDProfileXY.m"// pathName 
};
...
static emlrtRSInfo rb_emlrtRSI = { 54, // lineNo
  "makeSLDProfileXY",                  // fcnName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/makeSLDProfiles/makeSLDProfileXY.m"// pathName 
};

static emlrtRSInfo tc_emlrtRSI = { 169,// lineNo
  "colMajorFlatIter",                  // fcnName
  "/usr/local/MATLAB/R2020a/toolbox/eml/lib/matlab/datafun/private/combineVectorElements.m"// pathName 
};

static emlrtRSInfo uc_emlrtRSI = { 187,// lineNo
  "colMajorFlatIter",                  // fcnName
  "/usr/local/MATLAB/R2020a/toolbox/eml/lib/matlab/datafun/private/combineVectorElements.m"// pathName 
};

static emlrtRSInfo yc_emlrtRSI = { 145,// lineNo
...
static emlrtDCInfo sb_emlrtDCI = { 7,  // lineNo
  5,                                   // colNo
  "makeSLDProfileXY",                  // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/makeSLDProfiles/makeSLDProfileXY.m",// pName 
  4                                    // checkKind
...
static emlrtDCInfo tb_emlrtDCI = { 7,  // lineNo
  5,                                   // colNo
  "makeSLDProfileXY",                  // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/makeSLDProfiles/makeSLDProfileXY.m",// pName 
  1                                    // checkKind
...
static emlrtDCInfo ub_emlrtDCI = { 7,  // lineNo
  28,                                  // colNo
  "makeSLDProfileXY",                  // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/makeSLDProfiles/makeSLDProfileXY.m",// pName 
  4                                    // checkKind
...
static emlrtDCInfo vb_emlrtDCI = { 7,  // lineNo
  28,                                  // colNo
  "makeSLDProfileXY",                  // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/makeSLDProfiles/makeSLDProfileXY.m",// pName 
  1                                    // checkKind
...
static emlrtDCInfo wb_emlrtDCI = { 40, // lineNo
  12,                                  // colNo
  "makeSLDProfileXY",                  // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/makeSLDProfiles/makeSLDProfileXY.m",// pName 
  1                                    // checkKind
...
static emlrtDCInfo xb_emlrtDCI = { 37, // lineNo
  12,                                  // colNo
  "makeSLDProfileXY",                  // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/makeSLDProfiles/makeSLDProfileXY.m",// pName 
  1                                    // checkKind
...
static emlrtRTEInfo fh_emlrtRTEI = { 44,// lineNo
  9,                                   // colNo
  "makeSLDProfileXY",                  // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/makeSLDProfiles/makeSLDProfileXY.m"// pName 
};

static emlrtRTEInfo gh_emlrtRTEI = { 50,// lineNo
  5,                                   // colNo
  "makeSLDProfileXY",                  // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/makeSLDProfiles/makeSLDProfileXY.m"// pName 
};

static emlrtRTEInfo hh_emlrtRTEI = { 4,// lineNo
  23,                                  // colNo
  "makeSLDProfileXY",                  // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/makeSLDProfiles/makeSLDProfileXY.m"// pName 
};

static emlrtRTEInfo ih_emlrtRTEI = { 6,// lineNo
  5,                                   // colNo
  "makeSLDProfileXY",                  // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/makeSLDProfiles/makeSLDProfileXY.m"// pName 
};

static emlrtRTEInfo jh_emlrtRTEI = { 7,// lineNo
  5,                                   // colNo
  "makeSLDProfileXY",                  // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/makeSLDProfiles/makeSLDProfileXY.m"// pName 
};

static emlrtRTEInfo kh_emlrtRTEI = { 125,// lineNo
  13,                                  // colNo
  "combineVectorElements",             // fName
  "/usr/local/MATLAB/R2020a/toolbox/eml/lib/matlab/datafun/private/combineVectorElements.m"// pName 
};

static emlrtRTEInfo lh_emlrtRTEI = { 42,// lineNo
  11,                                  // colNo
  "makeSLDProfileXY",                  // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/makeSLDProfiles/makeSLDProfileXY.m"// pName 
};

static emlrtRTEInfo mh_emlrtRTEI = { 42,// lineNo
  5,                                   // colNo
  "makeSLDProfileXY",                  // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/makeSLDProfiles/makeSLDProfileXY.m"// pName 
};

static emlrtRTEInfo nh_emlrtRTEI = { 54,// lineNo
  1,                                   // colNo
  "makeSLDProfileXY",                  // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/makeSLDProfiles/makeSLDProfileXY.m"// pName 
};
                      ...
                      &out)
{
  ...
  if (numberOfLayers > 0.0) {
    ...
    b_layers.set_size((&hh_emlrtRTEI), sp, layers.size(0));
    for (i = 0; i < vstride; i++) {
      b_layers[i] = layers[i];
    }
    ...
    if (muDoubleScalarIsNaN(layerThicks)) {
      x.set_size((&ih_emlrtRTEI), sp, 1, 1);
      x[0] = rtNaN;
    } else if (layerThicks < 0.0) {
      x.set_size((&ih_emlrtRTEI), sp, 1, 0);
    } else if (muDoubleScalarIsInf(layerThicks) && (0.0 == layerThicks)) {
      x.set_size((&ih_emlrtRTEI), sp, 1, 1);
      x[0] = rtNaN;
    } else {
      vstride = static_cast<int32_T>(muDoubleScalarFloor(layerThicks));
      x.set_size((&ih_emlrtRTEI), sp, 1, (vstride + 1));
      for (i = 0; i <= vstride; i++) {
        x[i] = i;
      }
    }

    SLD.set_size((&jh_emlrtRTEI), sp, x.size(1), SLD.size(1));
    d = numberOfLayers * nrepeats;
    if (!(d + 2.0 >= 0.0)) {
      emlrtNonNegativeCheckR2012b(d + 2.0, &ub_emlrtDCI, sp);
    }

    d1 = static_cast<int32_T>(muDoubleScalarFloor(d + 2.0));
    if (d + 2.0 != d1) {
      emlrtIntegerCheckR2012b(d + 2.0, &vb_emlrtDCI, sp);
    }

    i = static_cast<int32_T>(d + 2.0);
    SLD.set_size((&jh_emlrtRTEI), sp, SLD.size(0), i);
    if (!(d + 2.0 >= 0.0)) {
      emlrtNonNegativeCheckR2012b(d + 2.0, &sb_emlrtDCI, sp);
    }

    if (d + 2.0 != d1) {
      emlrtIntegerCheckR2012b(d + 2.0, &tb_emlrtDCI, sp);
    }
    ...
    if (1 > layers.size(0)) {
      emlrtDynamicBoundsCheckR2012b(1, 1, layers.size(0), &hf_emlrtBCI, sp);
    }
    ...
    emlrtForLoopVectorCheckR2012b(1.0, 1.0, nrepeats, mxDOUBLE_CLASS,
      static_cast<int32_T>(nrepeats), &qb_emlrtRTEI, sp);
    for (n = 0; n < xoffset; n++) {
      ...
      for (int32_T b_i = 0; b_i < k; b_i++) {
        ...
        if ((vlen < 1) || (vlen > layers.size(0))) {
          emlrtDynamicBoundsCheckR2012b(vlen, 1, layers.size(0), &af_emlrtBCI,
            sp);
        }
        ...
        vlen = b_i + 1;
        if ((vlen < 1) || (vlen > layers.size(0))) {
          emlrtDynamicBoundsCheckR2012b(vlen, 1, layers.size(0), &gf_emlrtBCI,
            sp);
        }

        vlen = b_i + 1;
        if ((vlen < 1) || (vlen > layers.size(0))) {
          emlrtDynamicBoundsCheckR2012b(vlen, 1, layers.size(0), &ff_emlrtBCI,
            sp);
        }
        ...
        if ((vlen < 1) || (vlen > SLD.size(1))) {
          emlrtDynamicBoundsCheckR2012b(vlen, 1, SLD.size(1), &df_emlrtBCI, sp);
        }
    ...
    // layers(end,3);
    if (x.size(1) < 1) {
      emlrtDynamicBoundsCheckR2012b(x.size(1), 1, x.size(1), &ef_emlrtBCI, sp);
    }

    if (d + 1.0 != static_cast<int32_T>(muDoubleScalarFloor(d + 1.0))) {
      emlrtIntegerCheckR2012b(d + 1.0, &xb_emlrtDCI, sp);
    }

    xoffset = static_cast<int32_T>(d + 1.0);
    if ((xoffset < 1) || (xoffset > SLD.size(1))) {
      emlrtDynamicBoundsCheckR2012b(xoffset, 1, SLD.size(1), &cf_emlrtBCI, sp);
    }
    ...
    if (d + 2.0 != d1) {
      emlrtIntegerCheckR2012b(d + 2.0, &wb_emlrtDCI, sp);
    }

    if ((i < 1) || (i > SLD.size(1))) {
      emlrtDynamicBoundsCheckR2012b(i, 1, SLD.size(1), &bf_emlrtBCI, sp);
    }
    ...
    if ((SLD.size(0) == 0) || (SLD.size(1) == 0)) {
      ...
      b_layers.set_size((&lh_emlrtRTEI), (&c_st), (static_cast<int32_T>(sz_idx_0)));
      ...
      vstride = SLD.size(0);
      b_layers.set_size((&kh_emlrtRTEI), (&d_st), SLD.size(0));
    ...
    SLD.set_size((&mh_emlrtRTEI), sp, b_layers.size(0), 1);
    ...
    int32_T k;
    x.set_size((&eh_emlrtRTEI), sp, 1, 101);
    for (i = 0; i < 101; i++) {
      x[i] = i;
    }
    ...
    SLD.set_size((&fh_emlrtRTEI), sp, 1, 101);
    for (i = 0; i < 101; i++) {
      SLD[i] = i;
    }
    ...
    SLD.set_size((&gh_emlrtRTEI), sp, 1, airBox.size(1));
  ...
  out.set_size((&nh_emlrtRTEI), (&b_st), x.size(1), 2);
  vstride = x.size(1);
  for (i = 0; i < vstride; i++) {
    out[i] = x[i];
  }

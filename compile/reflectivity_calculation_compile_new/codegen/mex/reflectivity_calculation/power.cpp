...
static emlrtRSInfo yb_emlrtRSI = { 70, // lineNo
  "power",                             // fcnName
  "/usr/local/MATLAB/R2020a/toolbox/eml/lib/matlab/ops/power.m"// pathName
};

static emlrtRSInfo ac_emlrtRSI = { 79, // lineNo
  "fltpower",                          // fcnName
  "/usr/local/MATLAB/R2020a/toolbox/eml/lib/matlab/ops/power.m"// pathName
};

static emlrtRSInfo le_emlrtRSI = { 66, // lineNo
  "applyBinaryScalarFunction",         // fcnName
  "/usr/local/MATLAB/R2020a/toolbox/eml/eml/+coder/+internal/applyBinaryScalarFunction.m"// pathName 
};

static emlrtRSInfo me_emlrtRSI = { 188,// lineNo
  "flatIter",                          // fcnName
  "/usr/local/MATLAB/R2020a/toolbox/eml/eml/+coder/+internal/applyBinaryScalarFunction.m"// pathName 
};

static emlrtRTEInfo dj_emlrtRTEI = { 79,// lineNo
  5,                                   // colNo
  "power",                             // fName
           ...
           real_T, 1U> &y)
{
  ...
  y.set_size((&dj_emlrtRTEI), (&b_st), a.size(0));

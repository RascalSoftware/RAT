...
static emlrtRSInfo mg_emlrtRSI = { 26, // lineNo
...
static emlrtRTEInfo fc_emlrtRTEI = { 25,// lineNo
  13,                                  // colNo
...
static emlrtRTEInfo yj_emlrtRTEI = { 5,// lineNo
  1,                                   // colNo
  "resolution_polly_paraPoints",       // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/Resolution_Functions/Simple_Gaussian/resolution_polly_paraPoints.m"// pName 
};

static emlrtRTEInfo ak_emlrtRTEI = { 6,// lineNo
  1,                                   // colNo
  "resolution_polly_paraPoints",       // fName
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/Resolution_Functions/Simple_Gaussian/resolution_polly_paraPoints.m"// pName 
};
  ...
  coder::array<real_T, 1U> &out)
{
  ...
  out.set_size((&yj_emlrtRTEI), sp, loop_ub);
  for (i = 0; i < loop_ub; i++) {
    out[i] = 0.0;
  }

  dummyref.set_size((&ak_emlrtRTEI), sp, ydata.size(0));
    ...
    for (j = 0; j <= loop_ub; j++) {
      ...
      try {
        ...
        emlrtForLoopVectorCheckR2012b(static_cast<real_T>(ilow), 1.0, g,
          mxDOUBLE_CLASS, i2, &fc_emlrtRTEI, &st);
        for (c_i = 0; c_i < i2; c_i++) {
          ...
          if ((b_i < 1) || (b_i > xdata.size(0))) {
            emlrtDynamicBoundsCheckR2012b(b_i, 1, xdata.size(0), &wh_emlrtBCI,
              &b_st);
          }

          if (i1 > xdata.size(0)) {
            emlrtDynamicBoundsCheckR2012b(i1, 1, xdata.size(0), &xh_emlrtBCI,
              &b_st);
          }
          ...
          sumg += g;
          if (i1 > out.size(0)) {
            emlrtDynamicBoundsCheckR2012b(i1, 1, out.size(0), &yh_emlrtBCI, &st);
          }

          if (b_i > dummyref.size(0)) {
            emlrtDynamicBoundsCheckR2012b(b_i, 1, dummyref.size(0), &ai_emlrtBCI,
              &st);
          }

          if (i1 > out.size(0)) {
            emlrtDynamicBoundsCheckR2012b(i1, 1, out.size(0), &bi_emlrtBCI, &st);
          }
        ...
        if (sumg != 0.0) {
          if (i1 > out.size(0)) {
            emlrtDynamicBoundsCheckR2012b(i1, 1, out.size(0), &uh_emlrtBCI, &st);
          }

          if (i1 > out.size(0)) {
            emlrtDynamicBoundsCheckR2012b(i1, 1, out.size(0), &vh_emlrtBCI, &st);
          }

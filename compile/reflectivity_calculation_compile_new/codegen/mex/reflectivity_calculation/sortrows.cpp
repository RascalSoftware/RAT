...
static emlrtRSInfo ve_emlrtRSI = { 24, // lineNo
  "sortrows",                          // fcnName
  "/usr/local/MATLAB/R2020a/toolbox/eml/lib/matlab/datafun/sortrows.m"// pathName 
};

static emlrtRSInfo we_emlrtRSI = { 27, // lineNo
  "sortrows",                          // fcnName
  "/usr/local/MATLAB/R2020a/toolbox/eml/lib/matlab/datafun/sortrows.m"// pathName 
};

static emlrtRSInfo xe_emlrtRSI = { 28, // lineNo
  "sortrows",                          // fcnName
  "/usr/local/MATLAB/R2020a/toolbox/eml/lib/matlab/datafun/sortrows.m"// pathName 
};

static emlrtRSInfo ye_emlrtRSI = { 95, // lineNo
...
static emlrtRSInfo af_emlrtRSI = { 82, // lineNo
  "sortIdx",                           // fcnName
  "/usr/local/MATLAB/R2020a/toolbox/eml/eml/+coder/+internal/sortIdx.m"// pathName 
};

static emlrtRSInfo bf_emlrtRSI = { 86, // lineNo
  "sortIdx",                           // fcnName
  "/usr/local/MATLAB/R2020a/toolbox/eml/eml/+coder/+internal/sortIdx.m"// pathName 
};

static emlrtRSInfo cf_emlrtRSI = { 57, // lineNo
  "mergesort",                         // fcnName
  "/usr/local/MATLAB/R2020a/toolbox/eml/eml/+coder/+internal/mergesort.m"// pathName 
};

static emlrtRSInfo df_emlrtRSI = { 58, // lineNo
  "mergesort",                         // fcnName
  "/usr/local/MATLAB/R2020a/toolbox/eml/eml/+coder/+internal/mergesort.m"// pathName 
};

static emlrtRSInfo ef_emlrtRSI = { 85, // lineNo
  "mergesort",                         // fcnName
  "/usr/local/MATLAB/R2020a/toolbox/eml/eml/+coder/+internal/mergesort.m"// pathName 
};

static emlrtRSInfo ff_emlrtRSI = { 113,// lineNo
  "mergesort",                         // fcnName
  "/usr/local/MATLAB/R2020a/toolbox/eml/eml/+coder/+internal/mergesort.m"// pathName 
};

static emlrtRSInfo if_emlrtRSI = { 39, // lineNo
  "apply_row_permutation",             // fcnName
  "/usr/local/MATLAB/R2020a/toolbox/eml/lib/matlab/datafun/sortrows.m"// pathName 
};

static emlrtRSInfo jf_emlrtRSI = { 40, // lineNo
  "apply_row_permutation",             // fcnName
  "/usr/local/MATLAB/R2020a/toolbox/eml/lib/matlab/datafun/sortrows.m"// pathName 
};

static emlrtRSInfo kf_emlrtRSI = { 43, // lineNo
  "apply_row_permutation",             // fcnName
  "/usr/local/MATLAB/R2020a/toolbox/eml/lib/matlab/datafun/sortrows.m"// pathName 
};

static emlrtRTEInfo pm_emlrtRTEI = { 27,// lineNo
  1,                                   // colNo
  "sortrows",                          // fName
  "/usr/local/MATLAB/R2020a/toolbox/eml/lib/matlab/datafun/sortrows.m"// pName
};

static emlrtRTEInfo qm_emlrtRTEI = { 86,// lineNo
  15,                                  // colNo
  "sortIdx",                           // fName
  "/usr/local/MATLAB/R2020a/toolbox/eml/eml/+coder/+internal/sortIdx.m"// pName
};

static emlrtRTEInfo rm_emlrtRTEI = { 28,// lineNo
  5,                                   // colNo
  "sortrows",                          // fName
  "/usr/local/MATLAB/R2020a/toolbox/eml/lib/matlab/datafun/sortrows.m"// pName
};
...
void sortrows(const emlrtStack *sp, coder::array<real_T, 2U> &y)
{
  ...
  st.site = &we_emlrtRSI;
  n = y.size(0) + 1;
  idx.set_size((&pm_emlrtRTEI), (&st), y.size(0));
  i2 = y.size(0);
  for (j = 0; j < i2; j++) {
    idx[j] = 0;
  }
  ...
  if (y.size(0) == 0) {
    ...
    iwork.set_size((&qm_emlrtRTEI), (&b_st), y.size(0));
    i2 = y.size(0) - 1;
  ...
  st.site = &xe_emlrtRSI;
  i2 = y.size(0);
  ycol.set_size((&rm_emlrtRTEI), (&st), y.size(0));

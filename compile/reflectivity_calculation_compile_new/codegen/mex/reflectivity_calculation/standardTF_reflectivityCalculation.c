...
static emlrtRSInfo f_emlrtRSI = {
    16,      /* lineNo */
    "lower", /* fcnName */
    "/usr/local/MATLAB/R2021b/toolbox/eml/lib/matlab/strfun/lower.m" /* pathName
                                                                      */
};
...
static emlrtRSInfo g_emlrtRSI = {
    ...
    "/usr/local/MATLAB/R2021b/toolbox/eml/lib/matlab/strfun/"
    ...
    emxArray_cell_wrap_14 *allLayers)
{
  ...
  int8_T *t0_calculations_all_chis_data;
  boolean_T p;
  st.prev = sp;
  st.tls = sp->tls;
  b_st.prev = &st;
  ...
  emxInit_int8_T(sp, &t0_calculations_all_chis, &kf_emlrtRTEI);
  ...
  emxFree_int8_T(sp, &t0_calculations_all_chis);
  for (i1 = 0; i1 < ns; i1++) {
  ...
  emxEnsureCapacity_real_T(sp, problem->resample, i1, &jf_emlrtRTEI);
  for (i1 = 0; i1 < loop_ub_tmp; i1++) {
  ...
  for (i = 0; i < loop_ub_tmp; i++) {
    ...
    if (i > ns) {
      emlrtDynamicBoundsCheckR2012b(i, 0, ns, &xb_emlrtBCI, (emlrtCTX)sp);
    }
    i1 = reflectivity_data[i].f1->size[0] * reflectivity_data[i].f1->size[1];
    reflectivity_data[i].f1->size[1] = 2;
    emxEnsureCapacity_real_T(sp, reflectivity_data[i].f1, i1, &kf_emlrtRTEI);
  ...
  i = reflectivity->size[0];
  reflectivity->size[0] = loop_ub_tmp;
  emxEnsureCapacity_cell_wrap_9(sp, reflectivity, i, &lf_emlrtRTEI);
  reflectivity_data = reflectivity->data;
  for (ns = 0; ns < loop_ub_tmp; ns++) {
    ...
    i = reflectivity_data[ns].f1->size[0] * reflectivity_data[ns].f1->size[1];
    reflectivity_data[ns].f1->size[0] = 2;
    emxEnsureCapacity_real_T(sp, reflectivity_data[ns].f1, i, &mf_emlrtRTEI);
    if (ns > reflectivity->size[0] - 1) {
      emlrtDynamicBoundsCheckR2012b(ns, 0, reflectivity->size[0] - 1,
                                    &rb_emlrtBCI, (emlrtCTX)sp);
    }
    i = reflectivity_data[ns].f1->size[0] * reflectivity_data[ns].f1->size[1];
    reflectivity_data[ns].f1->size[1] = 2;
    emxEnsureCapacity_real_T(sp, reflectivity_data[ns].f1, i, &mf_emlrtRTEI);
    i = reflectivity->size[0];
    if (ns > reflectivity->size[0] - 1) {
      emlrtDynamicBoundsCheckR2012b(ns, 0, reflectivity->size[0] - 1,
    ...
    reflectivity_data[ns].f1->data[0] = 1.0;
    if (ns > i - 1) {
      emlrtDynamicBoundsCheckR2012b(ns, 0, i - 1, &jc_emlrtBCI, (emlrtCTX)sp);
    }
    reflectivity_data[ns].f1->data[1] = 1.0;
    if (ns > i - 1) {
      emlrtDynamicBoundsCheckR2012b(ns, 0, i - 1, &jc_emlrtBCI, (emlrtCTX)sp);
    }
    reflectivity_data[ns].f1->data[2] = 1.0;
    if (ns > i - 1) {
      emlrtDynamicBoundsCheckR2012b(ns, 0, i - 1, &jc_emlrtBCI, (emlrtCTX)sp);
    }
    reflectivity_data[ns].f1->data[3] = 1.0;
    if (*emlrtBreakCheckR2012bFlagVar != 0) {
      emlrtBreakCheckR2012b((emlrtCTX)sp);
    }
  }
  ...
  for (i = 0; i < loop_ub_tmp; i++) {
    ...
    if (i > Simulation->size[0] - 1) {
      emlrtDynamicBoundsCheckR2012b(i, 0, Simulation->size[0] - 1, &yb_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    reflectivity_data[i].f1->size[0] = 0;
    if (i > ns) {
      emlrtDynamicBoundsCheckR2012b(i, 0, ns, &yb_emlrtBCI, (emlrtCTX)sp);
    }
    i1 = reflectivity_data[i].f1->size[0] * reflectivity_data[i].f1->size[1];
    reflectivity_data[i].f1->size[1] = 2;
    emxEnsureCapacity_real_T(sp, reflectivity_data[i].f1, i1, &kf_emlrtRTEI);
  ...
  i = Simulation->size[0];
  Simulation->size[0] = loop_ub_tmp;
  emxEnsureCapacity_cell_wrap_9(sp, Simulation, i, &lf_emlrtRTEI);
  reflectivity_data = Simulation->data;
  for (ns = 0; ns < loop_ub_tmp; ns++) {
    ...
    i = reflectivity_data[ns].f1->size[0] * reflectivity_data[ns].f1->size[1];
    reflectivity_data[ns].f1->size[0] = 2;
    emxEnsureCapacity_real_T(sp, reflectivity_data[ns].f1, i, &nf_emlrtRTEI);
    if (ns > Simulation->size[0] - 1) {
      emlrtDynamicBoundsCheckR2012b(ns, 0, Simulation->size[0] - 1,
                                    &sb_emlrtBCI, (emlrtCTX)sp);
    }
  ...
  for (i = 0; i < loop_ub_tmp; i++) {
    ...
    if (i > ns) {
      emlrtDynamicBoundsCheckR2012b(i, 0, ns, &ac_emlrtBCI, (emlrtCTX)sp);
    }
  ...
  i = shifted_data->size[0];
  shifted_data->size[0] = loop_ub_tmp;
  emxEnsureCapacity_cell_wrap_14(sp, shifted_data, i, &lf_emlrtRTEI);
  shifted_data_data = shifted_data->data;
  for (ns = 0; ns < loop_ub_tmp; ns++) {
    ...
    i = shifted_data_data[ns].f1->size[0] * shifted_data_data[ns].f1->size[1];
    shifted_data_data[ns].f1->size[0] = 2;
    emxEnsureCapacity_real_T(sp, shifted_data_data[ns].f1, i, &of_emlrtRTEI);
    if (ns > shifted_data->size[0] - 1) {
      emlrtDynamicBoundsCheckR2012b(ns, 0, shifted_data->size[0] - 1,
                                    &tb_emlrtBCI, (emlrtCTX)sp);
    }
    i = shifted_data_data[ns].f1->size[0] * shifted_data_data[ns].f1->size[1];
    shifted_data_data[ns].f1->size[1] = 3;
    emxEnsureCapacity_real_T(sp, shifted_data_data[ns].f1, i, &of_emlrtRTEI);
    i = shifted_data->size[0];
    if (ns > shifted_data->size[0] - 1) {
      emlrtDynamicBoundsCheckR2012b(ns, 0, shifted_data->size[0] - 1,
    ...
    for (i1 = 0; i1 < 6; i1++) {
      if (ns > i - 1) {
        emlrtDynamicBoundsCheckR2012b(ns, 0, i - 1, &cc_emlrtBCI, (emlrtCTX)sp);
      }
      shifted_data_data[ns].f1->data[i1] = 1.0;
    }
    if (*emlrtBreakCheckR2012bFlagVar != 0) {
      emlrtBreakCheckR2012b((emlrtCTX)sp);
    }
  ...
  for (i = 0; i < loop_ub_tmp; i++) {
    ...
    if (i > layerSlds->size[0] - 1) {
      emlrtDynamicBoundsCheckR2012b(i, 0, layerSlds->size[0] - 1, &bc_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    layerSlds_data[i].f1->size[0] = 0;
    if (i > ns) {
      emlrtDynamicBoundsCheckR2012b(i, 0, ns, &bc_emlrtBCI, (emlrtCTX)sp);
    }
    i1 = layerSlds_data[i].f1->size[0] * layerSlds_data[i].f1->size[1];
    layerSlds_data[i].f1->size[1] = 3;
    emxEnsureCapacity_real_T(sp, layerSlds_data[i].f1, i1, &kf_emlrtRTEI);
    if (*emlrtBreakCheckR2012bFlagVar != 0) {
      emlrtBreakCheckR2012b((emlrtCTX)sp);
    }
  }
  ...
  i = layerSlds->size[0];
  layerSlds->size[0] = loop_ub_tmp;
  emxEnsureCapacity_cell_wrap_10(sp, layerSlds, i, &lf_emlrtRTEI);
  layerSlds_data = layerSlds->data;
  for (ns = 0; ns < loop_ub_tmp; ns++) {
    if (ns > layerSlds->size[0] - 1) {
      emlrtDynamicBoundsCheckR2012b(ns, 0, layerSlds->size[0] - 1, &ub_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    i = layerSlds_data[ns].f1->size[0] * layerSlds_data[ns].f1->size[1];
    layerSlds_data[ns].f1->size[0] = 2;
    emxEnsureCapacity_real_T(sp, layerSlds_data[ns].f1, i, &pf_emlrtRTEI);
    if (ns > layerSlds->size[0] - 1) {
      emlrtDynamicBoundsCheckR2012b(ns, 0, layerSlds->size[0] - 1, &ub_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    i = layerSlds_data[ns].f1->size[0] * layerSlds_data[ns].f1->size[1];
    layerSlds_data[ns].f1->size[1] = 3;
    emxEnsureCapacity_real_T(sp, layerSlds_data[ns].f1, i, &pf_emlrtRTEI);
    i = layerSlds->size[0];
    if (ns > layerSlds->size[0] - 1) {
      emlrtDynamicBoundsCheckR2012b(ns, 0, layerSlds->size[0] - 1, &ub_emlrtBCI,
    ...
    for (i1 = 0; i1 < 6; i1++) {
      if (ns > i - 1) {
        emlrtDynamicBoundsCheckR2012b(ns, 0, i - 1, &ec_emlrtBCI, (emlrtCTX)sp);
      }
      layerSlds_data[ns].f1->data[i1] = 1.0;
    }
    if (*emlrtBreakCheckR2012bFlagVar != 0) {
      emlrtBreakCheckR2012b((emlrtCTX)sp);
    }
  ...
  for (i = 0; i < loop_ub_tmp; i++) {
    ...
    shifted_data_data[i].f1->size[0] = 0;
    if (i > ns) {
      emlrtDynamicBoundsCheckR2012b(i, 0, ns, &dc_emlrtBCI, (emlrtCTX)sp);
    }
    shifted_data_data[i].f1->size[1] = 0;
    if (*emlrtBreakCheckR2012bFlagVar != 0) {
      emlrtBreakCheckR2012b((emlrtCTX)sp);
  ...
  i = sldProfiles->size[0];
  sldProfiles->size[0] = loop_ub_tmp;
  emxEnsureCapacity_cell_wrap_14(sp, sldProfiles, i, &lf_emlrtRTEI);
  shifted_data_data = sldProfiles->data;
  for (ns = 0; ns < loop_ub_tmp; ns++) {
    ...
    i = shifted_data_data[ns].f1->size[0] * shifted_data_data[ns].f1->size[1];
    shifted_data_data[ns].f1->size[0] = 2;
    emxEnsureCapacity_real_T(sp, shifted_data_data[ns].f1, i, &qf_emlrtRTEI);
    if (ns > sldProfiles->size[0] - 1) {
      emlrtDynamicBoundsCheckR2012b(ns, 0, sldProfiles->size[0] - 1,
                                    &vb_emlrtBCI, (emlrtCTX)sp);
    }
    i = shifted_data_data[ns].f1->size[0] * shifted_data_data[ns].f1->size[1];
    shifted_data_data[ns].f1->size[1] = 2;
    emxEnsureCapacity_real_T(sp, shifted_data_data[ns].f1, i, &qf_emlrtRTEI);
    i = sldProfiles->size[0];
    if (ns > sldProfiles->size[0] - 1) {
      emlrtDynamicBoundsCheckR2012b(ns, 0, sldProfiles->size[0] - 1,
    ...
    shifted_data_data[ns].f1->data[0] = 1.0;
    if (ns > i - 1) {
      emlrtDynamicBoundsCheckR2012b(ns, 0, i - 1, &hc_emlrtBCI, (emlrtCTX)sp);
    }
    shifted_data_data[ns].f1->data[1] = 1.0;
    if (ns > i - 1) {
      emlrtDynamicBoundsCheckR2012b(ns, 0, i - 1, &hc_emlrtBCI, (emlrtCTX)sp);
    }
    shifted_data_data[ns].f1->data[2] = 1.0;
    if (ns > i - 1) {
      emlrtDynamicBoundsCheckR2012b(ns, 0, i - 1, &hc_emlrtBCI, (emlrtCTX)sp);
    }
    shifted_data_data[ns].f1->data[3] = 1.0;
    if (*emlrtBreakCheckR2012bFlagVar != 0) {
      emlrtBreakCheckR2012b((emlrtCTX)sp);
    }
  }
  ...
  for (i = 0; i < loop_ub_tmp; i++) {
    ...
    if (i > allLayers->size[0] - 1) {
      emlrtDynamicBoundsCheckR2012b(i, 0, allLayers->size[0] - 1, &fc_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    shifted_data_data[i].f1->size[0] = 0;
    if (i > ns) {
  ...
  i = allLayers->size[0];
  allLayers->size[0] = loop_ub_tmp;
  emxEnsureCapacity_cell_wrap_14(sp, allLayers, i, &lf_emlrtRTEI);
  shifted_data_data = allLayers->data;
  for (ns = 0; ns < loop_ub_tmp; ns++) {
    if (ns > allLayers->size[0] - 1) {
      emlrtDynamicBoundsCheckR2012b(ns, 0, allLayers->size[0] - 1, &wb_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    i = shifted_data_data[ns].f1->size[0] * shifted_data_data[ns].f1->size[1];
    shifted_data_data[ns].f1->size[0] = 2;
    emxEnsureCapacity_real_T(sp, shifted_data_data[ns].f1, i, &rf_emlrtRTEI);
    if (ns > allLayers->size[0] - 1) {
      emlrtDynamicBoundsCheckR2012b(ns, 0, allLayers->size[0] - 1, &wb_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    ...
    for (i1 = 0; i1 < 6; i1++) {
      if (ns > i - 1) {
        emlrtDynamicBoundsCheckR2012b(ns, 0, i - 1, &gc_emlrtBCI, (emlrtCTX)sp);
      }
      shifted_data_data[ns].f1->data[i1] = 1.0;
    }
    if (*emlrtBreakCheckR2012bFlagVar != 0) {
  ...
  if (switch_expression->size[1] == 6) {
    ...
    do {
      exitg1 = 0;
      if (ns < 6) {
        if (switch_expression_data[ns] != b_cv[ns]) {
          exitg1 = 1;
        } else {
          ns++;
        }
  ...
  if (p) {
    ...
    if (switch_expression->size[1] == 13) {
      ...
      do {
        exitg1 = 0;
        if (ns < 13) {
          if (switch_expression_data[ns] != b_cv1[ns]) {
            exitg1 = 1;
          } else {
            ns++;
          }
    ...
    if (p) {
      ...
      if (switch_expression->size[1] == 9) {
        ...
        do {
          exitg1 = 0;
          if (ns < 9) {
            if (switch_expression_data[ns] != cv2[ns]) {
              exitg1 = 1;
            } else {
              ns++;
            }
  ...
  emxInitStruct_struct_T(sp, &b_problem, &yf_emlrtRTEI);
  emxInitStruct_struct_T(sp, &c_problem, &uf_emlrtRTEI);
  switch (ns) {
  case 0:
    ...
    emxEnsureCapacity_real_T(sp, problem->ssubs, i, &tf_emlrtRTEI);
    ...
    emxEnsureCapacity_real_T(sp, problem->backgrounds, i, &tf_emlrtRTEI);
    ...
    emxEnsureCapacity_real_T(sp, problem->qshifts, i, &tf_emlrtRTEI);
    ...
    emxEnsureCapacity_real_T(sp, problem->scalefactors, i, &tf_emlrtRTEI);
    ...
    emxEnsureCapacity_real_T(sp, problem->nbairs, i, &tf_emlrtRTEI);
    ...
    emxEnsureCapacity_real_T(sp, problem->nbsubs, i, &tf_emlrtRTEI);
    ...
    emxEnsureCapacity_real_T(sp, problem->resolutions, i, &tf_emlrtRTEI);
    ...
    emxEnsureCapacity_real_T(sp, problem->allSubRough, i, &tf_emlrtRTEI);
    ...
    emxEnsureCapacity_real_T(sp, problem->resample, i, &tf_emlrtRTEI);
  ...
  case 2:
    ...
    i = problem->ssubs->size[0];
    problem->ssubs->size[0] = b_problem.ssubs->size[0];
    emxEnsureCapacity_real_T(sp, problem->ssubs, i, &xf_emlrtRTEI);
    ns = b_problem.ssubs->size[0];
    for (i = 0; i < ns; i++) {
      problem->ssubs->data[i] = b_problem.ssubs->data[i];
    }
    i = problem->backgrounds->size[0];
    problem->backgrounds->size[0] = b_problem.backgrounds->size[0];
    emxEnsureCapacity_real_T(sp, problem->backgrounds, i, &xf_emlrtRTEI);
    ns = b_problem.backgrounds->size[0];
    for (i = 0; i < ns; i++) {
      problem->backgrounds->data[i] = b_problem.backgrounds->data[i];
    }
    i = problem->qshifts->size[0];
    problem->qshifts->size[0] = b_problem.qshifts->size[0];
    emxEnsureCapacity_real_T(sp, problem->qshifts, i, &xf_emlrtRTEI);
    ns = b_problem.qshifts->size[0];
    for (i = 0; i < ns; i++) {
      problem->qshifts->data[i] = b_problem.qshifts->data[i];
    }
    i = problem->scalefactors->size[0];
    problem->scalefactors->size[0] = b_problem.scalefactors->size[0];
    emxEnsureCapacity_real_T(sp, problem->scalefactors, i, &xf_emlrtRTEI);
    ns = b_problem.scalefactors->size[0];
    for (i = 0; i < ns; i++) {
      problem->scalefactors->data[i] = b_problem.scalefactors->data[i];
    }
    i = problem->nbairs->size[0];
    problem->nbairs->size[0] = b_problem.nbairs->size[0];
    emxEnsureCapacity_real_T(sp, problem->nbairs, i, &xf_emlrtRTEI);
    ns = b_problem.nbairs->size[0];
    for (i = 0; i < ns; i++) {
      problem->nbairs->data[i] = b_problem.nbairs->data[i];
    }
    i = problem->nbsubs->size[0];
    problem->nbsubs->size[0] = b_problem.nbsubs->size[0];
    emxEnsureCapacity_real_T(sp, problem->nbsubs, i, &xf_emlrtRTEI);
    ns = b_problem.nbsubs->size[0];
    for (i = 0; i < ns; i++) {
      problem->nbsubs->data[i] = b_problem.nbsubs->data[i];
    }
    i = problem->resolutions->size[0];
    problem->resolutions->size[0] = b_problem.resolutions->size[0];
    emxEnsureCapacity_real_T(sp, problem->resolutions, i, &xf_emlrtRTEI);
    ns = b_problem.resolutions->size[0];
    for (i = 0; i < ns; i++) {
      problem->resolutions->data[i] = b_problem.resolutions->data[i];
    }
    ...
    i = problem->allSubRough->size[0];
    problem->allSubRough->size[0] = b_problem.allSubRough->size[0];
    emxEnsureCapacity_real_T(sp, problem->allSubRough, i, &xf_emlrtRTEI);
    ns = b_problem.allSubRough->size[0];
    for (i = 0; i < ns; i++) {
      problem->allSubRough->data[i] = b_problem.allSubRough->data[i];
    }
  ...
  emxFreeStruct_struct_T(sp, &c_problem);
  emxFreeStruct_struct_T(sp, &b_problem);

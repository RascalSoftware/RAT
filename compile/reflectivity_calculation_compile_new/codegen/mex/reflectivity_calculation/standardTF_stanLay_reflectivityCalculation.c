    ...
    emxArray_cell_wrap_14 *allLayers)
{
  ...
  emxEnsureCapacity_real_T(sp, problem->ssubs, i1, &ag_emlrtRTEI);
  if (problemDef->numberOfContrasts != i) {
    emlrtIntegerCheckR2012b(problemDef->numberOfContrasts, &h_emlrtDCI,
                            (emlrtCTX)sp);
  }
  ...
  emxEnsureCapacity_real_T(sp, problem->backgrounds, i1, &bg_emlrtRTEI);
  if (loop_ub_tmp != i) {
    emlrtIntegerCheckR2012b(problemDef->numberOfContrasts, &j_emlrtDCI,
                            (emlrtCTX)sp);
  }
  ...
  emxEnsureCapacity_real_T(sp, problem->qshifts, i1, &cg_emlrtRTEI);
  if (loop_ub_tmp != i) {
    emlrtIntegerCheckR2012b(problemDef->numberOfContrasts, &k_emlrtDCI,
                            (emlrtCTX)sp);
  }
  ...
  emxEnsureCapacity_real_T(sp, problem->scalefactors, i1, &dg_emlrtRTEI);
  if (loop_ub_tmp != i) {
    emlrtIntegerCheckR2012b(problemDef->numberOfContrasts, &l_emlrtDCI,
                            (emlrtCTX)sp);
  }
  ...
  emxEnsureCapacity_real_T(sp, problem->nbairs, i1, &eg_emlrtRTEI);
  if (loop_ub_tmp != i) {
    emlrtIntegerCheckR2012b(problemDef->numberOfContrasts, &m_emlrtDCI,
                            (emlrtCTX)sp);
  }
  ...
  emxEnsureCapacity_real_T(sp, problem->nbsubs, i1, &fg_emlrtRTEI);
  if (loop_ub_tmp != i) {
    emlrtIntegerCheckR2012b(problemDef->numberOfContrasts, &n_emlrtDCI,
                            (emlrtCTX)sp);
  }
  ...
  emxEnsureCapacity_real_T(sp, problem->resolutions, i1, &hg_emlrtRTEI);
  if (loop_ub_tmp != i) {
    emlrtIntegerCheckR2012b(problemDef->numberOfContrasts, &p_emlrtDCI,
                            (emlrtCTX)sp);
  }
  ...
  emxEnsureCapacity_real_T(sp, problem->allSubRough, i1, &ig_emlrtRTEI);
  if (loop_ub_tmp != i) {
    emlrtIntegerCheckR2012b(problemDef->numberOfContrasts, &q_emlrtDCI,
                            (emlrtCTX)sp);
  }
  ...
  for (i = 0; i < loop_ub_tmp; i++) {
    ...
    if (i > loop_ub) {
      emlrtDynamicBoundsCheckR2012b(i, 0, loop_ub, &qc_emlrtBCI, (emlrtCTX)sp);
    }
    i1 = reflectivity_data[i].f1->size[0] * reflectivity_data[i].f1->size[1];
    reflectivity_data[i].f1->size[1] = 2;
    emxEnsureCapacity_real_T(sp, reflectivity_data[i].f1, i1, &jg_emlrtRTEI);
  ...
  i = reflectivity->size[0];
  reflectivity->size[0] = loop_ub_tmp;
  emxEnsureCapacity_cell_wrap_9(sp, reflectivity, i, &kg_emlrtRTEI);
  reflectivity_data = reflectivity->data;
  for (loop_ub = 0; loop_ub < loop_ub_tmp; loop_ub++) {
    ...
    if (loop_ub > i - 1) {
      emlrtDynamicBoundsCheckR2012b(loop_ub, 0, i - 1, &cd_emlrtBCI,
                                    (emlrtCTX)sp);
    }
  ...
  for (i = 0; i < loop_ub_tmp; i++) {
    ...
    if (i > Simulation->size[0] - 1) {
      emlrtDynamicBoundsCheckR2012b(i, 0, Simulation->size[0] - 1, &rc_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    reflectivity_data[i].f1->size[0] = 0;
    if (i > loop_ub) {
      emlrtDynamicBoundsCheckR2012b(i, 0, loop_ub, &rc_emlrtBCI, (emlrtCTX)sp);
    }
    i1 = reflectivity_data[i].f1->size[0] * reflectivity_data[i].f1->size[1];
    reflectivity_data[i].f1->size[1] = 2;
    emxEnsureCapacity_real_T(sp, reflectivity_data[i].f1, i1, &jg_emlrtRTEI);
  ...
  i = Simulation->size[0];
  Simulation->size[0] = loop_ub_tmp;
  emxEnsureCapacity_cell_wrap_9(sp, Simulation, i, &kg_emlrtRTEI);
  reflectivity_data = Simulation->data;
  for (loop_ub = 0; loop_ub < loop_ub_tmp; loop_ub++) {
  ...
  for (i = 0; i < loop_ub_tmp; i++) {
    ...
    if (i > loop_ub) {
      emlrtDynamicBoundsCheckR2012b(i, 0, loop_ub, &sc_emlrtBCI, (emlrtCTX)sp);
    }
  ...
  i = shifted_data->size[0];
  shifted_data->size[0] = loop_ub_tmp;
  emxEnsureCapacity_cell_wrap_14(sp, shifted_data, i, &kg_emlrtRTEI);
  shifted_data_data = shifted_data->data;
  for (loop_ub = 0; loop_ub < loop_ub_tmp; loop_ub++) {
    ...
    for (i1 = 0; i1 < 6; i1++) {
      if (loop_ub > i - 1) {
        emlrtDynamicBoundsCheckR2012b(loop_ub, 0, i - 1, &uc_emlrtBCI,
                                      (emlrtCTX)sp);
      }
  ...
  for (i = 0; i < loop_ub_tmp; i++) {
    ...
    if (i > layerSlds->size[0] - 1) {
      emlrtDynamicBoundsCheckR2012b(i, 0, layerSlds->size[0] - 1, &tc_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    layerSlds_data[i].f1->size[0] = 0;
    if (i > loop_ub) {
      emlrtDynamicBoundsCheckR2012b(i, 0, loop_ub, &tc_emlrtBCI, (emlrtCTX)sp);
    }
    i1 = layerSlds_data[i].f1->size[0] * layerSlds_data[i].f1->size[1];
    layerSlds_data[i].f1->size[1] = 3;
    emxEnsureCapacity_real_T(sp, layerSlds_data[i].f1, i1, &jg_emlrtRTEI);
    if (*emlrtBreakCheckR2012bFlagVar != 0) {
      emlrtBreakCheckR2012b((emlrtCTX)sp);
    }
  }
  ...
  i = layerSlds->size[0];
  layerSlds->size[0] = loop_ub_tmp;
  emxEnsureCapacity_cell_wrap_10(sp, layerSlds, i, &kg_emlrtRTEI);
  layerSlds_data = layerSlds->data;
  for (loop_ub = 0; loop_ub < loop_ub_tmp; loop_ub++) {
    ...
    emxEnsureCapacity_real_T(sp, layerSlds_data[loop_ub].f1, i, &og_emlrtRTEI);
    if (loop_ub > layerSlds->size[0] - 1) {
      emlrtDynamicBoundsCheckR2012b(loop_ub, 0, layerSlds->size[0] - 1,
                                    &nc_emlrtBCI, (emlrtCTX)sp);
    }
    ...
    for (i1 = 0; i1 < 6; i1++) {
      if (loop_ub > i - 1) {
        emlrtDynamicBoundsCheckR2012b(loop_ub, 0, i - 1, &wc_emlrtBCI,
                                      (emlrtCTX)sp);
      }
  ...
  for (i = 0; i < loop_ub_tmp; i++) {
    ...
    shifted_data_data[i].f1->size[0] = 0;
    if (i > loop_ub) {
      emlrtDynamicBoundsCheckR2012b(i, 0, loop_ub, &vc_emlrtBCI, (emlrtCTX)sp);
    }
    shifted_data_data[i].f1->size[1] = 0;
    if (*emlrtBreakCheckR2012bFlagVar != 0) {
      emlrtBreakCheckR2012b((emlrtCTX)sp);
  ...
  i = sldProfiles->size[0];
  sldProfiles->size[0] = loop_ub_tmp;
  emxEnsureCapacity_cell_wrap_14(sp, sldProfiles, i, &kg_emlrtRTEI);
  shifted_data_data = sldProfiles->data;
  for (loop_ub = 0; loop_ub < loop_ub_tmp; loop_ub++) {
    ...
    if (loop_ub > i - 1) {
      emlrtDynamicBoundsCheckR2012b(loop_ub, 0, i - 1, &ad_emlrtBCI,
                                    (emlrtCTX)sp);
    }
  ...
  for (i = 0; i < loop_ub_tmp; i++) {
    ...
    if (i > allLayers->size[0] - 1) {
      emlrtDynamicBoundsCheckR2012b(i, 0, allLayers->size[0] - 1, &xc_emlrtBCI,
                                    (emlrtCTX)sp);
    }
    shifted_data_data[i].f1->size[0] = 0;
    if (i > loop_ub) {
  ...
  i = allLayers->size[0];
  allLayers->size[0] = loop_ub_tmp;
  emxEnsureCapacity_cell_wrap_14(sp, allLayers, i, &kg_emlrtRTEI);
  shifted_data_data = allLayers->data;
  for (loop_ub = 0; loop_ub < loop_ub_tmp; loop_ub++) {
    ...
    for (i1 = 0; i1 < 6; i1++) {
      if (loop_ub > i - 1) {
        emlrtDynamicBoundsCheckR2012b(loop_ub, 0, i - 1, &yc_emlrtBCI,
                                      (emlrtCTX)sp);
      }
      shifted_data_data[loop_ub].f1->data[i1] = 1.0;
    }
  ...
  emxEnsureCapacity_real_T(sp, problem->resample, i, &rg_emlrtRTEI);

...
namespace RAT
{
  ...
  {
    void b_coreLayersCalculation(const ::coder::array<real_T, 2U>
      &contrastLayers, real_T rough, const char_T geometry_data[], const int32_T
      geometry_size[2], real_T bulkIn, real_T bulkOut, real_T resample,
      boolean_T calcSld, real_T scalefactor, real_T qzshift, real_T dataPresent,
      const ::coder::array<real_T, 2U> &data, const real_T dataLimits[2], const
      real_T simLimits[2], const real_T repeatLayers[2], real_T background,
      real_T resolution, real_T contrastBackgroundsType, real_T params, const
      real_T resamPars[2], boolean_T useImaginary, ::coder::array<real_T, 2U>
      ...
      chiSq, real_T *ssubs)
    {
      ...
      b_callReflectivity(bulkIn, bulkOut, simLimits, repeatLayers, shiftedData,
                         layerSld, *ssubs, resolution, useImaginary, reflect,
                         simulation);
    ...
    void coreLayersCalculation(const ::coder::array<real_T, 2U> &contrastLayers,
      ...
      contrastBackgroundsType, real_T params, const real_T resamPars[2],

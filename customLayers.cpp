...
#pragma omp parallel for \
 ...
 private(r,r1,r2,r3,d,d1,d2,d3,iv5,iv6,dv2,dv3,iv7,iv8,iv9,c_loop_ub,i2,i3,d_loop_ub)
        ...
        for (int i{0}; i < ub_loop; i++) {
          ...
          loop_ub = r7.size(1);
          layers[i].f1.set_size(r7.size(0), r7.size(1));

...
namespace RAT
{
  ...
  namespace domainsTF
  {
    static void c_contrastCalculation(const real_T backgroundParamIndex_data[],
      ...
      const int32_T resolutionType_size[2], const ::coder::array<cell_wrap_10,
      2U> &customFiles, real_T nParams, const char_T parallel_data[], const
      int32_T parallel_size[2], real_T resampleMinAngle, real_T resampleNPoints,
      ...
      *bulkOutValue, real_T *chi, ::coder::array<real_T, 2U> &reflectivity, ::
      ...
      real_T, 2U> &resolution, cell_wrap_9 layerSld[2], cell_wrap_9 sldProfile[2],
      cell_wrap_9 resampledLayer[2]);
    static void d_contrastCalculation(const real_T backgroundParamIndex_data[],
      ...
      &domainRatios, real_T dataPresent, const ::coder::array<real_T, 2U> &data,
      const real_T dataLimits[2], const real_T simLimits[2], const real_T
      repeatLayers[2], const ::coder::array<cell_wrap_10, 2U> &backgroundType,

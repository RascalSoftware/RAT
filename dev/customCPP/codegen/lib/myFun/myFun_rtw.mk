###########################################################################
## Makefile generated for component 'myFun'. 
## 
## Makefile     : myFun_rtw.mk
## Generated on : Tue Mar 08 18:33:34 2022
## Final product: ./myFun.a
...
START_DIR                 = /Users/arwel/Documents/coding/RAT/dev/customCPP/codegen/lib/myFun
...
SRCS = $(START_DIR)/myFun_data.cpp $(START_DIR)/myFun_initialize.cpp $(START_DIR)/myFun_terminate.cpp $(START_DIR)/myFun.cpp
...
OBJS = myFun_data.o myFun_initialize.o myFun_terminate.o myFun.o
...
myFun_data.o : $(START_DIR)/myFun_data.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


myFun_initialize.o : $(START_DIR)/myFun_initialize.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


myFun_terminate.o : $(START_DIR)/myFun_terminate.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


myFun.o : $(START_DIR)/myFun.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"

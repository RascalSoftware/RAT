...
//
// _coder_matlabEngineCaller_customLayers_api.cpp
//
...
static real_T emlrt_marshallIn(const emlrtStack *sp, const mxArray *contrast,
                               const char_T *identifier);
                               ...
                               const char_T *identifier)
{
  ...
  thisId.fParent = nullptr;
  thisId.bParentIsCell = false;
  y = emlrt_marshallIn(sp, emlrtAlias(contrast), &thisId);
                             ...
                             coder::array<char_T, 2U> &y)
{
  ...
  thisId.fParent = nullptr;
  thisId.bParentIsCell = false;
  emlrt_marshallIn(sp, emlrtAlias(funcName), &thisId, y);
...
void d_matlabEngineCaller_customLaye(const mxArray *const prhs[6], int32_T nlhs,
                                     const mxArray *plhs[2])
{
  coder::array<real_T, 2U> output;
  coder::array<real_T, 2U> params;
  coder::array<char_T, 2U> funcName;
  coder::array<char_T, 2U> funcPath;
  emlrtStack st{
      nullptr, // site
      nullptr, // tls
      nullptr  // prev
  ...
  contrast = emlrt_marshallIn(&st, emlrtAliasP(prhs[1]), "contrast");
  emlrt_marshallIn(&st, emlrtAliasP(prhs[2]), "funcName", funcName);
  emlrt_marshallIn(&st, emlrtAliasP(prhs[3]), "funcPath", funcPath);
  bulkIn = emlrt_marshallIn(&st, emlrtAliasP(prhs[4]), "bulkIn");
  bulkOut = emlrt_marshallIn(&st, emlrtAliasP(prhs[5]), "bulkOut");
  ...
  if (nlhs > 1) {
    plhs[1] = emlrt_marshallOut(sRough);
  }
  emlrtHeapReferenceStackLeaveFcnR2012b(&st);
}

// End of code generation (_coder_matlabEngineCaller_customLayers_api.cpp)

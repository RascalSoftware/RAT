function [problem,reflectivity,Simulation,shifted_data,layerSlds,sldProfiles,allLayers] = domainsTF_reflectivityCalculation(problemDef,problemDef_cells,problemDef_limits,controls)
...
%          allLayers]= domainsTF_stanLay_reflectivityCalculation(problemDef,problemDef_cells,problemDef_limits,controls);
        error('Standard layers domains not yet available');
    case 'custom layers'
        % Custom layers with user supplied custom model file
        [problem,reflectivity,Simulation,...
            shifted_data,layerSlds,sldProfiles,...
            allLayers] = domainsTF_custLay_reflectivityCalculation(problemDef,problemDef_cells,problemDef_limits,controls);
    case 'custom xy'
        % Custom SLD profile with user defined model file
%         [problem,reflectivity,Simulation,...
%            shifted_data,layerSlds,sldProfiles,...
%            allLayers] = domainsTF_custXY_reflectivityCalculation(problemDef,problemDef_cells,problemDef_limits,controls);
        error('Custom XY domains not available yet');
end

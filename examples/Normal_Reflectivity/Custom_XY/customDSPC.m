...
problem = project(name='Orso lipid example - custom XY', model='custom XY');
...
problem.addBacksPar('Backs par SMW',0,1e-7,1e-5,true);
problem.addBacksPar('Backs par H2O',0,1e-7,1e-5,true);

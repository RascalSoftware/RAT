...
% 
% R1 struct is converted into a projectClass using r1ToProjectClass
% 
...
% 
% projectClass is converted into r1 struct using projectClassToR1
% 
...
% The function usage:
%
% First load the projectClass to be converted using the following syntax

...
namespace RAT
{
  double extractProblemParams(const b_ProblemDefinition *problemStruct, char
    ...
    array<cell_wrap_9, 2U> &contrastResolutionParams, ::coder::array<double, 2U>
    &contrastDomainRatios, ::coder::array<double, 2U> &backgroundParams, ::coder::
    array<double, 2U> &scalefactors, ::coder::array<double, 2U> &bulkIns, ::
    coder::array<double, 2U> &bulkOuts, ::coder::array<double, 2U>
    &resolutionParams, ::coder::array<double, 2U> &domainRatios, ::coder::array<
    double, 2U> &dataPresent, ::coder::array<double, 2U> &params, ::coder::array<
    double, 2U> &resample, ::coder::array<cell_wrap_10, 2U>

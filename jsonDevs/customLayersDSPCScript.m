...
D2O_data = dlmread(fullfile('customLayers','c_PLP0016596.dat'));
SMW_data = dlmread(fullfile('customLayers','c_PLP0016601.dat'));
H2O_data = dlmread(fullfile('customLayers','c_PLP0016607.dat'));

...
switch results(1).meth
    ...
    case {'momentg'} % <=================== Geweke NSE, RNE diagnostics
        ...
        fprintf(fid,'Geweke Diagnostics for each parameter \n');
        vs  = 'Variable    ';
        cs1 = 'Mean';
        cs2 = 'std dev';
        cs3 = 'NSE iid';
    ...
    case{'coda'}
        ...
        fprintf(fid,'=================================================== \n');
        fprintf(fid,'MCMC CONVERGENCE diagnostics for chain number %2.0i \n',results(1).chain_number);
        fprintf(fid,'Based on sample size = %10d \n',results(1).ndraw);
        fprintf(fid,'=================================================== \n');

        fprintf(fid,'Autocorrelation for each parameter \n');

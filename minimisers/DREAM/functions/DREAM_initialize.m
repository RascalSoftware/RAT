function [chain,output,X,fx,CR,pCR,lCR,delta_tot,log_L] = DREAM_initialize(DREAMPar,Par_info,Meas_info,chain,output,log_L,ratInputs)
...
[fx] = Evaluate_model(x,DREAMPar,Meas_info,ratInputs);

% Calculate the log-likelihood and log-prior of x (fx)
[log_L_x,log_PR_x] = Calc_density(x,fx,DREAMPar,Par_info,Meas_info,ratInputs);

...
value = {'3','3',num2str(max(max(floor(DREAMPar.T/50),1),50)),'0.05','1e-12','''iqr''','0.2','''yes''','1','0.025'};
% Name variable
...
%Table_gamma = zeros(DREAMPar.delta,zz);
for zz = 1:DREAMPar.delta
    Table_gamma(:,zz) = 2.38./sqrt(2 * zz * [1:DREAMPar.d]');
end

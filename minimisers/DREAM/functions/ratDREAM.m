...
[DREAMPar,paramInfo,chain,output,log_L,Table_gamma,iloc,iteration,...
    gen] = setupDREAM(dreamVariables,paramInfo);
...
[chain,output,X,CR,pCR,lCR,delta_tot,log_L] = initializeDREAM(DREAMPar,paramInfo,chain,output,log_L,ratInputs);
...
for t = T_start : DREAMPar.nGenerations
    ...
    % Calculate log-prior
    log_PR_xnew = calcLogPrior(xnew, ratInputs.priors);

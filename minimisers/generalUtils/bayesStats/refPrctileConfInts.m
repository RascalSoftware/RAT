function allPredInts = refPrctileConfInts(bayesOutputs,problemDefStruct,problemDefCells,problemDefLimits,controlsStruct,result,parConfInts)
...
% cain onto....
firstRow = chain(1,:); 
problemDefStruct.fitParams = firstRow;
...
for i = 1:nsample
    ...
    problemDefStruct.fitParams = thisChain;
    problemDefStruct = unpackParams(problemDefStruct,controlsStruct);

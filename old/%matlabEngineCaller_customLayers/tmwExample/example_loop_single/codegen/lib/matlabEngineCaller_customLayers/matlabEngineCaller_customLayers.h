...
extern void matlabEngineCaller_customLayers(const double params[8], double
  contrast, const char funcName[10], const char funcPath[122], double bulkIn,
  double bulkOut, emxArray_real_T *output, double sRough_data[], int
  sRough_size[2]);

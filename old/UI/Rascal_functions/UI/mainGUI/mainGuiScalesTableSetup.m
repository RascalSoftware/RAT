...
constr = cell2mat(problemStruct.scalefactorConstr(:));
checks = problemStruct.scalefactorFitYesNo;
names = problemStruct.scalefactorNames;
min = constr(:,1);
val = problemStruct.scalefactors;
max = constr(:,2);
rows = length(val);

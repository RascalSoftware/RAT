    ...
    namespace customXY
    {
                          ...
                          1U> &allRoughs)
      {
        ...
        for (int32_T b_i{0}; b_i < loop_ub_tmp; b_i++) {
          ...
          b_callReflectivity(bulkIns[b_i], bulkOuts[b_i], problemCells->f4[b_i].
                             f1, problemCells->f1[b_i].f1, shiftedDat, layerSld,
                             0.0, resolutionParams[b_i], useImaginary, reflect,
                             simulation[b_i].f1);
...
// End of code generation (parallelPoints2.cpp)

...
namespace RAT
{
  static void printParameters(const struct11_T *DREAMPar)
  {
    ...
    bools[0].f1 = f1;
    bools[1].f1 = b_f1;
    coder::strjoin(t7_f1, t7_f2, tmp_data, tmp_size);
    c_f1.set_size(1, 100);
    for (i = 0; i < 100; i++) {
      c_f1[i] = tmp_data[i];
    }
    ...
    rv[1].f1 = d_f1;
    coder::strjoin(rv, r);
    coder::strjoin(r, t8_f2, e_f1);
    coder::c_snPrint(DREAMPar->nChains, f_f1);
    rv[0].f1 = e_f1;
    rv[1].f1 = f_f1;
    coder::strjoin(rv, r);
    coder::strjoin(r, t9_f2, g_f1);
    coder::c_snPrint(DREAMPar->nGenerations, h_f1);
    rv[0].f1 = g_f1;
    rv[1].f1 = h_f1;
    coder::strjoin(rv, r);
    coder::strjoin(r, t10_f2, i_f1);
    t7_f1.set_size(1, 6);
    for (i = 0; i < 5; i++) {
      t7_f1[i] = f1[i];
    }
    ...
    t7_f1[5] = '\x00';
    tmp_size[0] = (*(int32_T (*)[2])t7_f1.size())[0];
    tmp_size[1] = (*(int32_T (*)[2])t7_f1.size())[1];
    coder::snPrint((const char_T *)t7_f1.data(), tmp_size, j_f1);
    rv[0].f1 = i_f1;
    rv[1].f1 = j_f1;
    coder::strjoin(rv, r);
    coder::strjoin(r, t11_f2, k_f1);
    coder::c_snPrint(1.0, l_f1);
    rv[0].f1 = k_f1;
    rv[1].f1 = l_f1;
    coder::strjoin(rv, r);
    coder::strjoin(r, t12_f2, m_f1);
    coder::c_snPrint(DREAMPar->jumpProbability, n_f1);
    rv[0].f1 = m_f1;
    rv[1].f1 = n_f1;
    coder::strjoin(rv, r);
    coder::strjoin(r, t13_f2, o_f1);
    coder::c_snPrint(DREAMPar->pUnitGamma, p_f1);
    rv[0].f1 = o_f1;
    rv[1].f1 = p_f1;
    coder::strjoin(rv, r);
    coder::strjoin(r, t14_f2, q_f1);
    coder::c_snPrint(3.0, r_f1);
    rv[0].f1 = q_f1;
    rv[1].f1 = r_f1;
    coder::strjoin(rv, r);
    coder::strjoin(r, t15_f2, s_f1);
    coder::c_snPrint(3.0, t_f1);
    rv[0].f1 = s_f1;
    rv[1].f1 = t_f1;
    coder::strjoin(rv, r);
    coder::strjoin(r, t16_f2, u_f1);
    coder::c_snPrint(DREAMPar->steps, v_f1);
    rv[0].f1 = u_f1;
    rv[1].f1 = v_f1;
    coder::strjoin(rv, r);
    coder::strjoin(r, t17_f2, w_f1);
    coder::c_snPrint(1.0E-12, x_f1);
    rv[0].f1 = w_f1;
    rv[1].f1 = x_f1;
    coder::strjoin(rv, r);
    coder::strjoin(r, t18_f2, y_f1);
    ...
    rv[1].f1 = ab_f1;
    coder::strjoin(rv, r);
    coder::strjoin(r, t19_f2, bb_f1);
    i = DREAMPar->adaptPCR;
    t7_f1.set_size(1, bools[i].f1.size(1) + 1);
    loop_ub = bools[i].f1.size(1);
    for (int32_T i1{0}; i1 < loop_ub; i1++) {
      t7_f1[i1] = bools[static_cast<int32_T>(DREAMPar->adaptPCR)].f1[i1];
    }

    t7_f1[bools[i].f1.size(1)] = '\x00';
    tmp_size[0] = (*(int32_T (*)[2])t7_f1.size())[0];
    tmp_size[1] = (*(int32_T (*)[2])t7_f1.size())[1];
    coder::snPrint((const char_T *)t7_f1.data(), tmp_size, cb_f1);
    rv[0].f1 = bb_f1;
    rv[1].f1 = cb_f1;
    coder::strjoin(rv, r);
    coder::strjoin(r, t20_f2, db_f1);
    coder::c_snPrint(1.0, eb_f1);
    rv[0].f1 = db_f1;
    rv[1].f1 = eb_f1;
    coder::strjoin(rv, r);
    coder::strjoin(r, t21_f2, fb_f1);
    t7_f1.set_size(1, 6);
    for (i = 0; i < 5; i++) {
      t7_f1[i] = f1[i];
    }
    ...
    tmp_size[0] = (*(int32_T (*)[2])t7_f1.size())[0];
    tmp_size[1] = (*(int32_T (*)[2])t7_f1.size())[1];
    coder::snPrint((const char_T *)t7_f1.data(), tmp_size, gb_f1);
    rv[0].f1 = fb_f1;
    rv[1].f1 = gb_f1;
    coder::strjoin(rv, r);
    coder::strjoin(r, t22_f2, hb_f1);
    coder::c_snPrint(0.025, ib_f1);
    rv[0].f1 = hb_f1;
    rv[1].f1 = ib_f1;
    coder::strjoin(rv, r);
    coder::strjoin(r, t23_f2, jb_f1);
    t7_f1.set_size(1, 6);
    for (i = 0; i < 5; i++) {
      t7_f1[i] = f1[i];
    }
    ...
    tmp_size[0] = (*(int32_T (*)[2])t7_f1.size())[0];
    tmp_size[1] = (*(int32_T (*)[2])t7_f1.size())[1];
    coder::snPrint((const char_T *)t7_f1.data(), tmp_size, kb_f1);
    rv[0].f1 = jb_f1;
    rv[1].f1 = kb_f1;
    coder::strjoin(rv, r);
    coder::strjoin(r, t24_f2, lb_f1);
    t7_f1.set_size(1, 6);
    for (i = 0; i < 5; i++) {
      t7_f1[i] = f1[i];
    }
    ...
    tmp_size[0] = (*(int32_T (*)[2])t7_f1.size())[0];
    tmp_size[1] = (*(int32_T (*)[2])t7_f1.size())[1];
    coder::snPrint((const char_T *)t7_f1.data(), tmp_size, mb_f1);
    rv[0].f1 = lb_f1;
    rv[1].f1 = mb_f1;
    coder::strjoin(rv, r);
    coder::strjoin(r, t25_f2, nb_f1);
    ...
    coder::b_strjoin(t7_f1, t26_f2, r);
    triggerEvent(r);
  }
  ...
  void ratDREAM(real_T dreamVariables_nParams, real_T dreamVariables_nChains,
                ...
                ratInputs_problemStruct, const cell_16 *ratInputs_problemCells,

...
namespace RAT
{
  namespace domainsTF
  {
    static void contrastCalculation(const double backgroundParamIndex_data[],
      ...
      &domainContrastLayers2, const ::coder::array<cell_wrap_47, 2U>
      &outParameterisedLayers, double *qzshiftValue, double *scalefactorValue,
      double *bulkInValue, double *bulkOutValue, double *chi, ::coder::array<
      ...
      coder::array<double, 2U> &resolution, cell_wrap_9 layerSld[2], cell_wrap_7
 ...
 private(r,d,d1,d2,d3,d4,iv5,c_i,iv6,iv7,iv8,iv9,c_loop_ub,i2,i3)
        ...
        for (c_i = 0; c_i <= unnamed_idx_0_tmp_tmp; c_i++) {
          ...
          contrastCalculation((const double *)contrastBackgroundIndices[c_i].
            ...
            char *)contrastBackgroundTypes[c_i].f1.data(), iv7, (const char *)
                              contrastBackgroundActions[c_i].f1.data(), iv8, (
            const char *)contrastResolutionTypes[c_i].f1.data(), iv9,

...
namespace RAT
{
  namespace domainsTF
  {
    static double contrastCalculation(const double backgroundParamIndex_data[],
      ...
      array<double, 2U> &domainContrastLayers1, const ::coder::array<double, 2U>
      &domainContrastLayers2, const ::coder::array<cell_wrap_54, 2U>
      &outParameterisedLayers, ::coder::array<double, 2U> &reflectivity, ::coder::
      array<double, 2U> &simulation, ::coder::array<double, 2U> &shiftedData, ::
      coder::array<double, 2U> &background, ::coder::array<double, 2U>
      &resolution, cell_wrap_65 layerSld[2], cell_wrap_7 sldProfile[2],
      cell_wrap_65 resampledLayer[2], double &scalefactorValue, double
      &bulkInValue, double &bulkOutValue, double &chi);
  }
}
  ...
  namespace domainsTF
  {
      ...
      &bulkInValue, double &bulkOutValue, double &chi)
    {
      ...
      normalTF::coreLayersCalculation(b_data, roughness, geometry_data,
        ...
        reflect1, simul1, a__3, r1.f1, r2.f1);
    ...
    {
      ::coder::array<cell_wrap_54, 2U> outParameterisedLayers;
            ...
            *)((::coder::array<double, 2U> *)
            ...
            const char *)((::coder::array<char, 2U> *)
                          &problemStruct.contrastResolutionTypes[c_i].f1)->data(),
                              ...
                              outParameterisedLayers, reflectivity[c_i].f1,
        ...
        for (int i{0}; i < unnamed_idx_0_tmp_tmp_tmp; i++) {
          ...
          contrastCalculation((const double *)((::coder::array<double, 2U> *)
            &problemStruct.contrastBackgroundParams[i].f1)->data(), iv,
                              ...
                              .f1, b_dv, b_dv1, dv2, (const char *)((::coder::
            array<char, 2U> *)&problemStruct.contrastBackgroundTypes[i].f1)
                              ->data(), iv2, (const char *)((::coder::array<char,
            2U> *)&problemStruct.contrastBackgroundActions[i].f1)->data(), iv3,
                              (const char *)((::coder::array<char, 2U> *)
            &problemStruct.contrastResolutionTypes[i].f1)->data(), iv4,
                              ...
                              outParameterisedLayers, reflectivity[i].f1,
                              simulation[i].f1, r2, backgrounds[i].f1,
                              resolutions[i].f1, layerSlds[i].f1, sldProfiles[i]
 ...
 private(r,d,d1,d2,d3,iv5,iv6,dv3,dv4,dv5,iv7,iv8,iv9,d_loop_ub,i2,i3)
                        ...
                        &subRoughs)
    {
      ...
      numberOfContrasts = extractProblemParams(problemStruct, geometry_data,
        ...
        contrastBackgroundActions, contrastResolutionTypes, a__2, repeatLayers,
        data, dataLimits, simLimits, contrastLayers, layersDetails, customFiles,
        domainContrastLayers, nParams, a__1, useImaginary);
      resampleMinAngle = controls->resampleMinAngle;
      resampleNPoints = controls->resampleNPoints;
...
#pragma omp parallel for \
 num_threads(omp_get_max_threads()) \
 private(r,d,d1,d2,d3,iv5,iv6,dv3,dv4,dv5,iv7,iv8,iv9,c_loop_ub,i2,i3)
        ...
        for (int i{0}; i < unnamed_idx_0_tmp_tmp_tmp; i++) {
          ...
          contrastCalculation((const double *)contrastBackgroundIndices[i].
                              ...
                              backgroundParamArray, scalefactorArray,
                              bulkInArray, bulkOutArray, resolutionParamArray,
                              domainRatioArray, dataPresent[i], data[i].f1, b_dv,
                              b_dv1, dv2, (const char *)
                              contrastBackgroundTypes[i].f1.data(), iv2, (const
            char *)contrastBackgroundActions[i].f1.data(), iv3, (const char *)
                              contrastResolutionTypes[i].f1.data(), iv4,

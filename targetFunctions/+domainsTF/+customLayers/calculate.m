function [problem,reflectivity,Simulation,shifted_data,layerSlds,domainSldProfiles,allLayers] = calculate(problemDef,problemDefCells,problemDefLimits,controls)
...
switch controls.parallel
    case 'single'
          [outSsubs,backgs,qshifts,sfs,nbas,nbss,resols,chis,reflectivity,...
             ...
             allRoughs] = domainsTF.customLayers.single(problemDef,problemDefCells,...
             problemDefLimits,controls);
    case 'points'
          [outSsubs,backgs,qshifts,sfs,nbas,nbss,resols,chis,reflectivity,...
             Simulation,shifted_data,layerSlds,domainSldProfiles,allLayers,...
             allRoughs] = domainsTF.customLayers.parallelPoints(problemDef,problemDefCells,...
             problemDefLimits,controls);    
    case 'contrasts'
          [outSsubs,backgs,qshifts,sfs,nbas,nbss,resols,chis,reflectivity,...
             Simulation,shifted_data,layerSlds,domainSldProfiles,allLayers,...
             allRoughs] = domainsTF.customLayers.parallelContrasts(problemDef,problemDefCells,...
             problemDefLimits,controls);
end

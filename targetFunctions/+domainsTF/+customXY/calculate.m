...
switch controls.parallel
    case 'single'
          [outSsubs,backgs,qshifts,sfs,nbas,nbss,resols,chis,reflectivity,...
             ...
             allRoughs] = domainsTF.customXY.single(problemDef,problemDefCells,...
             problemDefLimits,controls);
    case 'points'
          [outSsubs,backgs,qshifts,sfs,nbas,nbss,resols,chis,reflectivity,...
             Simulation,shifted_data,layerSlds,domainSldProfiles,allLayers,...
             allRoughs] = domainsTF.customXY.parallelPoints(problemDef,problemDefCells,...
             problemDefLimits,controls);
    case 'contrasts'
          [outSsubs,backgs,qshifts,sfs,nbas,nbss,resols,chis,reflectivity,...
             Simulation,shifted_data,layerSlds,domainSldProfiles,allLayers,...
             allRoughs] = domainsTF.customXY.parallelContrasts(problemDef,problemDefCells,...
             problemDefLimits,controls);
end

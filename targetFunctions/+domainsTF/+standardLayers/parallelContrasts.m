...
parfor i = 1:numberOfContrasts
    ...
    % domain
    [sldProfile1,reflect1,Simul1,shifted_dat,layerSld1,resamLayers1,~,thisSsubs]= standardTF.layersCore(thisContrastLayers1, thisRough, ...
    ...
    [sldProfile2,reflect2,Simul2,~,layerSld2,resamLayers2,~,~] = standardTF.layersCore(thisContrastLayers2, thisRough, ...
    geometry, thisNba, thisNbs, thisResample, calcSld, thisSf, thisQshift,...
    thisDataPresent, thisData, thisDataLimits, thisSimLimits, thisRepeatLayers,...
    thisBackground,thisResol,thisBacksType,nParams,parallelPoints,resamPars,useImaginary);

    ...
    if strcmpi(parallel, coderEnums.parallelOptions.Contrasts)
        ...
        parfor i = 1:numberOfContrasts
            ...
            [backgroundParams(i),qzshifts(i),scalefactors(i),bulkIns(i),...
             ...
             resample(i),geometry,allRoughs(i),calcSld,calcAllLayers1{i},...
             calcAllLayers2{i});
...
function [backgroundParamValue,qzshiftValue,scalefactorValue,bulkInValue,...
    ...
    layerSld,sldProfile,allLayer,ssub] = contrastCalculation(backgroundParamIndex,...
    ...
    calcSld,calcAllLayers1,calcAllLayers2)

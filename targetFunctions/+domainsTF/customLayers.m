function [qzshifts,scalefactors,bulkIns,bulkOuts,chis,reflectivity,...
    ...
    [contrastLayers,subRoughs] = domainsTF.customLayers.processCustomFunction(contrastBulkInIndices,contrastBulkOutIndices,...
...
function [qzshiftValue,scalefactorValue,bulkInValue,bulkOutValue,chi,...
    ...
    nParams,parallel,resampleMinAngle,resampleNPoints,resample,geometry, ...
    ...
    % domain
    [sldProfile1,reflect1,simul1,~,layerSld1,resampledLayer1,~] = normalTF.coreLayersCalculation(contrastLayers1,roughness,...
    ...
    [sldProfile2,reflect2,simul2,shiftedData,layerSld2,resampledLayer2,~] = normalTF.coreLayersCalculation(contrastLayers2,roughness,...
     geometry,bulkInValue,bulkOutValue,resample,calcSld,shiftedData,simulationXData,dataIndices,repeatLayers,...
     resolution,background,backgroundAction,nParams,parallel,resampleMinAngle,resampleNPoints);

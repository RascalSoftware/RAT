function [qzshifts,scalefactors,bulkIns,bulkOuts,chis,reflectivity,...
    ...
    switch lower(problemStruct.modelType)
        ...
        case coderEnums.modelTypes.CustomXY
            ...
            [slds1,slds2,subRoughs] = domainsTF.processCustomFunction(...
...
function [reflectivity,simulation,shiftedData,background,resolution,...
    sldProfile,layers,resampledLayers,chi] = contrastLayersCalculation(...
    bulkIn,bulkOut,domainRatio,shiftedData,simulationXData,dataIndices,...
    resolution,background,repeatLayers,backgroundAction,nParams,parallel,...
...
function [reflectivity,simulation,shiftedData,background,resolution,...
    ...
    [reflectivity1,simulation1,~,...
     ...
     ] = normalTF.coreCustomXYCalculation(bulkIn,bulkOut,...
     shiftedData,simulationXData,dataIndices,...
     resolution,background,backgroundAction,...
     parallel,resampleMinAngle,resampleNPoints,roughness,sld1);
    ...
    [reflectivity2,simulation2,shiftedData,...
     ...
     shiftedData,simulationXData,dataIndices,...
     resolution,background,backgroundAction,...
     parallel,resampleMinAngle,resampleNPoints,roughness,sld2);

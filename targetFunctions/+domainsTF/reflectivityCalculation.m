function [problem,reflectivity,Simulation,shifted_data,layerSlds,domainSldProfiles,allLayers] = reflectivityCalculation(problemDef,problemDefCells,problemDefLimits,controls,customClass)
...
switch lower(type)
    case 'standard layers'
        ...
        [problem,reflectivity,Simulation,...
         ...
         allLayers]= domainsTF.standardLayers.calculate(problemDef,problemDefCells,problemDefLimits,controls);
    case 'custom layers'
        % Custom layers with user supplied custom model file
        [problem,reflectivity,Simulation,...
            shifted_data,layerSlds,domainSldProfiles,...
            allLayers] = domainsTF.customLayers.calculate(problemDef,problemDefCells,problemDefLimits,controls);
    case 'custom xy'
        % Custom SLD profile with user defined model file
        [problem,reflectivity,Simulation,...
           shifted_data,layerSlds,domainSldProfiles,...
           allLayers] = domainsTF.customXY.calculate(problemDef,problemDefCells,problemDefLimits,controls);
end
end
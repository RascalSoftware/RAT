function [problem,reflectivity,Simulation,shifted_data,layerSlds,domainSldProfiles,allLayers] = reflectivityCalculation(problemDef,problemDefCells,controls)

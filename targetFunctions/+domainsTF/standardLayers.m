    ...
    if strcmpi(parallel, coderEnums.parallelOptions.Contrasts)
        ...
        parfor i = 1:numberOfContrasts
            ...
            [qzshifts(i),scalefactors(i),bulkIns(i),bulkOuts(i),chis(i),...
             ...
             simulationNPoints,resampleMinAngle,resampleNPoints,resample(i),...
             geometry,subRoughs(i),calcSld,domainContrastLayers1{i},...
...
function [qzshift,scalefactor,bulkIn,bulkOut,chi,reflectivity,simulation,...
    ...
    parallel,simulationNPoints,resampleMinAngle,resampleNPoints,resample,...
    geometry,roughness,calcSld,domainLayersIndices1,domainLayersIndices2,...
    layerValues)

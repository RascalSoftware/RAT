...
function [qzshift,scalefactor,bulkIn,bulkOut,chi,reflectivity,simulation,...
    ...
    resampledLayer] = contrastCalculation(backgroundParamIndex,qzshiftIndex,...
    ...
    % domain
    [reflectivity1,simulation1,~,layerSld1,sldProfile1,resampledLayers1] = normalTF.coreLayersCalculation( ...
        layers1,roughness,geometry,bulkIn,bulkOut,resample,calcSld,shiftedData, ...
        simulationXData,dataIndices,repeatLayers,resolution,background, ...
        backgroundAction,parallel,resampleMinAngle,resampleNPoints);

    [reflectivity2,simulation2,shiftedData,layerSld2,sldProfile2,resampledLayers2] = normalTF.coreLayersCalculation( ...
        layers2,roughness,geometry,bulkIn,bulkOut,resample,calcSld,shiftedData, ...
        simulationXData,dataIndices,repeatLayers,resolution,background, ...
        backgroundAction,parallel,resampleMinAngle,resampleNPoints);
    ...
    resampledLayer = {resampledLayers1, resampledLayers2};

function [backgroundParams,qzshifts,scalefactors,bulkIns,bulkOuts,...
    ...
    sldProfiles,resampledLayers,allRoughs] = customLayers(problemStruct,problemCells,controls)
    ...
    [numberOfContrasts, geometry, contrastBackgroundIndices, contrastQzshiftIndices,...
     ...
     dataPresent, nParams, params, ~, resample, contrastBackgroundsType, cCustFiles,...
    ...
    [resampledLayers,allRoughs] = nonPolarisedTF.customLayers.processCustomFunction(contrastBulkInIndices,contrastBulkOutIndices,...

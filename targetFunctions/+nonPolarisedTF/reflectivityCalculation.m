...
switch lower(type)
    case coderEnums.modelTypes.StandardLayers
        ...
        [outSsubs,backgroundParams,qzshifts,scalefactors,bulkIns,...
         ...
         allRoughs] = nonPolarisedTF.standardLayers.standardLayers(problemStruct,problemCells,controls);
    ...
    case coderEnums.modelTypes.CustomLayers
        ...
        [outSsubs,backgroundParams,qzshifts,scalefactors,bulkIns,...
         bulkOuts,resolutionParams,chis,reflectivity,simulation,...
         shiftedData,layerSlds,sldProfiles,allLayers,...
         allRoughs] = nonPolarisedTF.customLayers.customLayers(problemStruct,problemCells,controls);
    ...
    case coderEnums.modelTypes.CustomXY
        ...
        [outSsubs,backgroundParams,qzshifts,scalefactors,bulkIns,...
         bulkOuts,resolutionParams,chis,reflectivity,simulation,...
         shiftedData,layerSlds,sldProfiles,allLayers,...
         allRoughs] = nonPolarisedTF.customXY.customXY(problemStruct,problemCells,controls);

function [backgroundParams,qzshifts,scalefactors,bulkIns,bulkOuts,...
    ...
    backgroundParams = problemStruct.contrastBackgroundParams;
    if any(backgroundParams(:,1) == -2)
        customFiles = problemCells{14};
        newData = applyBackgroundFunction(backgroundParams,data,customFiles,backgroundParamArray);
        data = newData;
    end

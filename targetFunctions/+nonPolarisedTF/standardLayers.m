function [qzshifts,scalefactors,bulkIns,bulkOuts,...
    ...
    if strcmpi(parallel, coderEnums.parallelOptions.Contrasts)
        ...
        parfor i = 1:numberOfContrasts
            ...
            [qzshifts(i),scalefactors(i),bulkIns(i),...
             ...
             sldProfiles{i},resampledLayers{i}...
                    ...
                    contrastBackgroundTypes{i},contrastBackgroundActions(i),customFiles,nParams,parallel,resampleMinAngle,resampleNPoints,...
        ...
        for i = 1:numberOfContrasts
            ...
            [qzshifts(i),...
                scalefactors(i),bulkIns(i),...
                bulkOuts(i),resolutionParams(i),...
                chis(i),reflectivity{i},...
                simulation{i},shiftedData{i},backgrounds{i},...
                layerSlds{i},sldProfiles{i},...
                resampledLayers{i}] = contrastCalculation(contrastBackgroundIndices(i,:),...
                    contrastQzshiftIndices(i),contrastScalefactorIndices(i),...
                    contrastBulkInIndices(i),contrastBulkOutIndices(i), ...
                    contrastResolutionParamIndices(i),backgroundParamArray,...
                    qzshiftArray,scalefactorArray,bulkInArray,...
                    bulkOutArray,resolutionParamArray,...
                    dataPresent(i),data{i},dataLimits{i},...
                    simLimits{i},repeatLayers{i},...
                    contrastBackgroundTypes{i},contrastBackgroundActions(i),customFiles,nParams,parallel,...
                    resampleMinAngle,resampleNPoints,...
                    useImaginary,resample(i),geometry,...
...
function [qzshiftValue,...
        ...
        resampledLayer] = contrastCalculation(backgroundParamIndex,...
                ...
                backgroundType,backgroundAction, ...
    ...
    [qzshiftValue,scalefactorValue,bulkInValue,bulkOutValue,...
        resolutionParamValue] = backSort(qzshiftIndex,scalefactorIndex,...
        bulkInIndex,bulkOutIndex,resolutionParamIndex,...
    ...
    [sldProfile,reflectivity,...
     ...
     chi] = nonPolarisedTF.coreLayersCalculation(thisContrastLayers,roughness,...
                                ...
                                resample,calcSld,shiftedData,simLimits,repeatLayers,...
                                resolutionParamValue,...
                                background,backgroundAction,nParams,...

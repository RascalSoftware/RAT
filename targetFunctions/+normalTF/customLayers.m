function [qzshifts,scalefactors,bulkIns,bulkOuts,chis,reflectivity,...
    ...
    [contrastLayers,subRoughs] = normalTF.customLayers.processCustomFunction(contrastBulkInIndices,contrastBulkOutIndices,...
...
function [qzshift,scalefactor,bulkIn,bulkOut,chi,reflectivity,simulation,...
    ...
    resample,geometry,roughness,calcSld,layers)
    ...
    [reflectivity,simulation,shiftedData,layerSld,sldProfile,...
        resampledLayer] = normalTF.coreLayersCalculation(layers,roughness,...

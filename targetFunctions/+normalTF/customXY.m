function [qzshifts,scalefactors,bulkIns,bulkOuts,...
    ...
    sldProfiles,resampledLayers,subRoughs] = customXY(problemStruct,controls)
    ...
    if strcmpi(parallel, coderEnums.parallelOptions.Contrasts)
        ...
        parfor i = 1:numberOfContrasts
            ...
            [qzshifts(i),scalefactors(i),bulkIns(i),...
             ...
             useImaginary,subRoughs(i),sldProfiles{i});
        end
...
function [qzshiftValue,scalefactorValue,bulkInValue,...
    ...
    backgroundAction,resolutionType,customFiles,nParams,parallel,resampleMinAngle,resampleNPoints,useImaginary,roughness,sldProfile)

        ...
        if strcmpi(parallel, coderEnums.parallelOptions.Contrasts)
            ...
            parfor i = 1:numberOfContrasts
                ...
                [reflectivity{i},simulation{i},shiftedData{i},...
                 ...
                 repeatLayers(i),resolutions{i},backgrounds{i},...
...
function [background,resolution,shiftedData,simulationXData,dataIndices...
    ] = setupCalculation(backgroundParamIndex,resolutionParamIndex,...
    backgroundParams,resolutionParams,qzshift,scalefactor,...
    dataPresent,data,dataLimits,simulationLimits,backgroundType,...
    resolutionType,customFiles,numSimulationPoints)

    ...
    if strcmpi(problemStruct.modelType, coderEnums.modelTypes.CustomXY)
        ...
        if strcmpi(parallel, coderEnums.parallelOptions.Contrasts)
            ...
            parfor i = 1:numberOfContrasts
                ...
                [backgrounds{i},resolutions{i},shiftedData{i},simulationXData,dataIndices...
                 ] = setupCalculation(contrastBackgroundIndices{i},...
                 contrastResolutionIndices{i},backgroundParamValues,resolutionParamValues,qzshifts(i),scalefactors(i),...
                 dataPresent(i),data{i},dataLimits{i},simulationLimits{i},...
                 contrastBackgroundTypes{i},contrastResolutionTypes{i},customFiles,numSimulationPoints);
        
                [reflectivity{i},simulation{i},shiftedData{i},...
                 sldProfiles{i},layers{i},resampledLayers{i},chis(i)...
                 ] = customXYContrastCalculation(bulkIns(i),bulkOuts(i),...
                 shiftedData{i},simulationXData,dataIndices,...
                 resolutions{i},backgrounds{i},contrastBackgroundActions{i},...
        ...
        if strcmpi(parallel, coderEnums.parallelOptions.Contrasts)
            ...
            parfor i = 1:numberOfContrasts
                ...
                [reflectivity{i},simulation{i},shiftedData{i},sldProfiles{i},layers{i},...
                 resampledLayers{i}] = normalTF.coreLayersCalculation(contrastLayers{i},subRoughs(i),...
                 geometry,bulkIns(i),bulkOuts(i),resample(i),calcSld,shiftedData{i},simulationXData,dataIndices,repeatLayers(i),...
                 resolutions{i},backgrounds{i},contrastBackgroundActions{i},parallel,resampleMinAngle,resampleNPoints);

                chis(i) = chiSquared(shiftedData{i},reflectivity{i},nParams);
...
function [reflectivity,simulation,...

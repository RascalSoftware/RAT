function [problem,reflectivity,Simulation,shifted_data,layerSlds,sldProfiles,allLayers] = calculate(problemDef,problemDefCells,problemDefLimits,controls,customClass)
...
switch controls.parallel
    case 'single'
          [outSsubs,backgs,qshifts,sfs,nbas,nbss,resols,chis,reflectivity,...
             ...
             allRoughs] = standardTF.customXY.single(problemDef,problemDefCells,...
             problemDefLimits,controls);
    case 'points'
          [outSsubs,backgs,qshifts,sfs,nbas,nbss,resols,chis,reflectivity,...
             Simulation,shifted_data,layerSlds,sldProfiles,allLayers,...
             allRoughs] = standardTF.customXY.parallelPoints(problemDef,problemDefCells,...
             problemDefLimits,controls);
    case 'contrasts'
          [outSsubs,backgs,qshifts,sfs,nbas,nbss,resols,chis,reflectivity,...
             Simulation,shifted_data,layerSlds,sldProfiles,allLayers,...
             allRoughs] = standardTF.customXY.parallelContrasts(problemDef,problemDefCells,...
             problemDefLimits,controls);
end

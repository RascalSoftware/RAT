...
function [output,subRough] = callCppFuncXY(params,nba,nbs,numberOfContrasts,libraryName,functionName)

    % Use 3rd party 'dylib.hpp' to implement a cross-platform Cpp runtime
    % class loader.... https://github.com/martin-olivier/dylib

    % This version is required since cusrom XY is [n x 2] array whereas
    % custom layers is [n x 3]

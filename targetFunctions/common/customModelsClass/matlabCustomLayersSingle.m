...
function [output, sRough] = matlabCustomLayersSingle(cBacks,cShifts,cScales,cNbas,cNbss,cRes,backs,...
    shifts,sf,nba,nbs,res,thisCustomFile,params,i,numberOfContrasts)

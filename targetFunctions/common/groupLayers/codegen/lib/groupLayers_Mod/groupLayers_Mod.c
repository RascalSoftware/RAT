                     ...
                     emxArray_real_T *outLayers, double *outSsubs)
{
  ...
  rsub = allRoughs;
  i0 = layers->size[0] * layers->size[1];
  layers->size[0] = 0;
  layers->size[1] = 0;
  emxEnsureCapacity((emxArray__common *)layers, i0, (int)sizeof(double));
  if (!((allLayers->size[0] == 0) || (allLayers->size[1] == 0))) {
    ...
    switch (kstr) {
     case 0:
      ...
      for (i0 = 0; i0 < loop_ub; i0++) {
        layers->data[i0] = allLayers->data[i0];
      }
     ...
     case 1:
      ...
      emxEnsureCapacity((emxArray__common *)sldss, i0, (int)sizeof(double));
      for (i0 = 0; i0 < loop_ub; i0++) {
        sldss->data[i0] = allLayers->data[i0 + allLayers->size[0]];
      }
      ...
      emxEnsureCapacity((emxArray__common *)thicks, i0, (int)sizeof(double));
      for (i0 = 0; i0 < loop_ub; i0++) {
        thicks->data[i0] = allLayers->data[i0];
      }

      i0 = allLayers->size[0] - 1;
      rsub = allLayers->data[i0 + (allLayers->size[0] << 1)];
      i0 = allLayers->size[0];
      if (1 > i0 - 1) {
        i0 = 0;
      } else {
      ...
      for (i0 = 0; i0 <= b_loop_ub; i0++) {
        roughs->data[i0 + 1] = b_allLayers->data[i0];
      }
      ...
      if (allLayers->size[1] == 5) {
        ...
        i0 = c_allLayers->size[0];
        c_allLayers->size[0] = d_loop_ub;
        emxEnsureCapacity((emxArray__common *)c_allLayers, i0, (int)sizeof
                          (double));
        for (i0 = 0; i0 < d_loop_ub; i0++) {
          c_allLayers->data[i0] = allLayers->data[i0 + allLayers->size[0] * 3];
        }
        ...
        emxEnsureCapacity((emxArray__common *)layers, i0, (int)sizeof(double));
        for (i0 = 0; i0 < loop_ub; i0++) {
          layers->data[i0] = thicks->data[i0];
        }

        for (i0 = 0; i0 < b_loop_ub; i0++) {
          layers->data[i0 + layers->size[0]] = sldss->data[i0];
        }

        for (i0 = 0; i0 < kstr; i0++) {
          layers->data[i0 + (layers->size[0] << 1)] = roughs->data[i0];
        }

        for (i0 = 0; i0 < c_loop_ub; i0++) {
          layers->data[i0 + layers->size[0] * 3] = c_allLayers->data[i0];
        }
    ...
    for (i0 = 0; i0 < 2; i0++) {
      n[i0] = (unsigned int)allLayers->size[i0];
    }
  ...
  i0 = outLayers->size[0] * outLayers->size[1];
  outLayers->size[0] = loop_ub;
  outLayers->size[1] = 3;
  emxEnsureCapacity((emxArray__common *)outLayers, i0, (int)sizeof(double));
  for (i0 = 0; i0 < 3; i0++) {
    for (kstr = 0; kstr < loop_ub; kstr++) {
      outLayers->data[kstr + outLayers->size[0] * i0] = layers->data[kstr +
        layers->size[0] * i0];
    }
  }

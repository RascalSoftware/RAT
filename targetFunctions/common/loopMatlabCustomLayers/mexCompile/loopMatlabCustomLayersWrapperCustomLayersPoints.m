function [allLayers, allRoughs] = loopMatlabCustomLayersWrapperCustomLayersPoints(cBacks,cShifts,cScales,cNbas,cNbss,cRes,backs,...
 ...
 [tempAllLayers, tempAllRoughs] = feval('loopMatlabCustomLayersPoints',cBacks,cShifts,cScales,cNbas,cNbss,cRes,backs,...
     shifts,sf,nba,nbs,res,cCustFiles,numberOfContrasts,customFiles,params);

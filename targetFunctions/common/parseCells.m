function [repeatLayers,data,dataLimits,simLimits,contrastLayers,layersDetails,customFiles,domainContrastLayers] = parseCells(problemCells)
...
%     * domainContrastLayers: Which specific combination of arrays are needed for each domain contrast.
...
customFiles = problemCells{7};
domainContrastLayers = problemCells{8};

...
switch para
    case 'single'
          ...
          [outSsubs,backgs,qshifts,sfs,nbas,nbss,resols,chis,reflectivity,...
             ...
             allRoughs] = domainsTF_custlay_single(problemDef,problemDef_cells,...
...
%           [outSsubs,backgs,qshifts,sfs,nbas,nbss,resols,chis,reflectivity,...
%              Simulation,shifted_data,layerSlds,sldProfiles,allLayers,...
%              allRoughs] = domainsTF_custlay_paraPoints(problemDef,problemDef_cells,...
%              problemDef_limits,controls);
%          
%     case 'contrasts'
%         
%           [outSsubs,backgs,qshifts,sfs,nbas,nbss,resols,chis,reflectivity,...
%              Simulation,shifted_data,layerSlds,sldProfiles,allLayers,...
%              allRoughs] = domainsTF_custlay_paraContrasts(problemDef,problemDef_cells,...
%              problemDef_limits,controls);

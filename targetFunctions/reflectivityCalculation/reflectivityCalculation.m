function [problem,result] = reflectivityCalculation(problemDef,problemDefCells,problemDefLimits,domains,domainsCells,controls)
...
switch whichTF
    ...
    %case 'domains'
        %[problem,reflectivity,Simulation,shifted_data,layerSlds,sldProfiles,allLayers] = domainsTF_reflectivityCalculation(problemDef,problemDefCells,problemDefLimits,domains,domainsCells,controls);
    %otherwise

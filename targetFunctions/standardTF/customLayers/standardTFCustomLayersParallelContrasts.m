...
case 'matlab'
    ...
    [allLayers, allRoughs] = loopMatlabCustomLayersWrapperCustomLayersContrast(cBacks,cShifts,cScales,cNbas,cNbss,cRes,backs,...
    shifts,sf,nba,nbs,res,cCustFiles,numberOfContrasts,customFiles,params);
case 'cpp'
    [allLayers,allRoughs] = loopCppCustomLayersWrapperCustomLayersContrast(cBacks,cShifts,cScales,cNbas,cNbss,cRes,backs,...
    shifts,sf,nba,nbs,res,cCustFiles,numberOfContrasts,customFiles,params);
end

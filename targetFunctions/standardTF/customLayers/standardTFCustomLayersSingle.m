...
case 'matlab'
    ...
    [allLayers, allRoughs] = loopMatlabCustomLayersWrapperCustomLayersSingle(cBacks,cShifts,cScales,cNbas,cNbss,cRes,backs,...
    shifts,sf,nba,nbs,res,cCustFiles,numberOfContrasts,customFiles,params);
case 'cpp'
    [allLayers,allRoughs] = loopCppCustomLayersWrapperCustomLayersSingle(cBacks,cShifts,cScales,cNbas,cNbss,cRes,backs,...
    shifts,sf,nba,nbs,res,cCustFiles,numberOfContrasts,customFiles,params); 
end

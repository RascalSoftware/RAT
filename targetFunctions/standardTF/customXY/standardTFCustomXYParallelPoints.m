function [outSsubs,backgs,qshifts,sfs,nbas,nbss,resols,chis,reflectivity,...
    ...
    allRoughs] = standardTFCustomXYParallelPoints(problemDef,problemDef_cells,...
...
case 'matlab'
    ...
    [sldProf, allRoughs] = loopMatlabCustomLayersWrapperXYPoints(cBacks,cShifts,cScales,cNbas,cNbss,cRes,backs,...
    shifts,sf,nba,nbs,res,cCustFiles,numberOfContrasts,customFiles,params);
% 
case 'cpp'
    [sldProf,allRoughs] = loopCppCustomLayersWrapperXYPoints(cBacks,cShifts,cScales,cNbas,cNbss,cRes,backs,...
    shifts,sf,nba,nbs,res,cCustFiles,numberOfContrasts,customFiles,params);

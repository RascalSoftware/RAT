function [problem,reflectivity,Simulation,shifted_data,layerSlds,sldProfiles,allLayers] = standardTFCustomLayersReflectivityCalculation(problemDef,problemDefCells,problemDefLimits,controls)
...
switch para
    ...
    case 'points'
          ...
          [outSsubs,backgs,qshifts,sfs,nbas,nbss,resols,chis,reflectivity,...
             Simulation,shifted_data,layerSlds,sldProfiles,allLayers,...
             allRoughs] = standardTFCustomLayersParallelPoints(problemDef,problemDefCells,...
             problemDefLimits,controls);
    ...
    case 'contrasts'
          ...
          [outSsubs,backgs,qshifts,sfs,nbas,nbss,resols,chis,reflectivity,...
             Simulation,shifted_data,layerSlds,sldProfiles,allLayers,...
             allRoughs] = standardTFCustomLayersParallelContrasts(problemDef,problemDefCells,...
             problemDefLimits,controls);

%           [outSsubs,backgs,qshifts,sfs,nbas,nbss,resols,chis,reflectivity,...
%              Simulation,shifted_data,layerSlds,sldProfiles,allLayers,...
%              allRoughs] = dev_custlay_paraContrasts(problemDef,problemDefCells,...
%              problemDefLimits,controls);

 ...
 *
 * _coder_standardTF_custlay_parallel_api.h
 *
 * Code generation for function '_coder_standardTF_custlay_parallel_api'
 *
 */

#ifndef _CODER_STANDARDTF_CUSTLAY_PARALLEL_API_H
#define _CODER_STANDARDTF_CUSTLAY_PARALLEL_API_H
...
typedef struct sgvqTPMhaUJUFDHFGDwCvAB cell_wrap_4;
...
extern void standardTF_custlay_parallel(emxArray_real_T *resam, real_T
  ...
  *cNbas, emxArray_real_T *cNbss, emxArray_real_T *cRes, emxArray_real_T *backs,
  ...
  emxArray_cell_wrap_1 *allData, emxArray_cell_wrap_0 *dataLimits,
  emxArray_cell_wrap_0 *simLimits, emxArray_cell_wrap_0 *repeatLayers, real_T
  nParams, emxArray_real_T *params, emxArray_cell_wrap_2 *contrastLayers, real_T
  numberOfLayers, real_T whichType, emxArray_char_T *fileHandle, emxArray_char_T
  *path, emxArray_real_T *outSsubs, emxArray_real_T *backgs, emxArray_real_T
  *qshifts, emxArray_real_T *sfs, emxArray_real_T *nbas, emxArray_real_T *nbss,
...
extern void standardTF_custlay_parallel_api(const mxArray *prhs[31], const
  mxArray *plhs[15]);
extern void standardTF_custlay_parallel_atexit(void);
extern void standardTF_custlay_parallel_initialize(void);
extern void standardTF_custlay_parallel_terminate(void);
extern void standardTF_custlay_parallel_xil_terminate(void);

#endif

/* End of code generation (_coder_standardTF_custlay_parallel_api.h) */

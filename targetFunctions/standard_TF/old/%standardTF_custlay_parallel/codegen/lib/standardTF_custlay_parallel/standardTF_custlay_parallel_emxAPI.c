 ...
 *
 * standardTF_custlay_parallel_emxAPI.c
 *
 * Code generation for function 'standardTF_custlay_parallel_emxAPI'
 *
 */
...
emxArray_cell_wrap_2 *emxCreateWrapperND_cell_wrap_2(int numDimensions, int
  *size)
{
  emxArray_cell_wrap_2 *emx;
  int numEl;
...
emxArray_cell_wrap_2 *emxCreateWrapper_cell_wrap_2(int rows, int cols)
{
  emxArray_cell_wrap_2 *emx;
  int size[2];
  int numEl;
...
/* End of code generation (standardTF_custlay_parallel_emxAPI.c) */

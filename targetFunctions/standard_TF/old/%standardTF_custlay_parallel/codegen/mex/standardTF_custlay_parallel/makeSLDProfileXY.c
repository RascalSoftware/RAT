                      ...
                      real_T nrepeats, emxArray_real_T *out)
{
  ...
  if (numberOfLayers > 0.0) {
    ...
    i9 = layers->size[0];
    if (!(1 <= i9)) {
      emlrtDynamicBoundsCheckR2012b(1, 1, i9, &sc_emlrtBCI, sp);
    }
    ...
    while (vstride <= (int32_T)nrepeats - 1) {
      ...
      while (k <= (int32_T)numberOfLayers - 1) {
        ...
        mtmp = k + 1;
        if (!((mtmp >= 1) && (mtmp <= i9))) {
          emlrtDynamicBoundsCheckR2012b(mtmp, 1, i9, &rc_emlrtBCI, sp);
        }

        i9 = layers->size[0];
        mtmp = k + 1;
        if (!((mtmp >= 1) && (mtmp <= i9))) {
          emlrtDynamicBoundsCheckR2012b(mtmp, 1, i9, &qc_emlrtBCI, sp);
        }

        i9 = layers->size[0];
        mtmp = k + 1;
        if (!((mtmp >= 1) && (mtmp <= i9))) {
          emlrtDynamicBoundsCheckR2012b(mtmp, 1, i9, &pc_emlrtBCI, sp);
        }
        ...
        if (1.0 + (real_T)k < numberOfLayers) {
          ...
          if (!((mtmp >= 1) && (mtmp <= i9))) {
            emlrtDynamicBoundsCheckR2012b(mtmp, 1, i9, &tc_emlrtBCI, sp);
          }
        ...
        i9 = r2->size[0];
        r2->size[0] = vlen;
        emxEnsureCapacity(sp, (emxArray__common *)r2, i9, (int32_T)sizeof
                          (int32_T), &i_emlrtRTEI);
        for (i9 = 0; i9 < vlen; i9++) {
          r2->data[i9] = i9;
        }
        ...
        mtmp = (int32_T)((1.0 + (real_T)k) + numberOfLayers * ((1.0 + (real_T)
          vstride) - 1.0));
        if (!((mtmp >= 1) && (mtmp <= i9))) {
          emlrtDynamicBoundsCheckR2012b(mtmp, 1, i9, &mc_emlrtBCI, sp);
        }

        i9 = mtmp - 1;
        iv2[0] = r2->size[0];
        emlrtSubAssignSizeCheckR2012b(iv2, 1, *(int32_T (*)[2])thisBox->size, 2,
          &d_emlrtECI, sp);
        vlen = r2->size[0];
        for (mtmp = 0; mtmp < vlen; mtmp++) {
          Lays->data[r2->data[mtmp] + Lays->size[0] * i9] = thisBox->data[mtmp];
        }
    ...
    mtmp = x->size[1];
    if (!((mtmp >= 1) && (mtmp <= i9))) {
      emlrtDynamicBoundsCheckR2012b(mtmp, 1, i9, &oc_emlrtBCI, sp);
    }

    i9 = x->size[1];
    mtmp = x->size[1];
    if (!((mtmp >= 1) && (mtmp <= i9))) {
      emlrtDynamicBoundsCheckR2012b(mtmp, 1, i9, &nc_emlrtBCI, sp);
    }

    vlen = Lays->size[0];
    i9 = r2->size[0];
    r2->size[0] = vlen;
    emxEnsureCapacity(sp, (emxArray__common *)r2, i9, (int32_T)sizeof(int32_T),
                      &i_emlrtRTEI);
    for (i9 = 0; i9 < vlen; i9++) {
      r2->data[i9] = i9;
    }
    ...
    if (!((mtmp >= 1) && (mtmp <= i9))) {
      emlrtDynamicBoundsCheckR2012b(mtmp, 1, i9, &lc_emlrtBCI, sp);
    }
    ...
    iv1[0] = r2->size[0];
    emlrtSubAssignSizeCheckR2012b(iv1, 1, *(int32_T (*)[2])thisBox->size, 2,
      &c_emlrtECI, sp);
    vlen = r2->size[0];
    for (mtmp = 0; mtmp < vlen; mtmp++) {
      Lays->data[r2->data[mtmp] + Lays->size[0] * i9] = thisBox->data[mtmp];
    ...
    mtmp = (int32_T)layerThicks;
    if (!((mtmp >= 1) && (mtmp <= i9))) {
      emlrtDynamicBoundsCheckR2012b(mtmp, 1, i9, &kc_emlrtBCI, sp);
    }

    i9 = mtmp - 1;
    iv3[0] = r2->size[0];
    emlrtSubAssignSizeCheckR2012b(iv3, 1, *(int32_T (*)[2])airBox->size, 2,
      &b_emlrtECI, sp);
    vlen = r2->size[0];
    for (mtmp = 0; mtmp < vlen; mtmp++) {
      Lays->data[r2->data[mtmp] + Lays->size[0] * i9] = airBox->data[mtmp];
    }

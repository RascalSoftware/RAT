...
static emlrtDCInfo db_emlrtDCI = { 12, /* lineNo */
  8,                                   /* colNo */
  "shiftdata",                         /* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/shiftData/shiftdata.m",/* pName */
  1                                    /* checkKind */
               ...
               emxArray_real_T *shifted_data)
{
  ...
  if (dataPresent != (int32_T)muDoubleScalarFloor(dataPresent)) {
    emlrtIntegerCheckR2012b(dataPresent, &db_emlrtDCI, sp);
  }
  ...
  switch ((int32_T)dataPresent) {
   case 1:
    ...
    emxInit_real_T1(sp, &b_data, 1, &fb_emlrtRTEI, true);
    b_ii[0] = ii->size[0];
    nx = data->size[0];
    i15 = b_data->size[0];
    b_data->size[0] = nx;
    ...
    emxInit_real_T1(sp, &c_data, 1, &fb_emlrtRTEI, true);
    d_data[0] = b_data->size[0];
    emlrtSubAssignSizeCheckR2012b(b_ii, 1, d_data, 1, &g_emlrtECI, sp);
    e_data = data->size[0];
    i15 = c_data->size[0];
    ...
    emxInit_real_T1(sp, &f_data, 1, &fb_emlrtRTEI, true);
    nx = data->size[0];
    i15 = f_data->size[0];
    f_data->size[0] = nx;
    ...
    emxInit_real_T1(sp, &lowIndex, 1, &gb_emlrtRTEI, true);
    ...
    emxInit_real_T1(sp, &g_data, 1, &fb_emlrtRTEI, true);
    nx = data->size[0];
    i15 = g_data->size[0];
    g_data->size[0] = nx;
    ...
    emxInit_boolean_T(sp, &x, 1, &fb_emlrtRTEI, true);
    st.site = &wc_emlrtRSI;
    nx = data->size[0];
    i15 = x->size[0];
    x->size[0] = nx;
    ...
    if (!(lowIndex->size[0] == 0)) {
      ...
      idx = lowIndex->size[0];
      if (!((idx >= 1) && (idx <= i15))) {
        emlrtDynamicBoundsCheckR2012b(idx, 1, i15, &de_emlrtBCI, sp);
      }
    ...
    if (b_lowIndex > hiIndex) {
      ...
      if (!((b_lowIndex >= 1) && (b_lowIndex <= i15))) {
        emlrtDynamicBoundsCheckR2012b(b_lowIndex, 1, i15, &ce_emlrtBCI, sp);
      }

      i15 = b_lowIndex - 1;
      idx = data->size[0];
      if (!((hiIndex >= 1) && (hiIndex <= idx))) {
        emlrtDynamicBoundsCheckR2012b(hiIndex, 1, idx, &ce_emlrtBCI, sp);
      }
    }

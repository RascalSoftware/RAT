...
MAKEFILE = standardTF_custlay_parallel_mex.mk

include standardTF_custlay_parallel_mex.mki


SRC_FILES =  \
	matlabCallFun.c \
	standardTF_custlay_parallel_mexutil.c \
	...
	abeles.c \
	chiSquared.c \
	_coder_standardTF_custlay_parallel_info.c \
	_coder_standardTF_custlay_parallel_api.c \
	_coder_standardTF_custlay_parallel_mex.c \
	standardTF_custlay_parallel_emxutil.c

MEX_FILE_NAME_WO_EXT = standardTF_custlay_parallel_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/standardTF_custlay_parallel"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/standardTF_custlay_parallel/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/standardTF_custlay_parallel/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/standardTF_custlay_parallel/%.cpp
	$(CXX) $(CPPFLAGS) "$<"

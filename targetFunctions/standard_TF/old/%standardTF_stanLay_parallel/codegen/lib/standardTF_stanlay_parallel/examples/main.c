...
#include "standardTF_stanlay_parallel_emxAPI.h"
...
static void c_main_standardTF_stanlay_paral(void);
...
static void c_main_standardTF_stanlay_paral(void)
{
  ...
  /* Initialize function 'standardTF_stanlay_parallel' input arguments. */
  ...
  layersDetails = argInit_1xUnbounded_cell_wrap_2();

  /* Initialize function input argument 'fileHandle'. */
  /* Call the entry-point 'standardTF_stanlay_parallel'. */
  ...
  emxDestroyArray_cell_wrap_2(layersDetails);
...
int main(int argc, const char * const argv[])
{
  ...
  c_main_standardTF_stanlay_paral();

...
static emlrtRSInfo kd_emlrtRSI = { 13, /* lineNo */
  "asin",                              /* fcnName */
...
static emlrtRTEInfo rc_emlrtRTEI = { 39,/* lineNo */
  19,                                  /* colNo */
  "abeles",                            /* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/callReflectivity/abeles.m"/* pName */
};
            ...
            real_T ssub, real_T layers, real_T points, emxArray_real_T *out)
{
  ...
  emxEnsureCapacity(sp, (emxArray__common *)out, i21, (int32_T)sizeof(real_T),
                    &vb_emlrtRTEI);
  loop = 0;
  while (loop <= (int32_T)points - 1) {
    ...
    i22 = loop + 1;
    if (!((i22 >= 1) && (i22 <= i21))) {
      emlrtDynamicBoundsCheckR2012b(i22, 1, i21, &lf_emlrtBCI, sp);
    }
    ...
    st.site = &id_emlrtRSI;
    preal = snsub * snsub - snair * snair * mpower(muDoubleScalarCos(theta));
    psub.re = preal;
    psub.im = preal * 0.0;
    b_sqrt(&psub);
    ...
    i21 = sld->size[0];
    if (!(1 <= i21)) {
      emlrtDynamicBoundsCheckR2012b(1, 1, i21, &mf_emlrtBCI, sp);
    }
    ...
    while (reploop <= (int32_T)nrepeats - 1) {
      ...
      while (nl <= (int32_T)layers - 1) {
        ...
        i22 = nl + 1;
        if (!((i22 >= 1) && (i22 <= i21))) {
          emlrtDynamicBoundsCheckR2012b(i22, 1, i21, &nf_emlrtBCI, sp);
        }

        i21 = sld->size[0];
        i22 = nl + 1;
        if (!((i22 >= 1) && (i22 <= i21))) {
          emlrtDynamicBoundsCheckR2012b(i22, 1, i21, &of_emlrtBCI, sp);
        }

        i21 = sld->size[0];
        i22 = nl + 1;
        if (!((i22 >= 1) && (i22 <= i21))) {
          emlrtDynamicBoundsCheckR2012b(i22, 1, i21, &pf_emlrtBCI, sp);
        }

        preal = 1.0 - sld->data[nl + sld->size[0]] * 3.2228875976108808;
        st.site = &jd_emlrtRSI;
        preal = preal * preal - snair * snair * mpower(muDoubleScalarCos(theta));
        pimag.re = preal;
        pimag.im = preal * 0.0;
        b_sqrt(&pimag);
        ...
        for (i21 = 0; i21 < 2; i21++) {
          for (i22 = 0; i22 < 2; i22++) {
            b_MI[i21 + (i22 << 1)].re = 0.0;
            b_MI[i21 + (i22 << 1)].im = 0.0;
            for (i23 = 0; i23 < 2; i23++) {
              b_MI[i21 + (i22 << 1)].re += MI[i21 + (i23 << 1)].re * N[i23 +
                (i22 << 1)].re - MI[i21 + (i23 << 1)].im * N[i23 + (i22 << 1)].
                im;
              b_MI[i21 + (i22 << 1)].im += MI[i21 + (i23 << 1)].re * N[i23 +
                (i22 << 1)].im + MI[i21 + (i23 << 1)].im * N[i23 + (i22 << 1)].
                re;
            }
          }
        }
    ...
    for (i21 = 0; i21 < 2; i21++) {
      for (i22 = 0; i22 < 2; i22++) {
        ...
        b_MI[i21 + (i22 << 1)].im = 0.0;
        for (i23 = 0; i23 < 2; i23++) {
          b_MI[i21 + (i22 << 1)].re += MI[i21 + (i23 << 1)].re * N[i23 + (i22 <<
            1)].re - MI[i21 + (i23 << 1)].im * N[i23 + (i22 << 1)].im;
          b_MI[i21 + (i22 << 1)].im += MI[i21 + (i23 << 1)].re * N[i23 + (i22 <<
            1)].im + MI[i21 + (i23 << 1)].im * N[i23 + (i22 << 1)].re;
        }
      }
    }
    ...
    i21 = out->size[0];
    if (!((loop + 1 >= 1) && (loop + 1 <= i21))) {
      emlrtDynamicBoundsCheckR2012b(loop + 1, 1, i21, &qf_emlrtBCI, sp);
    }

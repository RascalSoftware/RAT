                  ...
                  *f)
{
  ...
  emxInit_real_T(sp, &b_x, 2, &t_emlrtRTEI, true);
  ...
  emxInit_real_T(sp, &c_x, 2, &t_emlrtRTEI, true);
  st.site = &mb_emlrtRSI;
  b_erf(&st, b_x, f);
  ...
  emxInit_real_T(sp, &r4, 2, &t_emlrtRTEI, true);
  st.site = &mb_emlrtRSI;
  b_erf(&st, c_x, r4);
  emxFree_real_T(&c_x);
  for (b_f = 0; b_f < 2; b_f++) {
  ...
  if ((c_f[0] != iv6[0]) || (c_f[1] != iv6[1])) {
    emlrtSizeEqCheckNDR2012b(&c_f[0], &iv6[0], &b_emlrtECI, sp);
  }
                    ...
                    int32_T f_size[2])
{
  ...
  st.tls = sp->tls;
  emlrtHeapReferenceStackEnterFcnR2012b(sp);
  emxInit_real_T(sp, &x, 2, &t_emlrtRTEI, true);
  ...
  emxInit_real_T(sp, &r5, 2, &t_emlrtRTEI, true);
  st.site = &mb_emlrtRSI;
  b_erf(&st, x, r5);
  loop_ub = r5->size[0] * r5->size[1];
  emxFree_real_T(&x);
  for (i11 = 0; i11 < loop_ub; i11++) {
    f_data[i11] = r5->data[i11];
  }

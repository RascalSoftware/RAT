...
static emlrtRTEInfo nb_emlrtRTEI = { 19,/* lineNo */
  1,                                   /* colNo */
  "callReflectivity",                  /* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"/* pName */
};
...
static emlrtRTEInfo rb_emlrtRTEI = { 43,/* lineNo */
  5,                                   /* colNo */
  "callReflectivity",                  /* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"/* pName */
};

static emlrtRTEInfo sb_emlrtRTEI = { 48,/* lineNo */
  1,                                   /* colNo */
  "callReflectivity",                  /* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/callReflectivity/callReflectivity.m"/* pName */
};
...
static emlrtRTEInfo ub_emlrtRTEI = { 5,/* lineNo */
  1,                                   /* colNo */
                      ...
                      emxArray_real_T *reflectivity, emxArray_real_T *Simulation)
{
  ...
  emxInit_real_T1(sp, &xdata, 1, &nb_emlrtRTEI, true);
  ...
  emxInit_real_T(sp, &slds, 2, &ob_emlrtRTEI, true);
  if (layers->size[0] == 0) {
    dv0[0] = 0.0;
    dv0[1] = nbairs;
    dv0[2] = 0.0;
  ...
  emxInit_real_T1(sp, &middleSection, 1, &pb_emlrtRTEI, true);
  loop_ub = this_data->size[0];
  ...
  if (!(1 <= i17)) {
    emlrtDynamicBoundsCheckR2012b(1, 1, i17, &se_emlrtBCI, sp);
  }

  emxInit_real_T(sp, &firstSection, 2, &qb_emlrtRTEI, true);
  emxInit_real_T(sp, &simXdata, 2, &sb_emlrtRTEI, true);
  if (simLimits[0] < this_data->data[0]) {
    i17 = this_data->size[0];
    if (!(2 <= i17)) {
      emlrtDynamicBoundsCheckR2012b(2, 1, i17, &te_emlrtBCI, sp);
    }

    i17 = this_data->size[0];
    if (!(1 <= i17)) {
      emlrtDynamicBoundsCheckR2012b(1, 1, i17, &ue_emlrtBCI, sp);
    }

    step = this_data->data[1] - this_data->data[0];
    i17 = this_data->size[0];
    if (!(1 <= i17)) {
      emlrtDynamicBoundsCheckR2012b(1, 1, i17, &ve_emlrtBCI, sp);
    }
  ...
  if (!((i17 >= 1) && (i17 <= i18))) {
    emlrtDynamicBoundsCheckR2012b(i17, 1, i18, &we_emlrtBCI, sp);
  }

  emxInit_real_T(sp, &lastSection, 2, &rb_emlrtRTEI, true);
  if (simLimits[1] > this_data->data[i17 - 1]) {
    ...
    if (!((i17 >= 1) && (i17 <= i18))) {
      emlrtDynamicBoundsCheckR2012b(i17, 1, i18, &xe_emlrtBCI, sp);
    }

    if (!((i19 >= 1) && (i19 <= i20))) {
      emlrtDynamicBoundsCheckR2012b(i19, 1, i20, &bf_emlrtBCI, sp);
    }
    ...
    i18 = this_data->size[0];
    if (!((i17 >= 1) && (i17 <= i18))) {
      emlrtDynamicBoundsCheckR2012b(i17, 1, i18, &cf_emlrtBCI, &st);
    }
  ...
  emxInit_real_T1(sp, &simRef, 1, &tb_emlrtRTEI, true);
  emxInit_real_T1(sp, &dummydata, 1, &ub_emlrtRTEI, true);
  i17 = this_data->size[0];
  st.site = &cd_emlrtRSI;
  ...
  while (lays <= simXdata->size[1] - 1) {
    ...
    i19 = 1 + lays;
    if (!((i19 >= 1) && (i19 <= i18))) {
      emlrtDynamicBoundsCheckR2012b(i19, 1, i18, &ef_emlrtBCI, &st);
    }
    ...
    while (nm1d2 <= i18 - 1) {
      ...
      if (!((i20 >= 1) && (i20 <= i19))) {
        emlrtDynamicBoundsCheckR2012b(i20, 1, i19, &gf_emlrtBCI, &st);
      }

      i19 = simXdata->size[1];
      k = 1 + lays;
      if (!((k >= 1) && (k <= i19))) {
        emlrtDynamicBoundsCheckR2012b(k, 1, i19, &hf_emlrtBCI, &st);
      }
      ...
      i20 = lays + 1;
      if (!((i20 >= 1) && (i20 <= i19))) {
        emlrtDynamicBoundsCheckR2012b(i20, 1, i19, &ye_emlrtBCI, &st);
      }
      ...
      i20 = 1 + lays;
      if (!((i20 >= 1) && (i20 <= i19))) {
        emlrtDynamicBoundsCheckR2012b(i20, 1, i19, &if_emlrtBCI, &st);
      }

      i19 = simRef->size[0];
      k = (int32_T)(cdiff + (1.0 + (real_T)lays));
      if (!((k >= 1) && (k <= i19))) {
        emlrtDynamicBoundsCheckR2012b(k, 1, i19, &jf_emlrtBCI, &st);
      }

      i19 = dummydata->size[0];
      loop_ub = 1 + lays;
      if (!((loop_ub >= 1) && (loop_ub <= i19))) {
        emlrtDynamicBoundsCheckR2012b(loop_ub, 1, i19, &kf_emlrtBCI, &st);
      }
    ...
    if (ndbl != 0.0) {
      ...
      i19 = lays + 1;
      if (!((i19 >= 1) && (i19 <= i18))) {
        emlrtDynamicBoundsCheckR2012b(i19, 1, i18, &af_emlrtBCI, &st);
      }

      i18 = dummydata->size[0];
      i19 = 1 + lays;
      if (!((i19 >= 1) && (i19 <= i18))) {
        emlrtDynamicBoundsCheckR2012b(i19, 1, i18, &ff_emlrtBCI, &st);
      }
  ...
  emxInit_uint32_T(&st, &r6, 2, &mb_emlrtRTEI, true);
  nm1d2 = dummydata->size[0];
  i18 = r6->size[0] * r6->size[1];
  r6->size[0] = 1;
  r6->size[1] = i17;
  emxEnsureCapacity(sp, (emxArray__common *)r6, i18, (int32_T)sizeof(uint32_T),
                    &mb_emlrtRTEI);
  loop_ub = (int32_T)(i17 + MAX_uint32_T);
  for (i17 = 0; i17 <= loop_ub; i17++) {
    i18 = (int32_T)(((uint32_T)i17 + n) + 1U);
    if (!((i18 >= 1) && (i18 <= nm1d2))) {
      emlrtDynamicBoundsCheckR2012b(i18, 1, nm1d2, &df_emlrtBCI, sp);
    }

    r6->data[r6->size[0] * i17] = (uint32_T)i18;
  }
  ...
  loop_ub = r6->size[1];
  for (i17 = 0; i17 < loop_ub; i17++) {
    xdata->data[i17] = dummydata->data[(int32_T)r6->data[r6->size[0] * i17] - 1]
      + backgrounds;
  }

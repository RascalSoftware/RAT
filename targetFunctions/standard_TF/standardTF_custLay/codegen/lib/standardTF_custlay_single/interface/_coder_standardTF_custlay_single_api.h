 ...
 *
 * _coder_standardTF_custlay_single_api.h
 *
 * Code generation for function '_coder_standardTF_custlay_single_api'
 *
 */

#ifndef _CODER_STANDARDTF_CUSTLAY_SINGLE_API_H
#define _CODER_STANDARDTF_CUSTLAY_SINGLE_API_H
...
extern void standardTF_custlay_single(emxArray_real_T *resam, real_T
...
extern void standardTF_custlay_single_api(const mxArray *prhs[31], const mxArray
  *plhs[15]);
extern void standardTF_custlay_single_atexit(void);
extern void standardTF_custlay_single_initialize(void);
extern void standardTF_custlay_single_terminate(void);
extern void standardTF_custlay_single_xil_terminate(void);

#endif

/* End of code generation (_coder_standardTF_custlay_single_api.h) */

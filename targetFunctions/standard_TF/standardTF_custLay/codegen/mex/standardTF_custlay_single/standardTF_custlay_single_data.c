 ...
 *
 * Code generation for function 'standardTF_custlay_single_data'
 *
 */
...
emlrtRSInfo eb_emlrtRSI = { 37,        /* lineNo */
  "mpower",                            /* fcnName */
...
emlrtRTEInfo v_emlrtRTEI = { 36,       /* lineNo */
  6,                                   /* colNo */
  "find",                              /* fName */
  "/usr/local/MATLAB/R2016b/toolbox/eml/lib/matlab/elmat/find.m"/* pName */
};

emlrtRTEInfo rb_emlrtRTEI = { 281,     /* lineNo */
  27,                                  /* colNo */
  "cat",                               /* fName */
  "/usr/local/MATLAB/R2016b/toolbox/eml/eml/+coder/+internal/cat.m"/* pName */
};

emlrtRTEInfo sb_emlrtRTEI = { 88,      /* lineNo */
  9,                                   /* colNo */
...
emlrtRTEInfo yb_emlrtRTEI = { 243,     /* lineNo */
  9,                                   /* colNo */
  "find",                              /* fName */
  "/usr/local/MATLAB/R2016b/toolbox/eml/lib/matlab/elmat/find.m"/* pName */
};

emlrtRTEInfo ac_emlrtRTEI = { 381,     /* lineNo */
  15,                                  /* colNo */
  "colon",                             /* fName */
  "/usr/local/MATLAB/R2016b/toolbox/eml/lib/matlab/ops/colon.m"/* pName */
};

/* End of code generation (standardTF_custlay_single_data.c) */

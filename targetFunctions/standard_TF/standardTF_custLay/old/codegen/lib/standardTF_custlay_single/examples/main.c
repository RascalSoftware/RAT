...
#include "standardTF_custlay_single_emxAPI.h"
...
static void main_standardTF_custlay_single(void);
...
static emxArray_cell_wrap_1 *argInit_1xUnbounded_cell_wrap_1(void)
{
  ...
  for (idx1 = 0; idx1 < result->size[1U]; idx1++) {
    /* Set the value of the array element.
       Change this value to the value that the application requires. */
    argInit_cell_wrap_1(&result->data[result->size[0] * idx1]);
  }
...
static emxArray_cell_wrap_2 *argInit_1xUnbounded_cell_wrap_2(void)
{
  ...
  /* Set the size of the array.
     Change this size to the value that the application requires. */
  result = emxCreateND_cell_wrap_2(2, iv5);
...
static void argInit_51x3_real_T(double result[153])
{
  ...
  for (idx0 = 0; idx0 < 51; idx0++) {
    for (idx1 = 0; idx1 < 3; idx1++) {
      /* Set the value of the array element.
         Change this value to the value that the application requires. */
      result[idx0 + 51 * idx1] = argInit_real_T();
    }
  }
}
...
static void main_standardTF_custlay_single(void)
{
  ...
  emxInitArray_cell_wrap_4(&shifted_data, 2);
  emxInitArray_cell_wrap_4(&layerSlds, 2);
  emxInitArray_cell_wrap_3(&sldProfiles, 2);
  emxInitArray_cell_wrap_5(&allLayers, 2);
  emxInitArray_real_T(&allRoughs, 1);

  /* Initialize function 'standardTF_custlay_single' input arguments. */
  ...
  /* Call the entry-point 'standardTF_custlay_single'. */
  standardTF_custlay_single(resam, numberOfContrasts, geometry, nbairs, nbsubs,
  ...
  emxDestroyArray_cell_wrap_4(layerSlds);
  emxDestroyArray_cell_wrap_4(shifted_data);
...
int main(int argc, const char * const argv[])
{
  ...
  main_standardTF_custlay_single();

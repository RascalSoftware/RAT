...
emlrtContext emlrtContextGlobal = { true,/* bFirstTime */
  ...
  NULL,                                /* fErrorFunction */
  "standardTF_custlay_single",         /* fFunctionName */
  NULL,                                /* fRTCallStack */
  false,                               /* bDebugMode */
...
static void emxFree_cell_wrap_1(emxArray_cell_wrap_1 **pEmxArray)
{
  if (*pEmxArray != (emxArray_cell_wrap_1 *)NULL) {
    if (((*pEmxArray)->data != (cell_wrap_1 *)NULL) && (*pEmxArray)->canFreeData)
    {
      emlrtFreeMex((void *)(*pEmxArray)->data);
    }
  ...
  emlrtMsgIdentifier *msgId, real_T ret[153])
{
  ...
  emlrtCheckBuiltInR2012b(sp, msgId, src, "double", false, 2U, dims);
  for (i17 = 0; i17 < 3; i17++) {
    for (i18 = 0; i18 < 51; i18++) {
      ret[i18 + 51 * i17] = (*(real_T (*)[153])mxGetData(src))[i18 + 51 * i17];
    }
  }
  ...
  emlrtMsgIdentifier *parentId, emxArray_cell_wrap_1 *y)
{
  ...
  y->size[0] = sizes[0];
  y->size[1] = sizes[1];
  emxEnsureCapacity((emxArray__common *)y, i1, (int32_T)sizeof(cell_wrap_1));
  n = y->size[1];
  for (i1 = 0; i1 < n; i1++) {
...
void standardTF_custlay_single_api(const mxArray *prhs[31], const mxArray *plhs
  [15])
{
  ...
  emxInit_cell_wrap_4(&st, &shifted_data, 2, true);
  emxInit_cell_wrap_4(&st, &layerSlds, 2, true);
...
void standardTF_custlay_single_atexit(void)
{
  ...
  standardTF_custlay_single_xil_terminate();
}

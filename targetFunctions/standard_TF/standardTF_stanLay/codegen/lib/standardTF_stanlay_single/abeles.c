            ...
            points, emxArray_real_T *out)
{
  ...
  emxEnsureCapacity((emxArray__common *)out, i11, (int)sizeof(double));
  for (loop = 0; loop < (int)points; loop++) {
    ...
    for (reploop = 0; reploop < (int)nrepeats; reploop++) {
      for (nl = 0; nl < (int)layers; nl++) {
        ...
        for (i11 = 0; i11 < 2; i11++) {
          for (i12 = 0; i12 < 2; i12++) {
            b_MI[i11 + (i12 << 1)].re = 0.0;
            b_MI[i11 + (i12 << 1)].im = 0.0;
            for (i13 = 0; i13 < 2; i13++) {
              b_MI[i11 + (i12 << 1)].re += MI[i11 + (i13 << 1)].re * N[i13 +
                (i12 << 1)].re - MI[i11 + (i13 << 1)].im * N[i13 + (i12 << 1)].
                im;
              b_MI[i11 + (i12 << 1)].im += MI[i11 + (i13 << 1)].re * N[i13 +
                (i12 << 1)].im + MI[i11 + (i13 << 1)].im * N[i13 + (i12 << 1)].
                re;
            }
          }
        }
    ...
    for (i11 = 0; i11 < 2; i11++) {
      for (i12 = 0; i12 < 2; i12++) {
        ...
        b_MI[i11 + (i12 << 1)].im = 0.0;
        for (i13 = 0; i13 < 2; i13++) {
          b_MI[i11 + (i12 << 1)].re += MI[i11 + (i13 << 1)].re * N[i13 + (i12 <<
            1)].re - MI[i11 + (i13 << 1)].im * N[i13 + (i12 << 1)].im;
          b_MI[i11 + (i12 << 1)].im += MI[i11 + (i13 << 1)].re * N[i13 + (i12 <<
            1)].im + MI[i11 + (i13 << 1)].im * N[i13 + (i12 << 1)].re;
        }
      }
    }

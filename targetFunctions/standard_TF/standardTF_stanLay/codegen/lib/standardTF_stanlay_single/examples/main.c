...
static void main_standardTF_stanlay_single(void);
...
static emxArray_cell_wrap_2 *argInit_1xUnbounded_cell_wrap_2(void)
{
  ...
  for (idx1 = 0; idx1 < result->size[1U]; idx1++) {
    /* Set the value of the array element.
       Change this value to the value that the application requires. */
    result->data[result->size[0] * idx1] = argInit_cell_wrap_2();
  }
...
static emxArray_cell_wrap_3 *argInit_1xUnbounded_cell_wrap_3(void)
{
  ...
  /* Set the size of the array.
     Change this size to the value that the application requires. */
  result = emxCreateND_cell_wrap_3(2, iv7);

  /* Loop over the array to initialize each element. */
  for (idx1 = 0; idx1 < result->size[1U]; idx1++) {
    /* Set the value of the array element.
       Change this value to the value that the application requires. */
    result->data[result->size[0] * idx1] = argInit_cell_wrap_3();
  }
...
static void main_standardTF_stanlay_single(void)
{
  ...
  emxInitArray_cell_wrap_4(&reflectivity, 2);
  emxInitArray_cell_wrap_4(&Simulation, 2);
  emxInitArray_cell_wrap_1(&shifted_data, 2);
  emxInitArray_cell_wrap_1(&layerSlds, 2);
  emxInitArray_cell_wrap_4(&sldProfiles, 2);
  emxInitArray_cell_wrap_5(&allLayers, 2);
  emxInitArray_real_T(&allRoughs, 1);

  /* Initialize function 'standardTF_stanlay_single' input arguments. */
  ...
  dataLimits = argInit_1xUnbounded_cell_wrap_2();

  /* Initialize function input argument 'simLimits'. */
  simLimits = argInit_1xUnbounded_cell_wrap_2();

  /* Initialize function input argument 'repeatLayers'. */
  repeatLayers = argInit_1xUnbounded_cell_wrap_2();
  ...
  contrastLayers = argInit_1xUnbounded_cell_wrap_0();
  numberOfLayers = argInit_real_T();

  /* Initialize function input argument 'layersDetails'. */
  layersDetails = argInit_1xUnbounded_cell_wrap_3();

  /* Initialize function input argument 'fileHandle'. */
  /* Call the entry-point 'standardTF_stanlay_single'. */
  standardTF_stanlay_single(resam, numberOfContrasts, geometry, nbairs, nbsubs,
    ...
    nParams, params, contrastLayers, numberOfLayers, layersDetails,
    argInit_real_T(), outSsubs, backgs, qshifts, sfs, nbas, nbss, resols, chis,
    reflectivity, Simulation, shifted_data, layerSlds, sldProfiles, allLayers,
    allRoughs);
  emxDestroyArray_real_T(allRoughs);
  emxDestroyArray_cell_wrap_5(allLayers);
  emxDestroyArray_cell_wrap_4(sldProfiles);
  emxDestroyArray_cell_wrap_1(layerSlds);
  emxDestroyArray_cell_wrap_1(shifted_data);
  emxDestroyArray_cell_wrap_4(Simulation);
  emxDestroyArray_cell_wrap_4(reflectivity);
  ...
  emxDestroyArray_cell_wrap_3(layersDetails);
  emxDestroyArray_cell_wrap_0(contrastLayers);
  emxDestroyArray_real_T(params);
  emxDestroyArray_cell_wrap_2(repeatLayers);
  emxDestroyArray_cell_wrap_2(simLimits);
  emxDestroyArray_cell_wrap_2(dataLimits);
...
int main(int argc, const char * const argv[])
{
  ...
  standardTF_stanlay_single_initialize();

  /* Invoke the entry-point functions.
     You can call entry-point functions multiple times. */
  main_standardTF_stanlay_single();

  /* Terminate the application.
     You do not need to do this more than one time. */
  standardTF_stanlay_single_terminate();
  return 0;
}

                  ...
                  emxArray_real_T *y_new_tot)
{
  ...
  i5 = prof->size[0];
  prof->size[0] = nx;
  emxEnsureCapacity((emxArray__common *)prof, i5, (int)sizeof(double));
  for (i5 = 0; i5 < nx; i5++) {
    prof->data[i5] = sld->data[i5 + sld->size[0]];
  }

  emxInit_real_T(&x_new, 2);
  i5 = x_new->size[0] * x_new->size[1];
  x_new->size[0] = 10000;
  x_new->size[1] = 1;
  emxEnsureCapacity((emxArray__common *)x_new, i5, (int)sizeof(double));
  for (i5 = 0; i5 < 10000; i5++) {
    x_new->data[i5] = 0.0;
  }

  emxInit_real_T(&y_new, 2);
  i5 = y_new->size[0] * y_new->size[1];
  y_new->size[0] = 10000;
  y_new->size[1] = 1;
  emxEnsureCapacity((emxArray__common *)y_new, i5, (int)sizeof(double));
  for (i5 = 0; i5 < 10000; i5++) {
    y_new->data[i5] = 0.0;
  }
    ...
    if (fabs(this_step) < 1.0) {
      ...
      if (this_step > 0.0) {
        if (rtIsNaN(prof->data[i]) || rtIsNaN(prof->data[i + 1])) {
          i5 = newsteps->size[0] * newsteps->size[1];
          newsteps->size[0] = 1;
          newsteps->size[1] = 1;
          emxEnsureCapacity((emxArray__common *)newsteps, i5, (int)sizeof(double));
          ...
          for (i5 = 0; i5 <= nx; i5++) {
            newsteps->data[newsteps->size[0] * i5] = this_step + (double)i5;
          }
        } else {
      ...
      for (i5 = 0; i5 < 2; i5++) {
        varargin_1[i5] = prof->data[i5 + i];
      }

      for (i5 = 0; i5 < 2; i5++) {
        varargin_2[i5] = x->data[i5 + i];
      }

      for (i5 = 0; i5 < 2; i5++) {
        outsize[i5] = (unsigned int)newsteps->size[i5];
      }

      i5 = new_xs->size[0] * new_xs->size[1];
      new_xs->size[0] = 1;
      new_xs->size[1] = (int)outsize[1];
      emxEnsureCapacity((emxArray__common *)new_xs, i5, (int)sizeof(double));
      nx = (int)outsize[1];
      for (i5 = 0; i5 < nx; i5++) {
        new_xs->data[i5] = rtNaN;
      }
      ...
      if (newsteps->size[1] != 0) {
        ...
        do {
          ...
          if (nx + 3 < 3) {
            ...
            i5 = xi->size[0] * xi->size[1];
            xi->size[0] = 1;
            xi->size[1] = newsteps->size[1];
            emxEnsureCapacity((emxArray__common *)xi, i5, (int)sizeof(double));
            nx = newsteps->size[0] * newsteps->size[1];
            for (i5 = 0; i5 < nx; i5++) {
              xi->data[i5] = newsteps->data[i5];
            }
...
#pragma omp parallel for \
 ...
 private(r)
      ...
      i5 = b_x_new->size[0] * b_x_new->size[1];
      b_x_new->size[0] = 10000;
      b_x_new->size[1] = x_new->size[1] + idx;
      emxEnsureCapacity((emxArray__common *)b_x_new, i5, (int)sizeof(double));
      nx = x_new->size[1];
      for (i5 = 0; i5 < nx; i5++) {
        for (nm1d2 = 0; nm1d2 < 10000; nm1d2++) {
          b_x_new->data[nm1d2 + b_x_new->size[0] * i5] = x_new->data[nm1d2 +
            x_new->size[0] * i5];
        }
      }
      ...
      for (i5 = 0; i5 < idx; i5++) {
        for (nm1d2 = 0; nm1d2 < 10000; nm1d2++) {
          b_x_new->data[nm1d2 + b_x_new->size[0] * (i5 + x_new->size[1])] =
            new_xs->data[nm1d2 + 10000 * i5];
        }
      }
      ...
      for (i5 = 0; i5 < nx; i5++) {
        for (nm1d2 = 0; nm1d2 < 10000; nm1d2++) {
          x_new->data[nm1d2 + x_new->size[0] * i5] = b_x_new->data[nm1d2 +
            b_x_new->size[0] * i5];
        }
      }
      ...
      i5 = b_y_new->size[0] * b_y_new->size[1];
      b_y_new->size[0] = 10000;
      b_y_new->size[1] = y_new->size[1] + idx;
      emxEnsureCapacity((emxArray__common *)b_y_new, i5, (int)sizeof(double));
      nx = y_new->size[1];
      for (i5 = 0; i5 < nx; i5++) {
        for (nm1d2 = 0; nm1d2 < 10000; nm1d2++) {
          b_y_new->data[nm1d2 + b_y_new->size[0] * i5] = y_new->data[nm1d2 +
            y_new->size[0] * i5];
        }
      }
      ...
      for (i5 = 0; i5 < idx; i5++) {
        for (nm1d2 = 0; nm1d2 < 10000; nm1d2++) {
          b_y_new->data[nm1d2 + b_y_new->size[0] * (i5 + y_new->size[1])] =
            newsteps->data[nm1d2 + 10000 * i5];
        }
      }
      ...
      for (i5 = 0; i5 < nx; i5++) {
        for (nm1d2 = 0; nm1d2 < 10000; nm1d2++) {
          y_new->data[nm1d2 + y_new->size[0] * i5] = b_y_new->data[nm1d2 +
            b_y_new->size[0] * i5];
        }
      }
  ...
  emxEnsureCapacity((emxArray__common *)x_new_tot, i5, (int)sizeof(double));
  nx = (int)count;
  for (i5 = 0; i5 < nx; i5++) {
    x_new_tot->data[i5] = 0.0;
  }

  i5 = y_new_tot->size[0];
  y_new_tot->size[0] = (int)count;
  emxEnsureCapacity((emxArray__common *)y_new_tot, i5, (int)sizeof(double));
  nx = (int)count;
  for (i5 = 0; i5 < nx; i5++) {
    y_new_tot->data[i5] = 0.0;
  }
  ...
  emxEnsureCapacity((emxArray__common *)b_x, i5, (int)sizeof(boolean_T));
  nx = x_new_tot->size[0];
  for (i5 = 0; i5 < nx; i5++) {
    b_x->data[i5] = (x_new_tot->data[i5] != 0.0);
  }
  ...
  nx = ii->size[0];
  for (i5 = 0; i5 < nx; i5++) {
    x->data[i5] = ii->data[i5];
  }

  emxFree_int32_T(&ii);
  emxInit_real_T1(&b_x_new_tot, 1);
  i5 = b_x_new_tot->size[0];
  b_x_new_tot->size[0] = x->size[0];
  emxEnsureCapacity((emxArray__common *)b_x_new_tot, i5, (int)sizeof(double));
  nx = x->size[0];
  for (i5 = 0; i5 < nx; i5++) {
    b_x_new_tot->data[i5] = x_new_tot->data[(int)x->data[i5] - 1];
  }
  ...
  for (i5 = 0; i5 < nx; i5++) {
    x_new_tot->data[i5] = b_x_new_tot->data[i5];
  }

  emxFree_real_T(&b_x_new_tot);
  emxInit_real_T1(&b_y_new_tot, 1);
  i5 = b_y_new_tot->size[0];
  b_y_new_tot->size[0] = x->size[0];
  emxEnsureCapacity((emxArray__common *)b_y_new_tot, i5, (int)sizeof(double));
  nx = x->size[0];
  for (i5 = 0; i5 < nx; i5++) {
    b_y_new_tot->data[i5] = y_new_tot->data[(int)x->data[i5] - 1];
  }
  ...
  for (i5 = 0; i5 < nx; i5++) {
    y_new_tot->data[i5] = b_y_new_tot->data[i5];
  }

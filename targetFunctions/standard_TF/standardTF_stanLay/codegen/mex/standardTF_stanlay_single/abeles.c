...
static emlrtRTEInfo pc_emlrtRTEI = { 39,/* lineNo */
  19,                                  /* colNo */
  "abeles",                            /* fName */
  "/home/arwel/Documents/RascalDev/RAT/targetFunctions/common/callReflectivity/abeles.m"/* pName */
};
            ...
            real_T ssub, real_T layers, real_T points, emxArray_real_T *out)
{
  ...
  emxEnsureCapacity(sp, (emxArray__common *)out, i16, (int32_T)sizeof(real_T),
                    &tb_emlrtRTEI);
  loop = 0;
  while (loop <= (int32_T)points - 1) {
    ...
    i17 = loop + 1;
    if (!((i17 >= 1) && (i17 <= i16))) {
      emlrtDynamicBoundsCheckR2012b(i17, 1, i16, &nf_emlrtBCI, sp);
    }
    ...
    i16 = sld->size[0];
    if (!(1 <= i16)) {
      emlrtDynamicBoundsCheckR2012b(1, 1, i16, &of_emlrtBCI, sp);
    }
    ...
    while (reploop <= (int32_T)nrepeats - 1) {
      ...
      while (nl <= (int32_T)layers - 1) {
        ...
        i17 = nl + 1;
        if (!((i17 >= 1) && (i17 <= i16))) {
          emlrtDynamicBoundsCheckR2012b(i17, 1, i16, &pf_emlrtBCI, sp);
        }

        i16 = sld->size[0];
        i17 = nl + 1;
        if (!((i17 >= 1) && (i17 <= i16))) {
          emlrtDynamicBoundsCheckR2012b(i17, 1, i16, &qf_emlrtBCI, sp);
        }

        i16 = sld->size[0];
        i17 = nl + 1;
        if (!((i17 >= 1) && (i17 <= i16))) {
          emlrtDynamicBoundsCheckR2012b(i17, 1, i16, &rf_emlrtBCI, sp);
        }
        ...
        for (i16 = 0; i16 < 2; i16++) {
          for (i17 = 0; i17 < 2; i17++) {
            b_MI[i16 + (i17 << 1)].re = 0.0;
            b_MI[i16 + (i17 << 1)].im = 0.0;
            for (i18 = 0; i18 < 2; i18++) {
              b_MI[i16 + (i17 << 1)].re += MI[i16 + (i18 << 1)].re * N[i18 +
                (i17 << 1)].re - MI[i16 + (i18 << 1)].im * N[i18 + (i17 << 1)].
                im;
              b_MI[i16 + (i17 << 1)].im += MI[i16 + (i18 << 1)].re * N[i18 +
                (i17 << 1)].im + MI[i16 + (i18 << 1)].im * N[i18 + (i17 << 1)].
                re;
            }
          }
        }
    ...
    for (i16 = 0; i16 < 2; i16++) {
      for (i17 = 0; i17 < 2; i17++) {
        ...
        b_MI[i16 + (i17 << 1)].im = 0.0;
        for (i18 = 0; i18 < 2; i18++) {
          b_MI[i16 + (i17 << 1)].re += MI[i16 + (i18 << 1)].re * N[i18 + (i17 <<
            1)].re - MI[i16 + (i18 << 1)].im * N[i18 + (i17 << 1)].im;
          b_MI[i16 + (i17 << 1)].im += MI[i16 + (i18 << 1)].re * N[i18 + (i17 <<
            1)].im + MI[i16 + (i18 << 1)].im * N[i18 + (i17 << 1)].re;
        }
      }
    }
    ...
    i16 = out->size[0];
    if (!((loop + 1 >= 1) && (loop + 1 <= i16))) {
      emlrtDynamicBoundsCheckR2012b(loop + 1, 1, i16, &sf_emlrtBCI, sp);
    }

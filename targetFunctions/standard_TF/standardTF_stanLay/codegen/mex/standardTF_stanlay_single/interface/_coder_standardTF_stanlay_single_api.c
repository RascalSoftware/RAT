...
static emlrtRTEInfo yb_emlrtRTEI = { 1,/* lineNo */
  1,                                   /* colNo */
  "_coder_standardTF_stanlay_single_api",/* fName */
  ""                                   /* pName */
};
...
static const mxArray *b_emlrt_marshallOut(const emxArray_cell_wrap_4 *u)
{
  ...
  while (i29 < n) {
    r7 = &u->data[i29];
    emlrtSetCell(y, i29, c_emlrt_marshallOut(r7->f1));
    i29++;
  }
...
static const mxArray *d_emlrt_marshallOut(const emxArray_cell_wrap_4 *u)
{
  ...
  while (i31 < n) {
    r8 = &u->data[i31];
    emlrtSetCell(y, i31, c_emlrt_marshallOut(r8->f1));
    i31++;
  }
...
static const mxArray *e_emlrt_marshallOut(const emxArray_cell_wrap_1 *u)
{
  ...
  while (i32 < n) {
    r9 = &u->data[i32];
    emlrtSetCell(y, i32, f_emlrt_marshallOut(r9->f1));
    i32++;
  }
...
static const mxArray *f_emlrt_marshallOut(const emxArray_real_T *u)
{
  ...
  for (i = 0; i < 3; i++) {
    for (b_i = 0; b_i < u->size[0]; b_i++) {
      pData[i33] = u->data[b_i + u->size[0] * i];
      i33++;
    }
  }
  ...
  emlrtMsgIdentifier *msgId, emxArray_char_T *ret)
{
  ...
  emlrtCheckVsBuiltInR2012b(sp, msgId, src, "char", false, 2U, dims, &bv8[0],
    iv21);
  i38 = ret->size[0] * ret->size[1];
  ret->size[0] = iv21[0];
  ret->size[1] = iv21[1];
  emxEnsureCapacity(sp, (emxArray__common *)ret, i38, (int32_T)sizeof(char_T),
                    (emlrtRTEInfo *)NULL);
...
static const mxArray *g_emlrt_marshallOut(const emxArray_cell_wrap_1 *u)
{
  ...
  while (i34 < n) {
    r10 = &u->data[i34];
    emlrtSetCell(y, i34, f_emlrt_marshallOut(r10->f1));
    i34++;
  }
...
static const mxArray *h_emlrt_marshallOut(const emxArray_cell_wrap_4 *u)
{
  ...
  while (i35 < n) {
    r11 = &u->data[i35];
    emlrtSetCell(y, i35, c_emlrt_marshallOut(r11->f1));
    i35++;
  }
  ...
  emlrtMsgIdentifier *msgId, emxArray_real_T *ret)
{
  ...
  emlrtCheckVsBuiltInR2012b(sp, msgId, src, "double", false, 2U, dims, &bv10[0],
    iv23);
  i39 = ret->size[0] * ret->size[1];
  ret->size[0] = iv23[0];
  ret->size[1] = iv23[1];
  emxEnsureCapacity(sp, (emxArray__common *)ret, i39, (int32_T)sizeof(real_T),
                    (emlrtRTEInfo *)NULL);
  ...
  emxArray_cell_wrap_5 *u)
{
  ...
  while (i36 < n) {
    r13 = &u->data[i36];
    i37 = b_u->size[0] * b_u->size[1];
    b_u->size[0] = r13->f1->size[0];
    b_u->size[1] = r13->f1->size[1];
    emxEnsureCapacity(sp, (emxArray__common *)b_u, i37, (int32_T)sizeof(real_T),
                      (emlrtRTEInfo *)NULL);
    i37 = r13->f1->size[0];
    loop_ub = r13->f1->size[1];
    i = r12->size[0];
    r12->size[0] = i37 * loop_ub;
    emxEnsureCapacity(sp, (emxArray__common *)r12, i, (int32_T)sizeof(real_T),
                      (emlrtRTEInfo *)NULL);
    loop_ub *= i37;
    for (i37 = 0; i37 < loop_ub; i37++) {
      r12->data[i37] = r13->f1->data[i37];
    }

    loop_ub = r12->size[0];
    for (i37 = 0; i37 < loop_ub; i37++) {
      b_u->data[i37] = r12->data[i37];
    }
    ...
    for (loop_ub = 0; loop_ub < b_u->size[1]; loop_ub++) {
      for (i = 0; i < b_u->size[0]; i++) {
        pData[i37] = b_u->data[i + b_u->size[0] * loop_ub];
        i37++;
      }
    }

    emlrtAssign(&b_y, m3);
    emlrtSetCell(y, i36, b_y);
    i36++;
  }
  ...
  emlrtMsgIdentifier *msgId, emxArray_real_T *ret)
{
  ...
  emlrtCheckVsBuiltInR2012b(sp, msgId, src, "double", false, 2U, dims, &bv11[0],
    iv24);
  i40 = ret->size[0] * ret->size[1];
  ret->size[0] = iv24[0];
  ret->size[1] = iv24[1];
  emxEnsureCapacity(sp, (emxArray__common *)ret, i40, (int32_T)sizeof(real_T),
                    (emlrtRTEInfo *)NULL);
  emlrtImportArrayR2015b(sp, src, ret->data, 8, false);
  emlrtDestroyArray(&src);
}
  ...
  emlrtMsgIdentifier *parentId, emxArray_cell_wrap_0 *y)
{
  ...
  y->size[0] = sizes[0];
  y->size[1] = sizes[1];
  emxEnsureCapacity_cell_wrap_0(sp, y, i22, (emlrtRTEInfo *)NULL);
  n = y->size[1];
  for (i22 = 0; i22 < n; i22++) {
  ...
  emlrtMsgIdentifier *msgId, real_T ret[2])
{
  ...
  for (i41 = 0; i41 < 2; i41++) {
    ret[i41] = (*(real_T (*)[2])mxGetData(src))[i41];
  }
  ...
  emlrtMsgIdentifier *parentId, emxArray_cell_wrap_1 *y)
{
  ...
  y->size[0] = sizes[0];
  y->size[1] = sizes[1];
  emxEnsureCapacity_cell_wrap_1(sp, y, i23, (emlrtRTEInfo *)NULL);
  n = y->size[1];
  for (i23 = 0; i23 < n; i23++) {
    sprintf(&str[0], "%d", i23 + 1);
    thisId.fIdentifier = &str[0];
    n_emlrt_marshallIn(sp, emlrtAlias(emlrtGetCell(sp, parentId, u, i23)),
                       &thisId, y->data[i23].f1);
  }
  ...
  emlrtMsgIdentifier *parentId, emxArray_cell_wrap_2 *y)
{
  ...
  y->size[0] = sizes[0];
  y->size[1] = sizes[1];
  emxEnsureCapacity(sp, (emxArray__common *)y, i24, (int32_T)sizeof(cell_wrap_2),
                    (emlrtRTEInfo *)NULL);
  n = y->size[1];
  for (i24 = 0; i24 < n; i24++) {
    sprintf(&str[0], "%d", i24 + 1);
    thisId.fIdentifier = &str[0];
    q_emlrt_marshallIn(sp, emlrtAlias(emlrtGetCell(sp, parentId, u, i24)),
                       &thisId, y->data[i24].f1);
  }
  ...
  emlrtMsgIdentifier *parentId, emxArray_cell_wrap_2 *y)
{
  ...
  y->size[0] = sizes[0];
  y->size[1] = sizes[1];
  emxEnsureCapacity(sp, (emxArray__common *)y, i25, (int32_T)sizeof(cell_wrap_2),
                    (emlrtRTEInfo *)NULL);
  n = y->size[1];
  for (i25 = 0; i25 < n; i25++) {
    sprintf(&str[0], "%d", i25 + 1);
    thisId.fIdentifier = &str[0];
    q_emlrt_marshallIn(sp, emlrtAlias(emlrtGetCell(sp, parentId, u, i25)),
                       &thisId, y->data[i25].f1);
  }
  ...
  emlrtMsgIdentifier *parentId, emxArray_cell_wrap_2 *y)
{
  ...
  y->size[0] = sizes[0];
  y->size[1] = sizes[1];
  emxEnsureCapacity(sp, (emxArray__common *)y, i26, (int32_T)sizeof(cell_wrap_2),
                    (emlrtRTEInfo *)NULL);
  n = y->size[1];
  for (i26 = 0; i26 < n; i26++) {
    sprintf(&str[0], "%d", i26 + 1);
    thisId.fIdentifier = &str[0];
    q_emlrt_marshallIn(sp, emlrtAlias(emlrtGetCell(sp, parentId, u, i26)),
                       &thisId, y->data[i26].f1);
  }
  ...
  emlrtMsgIdentifier *parentId, emxArray_cell_wrap_0 *y)
{
  ...
  y->size[0] = sizes[0];
  y->size[1] = sizes[1];
  emxEnsureCapacity_cell_wrap_0(sp, y, i27, (emlrtRTEInfo *)NULL);
  n = y->size[1];
  for (i27 = 0; i27 < n; i27++) {
  ...
  emlrtMsgIdentifier *parentId, emxArray_cell_wrap_3 *y)
{
  ...
  y->size[0] = sizes[0];
  y->size[1] = sizes[1];
  emxEnsureCapacity_cell_wrap_3(sp, y, i28, (emlrtRTEInfo *)NULL);
  n = y->size[1];
  for (i28 = 0; i28 < n; i28++) {
    sprintf(&str[0], "%d", i28 + 1);
    thisId.fIdentifier = &str[0];
    ab_emlrt_marshallIn(sp, emlrtAlias(emlrtGetCell(sp, parentId, u, i28)),
                        &thisId, y->data[i28].f1.data, y->data[i28].f1.size);
  }

  emlrtDestroyArray(&u);
}

void standardTF_stanlay_single_api(const mxArray * const prhs[30], const mxArray
  *plhs[15])
{
  ...
  emxInit_real_T1(&st, &resam, 1, &yb_emlrtRTEI, true);
  emxInit_char_T(&st, &geometry, 2, &yb_emlrtRTEI, true);
  emxInit_real_T(&st, &nbairs, 2, &yb_emlrtRTEI, true);
  emxInit_real_T(&st, &nbsubs, 2, &yb_emlrtRTEI, true);
  emxInit_cell_wrap_0(&st, &repeats, 2, &yb_emlrtRTEI, true);
  emxInit_real_T(&st, &cBacks, 2, &yb_emlrtRTEI, true);
  emxInit_real_T(&st, &cShifts, 2, &yb_emlrtRTEI, true);
  emxInit_real_T(&st, &cScales, 2, &yb_emlrtRTEI, true);
  emxInit_real_T(&st, &cNbas, 2, &yb_emlrtRTEI, true);
  emxInit_real_T(&st, &cNbss, 2, &yb_emlrtRTEI, true);
  emxInit_real_T(&st, &cRes, 2, &yb_emlrtRTEI, true);
  emxInit_real_T(&st, &backs, 2, &yb_emlrtRTEI, true);
  emxInit_real_T(&st, &shifts, 2, &yb_emlrtRTEI, true);
  emxInit_real_T(&st, &sf, 2, &yb_emlrtRTEI, true);
  emxInit_real_T(&st, &nba, 2, &yb_emlrtRTEI, true);
  emxInit_real_T(&st, &nbs, 2, &yb_emlrtRTEI, true);
  emxInit_real_T(&st, &res, 2, &yb_emlrtRTEI, true);
  emxInit_real_T(&st, &dataPresent, 2, &yb_emlrtRTEI, true);
  emxInit_cell_wrap_1(&st, &allData, 2, &yb_emlrtRTEI, true);
  emxInit_cell_wrap_2(&st, &dataLimits, 2, &yb_emlrtRTEI, true);
  emxInit_cell_wrap_2(&st, &simLimits, 2, &yb_emlrtRTEI, true);
  emxInit_cell_wrap_2(&st, &repeatLayers, 2, &yb_emlrtRTEI, true);
  emxInit_real_T(&st, &params, 2, &yb_emlrtRTEI, true);
  emxInit_cell_wrap_0(&st, &contrastLayers, 2, &yb_emlrtRTEI, true);
  emxInit_cell_wrap_3(&st, &layersDetails, 2, &yb_emlrtRTEI, true);
  emxInit_real_T1(&st, &outSsubs, 1, &yb_emlrtRTEI, true);
  emxInit_real_T1(&st, &backgs, 1, &yb_emlrtRTEI, true);
  emxInit_real_T1(&st, &qshifts, 1, &yb_emlrtRTEI, true);
  emxInit_real_T1(&st, &sfs, 1, &yb_emlrtRTEI, true);
  emxInit_real_T1(&st, &nbas, 1, &yb_emlrtRTEI, true);
  emxInit_real_T1(&st, &nbss, 1, &yb_emlrtRTEI, true);
  emxInit_real_T1(&st, &resols, 1, &yb_emlrtRTEI, true);
  emxInit_real_T1(&st, &chis, 1, &yb_emlrtRTEI, true);
  emxInit_cell_wrap_4(&st, &reflectivity, 2, &yb_emlrtRTEI, true);
  emxInit_cell_wrap_4(&st, &Simulation, 2, &yb_emlrtRTEI, true);
  emxInit_cell_wrap_1(&st, &shifted_data, 2, &yb_emlrtRTEI, true);
  emxInit_cell_wrap_1(&st, &layerSlds, 2, &yb_emlrtRTEI, true);
  emxInit_cell_wrap_4(&st, &sldProfiles, 2, &yb_emlrtRTEI, true);
  emxInit_cell_wrap_5(&st, &allLayers, 2, &yb_emlrtRTEI, true);
  emxInit_real_T1(&st, &allRoughs, 1, &yb_emlrtRTEI, true);
  ...
  standardTF_stanlay_single(&st, resam, numberOfContrasts, geometry, nbairs,

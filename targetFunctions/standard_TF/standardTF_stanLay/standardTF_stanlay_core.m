...
%     background,resol,backsType,params,paralellPoints)
%
%   This is the main reflectivity calculation for Standard Layers in the 
%   standard target function. The function first selects the correct layers
%   needed for this contrast, and puts them in the correct order according
...
[reflect,Simul] = callReflectivity(nba,nbs,simLimits,repeatLayers,shifted_dat,layerSld,ssubs,background,resol,paralellPoints);

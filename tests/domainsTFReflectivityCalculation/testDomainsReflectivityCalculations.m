...
%% Read in test data
    ...
    methods (TestClassSetup, ParameterCombination='sequential')
        function addDataPath(testCase)
            ...
            path = fullfile(getappdata(0, 'root'), 'tests', 'domainsTFReflectivityCalculation');
...
%% Test Reflectivity Calculation Routines
        ...
        function testDomainsTFReflectivityCalculation(testCase)
            [contrastParams, calculationResults, reflectivity, simulation, shiftedData, backgrounds, layerSLDs, SLDProfiles, resampledLayers] = domainsTF.reflectivityCalculation(testCase.problemStruct, testCase.problemCells, testCase.controls);

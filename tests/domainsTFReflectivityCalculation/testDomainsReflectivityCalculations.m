...
% domainsTFStandardLayersReflectivityCalculation,
% domainsTFCustomLayersReflectivityCalculation,
% domainsTFCustomXYReflectivityCalculation, 
% domainsTFStandardLayersSingle, domainsTFCustomLayersSingle,
% domainsTFCustomXYSingle, domainsTFStandardLayersParallelContrasts,
% domainsTFCustomLayersParallelContrasts, domainsTFCustomXYParallelContrasts,
% domainsTFStandardLayersParallelPoints, domainsTFCustomLayersParallelPoints,
% domainsTFCustomXYParallelPoints,
...
%% Test Reflectivity Calculation Routines
        ...
        function testDomainsTFReflectivityCalculation(testCase)
            [problem, reflectivity, simulation, shiftedData, layerSLDs, SLDProfiles, allLayers] = domainsTFReflectivityCalculation(testCase.problemDef, testCase.problemDefCells, testCase.problemDefLimits, testCase.controls);
        ...
        function testDomainsTFLayersReflectivityCalculation(testCase, TFFile)
            ...
            switch TFFile
                case 'domainsStandardLayersTFParams.mat'
                    [problem, reflectivity, simulation, shiftedData, layerSLDs, SLDProfiles, allLayers] = domainsTFStandardLayersReflectivityCalculation(testCase.problemDef, testCase.problemDefCells, testCase.problemDefLimits, testCase.controls);
                case 'domainsCustomLayersTFParams.mat'
                    [problem, reflectivity, simulation, shiftedData, layerSLDs, SLDProfiles, allLayers] = domainsTFCustomLayersReflectivityCalculation(testCase.problemDef, testCase.problemDefCells, testCase.problemDefLimits, testCase.controls);
                case 'domainsCustomXYTFParams.mat'
                    [problem, reflectivity, simulation, shiftedData, layerSLDs, SLDProfiles, allLayers] = domainsTFCustomXYReflectivityCalculation(testCase.problemDef, testCase.problemDefCells, testCase.problemDefLimits, testCase.controls);
            end
        ...
        function testDomainsTFLayersSerialReflectivityCalculation(testCase, TFFile)
            ...
            switch TFFile
                case 'domainsStandardLayersTFParams.mat'
                    ...
                    allRoughs] = domainsTFStandardLayersSingle(testCase.problemDef,testCase.problemDefCells,...
                    testCase.problemDefLimits,testCase.controls);
                case 'domainsCustomLayersTFParams.mat'
                    [outSsubs,backgs,qshifts,sfs,nbas,nbss,resols,chis,reflectivity,...
                    simulation,shiftedData,layerSLDs,SLDProfiles,allLayers,...
                    allRoughs] = domainsTFCustomLayersSingle(testCase.problemDef,testCase.problemDefCells,...
                    testCase.problemDefLimits,testCase.controls);
                case 'domainsCustomXYTFParams.mat'
                    [outSsubs,backgs,qshifts,sfs,nbas,nbss,resols,chis,reflectivity,...
                    simulation,shiftedData,layerSLDs,SLDProfiles,allLayers,...
                    allRoughs] = domainsTFCustomXYSingle(testCase.problemDef,testCase.problemDefCells,...
                    testCase.problemDefLimits,testCase.controls);
            end
        ...
        function testDomainsTFLayersParallelContrastsReflectivityCalculation(testCase, TFFile)
            ...
            switch TFFile
                case 'domainsStandardLayersTFParams.mat'
                    [outSsubs,backgs,qshifts,sfs,nbas,nbss,resols,chis,reflectivity,...
                    simulation,shiftedData,layerSLDs,SLDProfiles,allLayers,...
                    allRoughs] = domainsTFStandardLayersParallelContrasts(testCase.problemDef,testCase.problemDefCells,...
                    testCase.problemDefLimits,testCase.controls);
                case 'domainsCustomLayersTFParams.mat'
                    [outSsubs,backgs,qshifts,sfs,nbas,nbss,resols,chis,reflectivity,...
                    simulation,shiftedData,layerSLDs,SLDProfiles,allLayers,...
                    allRoughs] = domainsTFCustomLayersParallelContrasts(testCase.problemDef,testCase.problemDefCells,...
                    testCase.problemDefLimits,testCase.controls);
                case 'domainsCustomXYTFParams.mat'
                    [outSsubs,backgs,qshifts,sfs,nbas,nbss,resols,chis,reflectivity,...
                    simulation,shiftedData,layerSLDs,SLDProfiles,allLayers,...
                    allRoughs] = domainsTFCustomXYParallelContrasts(testCase.problemDef,testCase.problemDefCells,...
                    testCase.problemDefLimits,testCase.controls);
            end
        ...
        function testDomainsTFLayersParallelPointsReflectivityCalculation(testCase, TFFile)
            ...
            switch TFFile
                case 'domainsStandardLayersTFParams.mat'
                    [outSsubs,backgs,qshifts,sfs,nbas,nbss,resols,chis,reflectivity,...
                    simulation,shiftedData,layerSLDs,SLDProfiles,allLayers,...
                    allRoughs] = domainsTFStandardLayersParallelPoints(testCase.problemDef,testCase.problemDefCells,...
                    testCase.problemDefLimits,testCase.controls);
                case 'domainsCustomLayersTFParams.mat'
                    [outSsubs,backgs,qshifts,sfs,nbas,nbss,resols,chis,reflectivity,...
                    simulation,shiftedData,layerSLDs,SLDProfiles,allLayers,...
                    allRoughs] = domainsTFCustomLayersParallelPoints(testCase.problemDef,testCase.problemDefCells,...
                    testCase.problemDefLimits,testCase.controls);
                case 'domainsCustomXYTFParams.mat'
                    [outSsubs,backgs,qshifts,sfs,nbas,nbss,resols,chis,reflectivity,...
                    simulation,shiftedData,layerSLDs,SLDProfiles,allLayers,...
                    allRoughs] = domainsTFCustomXYParallelPoints(testCase.problemDef,testCase.problemDefCells,...
                    testCase.problemDefLimits,testCase.controls);
            end

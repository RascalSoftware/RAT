...
## Generated on : Tue Feb 08 11:12:33 2022
...
DEFINES_ = -DBUILDING_CUSTOMBILAYER
DEFINES_CUSTOM = 
...
SRCS = $(START_DIR)/customBilayer_data.cpp $(START_DIR)/customBilayer_initialize.cpp $(START_DIR)/customBilayer_terminate.cpp $(START_DIR)/customBilayer.cpp
...
OBJS = customBilayer_data.o customBilayer_initialize.o customBilayer_terminate.o customBilayer.o
...
customBilayer_data.o : $(START_DIR)/customBilayer_data.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


customBilayer_initialize.o : $(START_DIR)/customBilayer_initialize.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


customBilayer_terminate.o : $(START_DIR)/customBilayer_terminate.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


customBilayer.o : $(START_DIR)/customBilayer.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"

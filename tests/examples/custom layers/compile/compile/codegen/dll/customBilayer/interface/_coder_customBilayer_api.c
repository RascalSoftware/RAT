...
static real_T c_emlrt_marshallIn(const emlrtStack *sp, const mxArray *bulk_in,
                                 ...
                                 const char_T *identifier)
{
  ...
  y = d_emlrt_marshallIn(sp, emlrtAlias(bulk_in), &thisId);
                       ...
                       const mxArray *plhs[2])
{
  ...
  bulk_in = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[1]), "bulk_in");
  bulk_out = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[2]), "bulk_out");
  contrast = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[3]), "contrast");
  ...
  if (nlhs > 1) {
    plhs[1] = b_emlrt_marshallOut(sub_rough);
  }
...
/* End of code generation (_coder_customBilayer_api.c) */

...
% We are using a data resolution here, which assumes the 4th column of the
% datafile to contain dq/q. We set a 'data' resolution type and use this
...
%% 
% Test the different parallelisations..

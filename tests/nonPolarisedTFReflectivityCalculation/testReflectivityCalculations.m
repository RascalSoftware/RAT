        ...
        function testNonPolarisedTFLayersReflectivityCalc(testCase, whichParallel, TFFile)
            ...
            switch TFFile
                case 'standardLayersTFParams.mat'
                    ...
                    allRoughs] = nonPolarisedTF.standardLayers.standardLayers(testCase.problemStruct,testCase.problemCells,...
                    testCase.controls);
                case 'customLayersTFParams.mat'
                    [outSsubs,backgroundParams,qzshifts,scalefactors,bulkIn,bulkOut,resolutionParams,chis,reflectivity,...
                    simulation,shiftedData,layerSLDs,SLDProfiles,allLayers,...
                    allRoughs] = nonPolarisedTF.customLayers.customLayers(testCase.problemStruct,testCase.problemCells,...
                    testCase.controls);
                case 'customXYTFParams.mat'
                    [outSsubs,backgroundParams,qzshifts,scalefactors,bulkIn,bulkOut,resolutionParams,chis,reflectivity,...
                    simulation,shiftedData,layerSLDs,SLDProfiles,allLayers,...
                    allRoughs] = nonPolarisedTF.customXY.customXY(testCase.problemStruct,testCase.problemCells,...
                    testCase.controls);
            end

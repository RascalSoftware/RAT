 classdef testBackgroundsClass < matlab.unittest.TestCase   
   ...
   methods (Test)
      function testCreation(testCase)
         ...
         testCase.verifyEqual(string(background.backPars.paramTable{1, :}), ...
                              string(testCase.parameters(1, :)), 'Start background parameter not set correctly');
         testCase.verifySize(background.backPars.paramTable, [3, 8], 'background Parameters has wrong dimension');
         
         testCase.verifyEqual(string(background.backgrounds.paramTable{1, :}), ...
                              string(testCase.backgrounds(1, :)), 'Start background parameter not set correctly');
         testCase.verifySize(background.backgrounds.paramTable, [1, 7], 'backgrounds has wrong dimension');
      end
      ...
      function testGetBackgroundNames(testCase)
         ...
         testCase.background.backgrounds.paramTable = [testCase.background.backgrounds.paramTable; vertcat(testCase.backgrounds(2:end, :))];
         names = testCase.background.getBackgroundNames();
      ...
      function testAddBackground(testCase)
         ...
         testCase.background.backPars.paramTable = [testCase.background.backPars.paramTable; vertcat(testCase.parameters(2:end, :))];
      ...
      function testRemoveBackground(testCase)
         ...
         testCase.verifyEqual(testCase.background.backgrounds.paramTable{:, 1}, ...
                              ["background 1"; "background 2"; "background 4"], 'removeBacksPar method not working');
         testCase.background.removeBackground([1, 3]);
         testCase.verifyEqual(testCase.background.backgrounds.paramTable{:, 1}, "background 2", 'removeBacksPar method not working');  
      end
      ...
      function testSetBackgroundName(testCase)
         ...
         testCase.verifyEqual(testCase.background.backgrounds.paramTable{1, 1}, ...
                              "background one", 'setBackgroundName method not working');
         testCase.background.setBackgroundName(3, 'background three');
         testCase.verifyEqual(testCase.background.backgrounds.paramTable{3, 1}, ...
      ...
      function testSetBackground(testCase)
         ...
         testCase.verifyEqual(testCase.background.backgrounds.paramTable{1, 1}, "Back 1", 'setBackground method not working');
         testCase.background.setBackground(1, 'name', 'Background 1');
         testCase.verifyEqual(testCase.background.backgrounds.paramTable{1, 1}, "Background 1", 'setBackground method not working');

         testCase.background.setBackground(1, 'type', allowedTypes.Constant.value);
         testCase.verifyEqual(testCase.background.backgrounds.paramTable{1, 2}, string(allowedTypes.Constant.value), 'setBackground method not working');
         testCase.background.setBackground('Background 1', 'type', allowedTypes.Function); 
         testCase.verifyEqual(testCase.background.backgrounds.paramTable{1, 2}, string(allowedTypes.Function.value), 'setBackground method not working');
         ...
         testCase.verifyEqual(testCase.background.backgrounds.paramTable{3, 3}, "random", 'setBackground method not working');
         testCase.background.setBackground('Background 3', 'Value1', 'Background par 1');
         testCase.verifyEqual(testCase.background.backgrounds.paramTable{3, 3}, "Background par 1", 'setBackground method not working');
         
         testCase.background.setBackground(2, 'Value2', 'Background par 1');
         testCase.verifyEqual(testCase.background.backgrounds.paramTable{2, 4}, "Background par 1", 'setBackground method not working');
         ...
         testCase.verifyEqual(testCase.background.backgrounds.paramTable{3, 1}, "New Name", 'setBackground method not working');
         testCase.verifyEqual(testCase.background.backgrounds.paramTable{3, 2}, string(allowedTypes.Constant.value), 'setBackground method not working');
         testCase.verifyEqual(testCase.background.backgrounds.paramTable{3, 3}, "Background par 3", 'setBackground method not working');
         testCase.verifyEqual(testCase.background.backgrounds.paramTable{3, 4}, "", 'setBackground method not working');
      end
      ...
      function testDisplayBackgroundsObject(testCase)
         ...
         testCase.verifyLength(displayArray, height(testCase.background.backPars.paramTable) + 3);
         ...
         testCase.verifyLength(displayArray, height(testCase.background.backgrounds.paramTable) + 3);
         displayHeader = eraseBetween(displayArray{2}, '<', '>', 'Boundaries','inclusive');
         displayHeader = regexp(displayHeader, '\s{2,}', 'split');
         testCase.verifyEqual(displayHeader, paramHeader);
         row = regexp(displayArray{4}, '\s{2,}', 'split');
      ...
      function testToStruct(testCase)
         ...
         testCase.background.backgrounds.paramTable = [testCase.background.backgrounds.paramTable; vertcat(testCase.backgrounds(2:3, :))];
         testCase.background.backPars.paramTable = [testCase.background.backPars.paramTable; vertcat(testCase.parameters(2:3, :))];

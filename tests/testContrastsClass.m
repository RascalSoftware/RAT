...
%% Test Contrasts Class Routines
    ...
    methods (Test, ParameterCombination='sequential')
        ...
        function testSetContrastNoDomainsNoOil(testCase)
            ...
            % If we include "oilData" or "domainRatio" here, we should
            % encounter an error
        ...
        function testDisplayContrastsObject(testCase)
            ...
            rowString(3) = strjoin(["Oil Data", ...
                                    testCase.exampleClass.contrasts{1}.oilData, ...
                                    testCase.exampleClass.contrasts{2}.oilData, ...
                                    testCase.exampleClass.contrasts{3}.oilData]);

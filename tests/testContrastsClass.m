...
%% Test Contrasts Class Routines
    ...
    methods (Test, ParameterCombination='sequential')
        ...
        function testDisplayContrastsObject(testCase)
            ...
            rowString(9) = strjoin(["Domain Ratio", ...

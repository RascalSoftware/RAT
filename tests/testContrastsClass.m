    ...
    properties (TestParameter)
        contrastInput = {{}, ...
                         ...
                         {'name', 'All params', ...
                          ...
                          'backgroundAction', actions.Subtract, ...
                          'bulkIn', 'Silicon', ...
                          'bulkOut', 'SLD H2O', ...
...
%% Set up test data
    ...
    methods (TestClassSetup)
        ...
        function initialiseDefaultContrastParams(testCase)
            ...
            testCase.defaultContrastParams = struct( ...
                ...
                'oilChiData', '', ...
                'background', '', ...
                'backgroundAction', actions.Add.value, ...
                'bulkIn', '', ...
                'bulkOut', '', ...
                'scalefactor', '', ...
                'resolution', '', ...
    ...
    methods (TestMethodSetup)
        ...
        function initialiseContrastsStruct(testCase)
            ...
            testCase.exampleStruct.contrastBackgrounds = {[1 1] [2 1] [3 1]};
    ...
    methods (Test, ParameterCombination='sequential')
        ...
        function testSetContrast(testCase)
            ...
            expectedContrast = struct( ...
                ...
                'oilChiData', 'Simulation', ...
                'background', 'Background SMW', ...
                'backgroundAction', actions.Subtract.value, ...
                'bulkIn', 'Silicon', ...
                'bulkOut', 'SLD SMW', ...
                'scalefactor', 'Test Scalefactor', ...
                'resolution', 'Test Resolution', ...
        ...
        function testDisplayContrastsObject(testCase)
            ...
            rowString(5) = strjoin(["Background Action", ...
            ...
            rowString(8) = strjoin(["Scalefactor", ...
            ...
            rowString(9) = strjoin(["Resolution", ...
        ...
        function testDisplayContrastsObjectEmpty(testCase)
            ...
            rowString = ["Name" "Data" "Background" "Background Action" "Bulk in"...
                "Bulk out" "Scalefactor" "Resolution" "Resample" "Model"];

classdef testControlsClass < matlab.unittest.TestCase   
    ...
    methods (Test)
        ...
        function testResampleMinAngle(testCase)
            ...
            testCase.controls.resampleMinAngle = 0.9;
            testCase.verifyEqual(testCase.controls.resampleMinAngle, 0.9, 'set.resampleMinAngle method is not working')            
        ...
        function testSetProcedureWithDream(testCase) 
            ...
            testCase.verifyError(@() testCase.controls.setProcedure(procedures.Dream.value,...
                {'boundHandling', 'invalid'}), exceptions.invalidOption.errorID);

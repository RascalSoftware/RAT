classdef testExamples < matlab.unittest.TestCase
    ...
    methods (Test,ParameterCombination="sequential")
        ...
        function testExample(testCase, ...
            ...
            testCase.verifyEqual(problem.layers.paramCount, exampleLayerCount);
            ...
            testCase.verifyEqual(problem.background.backgrounds.paramCount, exampleBackgroundsTypesCount);
            testCase.verifyEqual(problem.data.paramCount, exampleDataCount);
            ...
            testCase.verifyEqual(problem.resolution.resolutions.paramCount, 1);

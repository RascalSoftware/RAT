classdef testExamples < matlab.unittest.TestCase
    ...
    methods (Test,ParameterCombination="sequential")
        ...
        function testWriteScript(testCase, exampleFile)
            ...
            % Test properties
            testCase.verifyEqual(problem.parameters.varTable, scriptProblem.parameters.varTable, 'parameters are not correctly regenerated by the script', 'RelTol', testCase.tolerance, 'AbsTol', testCase.abs_tolerance)
            testCase.verifyEqual(problem.bulkIn.varTable, scriptProblem.bulkIn.varTable, 'bulkIn parameters are not correctly regenerated by the script', 'RelTol', testCase.tolerance, 'AbsTol', testCase.abs_tolerance)
            testCase.verifyEqual(problem.bulkOut.varTable, scriptProblem.bulkOut.varTable, 'bulkOut parameters are not correctly regenerated by the script', 'RelTol', testCase.tolerance, 'AbsTol', testCase.abs_tolerance)
            testCase.verifyEqual(problem.scalefactors.varTable, scriptProblem.scalefactors.varTable, 'scalefactors are not correctly regenerated by the script', 'RelTol', testCase.tolerance, 'AbsTol', testCase.abs_tolerance)
            testCase.verifyEqual(problem.qzshifts.varTable, scriptProblem.qzshifts.varTable, 'qz shifts are not correctly regenerated by the script', 'RelTol', testCase.tolerance, 'AbsTol', testCase.abs_tolerance)

            % Test backgrounds and resolutions
            testCase.verifyEqual(problem.background.backPars.varTable, scriptProblem.background.backPars.varTable, 'background parameters are not correctly regenerated by the script', 'RelTol', testCase.tolerance, 'AbsTol', testCase.abs_tolerance)
            testCase.verifyEqual(problem.background.backgrounds.varTable, scriptProblem.background.backgrounds.varTable, 'backgrounds are not correctly regenerated by the script', 'RelTol', testCase.tolerance, 'AbsTol', testCase.abs_tolerance)
            testCase.verifyEqual(problem.resolution.resolPars.varTable, scriptProblem.resolution.resolPars.varTable, 'resolution parameters not correctly regenerated by the script', 'RelTol', testCase.tolerance, 'AbsTol', testCase.abs_tolerance)
            testCase.verifyEqual(problem.resolution.resolutions.varTable, scriptProblem.resolution.resolutions.varTable, 'resolutions are not correctly regenerated by the script', 'RelTol', testCase.tolerance, 'AbsTol', testCase.abs_tolerance)

            % Test string classes and data
            testCase.verifyEqual(problem.layers.varTable, scriptProblem.layers.varTable, 'layers are not correctly regenerated by the script', 'RelTol', testCase.tolerance, 'AbsTol', testCase.abs_tolerance)
            testCase.verifyEqual(problem.customFile.varTable, scriptProblem.customFile.varTable, 'custom files are not correctly regenerated by the script', 'RelTol', testCase.tolerance, 'AbsTol', testCase.abs_tolerance)
            testCase.verifyEqual(problem.data.varTable, scriptProblem.data.varTable, 'data are not correctly regenerated by the script', 'RelTol', testCase.tolerance, 'AbsTol', testCase.abs_tolerance)
            ...
            for i=1:length(problem.contrasts.contrasts)
                testCase.verifyEqual(problem.contrasts.contrasts{i}, scriptProblem.contrasts.contrasts{i}, sprintf('contrast %i is not correctly regenerated by the script', i))
            end

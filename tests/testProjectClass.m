...
classdef testProjectClass < matlab.unittest.TestCase
    ...
    methods (Test)
        ...
        function testConversion(testCase)
            ...
            testCase.verifyFalse(testCase.project.contrasts.isDomains, 'Calculation Type not set correctly')
            ...
            testCase.verifyTrue(domains.contrasts.isDomains, 'Calculation Type not set correctly')
        ...
        function testWriteScript(testCase)
            ...
            testCase.verifyError(@() testCase.project.writeScript(path="invalid.txt"), exceptions.invalidValue.errorID);
            testCase.project.writeScript(objName="problem", path="newScript");
            run("newScript.m");
            ...
            testCase.verifyEqual(testCase.project.contrasts.isDomains, problem.contrasts.isDomains, 'contrasts domainsCalc is not correctly regenerated by the script');

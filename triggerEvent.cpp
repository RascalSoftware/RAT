...
namespace RAT
{
  ...
  {
    ::coder::array<cell_wrap_7, 2U> result_sldProfiles;
    ::coder::array<cell_wrap_9, 2U> result_resampledLayers;
    ...
    if (initialised) {
      int b_loop_ub;
      result_sldProfiles.set_size(varargin_1.sldProfiles.size(0),
        varargin_1.sldProfiles.size(1));
      loop_ub = varargin_1.sldProfiles.size(1);
      for (i = 0; i < loop_ub; i++) {
        b_loop_ub = varargin_1.sldProfiles.size(0);
        for (int i1{0}; i1 < b_loop_ub; i1++) {
          result_sldProfiles[i1 + result_sldProfiles.size(0) * i] =
            varargin_1.sldProfiles[i1 + varargin_1.sldProfiles.size(0) * i];
        }
      }

      result_resampledLayers.set_size(varargin_1.resampledLayers.size(0),
        varargin_1.resampledLayers.size(1));
      loop_ub = varargin_1.resampledLayers.size(1);
      for (i = 0; i < loop_ub; i++) {
        b_loop_ub = varargin_1.resampledLayers.size(0);
        for (int i1{0}; i1 < b_loop_ub; i1++) {
          result_resampledLayers[i1 + result_resampledLayers.size(0) * i] =
            varargin_1.resampledLayers[i1 + varargin_1.resampledLayers.size(0) *
            i];
        }
      }

      alignALProfiles(varargin_2_geometry_data, varargin_2_geometry_size,
                      varargin_2_modelType_data, varargin_2_modelType_size,
                      result_sldProfiles, result_resampledLayers);
      ...
      packCellArray(result_sldProfiles, sldProfiles, nSldProfiles);
      packCellArray(result_resampledLayers, layers, nLayers);
      ...
      if (i == 0) {
        b_packCellArray(result_sldProfiles, b_sldProfiles2, nSldProfiles2);
        ...
        b_packCellArray(result_resampledLayers, b_sldProfiles2, nSldProfiles2);
        loop_ub = b_sldProfiles2.size(0);

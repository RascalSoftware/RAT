...
if R1_DEBUG
    R1_DEBUGVARS.callReflectivityCalculation.reflectivity = reflectivity;
    R1_DEBUGVARS.callReflectivityCalculation.slds = sldProfiles;
    R1_DEBUGVARS.callReflectivityCalculation.layers = slds;
end
